...
public final class DebugCoroutineInfo {
    ...
    public static final class C12591 extends ContinuationImpl {
        Object L$0;
        Object L$1;
        Object L$2;
        int label;
        ...
        public C12591(Continuation<? super C12591> continuation) {
            super(continuation);
        }
    ...
    public DebugCoroutineInfo(@Nullable CoroutineContext coroutineContext, @Nullable StackTraceFrame stackTraceFrame, long j2) {
    ...
    */
    public final java.lang.Object yieldFrames(kotlin.sequences.SequenceScope<? super java.lang.StackTraceElement> r6, kotlin.coroutines.jvm.internal.CoroutineStackFrame r7, kotlin.coroutines.Continuation<? super kotlin.Unit> r8) {
        /*
            r5 = this;
            boolean r0 = r8 instanceof kotlinx.coroutines.debug.internal.DebugCoroutineInfo.C12591
            if (r0 == 0) goto L13
            r0 = r8
            kotlinx.coroutines.debug.internal.DebugCoroutineInfoImpl$yieldFrames$1 r0 = (kotlinx.coroutines.debug.internal.DebugCoroutineInfo.C12591) r0
            int r1 = r0.label
    ...
    public final void updateState$kotlinx_coroutines_core(@NotNull String state, @NotNull Continuation<?> frame) {
        ...
        this.lastObservedThread = Intrinsics.areEqual(state, "RUNNING") ? Thread.currentThread() : null;
    }
}
