...
public final class UndispatchedKt {
        ...
        try {
            ...
            try {
                ...
                if (objInvoke != IntrinsicsKt__IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
                    ...
                    continuationProbeCoroutineCreated.resumeWith(Result.m783constructorimpl(objInvoke));
                }
            } finally {
            ...
            continuationProbeCoroutineCreated.resumeWith(Result.m783constructorimpl(ResultKt.createFailure(th)));
        }
    }
    ...
    @Nullable
    public static final <T, R> Object startUndispatchedOrReturnIgnoreTimeout(@NotNull ScopeCoroutine<? super T> scopeCoroutine, R r2, @NotNull Function2<? super R, ? super Continuation<? super T>, ? extends Object> function2) throws Throwable {
        Object completedExceptionally;
        try {
            completedExceptionally = ((Function2) TypeIntrinsics.beforeCheckcastToFunctionOfArity(function2, 2)).invoke(r2, scopeCoroutine);
        } catch (Throwable th) {
