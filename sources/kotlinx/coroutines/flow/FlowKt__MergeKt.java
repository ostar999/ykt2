...
final /* synthetic */ class FlowKt__MergeKt {
    ...
    @Metadata(d1 = {"\u0000\u0010\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0000\u0010\u0005\u001a\u00020\u0004\"\u0004\b\u0000\u0010\u0000\"\u0004\b\u0001\u0010\u0001*\b\u0012\u0004\u0012\u00028\u00010\u00022\u0006\u0010\u0003\u001a\u00028\u0000H\u008a@"}, d2 = {ExifInterface.GPS_DIRECTION_TRUE, "R", "Lkotlinx/coroutines/flow/FlowCollector;", AdvanceSetting.NETWORK_TYPE, "", "<anonymous>"}, k = 3, mv = {1, 6, 0})
    @DebugMetadata(c = "kotlinx.coroutines.flow.FlowKt__MergeKt$flatMapLatest$1", f = "Merge.kt", i = {}, l = {R2.array.ease_excel_file_suffix, R2.array.ease_excel_file_suffix}, m = "invokeSuspend", n = {}, s = {})
    ...
    public static final class C12641<R, T> extends SuspendLambda implements Function3<FlowCollector<? super R>, T, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        public C12641(Function2<? super T, ? super Continuation<? super R>, ? extends Object> function2, Continuation<? super C12641> continuation) {
            super(3, continuation);
            this.$transform = function2;
        }
        ...
        @Nullable
        public final Object invoke(@NotNull FlowCollector<? super R> flowCollector, T t2, @Nullable Continuation<? super Unit> continuation) {
            C12641 c12641 = new C12641(this.$transform, continuation);
            c12641.L$0 = flowCollector;
            c12641.L$1 = t2;
            return c12641.invokeSuspend(Unit.INSTANCE);
        }
    ...
    public static final <T, R> Flow<R> mapLatest(@NotNull Flow<? extends T> flow, @BuilderInference @NotNull Function2<? super T, ? super Continuation<? super R>, ? extends Object> function2) {
        return FlowKt.transformLatest(flow, new C12641(function2, null));
    }
