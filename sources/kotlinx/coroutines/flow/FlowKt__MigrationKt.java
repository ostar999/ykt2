...
final /* synthetic */ class FlowKt__MigrationKt {
    ...
    public static final class C12651<T> extends SuspendLambda implements Function2<FlowCollector<? super T>, Continuation<? super Unit>, Object> {
        final /* synthetic */ long $timeMillis;
        int label;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C12651(long j2, Continuation<? super C12651> continuation) {
            super(2, continuation);
            this.$timeMillis = j2;
        }
        ...
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            return new C12651(this.$timeMillis, continuation);
        }

        @Override // kotlin.jvm.functions.Function2
        @Nullable
        public final Object invoke(@NotNull FlowCollector<? super T> flowCollector, @Nullable Continuation<? super Unit> continuation) {
            return ((C12651) create(flowCollector, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    /* JADX INFO: Add missing generic type declarations: [T] */
    @Metadata(d1 = {"\u0000\u0012\n\u0000\n\u0002\u0018\u0002\n\u0002\u0010\u0003\n\u0000\n\u0002\u0010\u0002\n\u0000\u0010\u0005\u001a\u00020\u0004\"\u0004\b\u0000\u0010\u0000*\b\u0012\u0004\u0012\u00028\u00000\u00012\u0006\u0010\u0003\u001a\u00020\u0002H\u008a@"}, d2 = {ExifInterface.GPS_DIRECTION_TRUE, "Lkotlinx/coroutines/flow/FlowCollector;", "", AliyunLogKey.KEY_EVENT, "", "<anonymous>"}, k = 3, mv = {1, 6, 0})
    ...
    public static final class AnonymousClass2<T> extends SuspendLambda implements Function3<FlowCollector<? super T>, Throwable, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        public AnonymousClass2(Function1<? super Throwable, Boolean> function1, T t2, Continuation<? super AnonymousClass2> continuation) {
    ...
    public static final <T> Flow<T> delayFlow(@NotNull Flow<? extends T> flow, long j2) {
        return FlowKt.onStart(flow, new C12651(j2, null));
    }
    ...
    public static final <T> Flow<T> onErrorReturn(@NotNull Flow<? extends T> flow, T t2, @NotNull Function1<? super Throwable, Boolean> function1) {
        return FlowKt.m2338catch(flow, new AnonymousClass2(function1, t2, null));
    }
