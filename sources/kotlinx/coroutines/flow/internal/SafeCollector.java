...
public final class SafeCollector<T> extends ContinuationImpl implements FlowCollector<T>, CoroutineStackFrame {
    ...
    public Object emit(T t2, @NotNull Continuation<? super Unit> continuation) {
        try {
            Object objEmit = emit(continuation, (Continuation<? super Unit>) t2);
    ...
    public Object invokeSuspend(@NotNull Object result) {
        ...
        if (thM786exceptionOrNullimpl != null) {
            this.lastEmissionContext = new DownstreamExceptionContext(thM786exceptionOrNullimpl, get$context());
        }
        Continuation<? super Unit> continuation = this.completion;
