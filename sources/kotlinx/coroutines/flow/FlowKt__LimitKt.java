...
final /* synthetic */ class FlowKt__LimitKt {
    ...
    public static final class C12631<R> extends SuspendLambda implements Function2<FlowCollector<? super R>, Continuation<? super Unit>, Object> {
        ...
        public C12631(Flow<? extends T> flow, Function3<? super FlowCollector<? super R>, ? super T, ? super Continuation<? super Boolean>, ? extends Object> function3, Continuation<? super C12631> continuation) {
        ...
        public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
            C12631 c12631 = new C12631(this.$this_transformWhile, this.$transform, continuation);
            c12631.L$0 = obj;
            return c12631;
        }
        ...
        public final Object invoke(@NotNull FlowCollector<? super R> flowCollector, @Nullable Continuation<? super Unit> continuation) {
            return ((C12631) create(flowCollector, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    */
    ...
    public static final <T, R> Flow<R> transformWhile(@NotNull Flow<? extends T> flow, @BuilderInference @NotNull Function3<? super FlowCollector<? super R>, ? super T, ? super Continuation<? super Boolean>, ? extends Object> function3) {
        return FlowKt.flow(new C12631(flow, function3, null));
    }
}
