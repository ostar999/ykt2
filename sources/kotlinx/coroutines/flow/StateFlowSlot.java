...
final class StateFlowSlot extends AbstractSharedFlowSlot<StateFlowImpl<?>> {
    ...
    public final Object awaitPending(@NotNull Continuation<? super Unit> continuation) {
        ...
        if (!a.a(_state$FU, this, StateFlowKt.NONE, cancellableContinuationImpl)) {
            Result.Companion companion = Result.INSTANCE;
            cancellableContinuationImpl.resumeWith(Result.m783constructorimpl(Unit.INSTANCE));
        }
    ...
    public final void makePending() {
        while (true) {
            ...
            if (obj == StateFlowKt.NONE) {
                if (a.a(_state$FU, this, obj, StateFlowKt.PENDING)) {
                    return;
                }
            } else if (a.a(_state$FU, this, obj, StateFlowKt.NONE)) {
                Result.Companion companion = Result.INSTANCE;
                ((CancellableContinuationImpl) obj).resumeWith(Result.m783constructorimpl(Unit.INSTANCE));
                return;
            }
        }
    }
