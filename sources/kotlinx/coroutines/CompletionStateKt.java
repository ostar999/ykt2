...
public final class CompletionStateKt {
    ...
    public static final <T> Object recoverResult(@Nullable Object obj, @NotNull Continuation<? super T> continuation) {
        if (obj instanceof CompletedExceptionally) {
            ...
            return Result.m783constructorimpl(ResultKt.createFailure(((CompletedExceptionally) obj).cause));
        }
    ...
    public static final <T> Object toState(@NotNull Object obj, @Nullable Function1<? super Throwable, Unit> function1) {
        ...
        return thM786exceptionOrNullimpl == null ? function1 != null ? new CompletedWithCancellation(obj, function1) : obj : new CompletedExceptionally(thM786exceptionOrNullimpl, false, 2, null);
    }
    ...
    public static final <T> Object toState(@NotNull Object obj, @NotNull CancellableContinuation<?> cancellableContinuation) {
        Throwable thM786exceptionOrNullimpl = Result.m786exceptionOrNullimpl(obj);
        return thM786exceptionOrNullimpl == null ? obj : new CompletedExceptionally(thM786exceptionOrNullimpl, false, 2, null);
    }
}
