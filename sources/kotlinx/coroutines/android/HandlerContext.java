...
public final class HandlerContext extends HandlerDispatcher implements Delay {
    ...
    private final void cancelOnRejection(CoroutineContext context, Runnable block) {
        ...
        Dispatchers.getIO().mo2362dispatch(context, block);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: invokeOnTimeout$lambda-3, reason: not valid java name */
    public static final void m2310invokeOnTimeout$lambda3(HandlerContext handlerContext, Runnable runnable) {
    ...
    public DisposableHandle invokeOnTimeout(long timeMillis, @NotNull final Runnable block, @NotNull CoroutineContext context) {
        if (this.handler.postDelayed(block, RangesKt___RangesKt.coerceAtMost(timeMillis, DurationKt.MAX_MILLIS))) {
            return new DisposableHandle() { // from class: kotlinx.coroutines.android.a
                @Override // kotlinx.coroutines.DisposableHandle
                public final void dispose() {
                    HandlerContext.m2310invokeOnTimeout$lambda3(this.f27646c, block);
                }
            };
        }
        cancelOnRejection(context, block);
    ...
    public void mo2363scheduleResumeAfterDelay(long timeMillis, @NotNull final CancellableContinuation<? super Unit> continuation) {
        ...
        if (this.handler.postDelayed(runnable, RangesKt___RangesKt.coerceAtMost(timeMillis, DurationKt.MAX_MILLIS))) {
