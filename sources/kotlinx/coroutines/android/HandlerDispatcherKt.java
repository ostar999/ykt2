...
public final class HandlerDispatcherKt {
    ...
    static {
        ...
        try {
            ...
            objM783constructorimpl = Result.m783constructorimpl(new HandlerContext(asHandler(Looper.getMainLooper(), true), null, 2, null));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM783constructorimpl = Result.m783constructorimpl(ResultKt.createFailure(th));
        }
        Main = (HandlerDispatcher) (Result.m789isFailureimpl(objM783constructorimpl) ? null : objM783constructorimpl);
    }
    ...
    public static final Object awaitFrame(@NotNull Continuation<? super Long> continuation) {
        ...
        Dispatchers.getMain().mo2362dispatch(EmptyCoroutineContext.INSTANCE, new Runnable() { // from class: kotlinx.coroutines.android.HandlerDispatcherKt$awaitFrame$lambda-3$$inlined$Runnable$1
    ...
    public static final void postFrameCallback(Choreographer choreographer2, final CancellableContinuation<? super Long> cancellableContinuation) {
        choreographer2.postFrameCallback(new Choreographer.FrameCallback() { // from class: kotlinx.coroutines.android.b
            ...
            public final void doFrame(long j2) {
                HandlerDispatcherKt.m2311postFrameCallback$lambda6(cancellableContinuation, j2);
            }
        });
    }
    ...
    public static final void m2311postFrameCallback$lambda6(CancellableContinuation cancellableContinuation, long j2) {
