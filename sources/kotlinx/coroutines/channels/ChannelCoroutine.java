...
public class ChannelCoroutine<E> extends AbstractCoroutine<Unit> implements Channel<E> {
    ...
    public Object mo2313receiveCatchingJP2dKIU(@NotNull Continuation<? super ChannelResult<? extends E>> continuation) {
        Object objMo2313receiveCatchingJP2dKIU = this._channel.mo2313receiveCatchingJP2dKIU(continuation);
        IntrinsicsKt__IntrinsicsKt.getCOROUTINE_SUSPENDED();
        return objMo2313receiveCatchingJP2dKIU;
    }
    ...
    public Object mo2314tryReceivePtdJZtk() {
        return this._channel.mo2314tryReceivePtdJZtk();
    }
    ...
    public Object mo2315trySendJP2dKIU(E element) {
        return this._channel.mo2315trySendJP2dKIU(element);
    }
