...
public interface ReceiveChannel<E> {
    ...
    public static final class DefaultImpls {
        ...
        public static <E> E poll(@NotNull ReceiveChannel<? extends E> receiveChannel) throws Throwable {
            Object objMo2314tryReceivePtdJZtk = receiveChannel.mo2314tryReceivePtdJZtk();
            if (ChannelResult.m2330isSuccessimpl(objMo2314tryReceivePtdJZtk)) {
                return (E) ChannelResult.m2326getOrThrowimpl(objMo2314tryReceivePtdJZtk);
            }
            Throwable thM2324exceptionOrNullimpl = ChannelResult.m2324exceptionOrNullimpl(objMo2314tryReceivePtdJZtk);
            if (thM2324exceptionOrNullimpl == null) {
                return null;
            }
            throw StackTraceRecoveryKt.recoverStackTrace(thM2324exceptionOrNullimpl);
        }
        ...
        */
        public static <E> java.lang.Object receiveOrNull(@org.jetbrains.annotations.NotNull kotlinx.coroutines.channels.ReceiveChannel<? extends E> r4, @org.jetbrains.annotations.NotNull kotlin.coroutines.Continuation<? super E> r5) {
            ...
            L37:
                kotlin.ResultKt.throwOnFailure(r5)
                r0.label = r3
                java.lang.Object r4 = r4.mo2313receiveCatchingJP2dKIU(r0)
                if (r4 != r1) goto L43
                return r1
            L43:
                java.lang.Object r4 = kotlinx.coroutines.channels.ChannelResult.m2325getOrNullimpl(r4)
                return r4
            */
    ...
    @Metadata(k = 3, mv = {1, 6, 0}, xi = 48)
    @DebugMetadata(c = "kotlinx.coroutines.channels.ReceiveChannel$DefaultImpls", f = "Channel.kt", i = {}, l = {R2.attr.arcLabelText}, m = "receiveOrNull", n = {}, s = {})
    ...
    Object mo2313receiveCatchingJP2dKIU(@NotNull Continuation<? super ChannelResult<? extends E>> continuation);
    ...
    Object mo2314tryReceivePtdJZtk();
}
