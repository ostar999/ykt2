...
public class SendElement<E> extends Send {
    ...
    public void resumeSendClosed(@NotNull Closed<?> closed) {
        ...
        cancellableContinuation.resumeWith(Result.m783constructorimpl(ResultKt.createFailure(closed.getSendException())));
    }

    @Override // kotlinx.coroutines.internal.LockFreeLinkedListNode
    @NotNull
    public String toString() {
        return DebugStringsKt.getClassSimpleName(this) + '@' + DebugStringsKt.getHexAddress(this) + '(' + getElement() + ')';
    }

    @Override // kotlinx.coroutines.channels.Send
    @Nullable
    public Symbol tryResumeSend(@Nullable LockFreeLinkedListNode.PrepareOp otherOp) {
        if (this.cont.tryResume(Unit.INSTANCE, otherOp != null ? otherOp.desc : null) == null) {
            return null;
        }
        if (otherOp != null) {
