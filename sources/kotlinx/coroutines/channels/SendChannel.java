...
public interface SendChannel<E> {
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(@NotNull SendChannel<? super E> sendChannel, E e2) throws Throwable {
            Object objMo2315trySendJP2dKIU = sendChannel.mo2315trySendJP2dKIU(e2);
            if (ChannelResult.m2330isSuccessimpl(objMo2315trySendJP2dKIU)) {
                return true;
            }
            Throwable thM2324exceptionOrNullimpl = ChannelResult.m2324exceptionOrNullimpl(objMo2315trySendJP2dKIU);
    ...
    Object mo2315trySendJP2dKIU(E element);
}
