...
public final class ConcurrentLinkedListKt {
    ...
    public static final <N extends ConcurrentLinkedListNode<N>> N close(@NotNull N n2) {
        while (true) {
            ...
            ?? r02 = (ConcurrentLinkedListNode) obj;
            if (r02 != 0) {
                n2 = r02;
    ...
    private static final <S extends Segment<S>> Object findSegmentInternal(S s2, long j2, Function2<? super Long, ? super S, ? extends S> function2) {
        while (true) {
            if (s2.getId() >= j2 && !s2.getRemoved()) {
                return SegmentOrClosed.m2365constructorimpl(s2);
            }
            Object obj = s2.get_next();
            if (obj == CLOSED) {
                return SegmentOrClosed.m2365constructorimpl(CLOSED);
            }
            S sInvoke = (S) ((ConcurrentLinkedListNode) obj);
            if (sInvoke == null) {
                sInvoke = function2.invoke(Long.valueOf(s2.getId() + 1), s2);
