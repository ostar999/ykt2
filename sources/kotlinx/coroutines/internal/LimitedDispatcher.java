...
public final class LimitedDispatcher extends CoroutineDispatcher implements Runnable, Delay {
    ...
    public void mo2362dispatch(@NotNull CoroutineContext context, @NotNull Runnable block) {
        ...
        this.dispatcher.mo2362dispatch(this, this);
    }
    ...
    */
    ...
    public void mo2363scheduleResumeAfterDelay(long timeMillis, @NotNull CancellableContinuation<? super Unit> continuation) {
        this.$$delegate_0.mo2363scheduleResumeAfterDelay(timeMillis, continuation);
    }
}
