...
public final class CoroutineScheduler implements Executor, Closeable {
    ...
    private final int createNewWorker() {
        synchronized (this.workers) {
            ...
            int iCoerceAtLeast = RangesKt___RangesKt.coerceAtLeast(i2 - ((int) ((j2 & BLOCKING_MASK) >> 21)), 0);
            ...
            if (!(i3 == ((int) (TarConstants.MAXID & controlState$FU.incrementAndGet(this))))) {
                throw new IllegalArgumentException("Failed requirement.".toString());
            }
            worker.start();
    ...
    private final Worker parkedWorkersStackPop() {
        while (true) {
            ...
            Worker worker = this.workers.get((int) (TarConstants.MAXID & j2));
            if (worker == null) {
                return null;
            }
    ...
    private final boolean tryCreateWorker(long state) {
        if (RangesKt___RangesKt.coerceAtLeast(((int) (TarConstants.MAXID & state)) - ((int) ((state & BLOCKING_MASK) >> 21)), 0) < this.corePoolSize) {
    ...
    public final void parkedWorkersStackTopUpdate(@NotNull Worker worker, int oldIndex, int newIndex) {
        while (true) {
            long j2 = this.parkedWorkersStack;
            int iParkedWorkersStackNextIndex = (int) (TarConstants.MAXID & j2);
            long j3 = (2097152 + j2) & PARKED_VERSION_MASK;
    ...
    */
    ...
    public final class Worker extends Thread {
        ...
        private final Task trySteal(boolean blockingOnly) {
            int i2 = (int) (CoroutineScheduler.this.controlState & TarConstants.MAXID);
            if (i2 < 2) {
                return null;
            }
