    ...
    */
    ...
    public static final Object delay(long j2, @NotNull Continuation<? super Unit> continuation) {
        ...
        if (j2 < Long.MAX_VALUE) {
            getDelay(cancellableContinuationImpl.get$context()).mo2363scheduleResumeAfterDelay(j2, cancellableContinuationImpl);
        }
    ...
    public static final Object m2299delayVtjQ1oo(long j2, @NotNull Continuation<? super Unit> continuation) {
        Object objDelay = delay(m2300toDelayMillisLRDsOJo(j2), continuation);
    ...
    public static final long m2300toDelayMillisLRDsOJo(long j2) {
        if (Duration.m2135compareToLRDsOJo(j2, Duration.INSTANCE.m2238getZEROUwyO8pc()) > 0) {
            return RangesKt___RangesKt.coerceAtLeast(Duration.m2154getInWholeMillisecondsimpl(j2), 1L);
        }
        return 0L;
    }
}
