...
public final class DebugStringsKt {
    ...
    public static final String toDebugString(@NotNull Continuation<?> continuation) {
        ...
        try {
            ...
            objM783constructorimpl = Result.m783constructorimpl(continuation + '@' + getHexAddress(continuation));
        } catch (Throwable th) {
        ...
        if (Result.m786exceptionOrNullimpl(objM783constructorimpl) != null) {
            objM783constructorimpl = continuation.getClass().getName() + '@' + getHexAddress(continuation);
        }
        return (String) objM783constructorimpl;
    }
}
