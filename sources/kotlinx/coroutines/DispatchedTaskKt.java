...
public final class DispatchedTaskKt {
    ...
    public static final <T> void dispatch(@NotNull DispatchedTask<? super T> dispatchedTask, int i2) {
        ...
        if (coroutineDispatcher.isDispatchNeeded(coroutineContext)) {
            coroutineDispatcher.mo2362dispatch(coroutineContext, dispatchedTask);
        } else {
    ...
    public static final <T> void resume(@NotNull DispatchedTask<? super T> dispatchedTask, @NotNull Continuation<? super T> continuation, boolean z2) {
        ...
        Object objM783constructorimpl = Result.m783constructorimpl(successfulResult$kotlinx_coroutines_core);
        if (!z2) {
            continuation.resumeWith(objM783constructorimpl);
            return;
        }
        ...
        try {
            dispatchedContinuation.continuation.resumeWith(objM783constructorimpl);
