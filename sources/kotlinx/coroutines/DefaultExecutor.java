        ...
        try {
            ...
            while (true) {
                ...
                if (jProcessNextEvent == Long.MAX_VALUE) {
                    ...
                    jProcessNextEvent = RangesKt___RangesKt.coerceAtMost(jProcessNextEvent, j3);
                } else {
                    j2 = Long.MAX_VALUE;
                }
