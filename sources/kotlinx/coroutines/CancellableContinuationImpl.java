...
public class CancellableContinuationImpl<T> extends DispatchedTask<T> implements CancellableContinuation<T>, CoroutineStackFrame {
    ...
    public boolean cancel(@Nullable Throwable cause) {
        ...
        } while (!androidx.concurrent.futures.a.a(_state$FU, this, obj, new CancelledContinuation(this, cause, z2)));
    ...
    public void invokeOnCancellation(@NotNull Function1<? super Throwable, Unit> handler) {
        ...
        while (true) {
            ...
            if (obj instanceof Active) {
                if (androidx.concurrent.futures.a.a(_state$FU, this, obj, cancelHandlerMakeCancelHandler)) {
                    return;
                }
                ...
                if (obj instanceof CompletedContinuation) {
                    ...
                    if (completedContinuation.getCancelled()) {
                        ...
                        if (androidx.concurrent.futures.a.a(_state$FU, this, obj, CompletedContinuation.copy$default(completedContinuation, null, cancelHandlerMakeCancelHandler, null, null, null, 29, null))) {
                            return;
                        }
                    }
                } else {
                    ...
                    if (androidx.concurrent.futures.a.a(_state$FU, this, obj, new CompletedContinuation(obj, cancelHandlerMakeCancelHandler, null, null, null, 28, null))) {
                        return;
                    }
                }
            }
