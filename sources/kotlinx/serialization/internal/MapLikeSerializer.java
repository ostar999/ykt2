...
public abstract class MapLikeSerializer<Key, Value, Collection, Builder extends Map<Key, Value>> extends AbstractCollectionSerializer<Map.Entry<? extends Key, ? extends Value>, Collection, Builder> {
    ...
    public abstract void insertKeyValuePair(@NotNull Builder builder, int i2, Key key, Value value);
    ...
    public void serialize(@NotNull Encoder encoder, Collection value) {
        ...
        while (itCollectionIterator.hasNext()) {
            ...
            compositeEncoderBeginCollection.encodeSerializableElement(getDescriptor(), i3, getValueSerializer(), value2);
            i2 = i3 + 1;
        }
    ...
    public final void readElement(@NotNull CompositeDecoder decoder, int index, @NotNull Builder builder, boolean checkIndex) {
        ...
        builder.put(objDecodeSerializableElement$default, (!builder.containsKey(objDecodeSerializableElement$default) || (this.valueSerializer.getDescriptor().getKind() instanceof PrimitiveKind)) ? CompositeDecoder.DefaultImpls.decodeSerializableElement$default(decoder, getDescriptor(), i2, this.valueSerializer, null, 8, null) : decoder.decodeSerializableElement(getDescriptor(), i2, this.valueSerializer, MapsKt__MapsKt.getValue(builder, objDecodeSerializableElement$default)));
    }
}
