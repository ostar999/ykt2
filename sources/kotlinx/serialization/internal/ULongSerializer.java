...
public final class ULongSerializer implements KSerializer<ULong> {
    ...
    public /* bridge */ /* synthetic */ Object deserialize(Decoder decoder) {
        return ULong.m951boximpl(m2402deserializeI7RO_PI(decoder));
    }

    /* renamed from: deserialize-I7RO_PI, reason: not valid java name */
    public long m2402deserializeI7RO_PI(@NotNull Decoder decoder) {
        Intrinsics.checkNotNullParameter(decoder, "decoder");
        return ULong.m957constructorimpl(decoder.decodeInline(getDescriptor()).decodeLong());
    }
    ...
    public /* bridge */ /* synthetic */ void serialize(Encoder encoder, Object obj) {
        m2403serialize2TYgG_w(encoder, ((ULong) obj).getData());
    }

    /* renamed from: serialize-2TYgG_w, reason: not valid java name */
    public void m2403serialize2TYgG_w(@NotNull Encoder encoder, long value) {
