            ...
            while (true) {
                ...
                if (iDecodeElementIndex != -1) {
                    if (iDecodeElementIndex == 0) {
                        ...
                        t2 = (T) CompositeDecoder.DefaultImpls.decodeSerializableElement$default(compositeDecoderBeginStructure, getDescriptor(), iDecodeElementIndex, PolymorphicSerializerKt.findPolymorphicSerializer(this, compositeDecoderBeginStructure, (String) t3), null, 8, null);
                    }
                } else {
                    if (t2 == null) {
