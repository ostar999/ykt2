...
public final class UShortArrayBuilder extends PrimitiveArrayBuilder<UShortArray> {
    ...
    private UShortArrayBuilder(short[] sArr) {
        this.buffer = sArr;
        this.position = UShortArray.m1123getSizeimpl(sArr);
    ...
    public final void m2404appendxj2QHRw$kotlinx_serialization_core(short c3) {
        PrimitiveArrayBuilder.ensureCapacity$kotlinx_serialization_core$default(this, 0, 1, null);
        short[] sArr = this.buffer;
        int position = getPosition();
        this.position = position + 1;
        UShortArray.m1127set01HTLdE(sArr, position, c3);
    }

    @Override // kotlinx.serialization.internal.PrimitiveArrayBuilder
    public /* bridge */ /* synthetic */ UShortArray build$kotlinx_serialization_core() {
        return UShortArray.m1115boximpl(m2405buildamswpOA$kotlinx_serialization_core());
    }

    @NotNull
    /* renamed from: build-amswpOA$kotlinx_serialization_core, reason: not valid java name */
    public short[] m2405buildamswpOA$kotlinx_serialization_core() {
        ...
        return UShortArray.m1117constructorimpl(sArrCopyOf);
    }

    @Override // kotlinx.serialization.internal.PrimitiveArrayBuilder
    public void ensureCapacity$kotlinx_serialization_core(int requiredCapacity) {
        if (UShortArray.m1123getSizeimpl(this.buffer) < requiredCapacity) {
            short[] sArr = this.buffer;
            short[] sArrCopyOf = Arrays.copyOf(sArr, RangesKt___RangesKt.coerceAtLeast(requiredCapacity, UShortArray.m1123getSizeimpl(sArr) * 2));
            Intrinsics.checkNotNullExpressionValue(sArrCopyOf, "copyOf(this, newSize)");
            this.buffer = UShortArray.m1117constructorimpl(sArrCopyOf);
        }
    }
