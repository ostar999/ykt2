...
public final class LinkedHashMapSerializer<K, V> extends MapLikeSerializer<K, V, Map<K, ? extends V>, LinkedHashMap<K, V>> {
    ...
    public void checkCapacity(@NotNull LinkedHashMap<K, V> linkedHashMap, int i2) {
    ...
    public /* bridge */ /* synthetic */ void insertKeyValuePair(Map map, int i2, Object obj, Object obj2) {
        insertKeyValuePair((LinkedHashMap<int, Object>) map, i2, (int) obj, obj2);
    }
    ...
    public void insertKeyValuePair(@NotNull LinkedHashMap<K, V> linkedHashMap, int i2, K k2, V v2) {
        Intrinsics.checkNotNullParameter(linkedHashMap, "<this>");
