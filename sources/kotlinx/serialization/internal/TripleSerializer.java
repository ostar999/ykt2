    ...
    public TripleSerializer(@NotNull KSerializer<A> aSerializer, @NotNull KSerializer<B> bSerializer, @NotNull KSerializer<C> cSerializer) {
        ...
        this.descriptor = SerialDescriptorsKt.buildClassSerialDescriptor("kotlin.Triple", new SerialDescriptor[0], new Function1<ClassSerialDescriptorBuilder, Unit>(this) { // from class: kotlinx.serialization.internal.TripleSerializer$descriptor$1
            ...
            public final void invoke2(@NotNull ClassSerialDescriptorBuilder buildClassSerialDescriptor) {
                ...
                ClassSerialDescriptorBuilder.element$default(buildClassSerialDescriptor, c.f3115e, ((TripleSerializer) this.this$0).cSerializer.getDescriptor(), null, false, 12, null);
            }
        });
    }
