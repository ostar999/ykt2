...
public abstract class Json implements StringFormat {
    ...
    public static final class Companion extends Json {
        private Companion() {
            super(new JsonConfiguration(false, false, false, false, false, false, null, false, false, null, false, false, null, R2.dimen.preference_seekbar_padding_start, null), SerializersModuleBuildersKt.EmptySerializersModule(), null);
        }
    ...
    public final <T> T decodeFromString(@NotNull DeserializationStrategy<? extends T> deserializer, @NotNull String string) {
        Intrinsics.checkNotNullParameter(deserializer, "deserializer");
