...
public abstract class JsonContentPolymorphicSerializer<T> implements KSerializer<T> {
    ...
    private final Void throwSubtypeNotRegistered(KClass<?> subClass, KClass<?> baseClass) {
        ...
        throw new SerializationException("Class '" + simpleName + "' is not registered for polymorphic serialization " + ("in the scope of '" + baseClass.getSimpleName() + CharPool.SINGLE_QUOTE) + ".\nMark the base class as 'sealed' or register the serializer explicitly.");
    }
