...
public final class JvmStreamsKt {
    ...
    @ExperimentalSerializationApi
    public static final <T> void encodeToStream(@NotNull Json json, @NotNull SerializationStrategy<? super T> serializer, T t2, @NotNull OutputStream stream) throws IOException {
        Intrinsics.checkNotNullParameter(json, "<this>");
