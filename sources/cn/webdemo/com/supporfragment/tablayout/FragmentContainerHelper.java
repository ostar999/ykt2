package cn.webdemo.com.supporfragment.tablayout;
...
public class FragmentContainerHelper {
    ...
    private Animator.AnimatorListener mAnimatorListener = new AnimatorListenerAdapter() { // from class: cn.webdemo.com.supporfragment.tablayout.FragmentContainerHelper.1
    ...
    private ValueAnimator.AnimatorUpdateListener mAnimatorUpdateListener = new ValueAnimator.AnimatorUpdateListener() { // from class: cn.webdemo.com.supporfragment.tablayout.FragmentContainerHelper.2
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void dispatchPageSelected(int i2) {
        Iterator<MagicIndicator> it = this.mMagicIndicators.iterator();
        while (it.hasNext()) {
    ...
    public void handlePageSelected(final int i2, boolean z2) {
        ...
        if (z2) {
            ...
            this.mScrollAnimator.addListener(new Animator.AnimatorListener() { // from class: cn.webdemo.com.supporfragment.tablayout.FragmentContainerHelper.3
                ...
                public void onAnimationEnd(Animator animator) {
                    FragmentContainerHelper.this.dispatchPageScrollStateChanged(0);
                    FragmentContainerHelper.this.dispatchPageSelected(i2);
                    FragmentContainerHelper.this.mScrollAnimator = null;
                }
