...
public class BaseLoadMoreModule implements LoadMoreListenerImp {
    ...
    public static final void m87checkDisableLoadMoreIfNotFullPage$lambda4(BaseLoadMoreModule this$0, RecyclerView.LayoutManager manager) {
    ...
    public static final void m88checkDisableLoadMoreIfNotFullPage$lambda5(RecyclerView.LayoutManager manager, BaseLoadMoreModule this$0) {
        Intrinsics.checkNotNullParameter(manager, "$manager");
        Intrinsics.checkNotNullParameter(this$0, "this$0");
    ...
    private final void invokeLoadMoreListener() {
        ...
        if (recyclerViewOrNull != null) {
            recyclerViewOrNull.post(new Runnable() { // from class: t0.f
                @Override // java.lang.Runnable
                public final void run() {
                    BaseLoadMoreModule.m89invokeLoadMoreListener$lambda3$lambda2(this.f28231c);
                }
            });
            return;
        }
    ...
    public static final void m89invokeLoadMoreListener$lambda3$lambda2(BaseLoadMoreModule this$0) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
    ...
    public static /* synthetic */ void loadMoreEnd$default(BaseLoadMoreModule baseLoadMoreModule, boolean z2, int i2, Object obj) {
        if (obj != null) {
        ...
        baseLoadMoreModule.loadMoreEnd(z2);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: setupViewHolder$lambda-1, reason: not valid java name */
    public static final void m90setupViewHolder$lambda1(BaseLoadMoreModule this$0, View view) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
    ...
    public final void checkDisableLoadMoreIfNotFullPage() {
        ...
        if (layoutManager instanceof LinearLayoutManager) {
            recyclerViewOrNull.postDelayed(new Runnable() { // from class: t0.d
                @Override // java.lang.Runnable
                public final void run() {
                    BaseLoadMoreModule.m87checkDisableLoadMoreIfNotFullPage$lambda4(this.f28227c, layoutManager);
                }
            }, 50L);
        } else if (layoutManager instanceof StaggeredGridLayoutManager) {
            recyclerViewOrNull.postDelayed(new Runnable() { // from class: t0.e
                @Override // java.lang.Runnable
                public final void run() {
                    BaseLoadMoreModule.m88checkDisableLoadMoreIfNotFullPage$lambda5(layoutManager, this);
                }
            }, 50L);
        }
    }
    ...
    public final void setEnableLoadMoreEndClick(boolean z2) {
        this.enableLoadMoreEndClick = z2;
    }

    public final void setEnableLoadMoreIfNotFullPage(boolean z2) {
    ...
    public final void setupViewHolder$com_github_CymChad_brvah(@NotNull BaseViewHolder viewHolder) {
        ...
        viewHolder.itemView.setOnClickListener(new View.OnClickListener() { // from class: t0.c
            ...
            public final void onClick(View view) {
                BaseLoadMoreModule.m90setupViewHolder$lambda1(this.f28226c, view);
            }
        });
    }
}
