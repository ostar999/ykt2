...
public class Config {
    ...
    public static class Builder {
        ...
        public Builder setEventUploadSwitchOpen(boolean z2) {
            this.mEventUploadSwitchOpen = z2 ? 1 : 0;
            return this;
        }
        ...
        public Builder setPerfUploadSwitchOpen(boolean z2) {
            this.mPerfUploadSwitchOpen = z2 ? 1 : 0;
            return this;
        }
    }
    ...
    private Config(Context context, Builder builder) {
        ...
        this.mAESKey = !TextUtils.isEmpty(builder.mAESKey) ? builder.mAESKey : be.m227a(context);
    ...
    public static Config defaultConfig(Context context) {
        return getBuilder().setEventEncrypted(true).setAESKey(be.m227a(context)).setMaxFileLength(1048576L).setEventUploadSwitchOpen(false).setEventUploadFrequency(86400L).setPerfUploadSwitchOpen(false).setPerfUploadFrequency(86400L).build(context);
    }
