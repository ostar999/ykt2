...
public final class jr {
    ...
    private static final Comparator f25489a = new a();
    ...
    public static class a implements Comparator {
        ...
        public int compare(Object obj, Object obj2) {
            ...
            return obj instanceof List ? jr.a((List) obj, (List) obj2) : obj instanceof Set ? jr.a((Set) obj, (Set) obj2) : obj instanceof Map ? jr.a((Map) obj, (Map) obj2) : obj instanceof byte[] ? jr.a((byte[]) obj, (byte[]) obj2) : jr.a((Comparable) obj, (Comparable) obj2);
        }
    }
    ...
    public static int a(List list, List list2) {
        ...
        for (int i2 = 0; i2 < list.size(); i2++) {
            int iCompare = f25489a.compare(list.get(i2), list2.get(i2));
            if (iCompare != 0) {
                return iCompare;
            }
        }
    ...
    public static int a(Map map, Map map2) {
        ...
        while (it.hasNext() && it2.hasNext()) {
            ...
            Comparator comparator2 = f25489a;
    ...
    public static int a(Set set, Set set2) {
        ...
        while (it.hasNext() && it2.hasNext()) {
            int iCompare = f25489a.compare(it.next(), it2.next());
            if (iCompare != 0) {
                return iCompare;
            }
        }
    ...
    public static ByteBuffer a(ByteBuffer byteBuffer) {
        return m656a(byteBuffer) ? byteBuffer : ByteBuffer.wrap(m657a(byteBuffer));
    }
    ...
    public static boolean m656a(ByteBuffer byteBuffer) {
        return byteBuffer.hasArray() && byteBuffer.position() == 0 && byteBuffer.arrayOffset() == 0 && byteBuffer.remaining() == byteBuffer.capacity();
    }

    /* renamed from: a, reason: collision with other method in class */
    public static byte[] m657a(ByteBuffer byteBuffer) {
        if (m656a(byteBuffer)) {
