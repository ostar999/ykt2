...
public final class IntentUtils {
    ...
    public static Intent getCallIntent(@NonNull String str) {
        return getIntent(new Intent("android.intent.action.CALL", Uri.parse(WebView.SCHEME_TEL + Uri.encode(str))), true);
    }
    ...
    public static Intent getDialIntent(@NonNull String str) {
        return getIntent(new Intent("android.intent.action.DIAL", Uri.parse(WebView.SCHEME_TEL + Uri.encode(str))), true);
    }
