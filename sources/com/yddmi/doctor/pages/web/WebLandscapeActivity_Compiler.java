...
public final class WebLandscapeActivity_Compiler implements ActivityCompiler {
    ...
    public void inject(@NotNull Activity activity) {
        ...
        if (titleParam != null) {
            ...
            viewStub.setOnInflateListener(new ViewStub.OnInflateListener() { // from class: com.yddmi.doctor.pages.web.e
                @Override // android.view.ViewStub.OnInflateListener
                public final void onInflate(ViewStub viewStub2, View view) throws Resources.NotFoundException {
                    WebLandscapeActivity_Compiler.inject$lambda$1$lambda$0(baseActivity, titleParam, viewStub2, view);
                }
            });
            viewStub.inflate();
        }
