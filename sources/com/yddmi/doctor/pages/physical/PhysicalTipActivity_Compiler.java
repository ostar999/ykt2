...
public final class PhysicalTipActivity_Compiler implements ActivityCompiler {
    ...
    public void inject(@NotNull Activity activity) {
        ...
        if (titleParam != null) {
            ...
            viewStub.setOnInflateListener(new ViewStub.OnInflateListener() { // from class: com.yddmi.doctor.pages.physical.d
                @Override // android.view.ViewStub.OnInflateListener
                public final void onInflate(ViewStub viewStub2, View view) throws Resources.NotFoundException {
                    PhysicalTipActivity_Compiler.inject$lambda$1$lambda$0(baseActivity, titleParam, viewStub2, view);
                }
            });
            viewStub.inflate();
        }
