...
public final class HeartlungActivity_Compiler implements ActivityCompiler {
    ...
    public void inject(@NotNull Activity activity) {
        ...
        if (titleParam != null) {
            ...
            viewStub.setOnInflateListener(new ViewStub.OnInflateListener() { // from class: com.yddmi.doctor.pages.heartlung.q
                @Override // android.view.ViewStub.OnInflateListener
                public final void onInflate(ViewStub viewStub2, View view) throws Resources.NotFoundException {
                    HeartlungActivity_Compiler.inject$lambda$1$lambda$0(baseActivity, titleParam, viewStub2, view);
                }
            });
            viewStub.inflate();
        }
