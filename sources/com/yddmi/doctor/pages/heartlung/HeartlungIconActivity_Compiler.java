...
public final class HeartlungIconActivity_Compiler implements ActivityCompiler {
    ...
    public void inject(@NotNull Activity activity) {
        ...
        if (titleParam != null) {
            ...
            viewStub.setOnInflateListener(new ViewStub.OnInflateListener() { // from class: com.yddmi.doctor.pages.heartlung.c0
                @Override // android.view.ViewStub.OnInflateListener
                public final void onInflate(ViewStub viewStub2, View view) throws Resources.NotFoundException {
                    HeartlungIconActivity_Compiler.inject$lambda$1$lambda$0(baseActivity, titleParam, viewStub2, view);
                }
            });
            viewStub.inflate();
        }
