...
public class Constant {
    ...
    public static final String ACTION_CMNT_AUTH_TOKEN = "cmntyd.getoken";
    public static final String ACTION_CMNT_LOGIN_CODE = "cmntyd.get.logincode";
    public static final String ACTION_CMNT_LOGIN_TOKEN = "cmntyd.get.logintoken";
    ...
    public static final String ACTION_SDK_CMNT_AUTH_TOKEN = "sdk.cmntyd.gettoken";
    public static final String ACTION_SDK_CMNT_LOGIN_CODE = "sdk.cmntyd.get.logincode";
    public static final String ACTION_SDK_CMNT_LOGIN_TOKEN = "sdk.cmntyd.get.logintoken";
    public static final String ACTION_SDK_CMNT_PRE_AUTH_TOKEN = "sdk.cmntyd.pregetoken";
    public static final String ACTION_SDK_CMNT_PRE_TOKEN = "sdk.cmntyd.get.pregetoken";
    ...
    public static final String ACTION_SDK_VENDOTLIST_DISPATCH = "sdk.vendor.dispatchconfig";
    ...
    public static final String CMCC_NT_GETINFO = "https://crbt.i139.cn:8143/may/impower";
    public static final String CMCC_NT_PRETOKEN = "http://crbt.i139.cn:8181/may/pretoken";
    ...
    public static final String VENDOR_CMCC_BJYD = "cmcc_bjyd";
    public static final String VENDOR_CMCC_NTYD = "cmcc_ntyd";
    public static final String VENDOR_CMCC_TYPE1 = "cmcc_1";
    public static final String VENDOR_CTCC = "ct_sjl";
    public static final String VENDOR_CTCC_TYPE1 = "ctcc_1";
    public static final String VENDOR_CTCC_TYPE2 = "ctcc_2";
    public static final String VENDOR_CUCC = "cu_xw";
    public static final String VENDOR_CUCC_TYPE1 = "cucc_1";
    public static final String VENDOR_CUCC_TYPE2 = "cucc_2";
    public static final String VENDOR_CUXZ = "cu_zx";
    public static final String VENDOR_NTCM = "cm_ntyd";
