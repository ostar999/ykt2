...
public class LoginPhoneInfo implements Jsoner {
    ...
    public static final class Builder {
        ...
        public Builder dispatchFlag(boolean z2) {
            try {
    ...
    private LoginPhoneInfo(Builder builder) {
        ...
        this.dispatchFlag = Builder.access$400(builder);
        this.channelCode = Builder.access$500(builder);
    }
    ...
    public String toString() {
        try {
            return "LoginPhoneInfo{phoneNumber='" + this.phoneNumber + CharPool.SINGLE_QUOTE + ", vendor='" + this.vendor + CharPool.SINGLE_QUOTE + ", protocolName='" + this.protocolName + CharPool.SINGLE_QUOTE + ", protocolUrl='" + this.protocolUrl + CharPool.SINGLE_QUOTE + ", dispatchFlag='" + this.dispatchFlag + CharPool.SINGLE_QUOTE + ", channelCode='" + this.channelCode + CharPool.SINGLE_QUOTE + '}';
        } catch (Throwable th) {
            try {
                ExceptionProcessor.processException(th);
                return null;
