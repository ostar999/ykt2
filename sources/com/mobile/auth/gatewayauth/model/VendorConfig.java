...
public class VendorConfig implements Jsoner {
    ...
    public String toString() {
        try {
            return "VendorConfig{vendorAccessId='" + this.vendorAccessId + CharPool.SINGLE_QUOTE + ", vendorAccessSecret='" + this.vendorAccessSecret + CharPool.SINGLE_QUOTE + ", vendorKey='" + this.vendorKey + CharPool.SINGLE_QUOTE + ", requestId='" + this.requestId + CharPool.SINGLE_QUOTE + '}';
        } catch (Throwable th) {
            try {
                ExceptionProcessor.processException(th);
                return null;
