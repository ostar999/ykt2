...
public class CmOperatorInfoRequest {
    ...
    @JsonerTag(keyName = "token")
    private String token;

    public String buildPopRequestParamas() {
        try {
            String strHashWithSalt = EncryptUtils.hashWithSalt("reqId=" + this.reqId + "&appId=" + this.appId + "&ct=" + this.ct + "&token=" + this.token, "2Dsx3oz01nIK5ob4");
