...
public class ImageViewAware extends ViewAware {
    ...
    private static int getImageViewFieldValue(Object obj, String str) throws NoSuchFieldException, SecurityException {
        try {
    ...
    public ImageViewAware(ImageView imageView, boolean z2) {
        super(imageView, z2);
    }
