...
public final class StorageUtils {
    ...
    public static File getCacheDirectory(Context context, boolean z2) {
        ...
        File externalCacheDir = (z2 && "mounted".equals(externalStorageState) && hasExternalStoragePermission(context)) ? getExternalCacheDir(context) : null;
    ...
    public static File getOwnCacheDirectory(Context context, String str, boolean z2) {
        File file = (z2 && "mounted".equals(Environment.getExternalStorageState()) && hasExternalStoragePermission(context)) ? new File(Environment.getExternalStorageDirectory(), str) : null;
        return (file == null || !(file.exists() || file.mkdirs())) ? context.getCacheDir() : file;
    }
}
