...
public final class AgentWeb {
    ...
    public static class CommonBuilder {
        ...
        public CommonBuilder isInterceptUnkownUrl(boolean z2) {
            this.mAgentBuilder.mIsInterceptUnkownUrl = z2;
            return this;
        }
    ...
    public static class IndicatorBuilder {
        ...
        public CommonBuilder setCustomIndicator(@NonNull BaseIndicatorView baseIndicatorView) {
            ...
            agentBuilder.mIsNeedDefaultProgress = z2;
            return new CommonBuilder(this.mAgentBuilder);
        }
    ...
    public AgentWeb ready() {
        ...
        boolean z2 = absAgentWebSettings instanceof AbsAgentWebSettings;
        if (z2) {
