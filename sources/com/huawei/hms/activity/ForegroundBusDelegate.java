...
public class ForegroundBusDelegate implements IBridgeActivityDelegate {
    ...
    public void errorReturn(int i2, String str) {
        ...
        if (responseCallback == null || (busResponseResultInnerError = responseCallback.innerError(this.mThisWeakRef.get(), i2, str)) == null) {
    ...
    public boolean onBridgeActivityResult(int i2, int i3, Intent intent) throws IllegalArgumentException {
        ...
        BusResponseResult busResponseResultSucceedReturn = responseCallback.succeedReturn(this.mThisWeakRef.get(), i3, intent);
