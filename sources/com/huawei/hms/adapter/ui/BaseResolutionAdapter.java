...
public class BaseResolutionAdapter implements IBridgeActivityDelegate {
    ...
    public WeakReference<Activity> f7433a;
    ...
    public final Activity b() {
        WeakReference<Activity> weakReference = this.f7433a;
    ...
    public final void c() {
        SystemManager.getInstance().notifyResolutionResult(null, this.f7434b);
        a();
    }
    ...
    public void onBridgeActivityCreate(Activity activity) throws IntentSender.SendIntentException {
        this.f7433a = new WeakReference<>(activity);
        ...
        this.f7434b = intent.getStringExtra(CommonCode.MapKey.TRANSACTION_ID);
        if (extras == null) {
            c();
            return;
        }
    ...
    public boolean onBridgeActivityResult(int i2, int i3, Intent intent) {
        ...
        if (i3 == -1 || intent.hasExtra(KpmsConstant.KIT_UPDATE_RESULT) || intent.hasExtra(CommonCode.MapKey.PRIVACY_STATEMENT_CONFIRM_RESULT)) {
            SystemManager.getInstance().notifyResolutionResult(intent, this.f7434b);
        } else {
            SystemManager.getInstance().notifyResolutionResult(null, this.f7434b);
        }
        a();
