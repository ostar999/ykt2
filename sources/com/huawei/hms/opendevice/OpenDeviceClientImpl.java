...
public class OpenDeviceClientImpl extends HuaweiApi<OpenDeviceOptions> implements OpenDeviceClient {
    ...
    public static final OpenDeviceHmsClientBuilder f7897a = new OpenDeviceHmsClientBuilder();

    /* renamed from: b, reason: collision with root package name */
    public static final Api<OpenDeviceOptions> f7898b = new Api<>(HuaweiApiAvailability.HMS_API_NAME_OD);

    /* renamed from: c, reason: collision with root package name */
    public static OpenDeviceOptions f7899c = new OpenDeviceOptions();

    public OpenDeviceClientImpl(Context context) {
        super(context, f7898b, f7899c, f7897a);
