...
public class SendUpStreamTask extends TaskApiCall<PushClient, BaseVoidTask> {
    ...
    public final void a(PushClient pushClient, ResponseErrorCode responseErrorCode) {
        HMSLog.i("SendUpStreamTask", "receive upstream, msgId :" + this.f8044b + " , packageName = " + this.f8043a + " , errorCode = " + responseErrorCode.getErrorCode());
        Intent intent = new Intent("com.huawei.push.action.MESSAGING_EVENT");
        intent.setPackage(this.f8043a);
        Bundle bundle = new Bundle();
        bundle.putString(MIPushNotificationHelper4Hybrid.KEY_MESSAGE_ID, this.f8044b);
