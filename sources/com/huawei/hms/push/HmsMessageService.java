...
public class HmsMessageService extends Service {
    ...
    public final Messenger f7948a = new Messenger(new t(new a()));
    ...
    public final Bundle a(Intent intent) {
        ...
        bundle.putString(MIPushNotificationHelper4Hybrid.KEY_MESSAGE_ID, intent.getStringExtra(MIPushNotificationHelper4Hybrid.KEY_MESSAGE_ID));
    ...
    public final synchronized void a(Intent intent, Bundle bundle, String str, int i2) {
        Context applicationContext = getApplicationContext();
        boolean z2 = !TextUtils.isEmpty(BaseUtils.getCacheData(applicationContext, applicationContext.getPackageName(), false));
        if (bundle.isEmpty() && z2) {
