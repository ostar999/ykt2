...
public class PluginUtil {
    ...
    public static boolean onDataMessage(Context context, String str, String str2, boolean z2) {
        ...
        bundle.putString(MIPushNotificationHelper4Hybrid.KEY_MESSAGE_ID, str);
        bundle.putByteArray(RemoteMessageConst.MSGBODY, str2.getBytes(x.f8055a));
    ...
    public static void saveNotifySwitch(Context context, boolean z2) {
        new PushPreferences(context, "push_notify_flag").saveBoolean("notify_msg_enable", z2);
    }
