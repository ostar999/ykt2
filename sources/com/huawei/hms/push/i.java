...
public class i {
    ...
    public static void a(Context context, Intent intent, byte[] bArr, byte[] bArr2) throws URISyntaxException {
    ...
    public static void a(Context context, Intent intent, String str, k kVar, int i2) throws URISyntaxException {
