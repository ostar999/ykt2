...
public class SafeIntent extends Intent {
    ...
    public boolean getBooleanExtra(String str, boolean z2) {
        try {
            return super.getBooleanExtra(str, z2);
        } catch (Exception unused) {
            return z2;
        }
    }
    ...
    @Override // android.content.Intent
    public byte getByteExtra(String str, byte b3) {
        try {
            return super.getByteExtra(str, b3);
        } catch (Exception unused) {
            return b3;
        }
    }
    ...
    @Override // android.content.Intent
    public char getCharExtra(String str, char c3) {
        try {
            return super.getCharExtra(str, c3);
        } catch (Exception unused) {
            return c3;
        }
    }
    ...
    @Override // android.content.Intent
    public double getDoubleExtra(String str, double d3) {
        try {
            return super.getDoubleExtra(str, d3);
        } catch (Exception unused) {
            return d3;
        }
    }
