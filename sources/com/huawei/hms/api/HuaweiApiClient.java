...
public abstract class HuaweiApiClient implements AidlApiClient {
    ...
    public static final class Builder {
        ...
        private final List<Scope> f7476b = new ArrayList();

        /* renamed from: c, reason: collision with root package name */
        private final List<PermissionInfo> f7477c = new ArrayList();

        /* renamed from: d, reason: collision with root package name */
        private final Map<Api<?>, Api.ApiOptions> f7478d = new HashMap();

        /* renamed from: e, reason: collision with root package name */
        private OnConnectionFailedListener f7479e;

        /* renamed from: f, reason: collision with root package name */
        private ConnectionCallbacks f7480f;

        /* renamed from: g, reason: collision with root package name */
        private int f7481g;

        /* renamed from: h, reason: collision with root package name */
        private Activity f7482h;
        ...
        public Builder addApi(Api<? extends Api.ApiOptions.NotRequiredOptions> api) {
            this.f7478d.put(api, null);
            if (HuaweiApiAvailability.HMS_API_NAME_GAME.equals(api.getApiName())) {
                HiAnalyticsUtil.getInstance().onEvent(this.f7475a.getApplicationContext(), HiAnalyticsConstant.KeyAndValue.GAME_INIT_KEY, HiAnalyticsConstant.REPORT_VAL_SEPARATOR + System.currentTimeMillis());
            }
            return this;
        }
        ...
        public Builder allowLifeCycleManagement(Activity activity, int i2, OnConnectionFailedListener onConnectionFailedListener) {
            ...
            this.f7481g = i2;
            this.f7482h = (Activity) Preconditions.checkNotNull(activity, "activity must not be Null.");
            return this;
        }
        ...
        public HuaweiApiClient build() {
            ...
            HuaweiApiClientImpl huaweiApiClientImpl = new HuaweiApiClientImpl(this.f7475a);
            huaweiApiClientImpl.setScopes(this.f7476b);
            huaweiApiClientImpl.setPermissionInfos(this.f7477c);
            huaweiApiClientImpl.setApiMap(this.f7478d);
            huaweiApiClientImpl.setConnectionCallbacks(this.f7480f);
            huaweiApiClientImpl.setConnectionFailedListener(this.f7479e);
            huaweiApiClientImpl.setAutoLifecycleClientId(this.f7481g);
            if (this.f7481g >= 0) {
        ...
        private void a(HuaweiApiClient huaweiApiClient) {
            AutoLifecycleFragment.getInstance(this.f7482h).startAutoMange(this.f7481g, huaweiApiClient);
        }
        ...
        public <O extends Api.ApiOptions.HasOptions> Builder addApiWithScope(Api<O> api, O o2, Scope... scopeArr) {
            ...
            Checker.checkNonNull(scopeArr, "Scopes must not be null");
            this.f7478d.put(api, o2);
            if (api.getOptions() != null) {
                this.f7476b.addAll(api.getOptions().getScopeList(o2));
                this.f7477c.addAll(api.getOptions().getPermissionInfoList(o2));
            }
            this.f7476b.addAll(new ArrayList(Arrays.asList(scopeArr)));
            return this;
        }
