...
final class b extends HuaweiApiAvailability {
    ...
    private static final b f7522a = new b();

    public class a implements BusResponseCallback {

        /* renamed from: a, reason: collision with root package name */
        final /* synthetic */ TaskCompletionSource[] f7523a;

        public a(b bVar, TaskCompletionSource[] taskCompletionSourceArr) {
            this.f7523a = taskCompletionSourceArr;
        }
        ...
        public BusResponseResult innerError(Activity activity, int i2, String str) {
            ...
            this.f7523a[0].setException(new AvailabilityException());
            return null;
        }
    ...
    public PendingIntent getErrPendingIntent(Context context, int i2, int i3) {
        ...
        Intent intentA = a(context, i2);
        if (intentA != null) {
            return PendingIntent.getActivity(context, i3, intentA, 67108864);
        }
        return null;
    }
