...
public final class ap {
    ...
    private static Map<String, String> f17546a;
    ...
    public static String a(String str) {
        ...
        try {
            ...
            if (f17546a.containsKey(str)) {
                return f17546a.get(str);
            }
            ...
            if (!TextUtils.isEmpty(systemProperty) && !systemProperty.equals("fail")) {
                f17546a.put(str, systemProperty);
            }
    ...
    public static void a(Parcel parcel, Map<String, PlugInBean> map) {
        if (map != null && map.size() > 0) {
            ...
            for (int i3 = 0; i3 < arrayList.size(); i3++) {
                bundle.putString("pluginVal" + i3 + "plugInId", ((PlugInBean) arrayList2.get(i3)).f17333a);
                bundle.putString("pluginVal" + i3 + "plugInUUID", ((PlugInBean) arrayList2.get(i3)).f17335c);
                bundle.putString("pluginVal" + i3 + "plugInVersion", ((PlugInBean) arrayList2.get(i3)).f17334b);
            }
            parcel.writeBundle(bundle);
            return;
        }
    ...
    public static boolean a(Context context, String str) {
        ...
        try {
            File file = new File(context.getFilesDir() + File.separator + str);
            if (file.exists()) {
                if (System.currentTimeMillis() - file.lastModified() < com.heytap.mcssdk.constant.a.f7153q) {
                    return false;
                }
    ...
    public static String a(File file, int i2, boolean z2) throws IOException {
