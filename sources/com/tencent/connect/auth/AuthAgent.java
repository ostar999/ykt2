...
public class AuthAgent extends BaseApi {
    ...
    private IUiListener f17947a;

    /* renamed from: d, reason: collision with root package name */
    private String f17948d;

    /* renamed from: e, reason: collision with root package name */
    private WeakReference<Activity> f17949e;
    ...
    public class a extends DefaultUiListener {
        ...
        public a(IUiListener iUiListener) {
            this.f17955a = iUiListener;
        }

        @Override // com.tencent.tauth.DefaultUiListener, com.tencent.tauth.IUiListener
        public void onCancel() {
            IUiListener iUiListener = this.f17955a;
            if (iUiListener != null) {
    ...
    public class c extends DefaultUiListener {
        ...
        private final IUiListener f17974b;
        ...
        public c(Context context, IUiListener iUiListener, boolean z2, boolean z3) {
            this.f17976d = context;
            this.f17974b = iUiListener;
            this.f17975c = z2;
        ...
        public void onComplete(Object obj) throws JSONException, IllegalAccessException, IllegalArgumentException, InvocationTargetException {
            ...
            try {
                ...
                if (string != null && ((BaseApi) AuthAgent.this).f18095c != null && string3 != null) {
                    ((BaseApi) AuthAgent.this).f18095c.setAccessToken(string, string2);
                    ((BaseApi) AuthAgent.this).f18095c.setOpenId(string3);
                    com.tencent.connect.a.a.d(this.f17976d, ((BaseApi) AuthAgent.this).f18095c);
                }
                String string4 = jSONObject.getString("pf");
                if (string4 != null) {
                    try {
                        this.f17976d.getSharedPreferences(Constants.PREFERENCE_PF, 0).edit().putString("pf", string4).commit();
                    } catch (Exception e2) {
                        e2.printStackTrace();
            ...
            this.f17974b.onComplete(jSONObject);
    ...
    public int doLogin(Activity activity, String str, IUiListener iUiListener, boolean z2, Fragment fragment, boolean z3, Map<String, Object> map) {
        this.f17948d = str;
        this.f17949e = new WeakReference<>(activity);
        this.f17947a = iUiListener;
        Object[] objArr = new Object[2];
        boolean booleanExtra = activity.getIntent().getBooleanExtra(KEY_FORCE_QR_LOGIN, false);
        boolean zB = g.a(activity, this.f18095c.getAppId()).b("C_LoginWeb");
        SLog.i("openSDK_LOG.AuthAgent", "doLogin needForceQrLogin=" + booleanExtra + ", toWebLogin=" + zB);
        if (!booleanExtra && !zB && a(activity, fragment, map, z2, objArr)) {
            SLog.i("openSDK_LOG.AuthAgent", "OpenUi, showUi, return Constants.UI_ACTIVITY");
            e.a().a(this.f18095c.getOpenId(), this.f18095c.getAppId(), "2", "1", "5", (String) objArr[0], "0", "0");
            return ((Integer) objArr[1]).intValue();
        }
        e.a().a(this.f18095c.getOpenId(), this.f18095c.getAppId(), "2", "1", "5", "1", "0", "0");
        SLog.w("openSDK_LOG.AuthAgent", "doLogin startActivity fail show dialog.");
        b bVar = new b(this.f17947a);
        this.f17947a = bVar;
        return a(z2, bVar, z3);
    }
    ...
    public void b(IUiListener iUiListener) {
        ...
        HttpUtils.requestAsync(this.f18095c, f.a(), "https://openmobile.qq.com/v3/user/get_info", bundleA, "GET", new BaseApi.TempRequestListener(new a(iUiListener)));
    }

    public int a(Activity activity, String str, IUiListener iUiListener, boolean z2, Fragment fragment, boolean z3) {
        return doLogin(activity, str, iUiListener, z2, fragment, z3, null);
    }

    private int a(boolean z2, IUiListener iUiListener, boolean z3) {
        ...
        bundleA.putString(Constants.PARAM_SCOPE, this.f17948d);
        bundleA.putString(Constants.PARAM_CLIENT_ID, this.f18095c.getAppId());
        if (BaseApi.isOEM) {
            bundleA.putString("pf", "desktop_m_qq-" + BaseApi.installChannel + "-android-" + BaseApi.registerChannel + "-" + BaseApi.businessId);
        } else {
            bundleA.putString("pf", Constants.DEFAULT_PF);
        }
        String str = (System.currentTimeMillis() / 1000) + "";
        bundleA.putString("sign", i.b(f.a(), str));
        bundleA.putString(CrashHianalyticsData.TIME, str);
        ...
        if (z3) {
            bundleA.putString(TtmlNode.TAG_STYLE, "qr");
        }
        ...
        j.b(new Runnable() { // from class: com.tencent.connect.auth.AuthAgent.1
            ...
            public void run() {
                ...
                JniInterface.loadSo();
                if (AuthAgent.this.f17949e == null || (activity = (Activity) AuthAgent.this.f17949e.get()) == null) {
                    return;
                }
                activity.runOnUiThread(new Runnable() { // from class: com.tencent.connect.auth.AuthAgent.1.1
                    ...
                    public void run() {
                        if (JniInterface.isJniOk) {
                            ...
                            com.tencent.connect.auth.a aVar = new com.tencent.connect.auth.a(activity2, "action_login", str2, cVar, ((BaseApi) AuthAgent.this).f18095c);
                        ...
                        TDialog tDialog = new TDialog(activity3, "", strA, cVar, ((BaseApi) AuthAgent.this).f18095c);
                        if (activity.isFinishing()) {
                            return;
                        }
                        tDialog.show();
    ...
    public class b extends DefaultUiListener {
        ...
        /* renamed from: a, reason: collision with root package name */
        WeakReference<IUiListener> f17957a;

        /* renamed from: c, reason: collision with root package name */
        private final String f17959c = "sendinstall";

        /* renamed from: d, reason: collision with root package name */
        private final String f17960d = "installwording";

        /* renamed from: e, reason: collision with root package name */
        private final String f17961e = "https://appsupport.qq.com/cgi-bin/qzapps/mapp_addapp.cgi";
        ...
        */
        public void onComplete(java.lang.Object r8) throws org.json.JSONException, android.content.pm.PackageManager.NameNotFoundException {
            /*
                ...
                int r3 = r1.getInt(r3)     // Catch: org.json.JSONException -> L1b
                r4 = 1
                if (r3 != r4) goto L13
                goto L14
            L13:
            ...
            L23:
                ...
                if (r4 != 0) goto L5d
                java.lang.ref.WeakReference<com.tencent.tauth.IUiListener> r1 = r7.f17957a
                ...
                return
            L5d:
                java.lang.ref.WeakReference<com.tencent.tauth.IUiListener> r3 = r7.f17957a
        ...
        public void onError(UiError uiError) {
            if (this.f17957a.get() != null) {
                this.f17957a.get().onError(uiError);
            }
        }
        ...
        private View a(Context context, Drawable drawable, String str, View.OnClickListener onClickListener, View.OnClickListener onClickListener2) {
            ...
            relativeLayout.setBackgroundColor(Color.rgb(R2.attr.actionModeCutDrawable, R2.attr.actionModeSelectAllDrawable, R2.attr.actionModeCutDrawable));
            PaintDrawable paintDrawable = new PaintDrawable(Color.rgb(R2.attr.actionModeCutDrawable, R2.attr.actionModeSelectAllDrawable, R2.attr.actionModeCutDrawable));
        ...
        public void a() {
            ...
            HttpUtils.requestAsync(((BaseApi) AuthAgent.this).f18095c, activity, "https://appsupport.qq.com/cgi-bin/qzapps/mapp_addapp.cgi", bundleB, "POST", null);
        }
    }

    private boolean a(Activity activity, Fragment fragment, Map<String, Object> map, boolean z2, Object[] objArr) {
        ...
        if (intentB != null) {
            ...
            intentB.putExtra("appid", this.f18095c.getAppId());
            bundleA.putString(Constants.KEY_PPSTS, i.a(activity, a(bundleA)));
            if (a(intentB)) {
                this.f17947a = new b(this.f17947a);
                UIListenerManager.getInstance().setListenerWithRequestcode(11101, this.f17947a);
                if (fragment != null) {
                ...
                e.a().a(0, "LOGIN_CHECK_SDK", Constants.DEFAULT_UIN, this.f18095c.getAppId(), "", Long.valueOf(SystemClock.elapsedRealtime()), 0, 1, "");
                objArr[0] = "0";
                objArr[1] = 1;
                return true;
            }
        }
        e.a().a(1, "LOGIN_CHECK_SDK", Constants.DEFAULT_UIN, this.f18095c.getAppId(), "", Long.valueOf(SystemClock.elapsedRealtime()), 0, 1, "startActionActivity fail");
    ...
    public void a(IUiListener iUiListener) throws NoSuchAlgorithmException {
        String strG;
        ...
        HttpUtils.requestAsync(this.f18095c, f.a(), "https://openmobile.qq.com/user/user_login_statis", bundleA, "POST", null);
