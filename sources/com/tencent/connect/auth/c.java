...
public class c {
    ...
    private AuthAgent f18026a;

    /* renamed from: b, reason: collision with root package name */
    private QQToken f18027b;

    private c(String str, Context context) throws IllegalAccessException, ClassNotFoundException, IllegalArgumentException, InvocationTargetException {
        SLog.i("openSDK_LOG.QQAuth", "new QQAuth() --start");
        this.f18027b = new QQToken(str);
        this.f18026a = new AuthAgent(this.f18027b);
        com.tencent.connect.a.a.c(context, this.f18027b);
    ...
    public int b(Activity activity, String str, IUiListener iUiListener) {
        ...
        return this.f18026a.a(activity, str, iUiListener, true, null, false);
    }

    public boolean c() {
        StringBuilder sb = new StringBuilder();
        sb.append("isSessionValid(), result = ");
        sb.append(this.f18027b.isSessionValid() ? k.a.f27523u : k.a.f27524v);
        SLog.i("openSDK_LOG.QQAuth", sb.toString());
        return this.f18027b.isSessionValid();
    }
    ...
    public void b(Context context, String str) {
        ...
        this.f18027b.setOpenId(str);
        com.tencent.connect.a.a.d(context, this.f18027b);
    ...
    public int a(Activity activity, String str, IUiListener iUiListener, boolean z2) {
        SLog.i("openSDK_LOG.QQAuth", "login()");
        return a(activity, null, str, iUiListener, "", z2);
    }
    ...
    public int a(Fragment fragment, String str, IUiListener iUiListener, String str2, boolean z2) {
        FragmentActivity activity = fragment.getActivity();
        SLog.i("openSDK_LOG.QQAuth", "-->login activity: " + activity);
        return a(activity, fragment, str, iUiListener, str2, z2);
    }
    ...
    private int a(Activity activity, Fragment fragment, String str, IUiListener iUiListener, String str2, boolean z2) {
        return a(activity, fragment, str, iUiListener, str2, z2, (Map<String, Object>) null);
    }

    private int a(Activity activity, Fragment fragment, String str, IUiListener iUiListener, String str2, boolean z2, Map<String, Object> map) {
        try {
            ...
            if (strA != null) {
                ...
                if (!TextUtils.isEmpty(strA2)) {
                    ...
                    return a(activity, str, iUiListener, z2, strA2, strA2, "");
                }
            }
        } catch (Throwable th) {
        ...
        BaseApi.isOEM = false;
        return this.f18026a.doLogin(activity, str, iUiListener, false, fragment, z2, map);
    }

    @Deprecated
    public int a(Activity activity, String str, IUiListener iUiListener, boolean z2, String str2, String str3, String str4) {
        ...
        return this.f18026a.a(activity, str, iUiListener, false, null, z2);
    }

    public void a() {
        this.f18026a.a((IUiListener) null);
    }

    public void a(IUiListener iUiListener) {
        this.f18026a.b(iUiListener);
    }

    public void a(String str, String str2) {
        SLog.i("openSDK_LOG.QQAuth", "setAccessToken(), validTimeInSecond = " + str2 + "");
        this.f18027b.setAccessToken(str, str2);
    }
}
