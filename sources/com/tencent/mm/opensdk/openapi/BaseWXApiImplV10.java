...
class BaseWXApiImplV10 implements IWXAPI {
    ...
    public BaseWXApiImplV10(Context context, String str, boolean z2, int i2) {
        this.checkSignature = false;
        this.launchMode = 2;
        Log.d(TAG, "<init>, appId = " + str + ", checkSignature = " + z2 + ", launchMode = " + i2);
        this.context = context;
        this.appId = str;
        this.checkSignature = z2;
        this.launchMode = i2;
        b.f20456a = context.getApplicationContext();
    }
    ...
    private String finderShareVideoJumpInfoToString(IWXChannelJumpInfo iWXChannelJumpInfo) throws JSONException {
        ...
        try {
            ...
            if (iWXChannelJumpInfo instanceof WXChannelBaseJumpInfo) {
                ...
                jSONObject.put(PushConstants.EXTRA, ((WXChannelBaseJumpInfo) iWXChannelJumpInfo).extra);
    ...
    public int getWXAppSupportAPI() throws InterruptedException {
        ...
        b.f20460e.submit(new Runnable() { // from class: com.tencent.mm.opensdk.openapi.BaseWXApiImplV10.1
    ...
    public boolean registerApp(String str, long j2) {
        ...
        c0344a.f20417a = "com.tencent.mm";
        c0344a.f20418b = ConstantsAPI.ACTION_HANDLE_APP_REGISTER;
        c0344a.f20419c = "weixin://registerapp?appid=" + this.appId;
        c0344a.f20420d = j2;
    ...
    public void unregisterApp() {
        ...
        a.C0344a c0344a = new a.C0344a();
        c0344a.f20417a = "com.tencent.mm";
        c0344a.f20418b = ConstantsAPI.ACTION_HANDLE_APP_UNREGISTER;
        c0344a.f20419c = "weixin://unregisterapp?appid=" + this.appId;
