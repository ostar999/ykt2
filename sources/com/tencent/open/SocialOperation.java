...
public class SocialOperation extends BaseApi {
    ...
    public void bindQQGroup(final Activity activity, String str, String str2, final IUiListener iUiListener) {
        ...
        HttpUtils.requestAsync(this.f18095c, activity, "https://openmobile.qq.com/cgi-bin/qunopensdk/check_group", bundleA, "GET", new BaseApi.TempRequestListener(defaultUiListener));
    ...
    public void makeFriend(Activity activity, Bundle bundle) {
        ...
        if (bundle == null) {
            ...
            e.a().a(this.f18095c.getOpenId(), this.f18095c.getAppId(), Constants.VIA_MAKE_FRIEND, Constants.VIA_REPORT_TYPE_MAKE_FRIEND, "18", "1");
            return;
        }
        ...
        if (!a(intent) || k.f(activity, "5.1.0")) {
            ...
            try {
                ...
                e.a().a(this.f18095c.getOpenId(), this.f18095c.getAppId(), Constants.VIA_MAKE_FRIEND, Constants.VIA_REPORT_TYPE_MAKE_FRIEND, "18", "0");
            } catch (Exception e2) {
    ...
    public void unBindGroup(Context context, String str, final IUiListener iUiListener) {
        ...
        bundleA.putString("appid", appId);
        bundleA.putString("orgid", str);
        HttpUtils.requestAsync(this.f18095c, context, "https://openmobile.qq.com/cgi-bin/qunopensdk/unbind", bundleA, "GET", new BaseApi.TempRequestListener(defaultUiListener));
    ...
    private void a(Activity activity, String str) {
        new TDialog(activity, "", a(str), null, this.f18095c).show();
    }
}
