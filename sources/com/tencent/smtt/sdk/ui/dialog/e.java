...
public class e {
    ...
    public static String d(String str) {
        ...
        String strSubstring = str.substring(str.lastIndexOf(StrPool.DOT) + 1, str.length());
        if (TextUtils.isEmpty(strSubstring)) {
            return MimeTypes.ANY_TYPE;
        }
        String str2 = StrPool.DOT + strSubstring;
        int i2 = 0;
        while (true) {
            String[][] strArr = f21352a;
            if (i2 >= strArr.length) {
                mimeTypeFromExtension = MimeTypes.ANY_TYPE;
                break;
            }
            if (str2.equalsIgnoreCase(strArr[i2][0])) {
                mimeTypeFromExtension = f21352a[i2][1];
                break;
            }
            i2++;
        }
        if (MimeTypes.ANY_TYPE.equalsIgnoreCase(mimeTypeFromExtension)) {
        ...
        map.put("chm", "text/plain");
        map.put("ape", "audio/x-ape");
        return (String) map.get(strSubstring.toLowerCase());
    }
}
