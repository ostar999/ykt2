...
public class WebViewClient {
    ...
    public WebResourceResponse shouldInterceptRequest(WebView webView, WebResourceRequest webResourceRequest) {
        j jVar = this.mX5Client;
        return jVar != null ? jVar.shouldInterceptRequest(webView.b(), webResourceRequest.getUrl().toString()) : shouldInterceptRequest(webView, webResourceRequest.getUrl().toString());
    }
    ...
    public boolean shouldOverrideUrlLoading(WebView webView, WebResourceRequest webResourceRequest) {
        j jVar = this.mX5Client;
        return jVar != null ? jVar.shouldOverrideUrlLoading(webView.b(), webResourceRequest.getUrl().toString()) : shouldOverrideUrlLoading(webView, webResourceRequest.getUrl().toString());
    }
