...
public interface IX5WebChromeClientExtension {
    ...
    boolean onSavePassword(ValueCallback<String> valueCallback, String str, String str2, String str3, String str4, String str5, boolean z2);

    boolean onSavePassword(String str, String str2, String str3, boolean z2, Message message);
