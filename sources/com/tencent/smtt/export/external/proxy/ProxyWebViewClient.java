...
public abstract class ProxyWebViewClient implements IX5WebViewClient {
    ...
    public void doUpdateVisitedHistory(IX5WebViewBase iX5WebViewBase, String str, boolean z2) {
        ...
        if (iX5WebViewClient != null) {
            iX5WebViewClient.doUpdateVisitedHistory(iX5WebViewBase, str, z2);
        }
    }
    ...
    public void onContentSizeChanged(IX5WebViewBase iX5WebViewBase, int i2, int i3) {
        IX5WebViewClient iX5WebViewClient = this.mWebViewClient;
        if (iX5WebViewClient != null) {
            iX5WebViewClient.onContentSizeChanged(iX5WebViewBase, i2, i3);
        }
    }
    ...
    public void onReceivedError(IX5WebViewBase iX5WebViewBase, int i2, String str, String str2) {
        IX5WebViewClient iX5WebViewClient = this.mWebViewClient;
        if (iX5WebViewClient != null) {
            iX5WebViewClient.onReceivedError(iX5WebViewBase, i2, str, str2);
        }
    }
    ...
    public void onScaleChanged(IX5WebViewBase iX5WebViewBase, float f2, float f3) {
        IX5WebViewClient iX5WebViewClient = this.mWebViewClient;
        if (iX5WebViewClient != null) {
            iX5WebViewClient.onScaleChanged(iX5WebViewBase, f2, f3);
        }
    }
