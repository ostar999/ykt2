...
public interface IX5WebChromeClient {
    ...
    boolean onCreateWindow(IX5WebViewBase iX5WebViewBase, boolean z2, boolean z3, Message message);
    ...
    void onReceivedTouchIconUrl(IX5WebViewBase iX5WebViewBase, String str, boolean z2);
    ...
    void openFileChooser(ValueCallback<Uri[]> valueCallback, String str, String str2, boolean z2);
}
