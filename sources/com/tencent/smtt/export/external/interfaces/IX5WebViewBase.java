...
public interface IX5WebViewBase {
    ...
    public static class HitTestResult {
        ...
        public void setIsFromSinglePress(boolean z2) {
            this.mIsFromSinglePress = z2;
        }
    ...
    public interface PictureListener {
        @Deprecated
        void onNewPicture(IX5WebViewBase iX5WebViewBase, Picture picture, boolean z2);
    ...
    boolean pageDown(boolean z2, int i2);

    boolean pageUp(boolean z2, int i2);

    void pauseTimers();

    void postUrl(String str, byte[] bArr);

    void refreshPlugins(boolean z2);
