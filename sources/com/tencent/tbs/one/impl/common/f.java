...
public final class f {
    ...
    public static int a(Context context, String str, String str2) {
        File[] fileArrListFiles = d(a(context.getDir("tbs", 0), str)).listFiles();
    ...
    public static File a(File file, int i2) {
        return new File(new File(file, "proc"), String.valueOf(i2));
    }
    ...
    public static File a(File file, String str, String str2) {
        String strEncodeToString = Base64.encodeToString((str + File.separator + str2).getBytes(b.f21979b), 2);
        ...
        if (!file2.exists()) {
            ...
            if (!file2.exists()) {
                ...
                if (!file2.exists()) {
                    com.tencent.tbs.one.impl.a.g.b("Failed to find component file %s or %s or %s in native library directory", file2.getAbsolutePath(), str3, string);
                }
            }
        }
        return file2;
    ...
    public static String b(Context context, String str) {
        ...
        if (fileArrListFiles != null) {
            for (File file : fileArrListFiles) {
                ...
                sb.append(":");
                sb.append(com.tencent.tbs.one.impl.e.f.c(file));
            }
        }
        return sb.toString();
    }
