...
public class c extends s {
    ...
    public c() {
        ...
        this.f18881x = "TXCYTBeautySmoothFilter";
    }
    ...
    public boolean b() {
        super.b();
        this.f18882y = GLES20.glGetUniformLocation(q(), "texelWidthOffset");
        this.f18883z = GLES20.glGetUniformLocation(q(), "texelHeightOffset");
    ...
    public void a(float f2, float f3) {
        a(this.f18882y, 1.0f / f2);
        a(this.f18883z, 1.0f / f3);
    }
