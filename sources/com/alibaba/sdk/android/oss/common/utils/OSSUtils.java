...
public class OSSUtils {
    ...
    public static boolean checkParamRange(long j2, long j3, boolean z2, long j4, boolean z3) {
        return (z2 && z3) ? j3 <= j2 && j2 <= j4 : (!z2 || z3) ? (z2 || z3) ? j3 < j2 && j2 <= j4 : j3 < j2 && j2 < j4 : j3 <= j2 && j2 < j4;
    }
    ...
    public static void signRequest(RequestMessage requestMessage) throws Exception {
        ...
        if (requestMessage.isAuthorizationRequired()) {
            ...
            boolean z2 = credentialProvider instanceof OSSFederationCredentialProvider;
            if (z2) {
            ...
            if (z2 || (credentialProvider instanceof OSSStsTokenCredentialProvider)) {
