...
public class SerializeConfig {
    ...
    public void config(Class<?> cls, SerializerFeature serializerFeature, boolean z2) throws ClassNotFoundException {
    ...
    private ObjectSerializer getObjectWriter(Class<?> cls, boolean z2) throws ClassNotFoundException {
    ...
    public ObjectSerializer createJavaBeanSerializer(SerializeBeanInfo serializeBeanInfo) {
        ...
        if (jSONType != null) {
            ...
            if (z3 && jSONType.serialzeFilters().length != 0) {
                z3 = false;
            }
        }
        ...
        if (z3 && !ASMUtils.checkName(cls.getSimpleName())) {
            z3 = false;
        }
        if (z3 && serializeBeanInfo.beanType.isInterface()) {
            z3 = false;
        }
        if (z3) {
        ...
        if (z2) {
            try {
                ...
                throw new JSONException("create asm serializer error, verson 1.2.66, class " + cls, th);
            }
        }
        return new JavaBeanSerializer(serializeBeanInfo);
    }
