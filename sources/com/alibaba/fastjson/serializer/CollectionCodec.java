...
public class CollectionCodec implements ObjectSerializer, ObjectDeserializer {
    ...
    public void write(JSONSerializer jSONSerializer, Object obj, Object obj2, Type type, int i2) throws IOException {
        ...
        Type collectionItemType = (serializeWriter.isEnabled(serializerFeature) || SerializerFeature.isEnabled(i2, serializerFeature)) ? TypeUtils.getCollectionItemType(type) : null;
                ...
                if (obj3 == null) {
                    ...
                    if (cls == Integer.class) {
                        ...
                        if (SerializerFeature.isEnabled(i2, SerializerFeature.WriteClassName) && (objectWriter instanceof JavaBeanSerializer)) {
                            ((JavaBeanSerializer) objectWriter).writeNoneASM(jSONSerializer, obj3, Integer.valueOf(i4 - 1), collectionItemType, i2);
                        } else {
                            objectWriter.write(jSONSerializer, obj3, Integer.valueOf(i4 - 1), collectionItemType, i2);
                        }
                    }
                }
                i3 = i4;
