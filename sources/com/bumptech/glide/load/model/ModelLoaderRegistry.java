...
public class ModelLoaderRegistry {
    ...
    @NonNull
    private static <A> Class<A> getClass(@NonNull A a3) {
    ...
    public <A> List<ModelLoader<A, ?>> getModelLoaders(@NonNull A a3) {
        List<ModelLoader<A, ?>> modelLoadersForClass = getModelLoadersForClass(getClass(a3));
        ...
        if (listEmptyList.isEmpty()) {
            throw new Registry.NoModelLoaderAvailableException(a3, modelLoadersForClass);
        }
