...
public final class Util {
    ...
    public static int getBitmapByteSize(@NonNull Bitmap bitmap) {
        ...
        throw new IllegalStateException("Cannot obtain size for recycled Bitmap: " + bitmap + StrPool.BRACKET_START + bitmap.getWidth() + "x" + bitmap.getHeight() + "] " + bitmap.getConfig());
    }
