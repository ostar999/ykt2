...
final class RequestOptionsExtensionGenerator {
    ...
    private MethodSpec generateMethodsForRequestOptionsExtension(ExecutableElement executableElement) {
        ...
        List<ParameterSpec> parameters = ProcessorUtil.getParameters(listSubList);
        ...
        builderAddAnnotation.addAnnotation(ProcessorUtil.checkResult()).addAnnotation(ProcessorUtil.nonNull());
