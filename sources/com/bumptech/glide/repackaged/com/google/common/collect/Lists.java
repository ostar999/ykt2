...
public final class Lists {
    ...
    public static class TransformingRandomAccessList<F, T> extends AbstractList<T> implements Serializable, RandomAccess {
        ...
        public ListIterator<T> listIterator(int i2) {
            return new TransformedListIterator<F, T>(this.fromList.listIterator(i2)) { // from class: com.bumptech.glide.repackaged.com.google.common.collect.Lists.TransformingRandomAccessList.1
    ...
    public static class TransformingSequentialList<F, T> extends AbstractSequentialList<T> implements Serializable {
        ...
        public ListIterator<T> listIterator(int i2) {
            return new TransformedListIterator<F, T>(this.fromList.listIterator(i2)) { // from class: com.bumptech.glide.repackaged.com.google.common.collect.Lists.TransformingSequentialList.1
                @Override // com.bumptech.glide.repackaged.com.google.common.collect.TransformedIterator
                public T transform(F f2) {
