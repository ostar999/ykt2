...
public interface RefreshLayout {
    ...
    RefreshLayout setFixedFooterViewId(@IdRes int i2);

    RefreshLayout setFixedHeaderViewId(@IdRes int i2);
    ...
    RefreshLayout setFooterInsetStartPx(int i2);

    RefreshLayout setFooterMaxDragRate(@FloatRange(from = 1.0d, to = 10.0d) float f2);

    RefreshLayout setFooterTranslationViewId(@IdRes int i2);
    ...
    RefreshLayout setHeaderInsetStartPx(int i2);

    RefreshLayout setHeaderMaxDragRate(@FloatRange(from = 1.0d, to = 10.0d) float f2);

    RefreshLayout setHeaderTranslationViewId(@IdRes int i2);
