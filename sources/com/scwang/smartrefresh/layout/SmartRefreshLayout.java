...
public class SmartRefreshLayout extends ViewGroup implements RefreshLayout, NestedScrollingParent {
    ...
    public class RefreshKernelImpl implements RefreshKernel {
        ...
        */
        ...
        /*
            ...
            To view partially-correct code enable 'Show inconsistent code' option in preferences
        */
        public com.scwang.smartrefresh.layout.api.RefreshKernel startTwoLevel(boolean r4) {
            /*
                r3 = this;
                if (r4 == 0) goto L28
                com.scwang.smartrefresh.layout.SmartRefreshLayout$RefreshKernelImpl$1 r4 = new com.scwang.smartrefresh.layout.SmartRefreshLayout$RefreshKernelImpl$1
                r4.<init>()
                com.scwang.smartrefresh.layout.SmartRefreshLayout r0 = com.scwang.smartrefresh.layout.SmartRefreshLayout.this
            ...
            L36:
                return r3
            */
            throw new UnsupportedOperationException("Method not decompiled: com.scwang.smartrefresh.layout.SmartRefreshLayout.RefreshKernelImpl.startTwoLevel(boolean):com.scwang.smartrefresh.layout.api.RefreshKernel");
        }
    }
    ...
    */
    ...
    public boolean isEnableTranslationContent(boolean z2, RefreshInternal refreshInternal) {
        return z2 || this.mEnablePureScrollMode || refreshInternal == null || refreshInternal.getSpinnerStyle() == SpinnerStyle.FixedBehind;
    }
    ...
    public void moveSpinnerInfinitely(float f2) {
        ...
        if (refreshState2 == RefreshState.TwoLevel && f3 > 0.0f) {
            ...
            if (f3 < i3) {
                ...
                double d3 = (this.mHeaderMaxDragRate - 1.0f) * i3;
            ...
            if (f3 > (-i5)) {
                ...
                double d6 = (this.mFooterMaxDragRate - 1.0f) * i5;
                int iMax2 = Math.max((this.mScreenHeightPixels * 4) / 3, getHeight());
                int i6 = this.mFooterHeight;
                double d7 = iMax2 - i6;
                double d8 = -Math.min(0.0f, (i6 + f3) * this.mDragRate);
                double d9 = -d8;
                if (d7 == 0.0d) {
                    d7 = 1.0d;
                }
            ...
            double d12 = this.mFooterMaxDragRate * this.mFooterHeight;
            ...
            this.mKernel.moveSpinner((int) (-Math.min(d12 * (1.0d - Math.pow(100.0d, d14 / dMax4)), d13)), true);
        }
        ...
        if (!isInEditMode()) {
            ...
            if (this.mRefreshFooter == null) {
                ...
                if (defaultRefreshFooterCreator != null) {
                    ...
                    boolean z3 = this.mEnableLoadMore;
    ...
    */
    ...
    public void overSpinner() {
        ...
        if (refreshState == RefreshState.TwoLevel) {
            if (this.mCurrentVelocity <= -1000 || this.mSpinner <= getMeasuredHeight() / 2) {
                ...
                ValueAnimator valueAnimatorAnimSpinner = this.mKernel.animSpinner(getMeasuredHeight());
    ...
    public RefreshLayout setFooterHeight(float f2) {
        ...
        if (dimensionStatus.canReplaceWith(dimensionStatus2)) {
            ...
            if (refreshInternal != null && this.mAttachedToWindow && this.mFooterHeightStatus.notified) {
                ...
                int i3 = this.mFooterHeight;
                refreshInternal2.onInitialized(refreshKernel, i3, (int) (this.mFooterMaxDragRate * i3));
            } else {
    ...
    public RefreshLayout setHeaderHeight(float f2) {
        ...
        if (dimensionStatus.canReplaceWith(dimensionStatus2)) {
            ...
            if (refreshInternal != null && this.mAttachedToWindow && this.mHeaderHeightStatus.notified) {
                ...
                RefreshKernel refreshKernel = this.mKernel;
                int i4 = this.mHeaderHeight;
                refreshInternal2.onInitialized(refreshKernel, i4, (int) (this.mHeaderMaxDragRate * i4));
            } else {
    ...
    public RefreshLayout setNoMoreData(boolean z2) {
        ...
        if (refreshState == RefreshState.Refreshing && z2) {
            ...
            RefreshInternal refreshInternal = this.mRefreshFooter;
            if (refreshInternal instanceof RefreshFooter) {
                if (((RefreshFooter) refreshInternal).setNoMoreData(z2)) {
        ...
        Runnable runnable = new Runnable() { // from class: com.scwang.smartrefresh.layout.SmartRefreshLayout.6
            ...
            public void run() {
                ...
                if (onMultiPurposeListener != null) {
                    ...
                    if (refreshInternal instanceof RefreshHeader) {
                        onMultiPurposeListener.onHeaderFinish((RefreshHeader) refreshInternal, z2);
                    }
                }
