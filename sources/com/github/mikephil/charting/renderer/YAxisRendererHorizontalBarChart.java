...
public class YAxisRendererHorizontalBarChart extends YAxisRenderer {
    ...
    public void computeAxis(float f2, float f3, boolean z2) {
        ...
        if (this.mViewPortHandler.contentHeight() > 10.0f && !this.mViewPortHandler.isFullyZoomedOutX()) {
            ...
            if (z2) {
                f4 = (float) valuesByTouchPoint2.f6564x;
                d3 = valuesByTouchPoint.f6564x;
            } else {
                f4 = (float) valuesByTouchPoint.f6564x;
                d3 = valuesByTouchPoint2.f6564x;
            }
    ...
    public void drawZeroLine(Canvas canvas) {
        ...
        path.reset();
        path.moveTo(((float) pixelForValues.f6564x) - 1.0f, this.mViewPortHandler.contentTop());
        path.lineTo(((float) pixelForValues.f6564x) - 1.0f, this.mViewPortHandler.contentBottom());
