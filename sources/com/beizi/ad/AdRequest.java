...
public final class AdRequest {
    public static final String DEVICE_ID_EMULATOR = com.beizi.ad.internal.network.a.f4362b;
    ...
    private final a.C0055a f3615a;

    public static final class Builder {
        private final a.C0055a mImpl;

        public Builder() {
            a.C0055a c0055a = new a.C0055a();
            this.mImpl = c0055a;
            c0055a.b(AdRequest.DEVICE_ID_EMULATOR);
        }
    ...
    public <T> Bundle getNetworkExtrasBundle(Class<T> cls) {
        return this.f3615a.a((Class<? extends com.beizi.ad.b.b>) cls);
    }

    public a.C0055a impl() {
        return this.f3615a;
    }

    private AdRequest(Builder builder) {
        this.f3615a = builder.mImpl;
    }
}
