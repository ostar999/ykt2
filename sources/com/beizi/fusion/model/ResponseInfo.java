...
public class ResponseInfo {
    ...
    private void initFail() {
        this.isInit = false;
        c.a(this.context).a(new b(com.beizi.fusion.d.b.f4908b, "", "410.500", "", com.beizi.fusion.d.b.a().b(), "", "", String.valueOf(System.currentTimeMillis()), ""));
    }
    ...
    public synchronized ResponseInfo init() {
        String strB;
        c.a(this.context).a(new b(com.beizi.fusion.d.b.f4908b, "", "410.000", "", com.beizi.fusion.d.b.a().b(), "", "", String.valueOf(System.currentTimeMillis()), ""));
        String str = (String) aq.b(this.context, "globalConfig", BeiZis.getTransferProtocol() ? DEFAULT_HTTPS_CONFIG_FILE : DEFAULT_CONFIG_FILE);
        if (TextUtils.isEmpty(str) || (strB = d.b(aa.a(), str)) == null) {
            initFail();
        } else {
            ...
            if (globalConfigObjectFromData != null) {
                ...
                this.isInit = true;
                x.a(this.context);
                c.a(this.context).a(new b(com.beizi.fusion.d.b.f4908b, "", "410.200", "", com.beizi.fusion.d.b.a().b(), "", "", String.valueOf(System.currentTimeMillis()), ""));
            } else {
                initFail();
            }
        }
