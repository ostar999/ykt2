...
public class RequestInfo {
    ...
    public RequestInfo init() {
        ...
        this.packageName = as.c(this.context);
        this.installTime = String.valueOf(as.a(this.context));
        this.updateTime = String.valueOf(as.b(this.context));
        this.appVersion = as.d(this.context);
        this.appVersionCode = String.valueOf(as.e(this.context));
        this.sdkVersion = "4.90.2.36";
