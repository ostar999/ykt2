...
public class u {
    ...
    public static final DownloadConfirmListener f5254b = new DownloadConfirmListener() { // from class: com.beizi.fusion.g.u.1
        public void onDownloadConfirm(Activity activity, int i2, String str, DownloadConfirmCallBack downloadConfirmCallBack) {
            if (activity == null || activity.isFinishing()) {
                return;
            }
            ac.a("DownloadConfirmHelper", "scenes:" + i2 + " info url:" + str);
            t tVar = new t(activity, u.a(str), downloadConfirmCallBack);
            if ((i2 & 256) != 0) {
                tVar.a();
                ac.a("DownloadConfirmHelper", "real scenes:" + (i2 & (-257)));
            }
            try {
                tVar.show();
    ...
    private static boolean f5255c = false;

    /* renamed from: d, reason: collision with root package name */
    private static JSONObject f5256d;
    ...
    public static a b(String str) {
        ...
        try {
            ...
            a aVar2 = new a();
            try {
                aVar2.f5257a = jSONObjectOptJSONObject.optString("iconUrl");
                aVar2.f5258b = jSONObjectOptJSONObject.optString("appName");
                aVar2.f5259c = jSONObjectOptJSONObject.optString("versionName");
                aVar2.f5260d = jSONObjectOptJSONObject.optString("authorName");
                JSONArray jSONArrayOptJSONArray = jSONObjectOptJSONObject.optJSONArray("permissions");
                if (jSONArrayOptJSONArray != null) {
                    aVar2.f5261e = new ArrayList();
                    for (int i2 = 0; i2 < jSONArrayOptJSONArray.length(); i2++) {
                        String string = jSONArrayOptJSONArray.getString(i2);
                        if (f5255c) {
                            aVar2.f5261e.add(jSONArrayOptJSONArray.getString(i2));
                        } else {
                            JSONObject jSONObjectOptJSONObject2 = f5256d.optJSONObject(string);
                            if (jSONObjectOptJSONObject2 != null) {
                                String strOptString = jSONObjectOptJSONObject2.optString("title");
                                if (!TextUtils.isEmpty(strOptString)) {
                                    aVar2.f5261e.add(strOptString);
                                }
                            }
                        }
                    }
                }
                aVar2.f5262f = jSONObjectOptJSONObject.optString("privacyAgreement");
                long jOptLong = jSONObjectOptJSONObject.optLong("apkPublishTime");
                if (jOptLong <= 946688401000L) {
                    jOptLong *= 1000;
                }
                aVar2.f5263g = jOptLong;
                aVar2.f5264h = jSONObjectOptJSONObject.optLong("fileSize");
                return aVar2;
            } catch (JSONException e2) {
                e = e2;
                aVar = aVar2;
