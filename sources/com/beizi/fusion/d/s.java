...
public class s extends e {
    ...
    public com.beizi.fusion.work.a a(AdSpacesBean.ForwardBean forwardBean, String str, AdSpacesBean.BuyerBean buyerBean, List<AdSpacesBean.RenderViewBean> list, com.beizi.fusion.work.a aVar) {
        ...
        switch (str) {
            case "CSJ":
                aVar = new com.beizi.fusion.work.f.c(this.f4927b, sleepTime, buyerBean, forwardBean, this, this.f4988v);
                break;
            case "GDT":
                aVar = new com.beizi.fusion.work.f.d(this.f4927b, sleepTime, buyerBean, forwardBean, this, this.f4988v);
                break;
            case "KUAISHOU":
                aVar = new com.beizi.fusion.work.f.e(this.f4927b, sleepTime, buyerBean, forwardBean, this, this.f4988v);
                break;
        }
        return (ar.b().equalsIgnoreCase(str) || "BEIZI".equalsIgnoreCase(str)) ? new com.beizi.fusion.work.f.b(this.f4927b, sleepTime, buyerBean, forwardBean, this, this.f4988v) : aVar;
    }
}
