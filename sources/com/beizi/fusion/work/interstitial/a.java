...
public class a extends com.beizi.fusion.work.a implements com.beizi.fusion.d.c {
    ...
    private TTFullScreenVideoAd f5846r;

    /* renamed from: s, reason: collision with root package name */
    private TTAdNative f5847s;
        ...
        if (dVar != null) {
            ...
            if (bVarA != null) {
                ...
                if (!as.a("com.bytedance.sdk.openadsdk.TTAdNative")) {
                    z();
                    this.f5549m.postDelayed(new Runnable() { // from class: com.beizi.fusion.work.interstitial.a.1
                    ...
                    A();
                    v.a(this, this.f5842n, this.f5544h, this.f5541e.getDirectDownload());
    ...
    @Override // com.beizi.fusion.work.a
    public void e() {
        Log.d("BeiZis", g() + ":requestAd:" + this.f5544h + "====" + this.f5545i + "===" + this.f5845q);
        long j2 = this.f5845q;
        if (j2 > 0) {
    ...
    public void p() {
        ...
        this.f5847s = v.a().createAdNative(this.f5842n);
        this.f5847s.loadFullScreenVideoAd(new AdSlot.Builder().setCodeId(this.f5545i).setExpressViewAcceptedSize(500.0f, 500.0f).setSupportDeepLink(true).setAdLoadType(TTAdLoadType.PRELOAD).build(), new TTAdNative.FullScreenVideoAdListener() { // from class: com.beizi.fusion.work.interstitial.a.2
            private void a() {
                a.this.f5846r.setFullScreenVideoAdInteractionListener(new TTFullScreenVideoAd.FullScreenVideoAdInteractionListener() { // from class: com.beizi.fusion.work.interstitial.a.2.1
                ...
                a.this.f5846r.setDownloadListener(new TTAppDownloadListener() { // from class: com.beizi.fusion.work.interstitial.a.2.2
            ...
            public void onFullScreenVideoAdLoad(TTFullScreenVideoAd tTFullScreenVideoAd) {
                ...
                a.this.f5846r = tTFullScreenVideoAd;
                a();
                if (a.this.ac()) {
                    a.this.aL();
                } else {
    ...
    public void a(Activity activity) {
        TTFullScreenVideoAd tTFullScreenVideoAd = this.f5846r;
