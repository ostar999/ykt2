...
public class SubTagsStatus extends BasicPushStatus {
    ...
    public class Tag implements Serializable {
        ...
        public String toString() {
            return "Tag{tagId=" + this.tagId + ", tagName='" + this.tagName + CharPool.SINGLE_QUOTE + '}';
        }
    }
    ...
    @Override // com.meizu.cloud.pushsdk.platform.message.BasicPushStatus
    public String toString() {
        return super.toString() + " SubTagsStatus{pushId='" + this.pushId + CharPool.SINGLE_QUOTE + ", tagList=" + this.tagList + '}';
    }
}
