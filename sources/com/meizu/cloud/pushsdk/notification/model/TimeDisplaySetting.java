...
public class TimeDisplaySetting implements Parcelable {
    ...
    public void setIsTimeDisplay(boolean z2) {
        this.isTimeDisplay = z2;
    }
    ...
    public String toString() {
        return "TimeDisplaySetting{isTimeDisplay=" + this.isTimeDisplay + ", startShowTime='" + this.startShowTime + CharPool.SINGLE_QUOTE + ", endShowTime='" + this.endShowTime + CharPool.SINGLE_QUOTE + '}';
    }
