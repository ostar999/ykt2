...
public class NotificationStyle implements Parcelable {
    ...
    public String toString() {
        return "NotificationStyle{baseStyle=" + this.baseStyle + ", innerStyle=" + this.innerStyle + ", expandableText='" + this.expandableText + CharPool.SINGLE_QUOTE + ", expandableImageUrl='" + this.expandableImageUrl + CharPool.SINGLE_QUOTE + ", bannerImageUrl='" + this.bannerImageUrl + CharPool.SINGLE_QUOTE + '}';
    }
