...
public class c extends com.meizu.cloud.pushsdk.notification.a {
    ...
    public void a(Notification notification, MessageV3 messageV3) {
        if (MinSdkChecker.isSupportNotificationBuild()) {
            ...
            remoteViews.setViewVisibility(com.meizu.cloud.pushsdk.notification.c.c.h(this.f9473a), 8);
    ...
    public void a(RemoteViews remoteViews, MessageV3 messageV3) {
        Bitmap bitmapA;
        if (messageV3.getmAppIconSetting() == null || a() || messageV3.getmAppIconSetting().isDefaultLargeIcon() || (bitmapA = a(messageV3.getmAppIconSetting().getLargeIconUrl())) == null) {
            remoteViews.setImageViewBitmap(com.meizu.cloud.pushsdk.notification.c.c.k(this.f9473a), a(this.f9473a, messageV3.getUploadDataPackageName()));
        } else {
            remoteViews.setImageViewBitmap(com.meizu.cloud.pushsdk.notification.c.c.k(this.f9473a), bitmapA);
        }
    }
}
