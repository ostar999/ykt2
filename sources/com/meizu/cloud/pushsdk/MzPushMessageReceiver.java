...
public abstract class MzPushMessageReceiver extends IntentReceiver {
    ...
    public void onHandleIntent(Context context, Intent intent) {
        a.a(context).a(TAG, new com.meizu.cloud.pushsdk.handler.a() { // from class: com.meizu.cloud.pushsdk.MzPushMessageReceiver.1
            ...
            public void a(Context context2, boolean z2) {
                ...
                MzPushMessageReceiver.this.onUnRegister(context2, z2);
            }
    ...
    public void onReceive(Context context, Intent intent) {
        try {
            ...
            c.a(context, context.getPackageName(), null, null, PushManager.TAG, "MzPushMessageReceiver " + e2.getMessage(), 3000);
        }
    }
