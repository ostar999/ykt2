...
public class MzPushMessage implements Serializable {
    ...
    public String toString() {
        return "MzPushMessage{title='" + this.title + CharPool.SINGLE_QUOTE + ", content='" + this.content + CharPool.SINGLE_QUOTE + ", pushType=" + this.pushType + ", taskId='" + this.taskId + CharPool.SINGLE_QUOTE + ", selfDefineContentString='" + this.selfDefineContentString + CharPool.SINGLE_QUOTE + ", notifyId=" + this.notifyId + '}';
    }
}
