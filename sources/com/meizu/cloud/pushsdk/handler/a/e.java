...
public class e extends a<MessageV3> {
    ...
    public void b(MessageV3 messageV3) throws JSONException {
        ...
        if (TextUtils.isEmpty(strB)) {
            ...
            com.meizu.cloud.pushsdk.util.c.d(c(), strB, messageV3.getDeviceId(), messageV3.getTaskId(), messageV3.getSeqId(), messageV3.getPushTimestamp());
        }
    }
