...
public class MessageV3 implements Parcelable {
    ...
    public static MessageV3 parse(String str, String str2, String str3, MPushMessage mPushMessage) {
        ...
        messageV3.setIsDiscard(k.a.f27523u.equals(mPushMessage.getIsDiscard()));
    ...
    public static MessageV3 parse(String str, String str2, String str3, String str4) throws JSONException {
        MessageV3 messageV3 = new MessageV3();
    ...
    public static MessageV3 parse(String str, String str2, String str3, String str4, String str5) throws JSONException {
        MessageV3 messageV3 = parse(str, str2, str3, str5);
        messageV3.setSeqId(str4);
        return messageV3;
    }

    public static MessageV3 parse(String str, String str2, String str3, String str4, String str5, String str6, String str7) throws JSONException {
        MessageV3 messageV3 = parse(str, str4, str5, str6, str7);
    ...
    public String toString() {
        return "MessageV3{taskId='" + this.taskId + CharPool.SINGLE_QUOTE + ", seqId='" + this.seqId + CharPool.SINGLE_QUOTE + ", deviceId='" + this.deviceId + CharPool.SINGLE_QUOTE + ", title='" + this.title + CharPool.SINGLE_QUOTE + ", content='" + this.content + CharPool.SINGLE_QUOTE + ", packageName='" + this.packageName + CharPool.SINGLE_QUOTE + ", clickType=" + this.clickType + ", isDiscard=" + this.isDiscard + ", activity='" + this.activity + CharPool.SINGLE_QUOTE + ", webUrl='" + this.webUrl + CharPool.SINGLE_QUOTE + ", uriPackageName='" + this.uriPackageName + CharPool.SINGLE_QUOTE + ", pushTimestamp='" + this.pushTimestamp + CharPool.SINGLE_QUOTE + ", uploadDataPackageName='" + this.uploadDataPackageName + CharPool.SINGLE_QUOTE + ", paramsMap=" + this.paramsMap + ", throughMessage='" + this.throughMessage + CharPool.SINGLE_QUOTE + ", notificationMessage='" + this.notificationMessage + CharPool.SINGLE_QUOTE + ", mAdvanceSetting=" + this.mAdvanceSetting + ", mAppIconSetting=" + this.mAppIconSetting + ", mNotificationStyle=" + this.mNotificationStyle + ", mTimeDisplaySetting=" + this.mTimeDisplaySetting + '}';
    }
