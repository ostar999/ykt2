...
@Metadata(d1 = {"\u0000Z\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\b\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000e\n\u0002\b\u0002\n\u0002\u0010\u0007\n\u0002\b\r\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0010\u0018\u00002\u00020\u0001B#\b\u0007\u0012\u0006\u0010\u0002\u001a\u00020\u0003\u0012\b\u0010\u0004\u001a\u0004\u0018\u00010\u0005\u0012\b\b\u0002\u0010\u0006\u001a\u00020\u0007¢\u0006\u0002\u0010\bJ\u0010\u0010&\u001a\u00020'2\u0006\u0010(\u001a\u00020)H\u0002J\u0010\u0010*\u001a\u00020'2\u0006\u0010(\u001a\u00020)H\u0002J\u0010\u0010+\u001a\u00020'2\u0006\u0010(\u001a\u00020)H\u0002J\u0018\u0010,\u001a\u00020'2\u0006\u0010(\u001a\u00020)2\u0006\u0010-\u001a\u00020\u000fH\u0002J\u0018\u0010.\u001a\u00020\u00072\u0006\u0010/\u001a\u00020\u00072\u0006\u00100\u001a\u00020\u0007H\u0002J\u0010\u00101\u001a\u00020'2\u0006\u0010(\u001a\u00020)H\u0014J\u0018\u00102\u001a\u00020'2\u0006\u00103\u001a\u00020\u00072\u0006\u00104\u001a\u00020\u0007H\u0014J\"\u00105\u001a\u00020'2\u0006\u00106\u001a\u00020\u00072\u0006\u00107\u001a\u00020\u00072\n\b\u0002\u00108\u001a\u0004\u0018\u00010\fR\u000e\u0010\t\u001a\u00020\nX\u0082\u0004¢\u0006\u0002\n\u0000R\u000e\u0010\u000b\u001a\u00020\fX\u0082\u000e¢\u0006\u0002\n\u0000R\u000e\u0010\r\u001a\u00020\nX\u0082\u0004¢\u0006\u0002\n\u0000R\u000e\u0010\u000e\u001a\u00020\u000fX\u0082\u000e¢\u0006\u0002\n\u0000R\u000e\u0010\u0010\u001a\u00020\u0007X\u0082\u000e¢\u0006\u0002\n\u0000R\u000e\u0010\u0011\u001a\u00020\u0007X\u0082\u000e¢\u0006\u0002\n\u0000R\u000e\u0010\u0012\u001a\u00020\u0007X\u0082\u000e¢\u0006\u0002\n\u0000R\u000e\u0010\u0013\u001a\u00020\u0007X\u0082\u000e¢\u0006\u0002\n\u0000R\u000e\u0010\u0014\u001a\u00020\u0007X\u0082\u000e¢\u0006\u0002\n\u0000R\u000e\u0010\u0015\u001a\u00020\nX\u0082\u000e¢\u0006\u0002\n\u0000R\u000e\u0010\u0016\u001a\u00020\u0007X\u0082\u000e¢\u0006\u0002\n\u0000R\u000e\u0010\u0017\u001a\u00020\nX\u0082\u000e¢\u0006\u0002\n\u0000R\u000e\u0010\u0018\u001a\u00020\u000fX\u0082\u000e¢\u0006\u0002\n\u0000R\u000e\u0010\u0019\u001a\u00020\u000fX\u0082\u000e¢\u0006\u0002\n\u0000R\u000e\u0010\u001a\u001a\u00020\u0007X\u0082\u000e¢\u0006\u0002\n\u0000R\u000e\u0010\u001b\u001a\u00020\u000fX\u0082\u000e¢\u0006\u0002\n\u0000R\u0010\u0010\u001c\u001a\u0004\u0018\u00010\u001dX\u0082\u000e¢\u0006\u0002\n\u0000R\u000e\u0010\u001e\u001a\u00020\u0007X\u0082\u000e¢\u0006\u0002\n\u0000R\u0010\u0010\u001f\u001a\u0004\u0018\u00010 X\u0082\u000e¢\u0006\u0002\n\u0000R\u000e\u0010!\u001a\u00020\u0007X\u0082\u000e¢\u0006\u0002\n\u0000R\u000e\u0010\"\u001a\u00020#X\u0082\u000e¢\u0006\u0002\n\u0000R\u000e\u0010$\u001a\u00020\u0007X\u0082\u000e¢\u0006\u0002\n\u0000R\u000e\u0010%\u001a\u00020\u0007X\u0082\u000e¢\u0006\u0002\n\u0000¨\u00069"}, d2 = {"Lcom/psychiatrygarden/widget/KnowledgePointsProgressView;", "Landroid/view/View;", com.umeng.analytics.pro.d.R, "Landroid/content/Context;", "attributeSet", "Landroid/util/AttributeSet;", "def", "", "(Landroid/content/Context;Landroid/util/AttributeSet;I)V", "circlePaint", "Landroid/graphics/Paint;", "mAllQuestionNumber", "", "mBackgroundGradientPaint", "mCurrentPercent", "", "mDefaultHeight", "mDefaultWidth", "mDoQuestionNumber", "mEndColor", "mHeight", "mInnerPaint", "mMiddleColor", "mOutterPaint", "mPercentSymbolWidth", "mPercentText", "mPercentTextColor", "mPercentTextWidth", "mRectF", "Landroid/graphics/RectF;", "mRightPercentTextColor", "mShader", "Landroid/graphics/Shader;", "mStartColor", "mTextPaint", "Landroid/text/TextPaint;", "mWidth", "strokeWidth", "drawArc", "", "canvas", "Landroid/graphics/Canvas;", "drawBackgroundGradientArc", "drawEndCircle", "drawText", "radius", "getSize", "defaultSize", "measureSpec", "onDraw", "onMeasure", "widthMeasureSpec", "heightMeasureSpec", "setCurrentPercent", "rightCount", "totalCount", "rightPercent", "xizongapp_ykbRelease"}, k = 1, mv = {1, 8, 0}, xi = 48)
/* loaded from: classes6.dex */
public final class KnowledgePointsProgressView extends View {
    ...
    @NotNull
    private final Paint mBackgroundGradientPaint;
    ...
    @JvmOverloads
    public KnowledgePointsProgressView(@NotNull Context context, @Nullable AttributeSet attributeSet) {
        this(context, attributeSet, 0, 4, null);
        Intrinsics.checkNotNullParameter(context, "context");
    }

    public /* synthetic */ KnowledgePointsProgressView(Context context, AttributeSet attributeSet, int i2, int i3, DefaultConstructorMarker defaultConstructorMarker) {
    ...
    private final void drawBackgroundGradientArc(Canvas canvas) {
        RectF rectF = this.mRectF;
        if (rectF != null) {
            float fDip2px = CommonUtil.dip2px(getContext(), 14.0f);
            RectF rectF2 = new RectF(rectF.left + fDip2px, rectF.top + fDip2px, rectF.right - fDip2px, rectF.bottom - fDip2px);
            this.mBackgroundGradientPaint.setShader(new LinearGradient(0.0f, rectF2.top, 0.0f, rectF2.bottom, new int[]{Color.parseColor("#FFF1F0"), Color.parseColor("#FFFFFF"), Color.parseColor("#FFFFFF"), Color.parseColor("#10FFFFFF")}, (float[]) null, Shader.TileMode.CLAMP));
            this.mBackgroundGradientPaint.setStyle(Paint.Style.FILL);
            this.mBackgroundGradientPaint.setStrokeWidth(this.strokeWidth * 1.0f);
            this.mBackgroundGradientPaint.setAntiAlias(true);
            this.mBackgroundGradientPaint.setStrokeCap(Paint.Cap.ROUND);
            canvas.drawArc(rectF2, 180.0f, 180.0f, false, this.mBackgroundGradientPaint);
        }
    }
    ...
    private final void drawEndCircle(Canvas canvas) {
        ...
        this.circlePaint.setColor(Color.parseColor("#F95843"));
    ...
    private final void drawText(Canvas canvas, float radius) {
        ...
        if (this.mDoQuestionNumber == 0) {
            strValueOf = "0";
        }
        canvas.drawText(strValueOf, (getWidth() - this.mTextPaint.measureText(strValueOf)) / 2.0f, CommonUtil.dip2px(getContext(), 33.0f) + f2, this.mTextPaint);
        this.mTextPaint.setTextSize(CommonUtil.sp2px(getContext(), 10.0f) * 1.0f);
        this.mTextPaint.setTypeface(Typeface.DEFAULT);
        this.mTextPaint.setColor(this.mRightPercentTextColor);
        this.mTextPaint.measureText(this.mAllQuestionNumber);
        canvas.drawText("0", ((getWidth() - this.mTextPaint.measureText("0")) / 3.0f) - CommonUtil.dip2px(getContext(), 16.0f), CommonUtil.dip2px(getContext(), 50.0f) + f2, this.mTextPaint);
        canvas.drawText(this.mAllQuestionNumber, (getWidth() / 3) * 2.0f, f2 + CommonUtil.dip2px(getContext(), 50.0f), this.mTextPaint);
    }
    ...
    public static /* synthetic */ void setCurrentPercent$default(KnowledgePointsProgressView knowledgePointsProgressView, int i2, int i3, String str, int i4, Object obj) {
        if ((i4 & 4) != 0) {
            str = "0.0";
        }
        knowledgePointsProgressView.setCurrentPercent(i2, i3, str);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final void setCurrentPercent$lambda$1(KnowledgePointsProgressView this$0, DecimalFormat fm, ValueAnimator it) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final void setCurrentPercent$lambda$2(KnowledgePointsProgressView this$0, DecimalFormat fm, ValueAnimator it) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        Intrinsics.checkNotNullParameter(fm, "$fm");
        Intrinsics.checkNotNullParameter(it, "it");
        String str = fm.format(it.getAnimatedValue());
    ...
    public void onDraw(@NotNull Canvas canvas) {
        ...
        drawBackgroundGradientArc(canvas);
    ...
    public final void setCurrentPercent(int rightCount, int totalCount, @Nullable String rightPercent) {
        int i2 = rightCount > totalCount ? totalCount : rightCount;
        if (i2 < 0) {
            i2 = 0;
        }
        if (i2 == 0 || rightPercent == null) {
        ...
        this.mAllQuestionNumber = String.valueOf(totalCount);
        ...
        valueAnimatorOfFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.psychiatrygarden.widget.oa
            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                KnowledgePointsProgressView.setCurrentPercent$lambda$1(this.f16759c, decimalFormat, valueAnimator);
            }
        });
        valueAnimatorOfFloat2.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.psychiatrygarden.widget.pa
            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                KnowledgePointsProgressView.setCurrentPercent$lambda$2(this.f16788c, decimalFormat, valueAnimator);
            }
        });
    ...
    @JvmOverloads
    public KnowledgePointsProgressView(@NotNull Context context, @Nullable AttributeSet attributeSet, int i2) {
        super(context, attributeSet, i2);
        Intrinsics.checkNotNullParameter(context, "context");
        this.mDefaultHeight = CommonUtil.dip2px(context, 320.0f);
        this.mDefaultWidth = CommonUtil.dip2px(context, 160.0f);
        this.mStartColor = Color.parseColor("#F95843");
        this.mMiddleColor = Color.parseColor("#F95843");
        this.mEndColor = Color.parseColor("#F95843");
        this.mTextPaint = new TextPaint();
        Paint paint = new Paint();
        this.circlePaint = paint;
        this.mAllQuestionNumber = "";
        this.mBackgroundGradientPaint = new Paint();
        ...
        this.mOutterPaint.setColor(Color.parseColor("#F2F4F6"));
        ...
        this.mPercentTextColor = Color.parseColor("#141516");
        this.mRightPercentTextColor = Color.parseColor("#909499");
        paint.setColor(Color.parseColor("#F95843"));
    }
}
