...
public class ReadMoreIcon extends AppCompatTextView {
    ...
    public class ReadMoreClickableSpan extends ClickableSpan {
        ...
        public void onClick(@NonNull View widget) {
            ReadMoreIcon.this.readMore = !r3.readMore;
            ReadMoreIcon.this.setText();
            if (ReadMoreIcon.this.mListener != null) {
                if (ReadMoreIcon.this.expandText == null) {
                    ReadMoreIcon readMoreIcon = ReadMoreIcon.this;
                    readMoreIcon.expandText = readMoreIcon.updateExpandedText();
                    ReadMoreIcon.this.mListener.updateContent(ReadMoreIcon.this.expandText, null);
                }
                ReadMoreIcon.this.mListener.onChange(ReadMoreIcon.this.readMore);
            }
        }
    ...
    public ReadMoreIcon(Context context) {
        this(context, null);
    }
    ...
    private void onGlobalLayoutLineEndIndex() {
        if (this.trimMode == 0) {
            getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() { // from class: com.psychiatrygarden.widget.ReadMoreIcon.1
                @Override // android.view.ViewTreeObserver.OnGlobalLayoutListener
                public void onGlobalLayout() {
                    if (ReadMoreIcon.this.text == null || ReadMoreIcon.this.text.length() <= 0) {
                        return;
                    }
                    ReadMoreIcon.this.getViewTreeObserver().removeOnGlobalLayoutListener(this);
                    ReadMoreIcon.this.refreshLineEndIndex();
                    ReadMoreIcon.this.setText();
                }
            });
        }
    ...
    public ReadMoreIcon(Context context, AttributeSet attrs) {
        super(context, attrs);
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attrs, R.styleable.ReadMoreIcon);
        this.trimLength = typedArrayObtainStyledAttributes.getInt(3, 240);
        this.trimCollapsedIconRes = typedArrayObtainStyledAttributes.getResourceId(2, R.drawable.collapsed_icon);
