...
public final class KnowledgePointStatisticsProgressView extends View {
    ...
    @JvmOverloads
    public KnowledgePointStatisticsProgressView(@NotNull Context context, @Nullable AttributeSet attributeSet) {
        this(context, attributeSet, 0, 4, null);
        Intrinsics.checkNotNullParameter(context, "context");
    }

    public /* synthetic */ KnowledgePointStatisticsProgressView(Context context, AttributeSet attributeSet, int i2, int i3, DefaultConstructorMarker defaultConstructorMarker) {
    ...
    private final void drawText(Canvas canvas, float radius) {
        ...
        float f3 = strValueOf.length() > 2 ? 8.0f : 1.0f;
        ...
        canvas.drawText(str, (((width - f4) / 2.0f) - (f4 / 4)) - f3, f2, this.mTextPaint);
        this.mTextPaint.setTextSize(CommonUtil.sp2px(getContext(), 12.0f) * 1.0f);
        this.mTextPaint.setTypeface(Typeface.DEFAULT_BOLD);
        float f5 = strValueOf.length() <= 2 ? strValueOf.length() > 1 ? 2.0f : 4.0f : 1.0f;
        float width2 = ((getWidth() / 2.0f) - (strValueOf.length() == 1 ? this.mPercentSymbolWidth / 2 : 0.0f)) + this.mPercentTextWidth;
        float f6 = this.mPercentSymbolWidth;
        if (ScreenUtil.isTablet(getContext())) {
            f5 = 3.0f;
        }
        canvas.drawText("%", width2 + (f6 / f5), f2, this.mTextPaint);
    ...
    public static /* synthetic */ void setCurrentPercent$default(KnowledgePointStatisticsProgressView knowledgePointStatisticsProgressView, int i2, int i3, String str, int i4, Object obj) {
        if ((i4 & 4) != 0) {
            str = "0.0";
        }
        knowledgePointStatisticsProgressView.setCurrentPercent(i2, i3, str);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final void setCurrentPercent$lambda$1(KnowledgePointStatisticsProgressView this$0, DecimalFormat fm, ValueAnimator it) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final void setCurrentPercent$lambda$2(KnowledgePointStatisticsProgressView this$0, DecimalFormat fm, ValueAnimator it) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        Intrinsics.checkNotNullParameter(fm, "$fm");
        Intrinsics.checkNotNullParameter(it, "it");
        String str = fm.format(it.getAnimatedValue());
    ...
    public final void setCurrentPercent(int rightCount, int totalCount, @Nullable String rightPercent) {
        ...
        valueAnimatorOfFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.psychiatrygarden.widget.ma
            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                KnowledgePointStatisticsProgressView.setCurrentPercent$lambda$1(this.f16705c, decimalFormat, valueAnimator);
            }
        });
        valueAnimatorOfFloat2.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.psychiatrygarden.widget.na
            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                KnowledgePointStatisticsProgressView.setCurrentPercent$lambda$2(this.f16732c, decimalFormat, valueAnimator);
            }
        });
    ...
    @JvmOverloads
    public KnowledgePointStatisticsProgressView(@NotNull Context context, @Nullable AttributeSet attributeSet, int i2) {
        ...
        this.mPercentTextColor = Color.parseColor("#303030");
        this.mRightPercentTextColor = Color.parseColor("#909090");
