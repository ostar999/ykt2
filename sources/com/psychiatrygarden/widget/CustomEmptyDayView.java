...
public class CustomEmptyDayView extends LinearLayout {
    ...
    public CustomEmptyDayView(Context context, int resImgId, String emptyStr) {
        super(context);
    ...
    private void init(Context context, int resImgId, String emptyStr, String type) {
        ...
        LayoutInflater.from(context).inflate(R.layout.layout_empty_common_day_view, this);
        ...
        if (resImgId == 0) {
            this.mResImgId = R.drawable.ic_empty_data_normal_day;
        }
    ...
    public void setLoadFileResUi(Context context) {
        ...
        ImageView imageView = this.imgView;
        if (imageView != null) {
            imageView.setImageResource(R.drawable.ic_load_data_failed_day);
        }
    }
    ...
    public CustomEmptyDayView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(context, 0, "", "");
    }

    public CustomEmptyDayView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(context, 0, "", "");
    }

    public CustomEmptyDayView(Context context, int resImgId, String emptyStr, String type) {
        super(context);
