...
public class PinnedSectionListView extends ListView {
    ...
    public PinnedSectionListView(Context context, AttributeSet attrs) {
        ...
        this.mOnScrollListener = new AbsListView.OnScrollListener() { // from class: com.psychiatrygarden.widget.PinnedSectionListView.1
            ...
            public void onScroll(AbsListView view, int firstVisibleItem, int visibleItemCount, int totalItemCount) {
                ...
                if (PinnedSectionListView.isItemViewTypePinned(adapter, adapter.getItemViewType(firstVisibleItem))) {
                ...
                int iFindCurrentSectionPosition = PinnedSectionListView.this.findCurrentSectionPosition(firstVisibleItem);
                if (iFindCurrentSectionPosition > -1) {
                    PinnedSectionListView.this.ensureShadowForPosition(iFindCurrentSectionPosition, firstVisibleItem, visibleItemCount);
                } else {
                    PinnedSectionListView.this.destroyPinnedShadow();
                }
            }
        ...
        this.mDataSetObserver = new DataSetObserver() { // from class: com.psychiatrygarden.widget.PinnedSectionListView.2
    ...
    public void initShadow(boolean visible) {
        if (visible) {
            if (this.mShadowDrawable == null) {
                this.mShadowDrawable = new GradientDrawable(GradientDrawable.Orientation.TOP_BOTTOM, new int[]{Color.parseColor("#ffffffff"), Color.parseColor("#ffffffff"), Color.parseColor("#ffffffff")});
            }
    ...
    public void onRestoreInstanceState(Parcelable state) {
        ...
        post(new Runnable() { // from class: com.psychiatrygarden.widget.PinnedSectionListView.3
