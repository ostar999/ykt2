...
public class RecruitmentInformationLeftItemView extends LinearLayout {
    ...
    public RecruitmentInformationLeftItemView(Context context, boolean isSchoolLine) {
        super(context);
    ...
    private void initView(boolean isSchoolLine) {
        ...
        LayoutInflater.from(getContext()).inflate(R.layout.item_recruitment_info_left_form_title, this);
        this.mTvName = (TextView) findViewById(R.id.tv_name);
        this.mTvLocalName = (TextView) findViewById(R.id.tv_name_local);
    ...
    public void setData(int position, EnrollmentData data) {
        ...
        if (position == 0) {
            this.mTvLocalName.setVisibility(8);
        ...
        this.mTvLocalName.setVisibility(4);
        this.mTvLocalName.setText(data.getMajor_title_local());
    ...
    public RecruitmentInformationLeftItemView(Context context, @Nullable AttributeSet attrs, boolean isSchoolLine) {
        super(context, attrs);
        initView(isSchoolLine);
    }

    public RecruitmentInformationLeftItemView(Context context, @Nullable AttributeSet attrs, int defStyleAttr, boolean isSchoolLine) {
