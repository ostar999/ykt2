...
public class ErrorQuestionRedoDialog extends Dialog {
    public static final int TWO_BUTTON = 2;
    private boolean isOutTouchDismiss;
    private TextView mBtnAllRedo;
    private TextView mBtnCancel;
    private TextView mBtnRedoOtherChapter;
    private RelativeLayout relView;
    private View viewRoot;

    public ErrorQuestionRedoDialog(Context context, boolean isCombine) {
        ...
        View viewInflate = LayoutInflater.from(context).inflate(R.layout.dialog_redo_question_view, (ViewGroup) null);
        ...
        this.mBtnCancel = (TextView) viewFindViewById.findViewById(R.id.btn_cancel);
        this.mBtnAllRedo = (TextView) this.viewRoot.findViewById(R.id.btn_all_redo);
        TextView textView = (TextView) this.viewRoot.findViewById(R.id.btn_redo_other_chapter);
        this.mBtnRedoOtherChapter = textView;
        textView.setVisibility(isCombine ? 8 : 0);
        ...
        setOnShowListener(new DialogInterface.OnShowListener() { // from class: com.psychiatrygarden.widget.x8
            @Override // android.content.DialogInterface.OnShowListener
            public final void onShow(DialogInterface dialogInterface) {
                this.f17088c.lambda$new$0(layoutParams, dialogInterface);
            }
        });
        this.viewRoot.setOnClickListener(new View.OnClickListener() { // from class: com.psychiatrygarden.widget.y8
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                ErrorQuestionRedoDialog.lambda$new$1(view);
            }
        });
        this.relView.setOnClickListener(new View.OnClickListener() { // from class: com.psychiatrygarden.widget.z8
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                this.f17148c.lambda$new$2(view);
            }
        });
        this.mBtnCancel.setOnClickListener(new View.OnClickListener() { // from class: com.psychiatrygarden.widget.a9
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                this.f16311c.lambda$new$3(view);
            }
        });
    }
    ...
    public void setButtonLisenter(View.OnClickListener allRedoLisenter, View.OnClickListener redoOtherLisenter) {
        this.mBtnAllRedo.setOnClickListener(allRedoLisenter);
        this.mBtnRedoOtherChapter.setOnClickListener(redoOtherLisenter);
    }
}
