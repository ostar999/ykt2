...
public class TagLabelsView extends ViewGroup implements View.OnClickListener, View.OnLongClickListener {
    ...
    private final List<LinearLayout> labelViews;
    ...
    public interface OnLabelClickListener {
        void onLabelClick(LinearLayout label, Object data, int position);
    }
    ...
    public TagLabelsView(Context context) {
        super(context);
        this.mLabelWidth = -2;
        this.mLabelHeight = -2;
    ...
    private <T> void addLabel(T data, int position, LabelTextProvider<T> provider) {
        ...
        if (i2 > 0) {
            ...
            if (i3 > 0) {
                ...
                linearLayout.setPadding(this.mTextPaddingLeft, this.mTextPaddingTop, this.mTextPaddingRight, this.mTextPaddingBottom);
            } else {
                int measuredWidth = getMeasuredWidth();
                int i4 = this.mWordMargin;
                int i5 = this.mColumns;
                textView.setWidth((measuredWidth - (i4 * (i5 - 1))) / i5);
                linearLayout.setPadding(0, this.mTextPaddingTop, 0, this.mTextPaddingBottom);
            }
        } else {
            linearLayout.setPadding(this.mTextPaddingLeft, this.mTextPaddingTop, this.mTextPaddingRight, this.mTextPaddingBottom);
        }
        ...
        linearLayout.setTag(R.id.tag_key_data, data);
        linearLayout.setTag(R.id.tag_key_position, Integer.valueOf(position));
        ...
        if (data instanceof ForumTopBean.KeyWordsData) {
            String label = ((ForumTopBean.KeyWordsData) data).getLabel();
            if (!TextUtils.isEmpty(label)) {
                textView.setPadding(0, 0, CommonUtil.dip2px(getContext(), 8.0f), 0);
                TextView textView2 = new TextView(this.mContext);
                textView2.setText(label);
                textView2.setTextColor(Color.parseColor(PLVAuthorizationBean.FCOLOR_DEFAULT));
                textView2.setTextSize(11.0f);
                textView2.setPadding(CommonUtil.dip2px(getContext(), 3.0f), CommonUtil.dip2px(getContext(), 1.0f), CommonUtil.dip2px(getContext(), 3.0f), CommonUtil.dip2px(getContext(), 1.0f));
                textView2.setBackground(ContextCompat.getDrawable(getContext(), R.drawable.bg_book_shelf_new));
                linearLayout.addView(textView2);
            }
        }
        linearLayout.setBackgroundDrawable(this.mLabelBg.getConstantState().newDrawable());
        addView(linearLayout, this.mLabelWidth, this.mLabelHeight);
        this.labelViews.add(linearLayout);
    }
    ...
    private void ensureLabelClickable() {
        int childCount = getChildCount();
        for (int i2 = 0; i2 < childCount; i2++) {
            ((LinearLayout) getChildAt(i2)).setClickable((this.mLabelClickListener == null && this.mLabelLongClickListener == null && this.mSelectType == SelectType.NONE) ? false : true);
        }
    }
        ...
        for (int i2 = 0; i2 < childCount; i2++) {
            ...
            if (childAt instanceof TextView) {
                ...
                if (childAt2 instanceof TextView) {
                    setLabelSelect((TextView) childAt2, false);
                }
            }
        }
    ...
    */
    private void measureMultiLine(int r14, int r15) {
        ...
        La0:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.psychiatrygarden.widget.TagLabelsView.measureMultiLine(int, int):void");
    }
    ...
    public List<LinearLayout> getLabelViews() {
    ...
    public void onClick(View v2) {
        if (v2 instanceof LinearLayout) {
            ...
            if (onLabelClickListener != null) {
                onLabelClickListener.onLabelClick(linearLayout, linearLayout.getTag(R.id.tag_key_data), ((Integer) linearLayout.getTag(R.id.tag_key_position)).intValue());
            }
        }
    }
    ...
    public void setLabels(List<String> labels) {
        setLabels(labels, new LabelTextProvider<String>() { // from class: com.psychiatrygarden.widget.TagLabelsView.1
    ...
    public TagLabelsView(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.mLabelWidth = -2;
        this.mLabelHeight = -2;
        this.mLabelGravity = 17;
    ...
    public TagLabelsView(Context context, AttributeSet attrs, int defStyleAttr) {
