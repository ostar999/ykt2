...
public class LabelsView extends ViewGroup implements View.OnClickListener, View.OnLongClickListener {
    ...
    private <T> void addLabel(T data, int position, LabelTextProvider<T> provider) {
        ...
        if ((data instanceof ChapterOptions) && "0".equals(((ChapterOptions) data).getPass())) {
            Drawable drawable = ContextCompat.getDrawable(getContext(), SkinManager.getCurrentSkinType(getContext()) == 1 ? R.drawable.ic_chapter_lock_night : R.drawable.ic_chapter_lock);
            GradientDrawable gradientDrawable = new GradientDrawable();
            gradientDrawable.setCornerRadius(CommonUtil.dip2px(getContext(), 4.0f));
            ...
            textView.setTextColor(Color.parseColor(SkinManager.getCurrentSkinType(getContext()) == 1 ? "#7380A9" : "#303030"));
            textView.setBackground(gradientDrawable);
            textView.setCompoundDrawablePadding(CommonUtil.dip2px(getContext(), 5.0f));
    ...
    */
    private void measureMultiLine(int r14, int r15) {
        ...
        La0:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.psychiatrygarden.widget.LabelsView.measureMultiLine(int, int):void");
    }
    ...
    public void setLabels(List<String> labels) {
        setLabels(labels, new LabelTextProvider<String>() { // from class: com.psychiatrygarden.widget.LabelsView.1
