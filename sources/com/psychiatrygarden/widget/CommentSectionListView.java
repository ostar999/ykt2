...
public class CommentSectionListView extends ListView implements NestedScrollingChild {
    int firstItem;
    ...
    public CommentSectionListView(Context context) {
        super(context);
        ...
        this.firstItem = 0;
        this.mOnScrollListener = new AbsListView.OnScrollListener() { // from class: com.psychiatrygarden.widget.CommentSectionListView.1
            @Override // android.widget.AbsListView.OnScrollListener
            public void onScroll(AbsListView view, int firstVisibleItem, int visibleItemCount, int totalItemCount) {
                CommentSectionListView commentSectionListView = CommentSectionListView.this;
                commentSectionListView.firstItem = firstVisibleItem;
                AbsListView.OnScrollListener onScrollListener = commentSectionListView.mDelegateOnScrollListener;
                if (onScrollListener != null) {
                    onScrollListener.onScroll(view, firstVisibleItem, visibleItemCount, totalItemCount);
                }
                ListAdapter adapter = CommentSectionListView.this.getAdapter();
                if (adapter == null || visibleItemCount == 0) {
                    return;
                }
                if (CommentSectionListView.isItemViewTypePinned(adapter, adapter.getItemViewType(firstVisibleItem))) {
                    CommentSectionListView commentSectionListView2 = CommentSectionListView.this;
                    commentSectionListView2.sectionView = commentSectionListView2.getChildAt(0);
                    CommentSectionListView.this.mListView.add(CommentSectionListView.this.sectionView);
                    EventBus.getDefault().post(new CommentTagEvent(view.getTag() + "", true));
                    if (CommentSectionListView.this.sectionView.getTop() == CommentSectionListView.this.getPaddingTop()) {
                        CommentSectionListView.this.destroyPinnedShadow();
                        CommentSectionListView.this.sectionView.setVisibility(0);
                    } else {
                        CommentSectionListView.this.sectionView.setVisibility(8);
                        CommentSectionListView.this.ensureShadowForPosition(firstVisibleItem, firstVisibleItem, visibleItemCount);
                    }
                } else {
                    int iFindCurrentSectionPosition = CommentSectionListView.this.findCurrentSectionPosition(firstVisibleItem);
                    if (iFindCurrentSectionPosition > -1) {
                        CommentSectionListView.this.ensureShadowForPosition(iFindCurrentSectionPosition, firstVisibleItem, visibleItemCount);
                        EventBus.getDefault().post(new CommentTagEvent(view.getTag() + "", true));
                        EventBus.getDefault().post(new HideChapterTitleEvent(true, view.getTag() + ""));
                    } else {
                        CommentSectionListView.this.destroyPinnedShadow();
                        View view2 = CommentSectionListView.this.sectionView;
                        if (view2 != null) {
                            view2.setVisibility(0);
                            EventBus.getDefault().post(new CommentTagEvent(view.getTag() + "", false));
                            EventBus.getDefault().post(new HideChapterTitleEvent(false, view.getTag() + ""));
                        }
                    }
                }
                if (firstVisibleItem != 0 || CommentSectionListView.this.mListView == null || CommentSectionListView.this.mListView.size() <= 2) {
                    return;
                }
                for (int i2 = 0; i2 < CommentSectionListView.this.mListView.size(); i2++) {
                    ((View) CommentSectionListView.this.mListView.get(i2)).setVisibility(0);
                }
                CommentSectionListView.this.mListView.clear();
            }

            @Override // android.widget.AbsListView.OnScrollListener
            public void onScrollStateChanged(AbsListView view, int scrollState) {
                AbsListView.OnScrollListener onScrollListener = CommentSectionListView.this.mDelegateOnScrollListener;
                if (onScrollListener != null) {
                    onScrollListener.onScrollStateChanged(view, scrollState);
                }
            }
        };
        this.mDataSetObserver = new DataSetObserver() { // from class: com.psychiatrygarden.widget.CommentSectionListView.2
            @Override // android.database.DataSetObserver
            public void onChanged() {
                CommentSectionListView.this.recreatePinnedShadow();
            }
    ...
    public static boolean isItemViewTypePinned(ListAdapter adapter, int viewType) {
        ...
        return ((PinnedSectionListView1.PinnedSectionListAdapter) adapter).isItemViewTypePinned(viewType);
    }
    ...
    public void onRestoreInstanceState(Parcelable state) {
        ...
        post(new Runnable() { // from class: com.psychiatrygarden.widget.CommentSectionListView.3
    ...
    public CommentSectionListView(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.mTouchRect = new Rect();
        this.mTouchPoint = new PointF();
        this.isPlanCanvas = 0;
    ...
    public CommentSectionListView(Context context, AttributeSet attrs, int defStyle) {
