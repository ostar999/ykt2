...
public class CourseDirectoryExportNoteFragment extends BaseFragment {
    ...
    /* renamed from: com.psychiatrygarden.activity.courselist.fragment.CourseDirectoryExportNoteFragment$1, reason: invalid class name */
    public class AnonymousClass1 extends TreeNodeDelegate<CourseDirectoryTreeBean> {
        ...
        public /* synthetic */ void lambda$convert$0(TreeNode treeNode, View view) {
            if (treeNode.getChildren() == null || treeNode.getChildren().isEmpty()) {
                CourseDirectoryExportNoteFragment.this.toastOnUiThread("没有子课程");
                return;
            }
            CourseDirectoryExportNoteFragment.this.selectOperaAllDirectory(treeNode, this.adapter, Boolean.valueOf(!TreeNodeUtilKt.allSelect(treeNode)));
            CourseDirectoryExportNoteFragment courseDirectoryExportNoteFragment = CourseDirectoryExportNoteFragment.this;
            courseDirectoryExportNoteFragment.updateSelectNoteCount(courseDirectoryExportNoteFragment.list);
        }

        /* JADX INFO: Access modifiers changed from: private */
        public /* synthetic */ void lambda$convert$1(TreeNode treeNode, View view) {
            if (treeNode.getChildren() == null || treeNode.getChildren().isEmpty()) {
                CourseDirectoryExportNoteFragment.this.toastOnUiThread("该目录下没有笔记");
            } else {
        ...
        public void convert(ViewHolder holder, final TreeNode<CourseDirectoryTreeBean> treeNode) {
            ...
            if (CourseDirectoryExportNoteFragment.this.noteCountMap.get(item.getChapter_id()) != null) {
                textView2.setText(CourseDirectoryExportNoteFragment.this.noteCountMap.get(item.getChapter_id()) + "条笔记");
            }
            imageView.setImageDrawable(CourseDirectoryExportNoteFragment.this.getResources().getDrawable(CourseDirectoryExportNoteFragment.this.getSelectImg(treeNode)));
            imageView.setVisibility(0);
            Log.d(CourseDirectoryExportNoteFragment.TAG, "convert: 刷新一级目录： " + treeNode.getValue().getTitle());
            imageView.setOnClickListener(new View.OnClickListener() { // from class: com.psychiatrygarden.activity.courselist.fragment.i0
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    this.f11961c.lambda$convert$0(treeNode, view);
                }
            });
            CourseDirectoryExportNoteFragment.this.childIsVideoItem(treeNode);
            holder.getConvertView().setOnClickListener(new View.OnClickListener() { // from class: com.psychiatrygarden.activity.courselist.fragment.j0
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    this.f11968c.lambda$convert$1(treeNode, view);
                }
            });
            imageView2.setVisibility(0);
            if (!treeNode.isExpand()) {
                CourseDirectoryExportNoteFragment.this.setArrowSpin(holder, treeNode, false);
            } else {
                CourseDirectoryExportNoteFragment.this.setArrowSpin(holder, treeNode, false);
                CourseDirectoryExportNoteFragment.this.firstExpandTree = treeNode;
            }
        }
    ...
    /* renamed from: com.psychiatrygarden.activity.courselist.fragment.CourseDirectoryExportNoteFragment$2, reason: invalid class name */
    public class AnonymousClass2 extends TreeNodeDelegate<CourseDirectoryTreeBean> {
        ...
        public void convert(ViewHolder holder, final TreeNode<CourseDirectoryTreeBean> treeNode) {
            ...
            imageView2.setImageDrawable(CourseDirectoryExportNoteFragment.this.getResources().getDrawable(CourseDirectoryExportNoteFragment.this.getSelectImg(treeNode)));
            imageView2.setVisibility(0);
            imageView2.setOnClickListener(new View.OnClickListener() { // from class: com.psychiatrygarden.activity.courselist.fragment.CourseDirectoryExportNoteFragment.2.1
                @Override // android.view.View.OnClickListener
                public void onClick(View v2) {
                    ...
                    CourseDirectoryExportNoteFragment.this.selectOperaAllDirectory(treeNode, anonymousClass2.adapter, Boolean.valueOf(!zAllSelect));
                    CourseDirectoryExportNoteFragment courseDirectoryExportNoteFragment = CourseDirectoryExportNoteFragment.this;
                    courseDirectoryExportNoteFragment.updateSelectNoteCount(courseDirectoryExportNoteFragment.list);
            ...
            imageView.setVisibility(0);
            holder.getConvertView().setOnClickListener(new View.OnClickListener() { // from class: com.psychiatrygarden.activity.courselist.fragment.k0
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    this.f11975c.lambda$convert$0(treeNode, view);
                }
            });
        }
    ...
    /* renamed from: com.psychiatrygarden.activity.courselist.fragment.CourseDirectoryExportNoteFragment$3, reason: invalid class name */
    public class AnonymousClass3 extends TreeNodeDelegate<CourseDirectoryTreeBean> {
        ...
        public void convert(ViewHolder holder, final TreeNode<CourseDirectoryTreeBean> treeNode) {
            ...
            int iDip2px = DpOrPxUtils.dip2px(((BaseFragment) CourseDirectoryExportNoteFragment.this).mContext, 12.0f);
            Log.d(CourseDirectoryExportNoteFragment.TAG, "convert: 第三级数据： pos:" + absoluteAdapterPosition + "--- value: " + treeNode.getValue().getTitle());
            ...
            if (TreeNodeUtilKt.haveSecondPresent(treeNode)) {
                ...
                if (TreeNodeUtilKt.isOnlyOneItem(treeNode)) {
                    ...
                    relativeLayout.setBackground(CourseDirectoryExportNoteFragment.this.getResources().getDrawable(R.drawable.shape_new_bg_two_color_corner12, ((BaseFragment) CourseDirectoryExportNoteFragment.this).mContext.getTheme()));
                } else if (TreeNodeUtilKt.isTopRadiusItem(treeNode)) {
                    view.setVisibility(0);
                    relativeLayout.setBackground(CourseDirectoryExportNoteFragment.this.getResources().getDrawable(R.drawable.shape_new_bg_two_color_top_corner12, ((BaseFragment) CourseDirectoryExportNoteFragment.this).mContext.getTheme()));
                } else if (TreeNodeUtilKt.isBottomRadiusItem(treeNode)) {
                    view.setVisibility(4);
                    relativeLayout.setBackground(CourseDirectoryExportNoteFragment.this.getResources().getDrawable(R.drawable.shape_new_bg_two_color_bottom_corner12, ((BaseFragment) CourseDirectoryExportNoteFragment.this).mContext.getTheme()));
                } else {
                    view.setVisibility(0);
                    relativeLayout.setBackground(CourseDirectoryExportNoteFragment.this.getResources().getDrawable(R.drawable.shape_project_normal_bg, ((BaseFragment) CourseDirectoryExportNoteFragment.this).mContext.getTheme()));
                }
            } else {
            ...
            imageView.setImageDrawable(CourseDirectoryExportNoteFragment.this.getResources().getDrawable(CourseDirectoryExportNoteFragment.this.getSelectImg(treeNode)));
            imageView.setVisibility(0);
            imageView.setOnClickListener(new View.OnClickListener() { // from class: com.psychiatrygarden.activity.courselist.fragment.l0
                @Override // android.view.View.OnClickListener
                public final void onClick(View view2) {
                    this.f11981c.lambda$convert$0(treeNode, view2);
                }
            });
        }
    ...
    private void getListData() {
        ...
        YJYHttpUtils.get(this.mContext, NetworkRequestsURL.courseDirectoryNote, ajaxParams, new AjaxCallBack<String>() { // from class: com.psychiatrygarden.activity.courselist.fragment.CourseDirectoryExportNoteFragment.4
            @Override // net.tsz.afinal.http.AjaxCallBack
            public void onFailure(Throwable t2, int errorNo, String strMsg) {
                super.onFailure(t2, errorNo, strMsg);
                CourseDirectoryExportNoteFragment.this.emptyView.setLoadFileResUi(CourseDirectoryExportNoteFragment.this.getContext());
                CourseDirectoryExportNoteFragment.this.emptyView.setVisibility(0);
                CourseDirectoryExportNoteFragment.this.courseNoteRecyclerView.setVisibility(8);
            }
            ...
            public void onSuccess(String t2) {
                ...
                try {
                    CourseDirectoryExportNoteFragment.this.refreshLayout.finishRefresh(true);
                    JSONObject jSONObject = new JSONObject(t2);
                    if (jSONObject.optString("code").equals("200")) {
                        List list = (List) new Gson().fromJson(jSONObject.optString("data"), new TypeToken<List<CourseDirectoryItemData>>() { // from class: com.psychiatrygarden.activity.courselist.fragment.CourseDirectoryExportNoteFragment.4.1
                        }.getType());
                        CourseDirectoryExportNoteFragment.this.initNoteCount(list);
                        CourseDirectoryExportNoteFragment.this.initListLayout(list);
                        CourseDirectoryExportNoteFragment.this.emptyView.setVisibility(8);
                        CourseDirectoryExportNoteFragment.this.courseNoteRecyclerView.setVisibility(0);
                    } else {
                        CourseDirectoryExportNoteFragment.this.emptyView.uploadEmptyViewResUi();
                        CourseDirectoryExportNoteFragment.this.emptyView.setVisibility(0);
                        CourseDirectoryExportNoteFragment.this.courseNoteRecyclerView.setVisibility(8);
                    }
                } catch (Exception e2) {
                    Log.e(CourseDirectoryExportNoteFragment.TAG, "onSuccess: 请求目录列表异常:" + e2.getMessage());
                    CourseDirectoryExportNoteFragment.this.emptyView.setLoadFileResUi(CourseDirectoryExportNoteFragment.this.getContext());
                    CourseDirectoryExportNoteFragment.this.emptyView.setVisibility(0);
                    CourseDirectoryExportNoteFragment.this.courseNoteRecyclerView.setVisibility(8);
                }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$getNoteDownLoad$2() {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$updateSelectNoteCount$3() {
    ...
    public void setArrowSpin(ViewHolder helper, TreeNode<CourseDirectoryTreeBean> data, boolean isAnimate) {
        ...
        if (isAnimate) {
            ...
            objectAnimatorOfFloat.addListener(new Animator.AnimatorListener() { // from class: com.psychiatrygarden.activity.courselist.fragment.CourseDirectoryExportNoteFragment.6
                ...
                public void onAnimationEnd(Animator animation) {
                    ...
                    if (SkinManager.getCurrentSkinType(CourseDirectoryExportNoteFragment.this.getActivity()) == 1) {
    ...
    public void updateSelectNoteCount(List<TreeNode<CourseDirectoryTreeBean>> list) {
        ...
        if (this.selectNumChangeListener != null) {
            new Handler().postDelayed(new Runnable() { // from class: com.psychiatrygarden.activity.courselist.fragment.f0
                @Override // java.lang.Runnable
                public final void run() {
                    this.f11946c.lambda$updateSelectNoteCount$3();
                }
            }, 500L);
        }
    ...
    public int getLayoutId() {
        return R.layout.fragment_course_directory_export_note;
    }
    ...
    public void getNoteDownLoad() {
        if (!CommonUtil.hasRequiredPermissionsWriteStorage(getActivity())) {
            new XPopup.Builder(getActivity()).asCustom(new RequestMediaPermissionPop(getActivity(), new OnConfirmListener() { // from class: com.psychiatrygarden.activity.courselist.fragment.e0
                @Override // com.lxj.xpopup.interfaces.OnConfirmListener
                public final void onConfirm() {
                    this.f11940a.lambda$getNoteDownLoad$2();
                }
            })).show();
        }
        ...
        YJYHttpUtils.getNoteFile(getActivity(), str, this.noteFilePath, ajaxParams, new AjaxCallBack<File>() { // from class: com.psychiatrygarden.activity.courselist.fragment.CourseDirectoryExportNoteFragment.5
            @Override // net.tsz.afinal.http.AjaxCallBack
            public void onFailure(Throwable t2, int errorNo, String strMsg) {
                super.onFailure(t2, errorNo, strMsg);
                CourseDirectoryExportNoteFragment.this.hideProgressDialog();
                if (errorNo == 0) {
                    CourseDirectoryExportNoteFragment.this.AlertToast("无法导出,请检查app存储权限是否打开！");
                    return;
                }
                if (errorNo == 200) {
                    CourseDirectoryExportNoteFragment.this.AlertToast(strMsg);
                    return;
                }
                CourseDirectoryExportNoteFragment.this.AlertToast(strMsg + "");
            }
            ...
            public void onStart() {
                super.onStart();
                CourseDirectoryExportNoteFragment.this.showProgressDialog();
            }
            ...
            public void onSuccess(File file2) {
                ...
                CourseDirectoryExportNoteFragment.this.hideProgressDialog();
                CommonUtil.showDialog(CourseDirectoryExportNoteFragment.this.getActivity(), file2.getAbsolutePath());
            }
        });
    }
    ...
    public void initViews(com.psychiatrygarden.baseview.ViewHolder holder, View root) {
        ...
        this.refreshLayout.setOnRefreshListener(new OnRefreshListener() { // from class: com.psychiatrygarden.activity.courselist.fragment.g0
            @Override // com.scwang.smartrefresh.layout.listener.OnRefreshListener
            public final void onRefresh(RefreshLayout refreshLayout) {
                this.f11951c.lambda$initViews$0(refreshLayout);
            }
        });
        ...
        this.emptyView.setOnReloadData(new View.OnClickListener() { // from class: com.psychiatrygarden.activity.courselist.fragment.h0
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                this.f11956c.lambda$initViews$1(view);
            }
        });
