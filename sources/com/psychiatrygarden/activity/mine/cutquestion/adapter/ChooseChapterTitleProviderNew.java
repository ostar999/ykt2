...
public class ChooseChapterTitleProviderNew extends BaseNodeProvider {
    private boolean mIsShowCount;
    private ChooseChapterAdpNew.JumpToQList mJumpToQList;

    public ChooseChapterTitleProviderNew(ChooseChapterAdpNew.JumpToQList mJumpToQList, boolean isShowCount) {
    ...
    public void convert(@NotNull final BaseViewHolder helper, @NotNull final BaseNode data) {
        ...
        if (!"1".equals(dataBean.getPass())) {
            ...
            if (dataBean.getIsSelected() == 1) {
                ...
                imageView3.setVisibility(0);
                imageView4.setVisibility(8);
                imageView3.setImageResource(z2 ? R.drawable.download_part_select_night : R.drawable.download_part_select);
            } else {
                imageView3.setVisibility(0);
                imageView4.setVisibility(8);
            ...
            imageView3.setOnClickListener(new View.OnClickListener() { // from class: l1.b
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    this.f27665c.lambda$convert$0(dataBean, helper, view);
                }
            });
        } else {
            imageView3.setVisibility(8);
        ...
        BaseViewHolderUtilKt.getCustomerItemView(helper).setOnClickListener(new View.OnClickListener() { // from class: l1.c
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                this.f27668c.lambda$convert$1(dataBean, helper, data, textView, imageView, view);
            }
        });
        if (dataBean.getChildren() == null || dataBean.getChildren().size() <= 0) {
