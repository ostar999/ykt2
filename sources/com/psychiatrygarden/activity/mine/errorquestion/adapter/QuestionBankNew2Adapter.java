...
public class QuestionBankNew2Adapter extends BaseNodeAdapter {
    ...
    public interface JumpToQList {
        ...
        void mJumpToQList(String primary_id, String unit, String parent_title, String title, BaseNode node);
    }

    public QuestionBankNew2Adapter(JumpToQList mJumpToQList) {
        addNodeProvider(new QuestionBankNew2Provider(mJumpToQList));
        addNodeProvider(new QuestionBankNewSecond2Provider(mJumpToQList));
    }
