...
public class RegisterSelectMajorThreeActivity extends BaseActivity {
    ...
    private void getMajorTwo(String major_id) throws PackageManager.NameNotFoundException {
        ...
        YJYHttpUtils.postTemp(this.mContext, NetworkRequestsURL.majorUrl, ajaxParams, new AjaxCallBack<String>() { // from class: com.psychiatrygarden.activity.RegisterCommon.RegisterSelectMajorThreeActivity.2
    ...
    public /* synthetic */ void lambda$setListenerForWidget$0(AdapterView adapterView, View view, int i2, long j2) throws PackageManager.NameNotFoundException {
        ...
        Intent intent = new Intent(this, (Class<?>) RegisterSelectMajorTwoActivity.class);
    ...
    public void setContentView() {
        ...
        CommAdapter<MajorBean.DataBean> commAdapter = new CommAdapter<MajorBean.DataBean>(this.dataMajor, this.mContext, R.layout.activity_txt) { // from class: com.psychiatrygarden.activity.RegisterCommon.RegisterSelectMajorThreeActivity.1
    ...
    public void setListenerForWidget() {
        this.mRegister_comList.setOnItemClickListener(new AdapterView.OnItemClickListener() { // from class: com.psychiatrygarden.activity.RegisterCommon.l
            ...
            public final void onItemClick(AdapterView adapterView, View view, int i2, long j2) throws PackageManager.NameNotFoundException {
                this.f10969c.lambda$setListenerForWidget$0(adapterView, view, i2, j2);
            }
        });
    }
}
