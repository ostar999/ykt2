...
public class RegisterSelectDepartThreeActivity extends BaseActivity {
    ...
    private void getDepartTwo(String department_id) throws PackageManager.NameNotFoundException {
        ...
        YJYHttpUtils.postTemp(this.mContext, NetworkRequestsURL.mDepartmentUrl, ajaxParams, new AjaxCallBack<String>() { // from class: com.psychiatrygarden.activity.RegisterCommon.RegisterSelectDepartThreeActivity.2
            @Override // net.tsz.afinal.http.AjaxCallBack
            public void onFailure(Throwable t2, int errorNo, String strMsg) {
                super.onFailure(t2, errorNo, strMsg);
                RegisterSelectDepartThreeActivity.this.hideProgressDialog();
            }

            @Override // net.tsz.afinal.http.AjaxCallBack
            public void onStart() {
                super.onStart();
                RegisterSelectDepartThreeActivity.this.showProgressDialog();
            }
            ...
            public void onSuccess(String s2) {
                ...
                try {
                    ...
                    if (registerDepartmentBean.getCode().equals("200")) {
                        Intent intent = new Intent(RegisterSelectDepartThreeActivity.this, (Class<?>) RegisterSelectDepartFourActivity.class);
                        intent.putExtra("dataList", (Serializable) registerDepartmentBean.getData());
                        RegisterSelectDepartThreeActivity.this.startActivityForResult(intent, 8);
                    } else {
                        RegisterSelectDepartThreeActivity.this.AlertToast(registerDepartmentBean.getMessage());
                    }
                } catch (Exception e2) {
                    e2.printStackTrace();
                }
    ...
    public /* synthetic */ void lambda$setListenerForWidget$0(AdapterView adapterView, View view, int i2, long j2) throws PackageManager.NameNotFoundException {
        ...
        Intent intent = new Intent(this, (Class<?>) RegisterSelectDepartTwoActivity.class);
    ...
    public void setContentView() {
        ...
        CommAdapter<RegisterDepartmentBean.DataBean> commAdapter = new CommAdapter<RegisterDepartmentBean.DataBean>(this.dataDepartmentList, this.mContext, R.layout.activity_txt) { // from class: com.psychiatrygarden.activity.RegisterCommon.RegisterSelectDepartThreeActivity.1
    ...
    public void setListenerForWidget() {
        this.mRegister_comList.setOnItemClickListener(new AdapterView.OnItemClickListener() { // from class: com.psychiatrygarden.activity.RegisterCommon.c
            ...
            public final void onItemClick(AdapterView adapterView, View view, int i2, long j2) throws PackageManager.NameNotFoundException {
                this.f10960c.lambda$setListenerForWidget$0(adapterView, view, i2, j2);
            }
        });
    }
}
