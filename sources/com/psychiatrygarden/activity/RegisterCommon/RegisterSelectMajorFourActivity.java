...
public class RegisterSelectMajorFourActivity extends BaseActivity {
    ...
    public /* synthetic */ void lambda$setListenerForWidget$0(AdapterView adapterView, View view, int i2, long j2) {
        Intent intent = this.type.equals("3") ? new Intent(this, (Class<?>) RegisterSelectMajorActivity.class) : new Intent(this, (Class<?>) RegisterSelectMajorThreeActivity.class);
    ...
    public void setContentView() {
        ...
        CommAdapter<MajorBean.DataBean> commAdapter = new CommAdapter<MajorBean.DataBean>(this.dataMajor, this.mContext, R.layout.activity_txt) { // from class: com.psychiatrygarden.activity.RegisterCommon.RegisterSelectMajorFourActivity.1
    ...
    public void setListenerForWidget() {
        this.mRegister_comList.setOnItemClickListener(new AdapterView.OnItemClickListener() { // from class: com.psychiatrygarden.activity.RegisterCommon.k
            @Override // android.widget.AdapterView.OnItemClickListener
            public final void onItemClick(AdapterView adapterView, View view, int i2, long j2) {
                this.f10968c.lambda$setListenerForWidget$0(adapterView, view, i2, j2);
            }
        });
    }
}
