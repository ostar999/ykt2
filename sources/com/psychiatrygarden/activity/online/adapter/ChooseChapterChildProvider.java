...
public class ChooseChapterChildProvider extends BaseNodeProvider {
    private boolean mIsShowCount;
    private ChooseChapterAdp.JumpToQList mJumpToQList;

    public ChooseChapterChildProvider(ChooseChapterAdp.JumpToQList mJumpToQList, boolean isShowCount) {
    ...
    public void convert(@NotNull final BaseViewHolder helper, @NotNull BaseNode baseNode) {
        ...
        linearLayout.setOnClickListener(new View.OnClickListener() { // from class: com.psychiatrygarden.activity.online.adapter.a
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                this.f13092c.lambda$convert$0(childrenBean, helper, view);
            }
        });
    }
}
