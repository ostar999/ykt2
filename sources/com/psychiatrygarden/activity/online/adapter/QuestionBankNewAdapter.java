...
public class QuestionBankNewAdapter extends BaseNodeAdapter {
    ...
    public QuestionBankNewAdapter(JumpToQList mJumpToQList) {
        addNodeProvider(new QuestionBankNewProvider(mJumpToQList));
        addNodeProvider(new QuestionBankNewSecondProvider(mJumpToQList));
    }
