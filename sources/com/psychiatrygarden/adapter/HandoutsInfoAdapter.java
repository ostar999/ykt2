...
public class HandoutsInfoAdapter extends BaseAdapter implements PinnedSectionListView1.PinnedSectionListAdapter {
    ...
    /* renamed from: com.psychiatrygarden.adapter.HandoutsInfoAdapter$1, reason: invalid class name */
    public class AnonymousClass1 extends Handler {

        /* renamed from: com.psychiatrygarden.adapter.HandoutsInfoAdapter$1$1, reason: invalid class name and collision with other inner class name */
        public class C02871 implements onDialogShareClickListener {
            ...
            public C02871(final CommentBean.DataBean.HotBean.ReplyBean val$commListBean, final String val$reply_primary_id, final CommentBean.DataBean.HotBean val$mHotbean, final View val$v) {
            ...
            public /* synthetic */ void lambda$onclickIntBack$0(CommentBean.DataBean.HotBean.ReplyBean replyBean, String str, CommentBean.DataBean.HotBean hotBean, String str2, String str3, String str4) {
                if (!UserConfig.getInstance().getUser().getAdmin().equals("1")) {
                    ...
                    bundle.putString("module_type", HandoutsInfoAdapter.this.module_type + "");
                    ...
                    HandoutsInfoAdapter.this.putComment(bundle, 1, hotBean);
                    return;
                }
                Bundle bundle2 = new Bundle();
                bundle2.putString("to_user_id", replyBean.getUser_id());
                bundle2.putString("module_type", HandoutsInfoAdapter.this.module_type + "");
                ...
                Intent intent = new Intent(HandoutsInfoAdapter.this.context, (Class<?>) CorpCupActivity.class);
                intent.putExtra("bundleIntent", bundle2);
                HandoutsInfoAdapter.this.mActivity.startActivityForResult(intent, 0);
            }
            ...
            public /* synthetic */ void lambda$onclickIntBack$1(CommentBean.DataBean.HotBean.ReplyBean replyBean, CommentBean.DataBean.HotBean hotBean, String str, String str2, String str3) {
                HandoutsInfoAdapter.this.mBianjiDataVisition(replyBean.getId(), replyBean.getCtime_timestamp(), str, replyBean.getPraise_num(), replyBean.getOppose_num(), replyBean, 1, hotBean, str2, str3);
            }
            ...
            public /* synthetic */ void lambda$onclickIntBack$2(final CommentBean.DataBean.HotBean.ReplyBean replyBean, final CommentBean.DataBean.HotBean hotBean, View view, int i2) {
                if (i2 == 0) {
                    new PopInputWindow(HandoutsInfoAdapter.this.context, replyBean.getCtime_timestamp(), 1, new OnMInputListenster() { // from class: com.psychiatrygarden.adapter.HandoutsInfoAdapter.1.1.1
                        @Override // com.psychiatrygarden.interfaceclass.OnMInputListenster
                        public void mInputDataListter(String txtSter) {
                            HandoutsInfoAdapter handoutsInfoAdapter = HandoutsInfoAdapter.this;
                            ...
                            handoutsInfoAdapter.mBianjiDataVisition(id, txtSter, content, praise_num, oppose_num, replyBean2, 1, hotBean, replyBean2.getC_imgs().getB_img(), replyBean.getC_imgs().getS_img());
                        }
                    }).showPopUp(view);
                    return;
                }
                if (i2 != 1) {
                    if (i2 == 2) {
                        new PopInputWindow(HandoutsInfoAdapter.this.context, replyBean.getPraise_num(), 2, new OnMInputListenster() { // from class: com.psychiatrygarden.adapter.HandoutsInfoAdapter.1.1.2
                            @Override // com.psychiatrygarden.interfaceclass.OnMInputListenster
                            public void mInputDataListter(String txtSter) {
                                HandoutsInfoAdapter handoutsInfoAdapter = HandoutsInfoAdapter.this;
                                String id = replyBean.getId();
                                ...
                                String oppose_num = replyBean.getOppose_num();
                                CommentBean.DataBean.HotBean.ReplyBean replyBean2 = replyBean;
                                handoutsInfoAdapter.mBianjiDataVisition(id, ctime_timestamp, content, txtSter, oppose_num, replyBean2, 1, hotBean, replyBean2.getC_imgs().getB_img(), replyBean.getC_imgs().getS_img());
                            }
                        }).showPopUp(view);
                        return;
                    } else {
                        ...
                        new PopInputWindow(HandoutsInfoAdapter.this.context, replyBean.getOppose_num(), 3, new OnMInputListenster() { // from class: com.psychiatrygarden.adapter.HandoutsInfoAdapter.1.1.3
                            @Override // com.psychiatrygarden.interfaceclass.OnMInputListenster
                            public void mInputDataListter(String txtSter) {
                                HandoutsInfoAdapter handoutsInfoAdapter = HandoutsInfoAdapter.this;
                                String id = replyBean.getId();
                                ...
                                String praise_num = replyBean.getPraise_num();
                                CommentBean.DataBean.HotBean.ReplyBean replyBean2 = replyBean;
                                handoutsInfoAdapter.mBianjiDataVisition(id, ctime_timestamp, content, praise_num, txtSter, replyBean2, 1, hotBean, replyBean2.getC_imgs().getB_img(), replyBean.getC_imgs().getS_img());
                            }
                        }).showPopUp(view);
                        return;
                    }
                }
                new DialogInput(HandoutsInfoAdapter.this.context, new onDialogClickListener() { // from class: com.psychiatrygarden.adapter.l7
                    ...
                    public final void onclickStringBack(String str, String str2, String str3) {
                        this.f14714a.lambda$onclickIntBack$1(replyBean, hotBean, str, str2, str3);
                    }
                }, replyBean.getContent(), "正在编辑" + replyBean.getNickname() + "的评论...", HandoutsInfoAdapter.this.isNewComzantong, replyBean.getC_imgs().getB_img(), replyBean.getC_imgs().getS_img(), 1, replyBean.getC_imgs().getVideoId()).show();
            }
            ...
            /* JADX INFO: Access modifiers changed from: private */
            public /* synthetic */ void lambda$onclickIntBack$4(CommentBean.DataBean.HotBean.ReplyBean replyBean, CommentBean.DataBean.HotBean hotBean, String str, String str2, String str3, String str4) {
                HandoutsInfoAdapter.this.mBianjiDataVisition(replyBean.getId(), str, str2, str3, str4, replyBean, 1, hotBean, replyBean.getC_imgs().getB_img(), replyBean.getC_imgs().getS_img());
            }

            /* JADX INFO: Access modifiers changed from: private */
            public /* synthetic */ void lambda$onclickIntBack$5(final CommentBean.DataBean.HotBean.ReplyBean replyBean, View view, final String str, final PopupComWindow popupComWindow) {
                new PopupComWindow(HandoutsInfoAdapter.this.mActivity, "请选择封禁理由", "", 3, new OnClickDiogListenter() { // from class: com.psychiatrygarden.adapter.HandoutsInfoAdapter.1.1.4
                    ...
                    public void onDiogClick(String str2, PopupComWindow popupComWindow2) {
                        ...
                        HttpRequstData.getIntance(HandoutsInfoAdapter.this.context).postBannedData(replyBean.getUser_id(), str2, str);
                    }
                }).showPopUp(view);
            }

            /* JADX INFO: Access modifiers changed from: private */
            public /* synthetic */ void lambda$onclickIntBack$6() {
                HandoutsInfoAdapter.this.setAlpha(true);
            }
            ...
            public void onclickIntBack(int i2) {
                switch (i2) {
                    case 0:
                        Context context = HandoutsInfoAdapter.this.context;
                        ...
                        new DialogInput(context, new onDialogClickListener() { // from class: com.psychiatrygarden.adapter.f7
                            @Override // com.psychiatrygarden.interfaceclass.onDialogClickListener
                            public final void onclickStringBack(String str2, String str3, String str4) {
                                this.f14471a.lambda$onclickIntBack$0(replyBean, str, hotBean, str2, str3, str4);
                            }
                        }, "", "回复 " + this.val$commListBean.getNickname(), false).show();
                        break;
                    case 1:
                        if (UserConfig.getInstance().getUser().getAdmin().equals("1")) {
                            BaseActivity baseActivity = HandoutsInfoAdapter.this.mActivity;
                            ...
                            new XPopup.Builder(HandoutsInfoAdapter.this.context).autoDismiss(Boolean.FALSE).popupAnimation(null).asCustom(new PopupBianjiComWindow(baseActivity, new OnClickbianjiListenter() { // from class: com.psychiatrygarden.adapter.g7
                                @Override // com.psychiatrygarden.interfaceclass.OnClickbianjiListenter
                                public final void mBianjiData(int i3) {
                                    this.f14512a.lambda$onclickIntBack$2(replyBean2, hotBean2, view, i3);
                                }
                            })).show();
                            break;
                        } else {
                            Context context2 = HandoutsInfoAdapter.this.context;
                            ...
                            new DialogInput(context2, new onDialogClickListener() { // from class: com.psychiatrygarden.adapter.h7
                                @Override // com.psychiatrygarden.interfaceclass.onDialogClickListener
                                public final void onclickStringBack(String str2, String str3, String str4) {
                                    this.f14556a.lambda$onclickIntBack$3(replyBean3, hotBean3, str2, str3, str4);
                                }
                            }, this.val$commListBean.getContent(), "正在编辑" + this.val$commListBean.getNickname() + "的评论...", HandoutsInfoAdapter.this.isNewComzantong, this.val$commListBean.getC_imgs().getB_img(), this.val$commListBean.getC_imgs().getS_img(), 1, this.val$commListBean.getC_imgs().getVideoId()).show();
                            break;
                        }
                    case 2:
                        HandoutsInfoAdapter.this.deleteComm(this.val$commListBean.getId(), this.val$reply_primary_id, 1, this.val$mHotbean);
                        break;
                    case 3:
                        ((ClipboardManager) HandoutsInfoAdapter.this.context.getSystemService("clipboard")).setText(this.val$commListBean.getContent());
                        NewToast.showShort(HandoutsInfoAdapter.this.context, "复制成功", 0).show();
                        break;
                    case 4:
                        HandoutsInfoAdapter handoutsInfoAdapter = HandoutsInfoAdapter.this;
                        handoutsInfoAdapter.getUserInfo(handoutsInfoAdapter.context, this.val$commListBean.getUser_id());
                        break;
                    case 5:
                        if ((TextUtils.isEmpty(this.val$commListBean.getIs_essence()) ? "0" : this.val$commListBean.getIs_essence()).equals("1")) {
                            for (int i3 = 0; i3 < HandoutsInfoAdapter.this.list.size(); i3++) {
                                try {
                                    if (this.val$commListBean.getId().equals(((CommentBean.DataBean.HotBean) HandoutsInfoAdapter.this.list.get(i3)).getId())) {
                                        ((CommentBean.DataBean.HotBean) HandoutsInfoAdapter.this.list.get(i3)).setIs_essence("0");
                                    }
                                    if (((CommentBean.DataBean.HotBean) HandoutsInfoAdapter.this.list.get(i3)).getReply() != null && ((CommentBean.DataBean.HotBean) HandoutsInfoAdapter.this.list.get(i3)).getReply().size() > 0) {
                                        for (int i4 = 0; i4 < ((CommentBean.DataBean.HotBean) HandoutsInfoAdapter.this.list.get(i3)).getReply().size(); i4++) {
                                            if (this.val$commListBean.getId().equals(((CommentBean.DataBean.HotBean) HandoutsInfoAdapter.this.list.get(i3)).getReply().get(i4).getId())) {
                                                ((CommentBean.DataBean.HotBean) HandoutsInfoAdapter.this.list.get(i3)).getReply().get(i4).setIs_essence("0");
                                            }
                                        }
                                    }
                                } catch (Exception e2) {
                            ...
                            NewToast.showShort(HandoutsInfoAdapter.this.context, "取消加精成功", 0).show();
                        } else {
                            for (int i5 = 0; i5 < HandoutsInfoAdapter.this.list.size(); i5++) {
                                try {
                                    if (this.val$commListBean.getId().equals(((CommentBean.DataBean.HotBean) HandoutsInfoAdapter.this.list.get(i5)).getId())) {
                                        ((CommentBean.DataBean.HotBean) HandoutsInfoAdapter.this.list.get(i5)).setIs_essence("1");
                                    }
                                    if (((CommentBean.DataBean.HotBean) HandoutsInfoAdapter.this.list.get(i5)).getReply() != null && ((CommentBean.DataBean.HotBean) HandoutsInfoAdapter.this.list.get(i5)).getReply().size() > 0) {
                                        for (int i6 = 0; i6 < ((CommentBean.DataBean.HotBean) HandoutsInfoAdapter.this.list.get(i5)).getReply().size(); i6++) {
                                            if (this.val$commListBean.getId().equals(((CommentBean.DataBean.HotBean) HandoutsInfoAdapter.this.list.get(i5)).getReply().get(i6).getId())) {
                                                ((CommentBean.DataBean.HotBean) HandoutsInfoAdapter.this.list.get(i5)).getReply().get(i6).setIs_essence("1");
                                            }
                                        }
                                    }
                                } catch (Exception e3) {
                            ...
                            HandoutsInfoAdapter.this.putDigest(this.val$commListBean.getId());
                        }
                        HandoutsInfoAdapter.this.notifyDataSetChanged();
                        break;
                    case 6:
                        Context context3 = HandoutsInfoAdapter.this.context;
                        ...
                        new DialogAdminInput(context3, new BianjiInfaceInput() { // from class: com.psychiatrygarden.adapter.i7
                            ...
                            public final void mBianjiInfaceInput(String str2, String str3, String str4, String str5) {
                                this.f14595a.lambda$onclickIntBack$4(replyBean4, hotBean4, str2, str3, str4, str5);
                            }
                        ...
                        break;
                    case 7:
                        BaseActivity baseActivity2 = HandoutsInfoAdapter.this.mActivity;
                        final CommentBean.DataBean.HotBean.ReplyBean replyBean5 = this.val$commListBean;
                        final View view2 = this.val$v;
                        PopupComWindow popupComWindow = new PopupComWindow(baseActivity2, "请选择封禁类型", "", 1, new OnClickDiogListenter() { // from class: com.psychiatrygarden.adapter.j7
                            @Override // com.psychiatrygarden.interfaceclass.OnClickDiogListenter
                            public final void onDiogClick(String str2, PopupComWindow popupComWindow2) {
                                this.f14640a.lambda$onclickIntBack$5(replyBean5, view2, str2, popupComWindow2);
                            }
                        });
                        popupComWindow.setOnDismissListener(new PopupWindow.OnDismissListener() { // from class: com.psychiatrygarden.adapter.k7
                            @Override // android.widget.PopupWindow.OnDismissListener
                            public final void onDismiss() {
                                this.f14675c.lambda$onclickIntBack$6();
                            }
                        });
                        HandoutsInfoAdapter.this.setAlpha(false);
                        popupComWindow.showPopUp(this.val$v);
                        break;
                    case 8:
                        new PopupComWindow(HandoutsInfoAdapter.this.mActivity, "欢迎举报,请选择举报理由", "（被举报的评论将及时清理）", 2, new OnClickDiogListenter() { // from class: com.psychiatrygarden.adapter.HandoutsInfoAdapter.1.1.5
                            @Override // com.psychiatrygarden.interfaceclass.OnClickDiogListenter
                            public void onDiogClick(String str2, PopupComWindow popupComWindow2) {
                                if (popupComWindow2 != null && popupComWindow2.isShowing()) {
                                    popupComWindow2.dismiss();
                                }
                                HttpRequstData.getIntance(HandoutsInfoAdapter.this.context).postReportData(C02871.this.val$commListBean.getId(), str2, HandoutsInfoAdapter.this.module_type + "");
                            }
        ...
        public void handleMessage(Message message) {
            ...
            if (i2 != 1) {
                if (i2 == 2) {
                    HandoutsInfoAdapter.this.putPraise(message.getData().getString("id"), message.getData().getString("is_praise").equals("0") ? "1" : "0");
                    return;
                } else {
                    if (i2 != 3) {
                        return;
                    }
                    HandoutsInfoAdapter.this.putOppose(message.getData().getString("id"), message.getData().getString("is_Oppose").equals("0") ? "1" : "0");
                    return;
                }
            }
            ...
            if ("1".equals(replyBean.getStatus())) {
                CommonUtil.mToastShow(HandoutsInfoAdapter.this.context);
                return;
            }
            new XPopup.Builder(HandoutsInfoAdapter.this.context).autoDismiss(Boolean.FALSE).asCustom(new PopupWin7Comment(HandoutsInfoAdapter.this.context, replyBean.getContent(), replyBean.getNickname(), zEquals ? 1 : 0, replyBean.getIs_anonymous() + "", replyBean.getDelete_skill(), new C02871(replyBean, string, hotBean, view))).show();
        }
    }

    /* renamed from: com.psychiatrygarden.adapter.HandoutsInfoAdapter$3, reason: invalid class name */
    public class AnonymousClass3 implements MyExpendView.OnExpandStateChangeListener {
        ...
        /* renamed from: com.psychiatrygarden.adapter.HandoutsInfoAdapter$3$1, reason: invalid class name */
        public class AnonymousClass1 implements onDialogShareClickListener {
            ...
            public /* synthetic */ void lambda$onclickIntBack$0(CommentBean.DataBean.HotBean hotBean, String str, String str2, String str3) {
                if (!UserConfig.getInstance().getUser().getAdmin().equals("1")) {
                    ...
                    HandoutsInfoAdapter.this.putComment(bundle, 2, hotBean);
                    return;
                }
                Bundle bundle2 = new Bundle();
            ...
            /* JADX INFO: Access modifiers changed from: private */
            public /* synthetic */ void lambda$onclickIntBack$1(CommentBean.DataBean.HotBean hotBean, String str) {
                HandoutsInfoAdapter.this.mBianjiDataVisition(hotBean.getId(), str, hotBean.getContent(), hotBean.getPraise_num(), hotBean.getOppose_num(), null, 2, hotBean, hotBean.getC_imgs().getB_img(), hotBean.getC_imgs().getS_img());
            }

            /* JADX INFO: Access modifiers changed from: private */
            public /* synthetic */ void lambda$onclickIntBack$2(CommentBean.DataBean.HotBean hotBean, String str, String str2, String str3) {
                HandoutsInfoAdapter.this.mBianjiDataVisition(hotBean.getId(), hotBean.getCtime_timestamp(), str, hotBean.getPraise_num(), hotBean.getOppose_num(), null, 2, hotBean, str2, str3);
            }

            /* JADX INFO: Access modifiers changed from: private */
            public /* synthetic */ void lambda$onclickIntBack$3(CommentBean.DataBean.HotBean hotBean, String str) {
                HandoutsInfoAdapter.this.mBianjiDataVisition(hotBean.getId(), hotBean.getCtime_timestamp(), hotBean.getContent(), str, hotBean.getOppose_num(), null, 2, hotBean, hotBean.getC_imgs().getB_img(), hotBean.getC_imgs().getS_img());
            }

            /* JADX INFO: Access modifiers changed from: private */
            public /* synthetic */ void lambda$onclickIntBack$4(final CommentBean.DataBean.HotBean hotBean, View view, int i2) {
                if (i2 == 0) {
                    new PopInputWindow(HandoutsInfoAdapter.this.context, hotBean.getCtime_timestamp(), 1, new OnMInputListenster() { // from class: com.psychiatrygarden.adapter.n7
                        @Override // com.psychiatrygarden.interfaceclass.OnMInputListenster
                        public final void mInputDataListter(String str) {
                            this.f14797a.lambda$onclickIntBack$1(hotBean, str);
                        }
                    }).showPopUp(view);
                    return;
                }
                if (i2 != 1) {
                    if (i2 == 2) {
                        new PopInputWindow(HandoutsInfoAdapter.this.context, hotBean.getPraise_num(), 2, new OnMInputListenster() { // from class: com.psychiatrygarden.adapter.p7
                            @Override // com.psychiatrygarden.interfaceclass.OnMInputListenster
                            public final void mInputDataListter(String str) {
                                this.f14875a.lambda$onclickIntBack$3(hotBean, str);
                            }
                        }).showPopUp(view);
                        return;
                    } else {
                        ...
                        new PopInputWindow(HandoutsInfoAdapter.this.context, hotBean.getOppose_num(), 3, new OnMInputListenster() { // from class: com.psychiatrygarden.adapter.HandoutsInfoAdapter.3.1.1
                            @Override // com.psychiatrygarden.interfaceclass.OnMInputListenster
                            public void mInputDataListter(String txtSter) {
                                HandoutsInfoAdapter handoutsInfoAdapter = HandoutsInfoAdapter.this;
                                ...
                                handoutsInfoAdapter.mBianjiDataVisition(id, ctime_timestamp, content, praise_num, txtSter, null, 2, hotBean2, hotBean2.getC_imgs().getB_img(), hotBean.getC_imgs().getS_img());
                            }
                        }).showPopUp(view);
                        return;
                    }
                }
                new DialogInput(HandoutsInfoAdapter.this.context, new onDialogClickListener() { // from class: com.psychiatrygarden.adapter.o7
                    @Override // com.psychiatrygarden.interfaceclass.onDialogClickListener
                    public final void onclickStringBack(String str, String str2, String str3) {
                        this.f14835a.lambda$onclickIntBack$2(hotBean, str, str2, str3);
                    }
                }, hotBean.getContent(), "正在编辑" + hotBean.getNickname() + "的评论...", HandoutsInfoAdapter.this.isNewComzantong, hotBean.getC_imgs().getB_img(), hotBean.getC_imgs().getS_img(), 1, hotBean.getC_imgs().getVideoId()).show();
            }
            ...
            public /* synthetic */ void lambda$onclickIntBack$6(CommentBean.DataBean.HotBean hotBean, String str, String str2, String str3, String str4) {
                HandoutsInfoAdapter.this.mBianjiDataVisition(hotBean.getId(), str, str2, str3, str4, null, 2, hotBean, hotBean.getC_imgs().getB_img(), hotBean.getC_imgs().getS_img());
            }

            /* JADX INFO: Access modifiers changed from: private */
            public static /* synthetic */ void lambda$onclickIntBack$7(PopupComWindow popupComWindow, CommentBean.DataBean.HotBean hotBean, String str, String str2, PopupComWindow popupComWindow2) {
            ...
            /* JADX INFO: Access modifiers changed from: private */
            public /* synthetic */ void lambda$onclickIntBack$8(final CommentBean.DataBean.HotBean hotBean, View view, final String str, final PopupComWindow popupComWindow) {
                new PopupComWindow(HandoutsInfoAdapter.this.mActivity, "请选择封禁理由", "", 3, new OnClickDiogListenter() { // from class: com.psychiatrygarden.adapter.m7
                    @Override // com.psychiatrygarden.interfaceclass.OnClickDiogListenter
                    public final void onDiogClick(String str2, PopupComWindow popupComWindow2) {
                        HandoutsInfoAdapter.AnonymousClass3.AnonymousClass1.lambda$onclickIntBack$7(popupComWindow, hotBean, str, str2, popupComWindow2);
                    }
                }).showPopUp(view);
            }

            /* JADX INFO: Access modifiers changed from: private */
            public /* synthetic */ void lambda$onclickIntBack$9() {
                HandoutsInfoAdapter.this.setAlpha(true);
            }
            ...
            public void onclickIntBack(int i2) {
                switch (i2) {
                    case 0:
                        ...
                        new DialogInput(context, new onDialogClickListener() { // from class: com.psychiatrygarden.adapter.q7
                            @Override // com.psychiatrygarden.interfaceclass.onDialogClickListener
                            public final void onclickStringBack(String str, String str2, String str3) {
                                this.f14912a.lambda$onclickIntBack$0(hotBean, str, str2, str3);
                            }
                        }, "", "回复 " + AnonymousClass3.this.val$mCommentBean.getNickname(), HandoutsInfoAdapter.this.isNewComzantong).show();
                        break;
                    case 1:
                        if (UserConfig.getInstance().getUser().getAdmin().equals("1")) {
                            AnonymousClass3 anonymousClass3 = AnonymousClass3.this;
                            BaseActivity baseActivity = HandoutsInfoAdapter.this.mActivity;
                            final CommentBean.DataBean.HotBean hotBean2 = anonymousClass3.val$mCommentBean;
                            final View view = this.val$v;
                            new XPopup.Builder(HandoutsInfoAdapter.this.context).autoDismiss(Boolean.FALSE).popupAnimation(null).asCustom(new PopupBianjiComWindow(baseActivity, new OnClickbianjiListenter() { // from class: com.psychiatrygarden.adapter.r7
                                @Override // com.psychiatrygarden.interfaceclass.OnClickbianjiListenter
                                public final void mBianjiData(int i3) {
                                    this.f14956a.lambda$onclickIntBack$4(hotBean2, view, i3);
                                }
                            })).show();
                            break;
                        } else {
                            ...
                            new DialogInput(context2, new onDialogClickListener() { // from class: com.psychiatrygarden.adapter.s7
                                @Override // com.psychiatrygarden.interfaceclass.onDialogClickListener
                                public final void onclickStringBack(String str, String str2, String str3) {
                                    this.f14997a.lambda$onclickIntBack$5(hotBean3, str, str2, str3);
                                }
                            }, AnonymousClass3.this.val$mCommentBean.getContent(), "正在编辑" + AnonymousClass3.this.val$mCommentBean.getNickname() + "的评论...", HandoutsInfoAdapter.this.isNewComzantong, AnonymousClass3.this.val$mCommentBean.getC_imgs().getB_img(), AnonymousClass3.this.val$mCommentBean.getC_imgs().getS_img(), 1, AnonymousClass3.this.val$mCommentBean.getC_imgs().getVideoId()).show();
                            break;
                        }
                    case 2:
                        AnonymousClass3 anonymousClass32 = AnonymousClass3.this;
                        HandoutsInfoAdapter.this.deleteComm(anonymousClass32.val$mCommentBean.getId(), AnonymousClass3.this.val$mCommentBean.getReply_primary_id(), 2, AnonymousClass3.this.val$mCommentBean);
                        break;
                    case 3:
                        ((ClipboardManager) HandoutsInfoAdapter.this.context.getSystemService("clipboard")).setText(AnonymousClass3.this.val$mCommentBean.getContent());
                        NewToast.showShort(HandoutsInfoAdapter.this.context, "复制成功", 0).show();
                        break;
                    case 4:
                        HandoutsInfoAdapter handoutsInfoAdapter = HandoutsInfoAdapter.this;
                        handoutsInfoAdapter.getUserInfo(handoutsInfoAdapter.context, AnonymousClass3.this.val$mCommentBean.getUser_id());
                        break;
                    case 5:
                        if ((TextUtils.isEmpty(AnonymousClass3.this.val$mCommentBean.getIs_essence()) ? "0" : AnonymousClass3.this.val$mCommentBean.getIs_essence()).equals("1")) {
                            try {
                                ...
                                for (int i3 = 0; i3 < HandoutsInfoAdapter.this.list.size(); i3++) {
                                    List<CommentBean.DataBean.HotBean.ReplyBean> reply = ((CommentBean.DataBean.HotBean) HandoutsInfoAdapter.this.list.get(i2)).getReply();
                            ...
                            try {
                                ...
                                for (int i5 = 0; i5 < HandoutsInfoAdapter.this.list.size(); i5++) {
                                    List<CommentBean.DataBean.HotBean.ReplyBean> reply2 = ((CommentBean.DataBean.HotBean) HandoutsInfoAdapter.this.list.get(i2)).getReply();
                            ...
                            HandoutsInfoAdapter.this.putDigest(anonymousClass33.val$mCommentBean.getId());
                            break;
                        }
                        break;
                    case 6:
                        ...
                        new DialogAdminInput(context3, new BianjiInfaceInput() { // from class: com.psychiatrygarden.adapter.t7
                            @Override // com.psychiatrygarden.interfaceclass.BianjiInfaceInput
                            public final void mBianjiInfaceInput(String str, String str2, String str3, String str4) {
                                this.f15034a.lambda$onclickIntBack$6(hotBean4, str, str2, str3, str4);
                            }
                    ...
                    case 7:
                        ...
                        BaseActivity baseActivity2 = HandoutsInfoAdapter.this.mActivity;
                        final CommentBean.DataBean.HotBean hotBean5 = anonymousClass34.val$mCommentBean;
                        final View view2 = this.val$v;
                        PopupComWindow popupComWindow = new PopupComWindow(baseActivity2, "请选择封禁类型", "", 1, new OnClickDiogListenter() { // from class: com.psychiatrygarden.adapter.u7
                            @Override // com.psychiatrygarden.interfaceclass.OnClickDiogListenter
                            public final void onDiogClick(String str, PopupComWindow popupComWindow2) {
                                this.f15071a.lambda$onclickIntBack$8(hotBean5, view2, str, popupComWindow2);
                            }
                        });
                        popupComWindow.setOnDismissListener(new PopupWindow.OnDismissListener() { // from class: com.psychiatrygarden.adapter.v7
                            @Override // android.widget.PopupWindow.OnDismissListener
                            public final void onDismiss() {
                                this.f15105c.lambda$onclickIntBack$9();
                            }
                        });
                        HandoutsInfoAdapter.this.setAlpha(false);
                        popupComWindow.showPopUp(this.val$v);
                        break;
                    case 8:
                        new PopupComWindow(HandoutsInfoAdapter.this.mActivity, "欢迎举报,请选择举报理由", "（被举报的评论将及时清理）", 2, new OnClickDiogListenter() { // from class: com.psychiatrygarden.adapter.HandoutsInfoAdapter.3.1.2
                            @Override // com.psychiatrygarden.interfaceclass.OnClickDiogListenter
                            public void onDiogClick(String str, PopupComWindow popupComWindow2) {
                                if (popupComWindow2 != null && popupComWindow2.isShowing()) {
                                    popupComWindow2.dismiss();
                                }
                                HttpRequstData.getIntance(HandoutsInfoAdapter.this.context).postReportData(AnonymousClass3.this.val$mCommentBean.getId(), str, HandoutsInfoAdapter.this.module_type + "");
                            }
                        }).showPopUp(this.val$v);
                        break;
                }
        ...
        public void onClickStateChange(View view) {
            ...
            new XPopup.Builder(HandoutsInfoAdapter.this.context).autoDismiss(Boolean.FALSE).asCustom(new PopupWin7Comment(HandoutsInfoAdapter.this.context, this.val$mCommentBean.getContent(), this.val$mCommentBean.getNickname(), zEquals ? 1 : 0, this.val$mCommentBean.getIs_anonymous() + "", this.val$mCommentBean.getDelete_skill(), new AnonymousClass1(view))).show();
        }
    ...
    /* renamed from: com.psychiatrygarden.adapter.HandoutsInfoAdapter$4, reason: invalid class name */
    public class AnonymousClass4 implements onDialogShareClickListener {
        final /* synthetic */ CommentBean.DataBean.HotBean val$mCommentBean;
        final /* synthetic */ View val$v;

        public AnonymousClass4(final CommentBean.DataBean.HotBean val$mCommentBean, final View val$v) {
            this.val$mCommentBean = val$mCommentBean;
            this.val$v = val$v;
        }
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public /* synthetic */ void lambda$onclickIntBack$3(final CommentBean.DataBean.HotBean hotBean, View view, int i2) {
            if (i2 == 0) {
                new PopInputWindow(HandoutsInfoAdapter.this.context, hotBean.getCtime_timestamp(), 1, new OnMInputListenster() { // from class: com.psychiatrygarden.adapter.w7
                    @Override // com.psychiatrygarden.interfaceclass.OnMInputListenster
                    public final void mInputDataListter(String str) {
                        this.f15134a.lambda$onclickIntBack$1(hotBean, str);
                    }
                }).showPopUp(view);
                return;
            }
            if (i2 != 1) {
                if (i2 == 2) {
                    new PopInputWindow(HandoutsInfoAdapter.this.context, hotBean.getPraise_num(), 2, new OnMInputListenster() { // from class: com.psychiatrygarden.adapter.HandoutsInfoAdapter.4.1
                        @Override // com.psychiatrygarden.interfaceclass.OnMInputListenster
                        public void mInputDataListter(String txtSter) {
                            HandoutsInfoAdapter handoutsInfoAdapter = HandoutsInfoAdapter.this;
                            String id = hotBean.getId();
                            ...
                            CommentBean.DataBean.HotBean hotBean2 = hotBean;
                            handoutsInfoAdapter.mBianjiDataVisition(id, ctime_timestamp, content, txtSter, oppose_num, null, 2, hotBean2, hotBean2.getC_imgs().getB_img(), hotBean.getC_imgs().getS_img());
                        }
                    }).showPopUp(view);
                    return;
                } else {
                    ...
                    new PopInputWindow(HandoutsInfoAdapter.this.context, hotBean.getOppose_num(), 3, new OnMInputListenster() { // from class: com.psychiatrygarden.adapter.HandoutsInfoAdapter.4.2
                        @Override // com.psychiatrygarden.interfaceclass.OnMInputListenster
                        public void mInputDataListter(String txtSter) {
                            HandoutsInfoAdapter handoutsInfoAdapter = HandoutsInfoAdapter.this;
                            String id = hotBean.getId();
            ...
            new DialogInput(HandoutsInfoAdapter.this.context, new onDialogClickListener() { // from class: com.psychiatrygarden.adapter.x7
                @Override // com.psychiatrygarden.interfaceclass.onDialogClickListener
                public final void onclickStringBack(String str, String str2, String str3) {
                    this.f15165a.lambda$onclickIntBack$2(hotBean, str, str2, str3);
                }
            }, hotBean.getContent(), "正在编辑" + hotBean.getNickname() + "的评论...", HandoutsInfoAdapter.this.isNewComzantong, hotBean.getC_imgs().getB_img(), hotBean.getC_imgs().getS_img(), 1, hotBean.getC_imgs().getVideoId()).show();
        }
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public /* synthetic */ void lambda$onclickIntBack$5(CommentBean.DataBean.HotBean hotBean, String str, String str2, String str3, String str4) {
            HandoutsInfoAdapter.this.mBianjiDataVisition(hotBean.getId(), str, str2, str3, str4, null, 2, hotBean, hotBean.getC_imgs().getB_img(), hotBean.getC_imgs().getS_img());
        }

        /* JADX INFO: Access modifiers changed from: private */
        public /* synthetic */ void lambda$onclickIntBack$6(final CommentBean.DataBean.HotBean hotBean, View view, final String str, final PopupComWindow popupComWindow) {
            new PopupComWindow(HandoutsInfoAdapter.this.mActivity, "请选择封禁理由", "", 3, new OnClickDiogListenter() { // from class: com.psychiatrygarden.adapter.HandoutsInfoAdapter.4.3
                @Override // com.psychiatrygarden.interfaceclass.OnClickDiogListenter
                public void onDiogClick(String str2, PopupComWindow popupComWindow2) {
                    PopupComWindow popupComWindow3 = popupComWindow;
                    if (popupComWindow3 != null && popupComWindow3.isShowing()) {
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public /* synthetic */ void lambda$onclickIntBack$7() {
            HandoutsInfoAdapter.this.setAlpha(true);
        }
        ...
        public void onclickIntBack(int i2) {
            switch (i2) {
                case 0:
                    ...
                    new DialogInput(context, new onDialogClickListener() { // from class: com.psychiatrygarden.adapter.y7
                        @Override // com.psychiatrygarden.interfaceclass.onDialogClickListener
                        public final void onclickStringBack(String str, String str2, String str3) {
                            this.f15200a.lambda$onclickIntBack$0(hotBean, str, str2, str3);
                        }
                    }, "", "回复 " + this.val$mCommentBean.getNickname(), HandoutsInfoAdapter.this.isNewComzantong).show();
                    break;
                case 1:
                    if (UserConfig.getInstance().getUser().getAdmin().equals("1")) {
                        BaseActivity baseActivity = HandoutsInfoAdapter.this.mActivity;
                        ...
                        final View view = this.val$v;
                        new XPopup.Builder(HandoutsInfoAdapter.this.context).autoDismiss(Boolean.FALSE).popupAnimation(null).asCustom(new PopupBianjiComWindow(baseActivity, new OnClickbianjiListenter() { // from class: com.psychiatrygarden.adapter.z7
                            @Override // com.psychiatrygarden.interfaceclass.OnClickbianjiListenter
                            public final void mBianjiData(int i3) {
                                this.f15234a.lambda$onclickIntBack$3(hotBean2, view, i3);
                            }
                        })).show();
                        break;
                    } else {
                        ...
                        new DialogInput(context2, new onDialogClickListener() { // from class: com.psychiatrygarden.adapter.a8
                            @Override // com.psychiatrygarden.interfaceclass.onDialogClickListener
                            public final void onclickStringBack(String str, String str2, String str3) {
                                this.f14285a.lambda$onclickIntBack$4(hotBean3, str, str2, str3);
                            }
                        }, this.val$mCommentBean.getContent(), "正在编辑" + this.val$mCommentBean.getNickname() + "的评论...", HandoutsInfoAdapter.this.isNewComzantong, this.val$mCommentBean.getC_imgs().getB_img(), this.val$mCommentBean.getC_imgs().getS_img(), 1, this.val$mCommentBean.getC_imgs().getVideoId()).show();
                        break;
                    }
                case 2:
                    HandoutsInfoAdapter.this.deleteComm(this.val$mCommentBean.getId(), this.val$mCommentBean.getReply_primary_id(), 2, this.val$mCommentBean);
                    break;
                case 3:
                    ((ClipboardManager) HandoutsInfoAdapter.this.context.getSystemService("clipboard")).setText(this.val$mCommentBean.getContent());
                    NewToast.showShort(HandoutsInfoAdapter.this.context, "复制成功", 0).show();
                    break;
                case 4:
                    HandoutsInfoAdapter handoutsInfoAdapter = HandoutsInfoAdapter.this;
                    handoutsInfoAdapter.getUserInfo(handoutsInfoAdapter.context, this.val$mCommentBean.getUser_id());
                    break;
                case 5:
                    if ((TextUtils.isEmpty(this.val$mCommentBean.getIs_essence()) ? "0" : this.val$mCommentBean.getIs_essence()).equals("1")) {
                        ...
                        HandoutsInfoAdapter.this.putDigest(this.val$mCommentBean.getId());
                        break;
                    }
                    break;
                case 6:
                    ...
                    new DialogAdminInput(context3, new BianjiInfaceInput() { // from class: com.psychiatrygarden.adapter.b8
                        @Override // com.psychiatrygarden.interfaceclass.BianjiInfaceInput
                        public final void mBianjiInfaceInput(String str, String str2, String str3, String str4) {
                            this.f14323a.lambda$onclickIntBack$5(hotBean4, str, str2, str3, str4);
                        }
                ...
                case 7:
                    ...
                    final View view2 = this.val$v;
                    PopupComWindow popupComWindow = new PopupComWindow(baseActivity2, "请选择封禁类型", "", 1, new OnClickDiogListenter() { // from class: com.psychiatrygarden.adapter.c8
                        @Override // com.psychiatrygarden.interfaceclass.OnClickDiogListenter
                        public final void onDiogClick(String str, PopupComWindow popupComWindow2) {
                            this.f14359a.lambda$onclickIntBack$6(hotBean5, view2, str, popupComWindow2);
                        }
                    });
                    popupComWindow.setOnDismissListener(new PopupWindow.OnDismissListener() { // from class: com.psychiatrygarden.adapter.d8
                        @Override // android.widget.PopupWindow.OnDismissListener
                        public final void onDismiss() {
                            this.f14403c.lambda$onclickIntBack$7();
                        }
                    });
                    HandoutsInfoAdapter.this.setAlpha(false);
                    popupComWindow.showPopUp(this.val$v);
                    break;
                case 8:
                    new PopupComWindow(HandoutsInfoAdapter.this.mActivity, "欢迎举报,请选择举报理由", "（被举报的评论将及时清理）", 2, new OnClickDiogListenter() { // from class: com.psychiatrygarden.adapter.HandoutsInfoAdapter.4.4
                        @Override // com.psychiatrygarden.interfaceclass.OnClickDiogListenter
                        public void onDiogClick(String str, PopupComWindow popupComWindow2) {
                            if (popupComWindow2 != null && popupComWindow2.isShowing()) {
                                popupComWindow2.dismiss();
                            }
                            HttpRequstData.getIntance(HandoutsInfoAdapter.this.context).postReportData(AnonymousClass4.this.val$mCommentBean.getId(), str, HandoutsInfoAdapter.this.module_type + "");
                        }
                    }).showPopUp(this.val$v);
                    break;
            }
    ...
    /* renamed from: com.psychiatrygarden.adapter.HandoutsInfoAdapter$5, reason: invalid class name */
    public class AnonymousClass5 implements CommentListenter {
        ...
        public void commListOppose(String moudle_type, String is_Oppose, String id, String obj_id) {
            ...
            HandoutsInfoAdapter.this.mHandler.sendMessage(messageObtain);
        }
        ...
        public void commListPraiseFaile() {
            NewToast.showShort(HandoutsInfoAdapter.this.context, "您已经点赞了", 0).show();
        }

        @Override // com.psychiatrygarden.utils.CommentListenter
        public void commListReply(final CommentBean.DataBean.HotBean.ReplyBean cmt, View v2) {
            if (Integer.parseInt(cmt.getReply_num()) >= 1) {
                Intent intent = new Intent(HandoutsInfoAdapter.this.context, (Class<?>) CommentReplyActivity.class);
                intent.putExtra("is_replybean", true);
                intent.putExtra("module_type", HandoutsInfoAdapter.this.module_type);
                intent.putExtra("comment_type", HandoutsInfoAdapter.this.comment_type);
                intent.putExtra("bean", cmt);
                intent.putExtra("isVisiable", true);
                intent.putExtra("app_id", HandoutsInfoAdapter.this.mAppId);
                HandoutsInfoAdapter.this.context.startActivity(intent);
                return;
            }
            if (cmt.getIs_del().equals("1")) {
                NewToast.showShort(HandoutsInfoAdapter.this.context, "评论已删除", 0).show();
                return;
            }
            Context context = HandoutsInfoAdapter.this.context;
            final CommentBean.DataBean.HotBean hotBean = this.val$mCommentBean;
            new DialogInput(context, new onDialogClickListener() { // from class: com.psychiatrygarden.adapter.e8
                @Override // com.psychiatrygarden.interfaceclass.onDialogClickListener
                public final void onclickStringBack(String str, String str2, String str3) {
                    this.f14437a.lambda$commListReply$0(cmt, hotBean, str, str2, str3);
                }
            }, "", "回复 " + cmt.getNickname(), HandoutsInfoAdapter.this.isNewComzantong).show();
        }
        ...
        public void commentListenerData(CommentBean.DataBean.HotBean.ReplyBean commListBean, View v2) {
            if (HandoutsInfoAdapter.this.is_is_prohibit.equals("1")) {
                ToastUtil.shortToast(HandoutsInfoAdapter.this.mActivity, "本帖已被锁定，不支持回帖");
                return;
            }
            Message messageObtain = Message.obtain();
            messageObtain.obj = v2;
    ...
    public HandoutsInfoAdapter(Context context, List<CommentBean.DataBean.HotBean> list, List<CommentBean.DataBean.HotBean> time_line, int module_type, String comment_type, String question_id, BaseActivity mActivity, String is_is_prohibit, String appId, CircleInfoClickIml circleInfoClickIml) {
    ...
    public void getUserInfo(Context mContext, String user_id) {
        ...
        YJYHttpUtils.get(mContext, NetworkRequestsURL.mGetUserInfoUrl, ajaxParams, new AjaxCallBack<String>() { // from class: com.psychiatrygarden.adapter.HandoutsInfoAdapter.11
            ...
            public void onSuccess(String t2) {
                try {
                    ...
                    if (jSONObject.optString("code").equals("200")) {
                        CommonUtil.mPutChatData(HandoutsInfoAdapter.this.mActivity, jSONObject.optJSONObject("data").optString("user_uuid"), jSONObject.optJSONObject("data").optString("nickname"));
                    }
                } catch (Exception e2) {
                    e2.printStackTrace();
                }
    ...
    public /* synthetic */ void lambda$getView$10(CommentBean.DataBean.HotBean hotBean, View view) {
        ...
        new XPopup.Builder(this.context).autoDismiss(Boolean.FALSE).asCustom(new PopupWin7Comment(this.context, hotBean.getContent(), hotBean.getNickname(), zEquals ? 1 : 0, hotBean.getIs_anonymous() + "", hotBean.getDelete_skill(), new AnonymousClass4(hotBean, view))).show();
    }
    ...
    public /* synthetic */ void lambda$getView$7(final CommentBean.DataBean.HotBean hotBean, View view) {
        if (Integer.parseInt(hotBean.getReply_num()) <= 0) {
            new DialogInput(this.context, new onDialogClickListener() { // from class: com.psychiatrygarden.adapter.s6
                @Override // com.psychiatrygarden.interfaceclass.onDialogClickListener
                public final void onclickStringBack(String str, String str2, String str3) {
                    this.f14995a.lambda$getView$6(hotBean, str, str2, str3);
                }
            }, "", "回复 " + hotBean.getNickname(), this.isNewComzantong).show();
            return;
        }
    ...
    public void Toast_pop(View v2, int flag) {
        ...
        popupWindow.setOnDismissListener(new PopupWindow.OnDismissListener() { // from class: com.psychiatrygarden.adapter.w6
            @Override // android.widget.PopupWindow.OnDismissListener
            public final void onDismiss() {
                HandoutsInfoAdapter.lambda$Toast_pop$11();
            }
        });
        ...
        new Handler().postDelayed(new Runnable() { // from class: com.psychiatrygarden.adapter.x6
    ...
    public void deleteComm(final String id, String reply_primary_id, final Integer valueInt, final CommentBean.DataBean.HotBean mHotBean) {
        ...
        YJYHttpUtils.post(this.context.getApplicationContext(), NetworkRequestsURL.mDeleteUrl, ajaxParams, new AjaxCallBack<String>() { // from class: com.psychiatrygarden.adapter.HandoutsInfoAdapter.10
            @Override // net.tsz.afinal.http.AjaxCallBack
            public void onFailure(Throwable t2, int errorNo, String strMsg) {
                super.onFailure(t2, errorNo, strMsg);
                HandoutsInfoAdapter.this.mActivity.hideProgressDialog();
                NewToast.showShort(HandoutsInfoAdapter.this.context, "请求服务器失败", 0).show();
            }
                ...
                try {
                    ...
                    if (jSONObject.optString("code").equals("200")) {
                        ...
                        if (valueInt.intValue() == 1) {
                            for (int i2 = 0; i2 < HandoutsInfoAdapter.this.list.size(); i2++) {
                                List<CommentBean.DataBean.HotBean.ReplyBean> reply = ((CommentBean.DataBean.HotBean) HandoutsInfoAdapter.this.list.get(i2)).getReply();
                                if (reply != null && reply.size() > 0) {
                                    for (int i3 = 0; i3 < ((CommentBean.DataBean.HotBean) HandoutsInfoAdapter.this.list.get(i2)).getReply().size(); i3++) {
                                        if (id.equals(((CommentBean.DataBean.HotBean) HandoutsInfoAdapter.this.list.get(i2)).getReply().get(i3).getId())) {
                                            ((CommentBean.DataBean.HotBean) HandoutsInfoAdapter.this.list.get(i2)).getReply().get(i3).setContent("已删除");
                                            ((CommentBean.DataBean.HotBean) HandoutsInfoAdapter.this.list.get(i2)).getReply().get(i3).setC_imgs(new ImagesBean());
                                            ((CommentBean.DataBean.HotBean) HandoutsInfoAdapter.this.list.get(i2)).getReply().get(i3).setIs_del("1");
                                        }
                                    }
                                }
                            }
                            ...
                            int i4 = -1;
                            for (int i5 = 0; i5 < HandoutsInfoAdapter.this.list.size(); i5++) {
                                if (mHotBean.getId().equals(((CommentBean.DataBean.HotBean) HandoutsInfoAdapter.this.list.get(i5)).getId())) {
                                    i4 = i5;
                                }
                            }
                            if (i4 > -1) {
                                if (((CommentBean.DataBean.HotBean) HandoutsInfoAdapter.this.list.get(i4)).getReply() == null || ((CommentBean.DataBean.HotBean) HandoutsInfoAdapter.this.list.get(i4)).getReply().size() <= 0) {
                                    HandoutsInfoAdapter.this.list.remove(i4);
                                } else {
                                    int size = ((CommentBean.DataBean.HotBean) HandoutsInfoAdapter.this.list.get(i4)).getReply().size() - 1;
                                    CommentBean.DataBean.HotBean.ReplyBean replyBean = ((CommentBean.DataBean.HotBean) HandoutsInfoAdapter.this.list.get(i4)).getReply().get(size);
                                    if (size > 0) {
                                        List<CommentBean.DataBean.HotBean.ReplyBean> listSubList = ((CommentBean.DataBean.HotBean) HandoutsInfoAdapter.this.list.get(i4)).getReply().subList(0, size);
                                        HandoutsInfoAdapter.this.list.set(i4, replyBean);
                                        ((CommentBean.DataBean.HotBean) HandoutsInfoAdapter.this.list.get(i4)).setReply(listSubList);
                                    } else {
                                        ((CommentBean.DataBean.HotBean) HandoutsInfoAdapter.this.list.get(i4)).setReply(null);
                                        HandoutsInfoAdapter.this.list.set(i4, replyBean);
                                    }
                                }
                            }
                    ...
                    NewToast.showShort(HandoutsInfoAdapter.this.context, jSONObject.optString("message"), 0).show();
                    HandoutsInfoAdapter.this.mActivity.hideProgressDialog();
                } catch (Exception e2) {
                    e2.printStackTrace();
                }
    ...
    public View getView(int position, View converView, ViewGroup viewGrop) throws InterruptedException {
        ...
        if (converView == null) {
            ...
            viewInflate = LayoutInflater.from(this.context).inflate(R.layout.activity_circleinfo, (ViewGroup) null);
        ...
        if (this.showAd && position == 9) {
            ...
            if (this.ykbAd) {
                viewHolder.llAd.loadYkbAd(item.getAds(), position, new QuestionAdWidegt.OnRemoveListener() { // from class: com.psychiatrygarden.adapter.y6
                    @Override // com.psychiatrygarden.widget.QuestionAdWidegt.OnRemoveListener
                    public final void onCloseAd(int i2) {
                        this.f15198a.lambda$getView$0(viewHolder, i2);
                    }
                });
            } else {
        ...
        if (item.getType() == 1) {
            ...
            viewHolder.remen2.setOnClickListener(new View.OnClickListener() { // from class: com.psychiatrygarden.adapter.z6
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    this.f15233c.lambda$getView$1(view);
                }
            });
            viewHolder.zuixin2.setOnClickListener(new View.OnClickListener() { // from class: com.psychiatrygarden.adapter.a7
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    this.f14284c.lambda$getView$2(view);
                }
            });
        } else {
            ...
            if (item.getUser_identity().equals("1") || item.getIs_authentication().equals("1")) {
                ...
                viewHolder.isverauth.setOnClickListener(new View.OnClickListener() { // from class: com.psychiatrygarden.adapter.b7
                    @Override // android.view.View.OnClickListener
                    public final void onClick(View view) {
                        this.f14322c.lambda$getView$3(view);
                    }
                });
            } else {
                viewHolder.jiav.setVisibility(8);
            ...
            viewHolder.tv_support.setOnClickListener(new View.OnClickListener() { // from class: com.psychiatrygarden.adapter.c7
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    this.f14356c.lambda$getView$4(item, viewHolder, view);
                }
            });
            viewHolder.tv_oppose.setOnClickListener(new View.OnClickListener() { // from class: com.psychiatrygarden.adapter.d7
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    this.f14400c.lambda$getView$5(item, viewHolder, view);
                }
            });
            viewHolder.tv_reply.setOnClickListener(new View.OnClickListener() { // from class: com.psychiatrygarden.adapter.e7
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    this.f14435c.lambda$getView$7(item, view);
                }
            });
            viewHolder.commentList_item_userIcon.setOnClickListener(new View.OnClickListener() { // from class: com.psychiatrygarden.adapter.t6
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    this.f15032c.lambda$getView$8(item, view);
                }
            });
            viewHolder.commentList_item_tv_userName.setOnClickListener(new View.OnClickListener() { // from class: com.psychiatrygarden.adapter.u6
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    this.f15069c.lambda$getView$9(item, view);
                }
            });
            ...
            viewInflate.setOnClickListener(new View.OnClickListener() { // from class: com.psychiatrygarden.adapter.v6
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    this.f15103c.lambda$getView$10(item, view);
                }
            });
    ...
    public void mBianjiDataVisition(String id, final String pushTime, final String pushcontent, final String pushoppn, final String pushno, final CommentBean.DataBean.HotBean.ReplyBean commListBean, final int type, final CommentBean.DataBean.HotBean mHotbean, final String b_img, final String s_img) {
        ...
        YJYHttpUtils.post(this.context.getApplicationContext(), NetworkRequestsURL.mPutBianAdminDataUrl, ajaxParams, new AjaxCallBack<String>() { // from class: com.psychiatrygarden.adapter.HandoutsInfoAdapter.2
            @Override // net.tsz.afinal.http.AjaxCallBack
            public void onFailure(Throwable t2, int errorNo, String strMsg) {
                super.onFailure(t2, errorNo, strMsg);
            }
            ...
            public void onSuccess(String s2) {
                ...
                try {
                    if (!new JSONObject(s2).optString("code").equals("200")) {
                        NewToast.showShort(HandoutsInfoAdapter.this.context, new JSONObject(s2).optString("message"), 0).show();
                        return;
                    }
                    int i2 = type;
                    if (i2 == 1) {
    ...
    public void putComment(Bundle b3, final Integer changeCode, final CommentBean.DataBean.HotBean mHotBean) {
        ...
        ajaxParams.put("obj_id", mHotBean.getObj_id());
        ajaxParams.put("module_type", this.module_type + "");
        ajaxParams.put("comment_type", this.comment_type);
        ...
        YJYHttpUtils.post(this.context.getApplicationContext(), NetworkRequestsURL.mPutComment, ajaxParams, new AjaxCallBack<String>() { // from class: com.psychiatrygarden.adapter.HandoutsInfoAdapter.6
            @Override // net.tsz.afinal.http.AjaxCallBack
            public void onFailure(Throwable t2, int errorNo, String strMsg) {
                super.onFailure(t2, errorNo, strMsg);
                NewToast.showShort(HandoutsInfoAdapter.this.context, "请求服务器超时！", 0).show();
            }
            ...
            public void onSuccess(String s2) {
                ...
                try {
                    ...
                    if (HandoutsInfoAdapter.this.mActionListener != null) {
                        HandoutsInfoAdapter.this.mActionListener.updateBottom();
                    }
                    SharePreferencesUtils.writeStrConfig(CommonParameter.PINGLUNTXT, "", HandoutsInfoAdapter.this.context);
                    if (!StrPool.EMPTY_JSON.equals(jSONObject.optString("data"))) {
                        HandoutsInfoAdapter.this.mH = (CommentBean.DataBean.HotBean) new Gson().fromJson(jSONObject.optString("data"), CommentBean.DataBean.HotBean.class);
                        int i2 = -1;
                        for (int i3 = 0; i3 < HandoutsInfoAdapter.this.list.size(); i3++) {
                            if (mHotBean.getId().equals(((CommentBean.DataBean.HotBean) HandoutsInfoAdapter.this.list.get(i3)).getId())) {
                                i2 = i3;
                            }
                        }
                        HandoutsInfoAdapter.this.list.set(i2, HandoutsInfoAdapter.this.mH);
                        HandoutsInfoAdapter.this.notifyDataSetChanged();
                    }
    ...
    public void putDigest(String id) {
        ...
        YJYHttpUtils.post(this.context.getApplicationContext(), NetworkRequestsURL.mDigest, ajaxParams, new AjaxCallBack<String>() { // from class: com.psychiatrygarden.adapter.HandoutsInfoAdapter.9
            @Override // net.tsz.afinal.http.AjaxCallBack
            public void onFailure(Throwable t2, int errorNo, String strMsg) {
                super.onFailure(t2, errorNo, strMsg);
            }
            ...
            public void onSuccess(String s2) {
                ...
                try {
                    if (new JSONObject(s2).optString("code").equals("200")) {
                        NewToast.showShort(HandoutsInfoAdapter.this.context, "加精成功", 0).show();
                    }
                } catch (Exception unused) {
                }
            }
    ...
    public void putOppose(String id, String type) {
        ...
        YJYHttpUtils.post(this.context.getApplicationContext(), NetworkRequestsURL.mPutOpposeUrl, ajaxParams, new AjaxCallBack<String>() { // from class: com.psychiatrygarden.adapter.HandoutsInfoAdapter.7
            @Override // net.tsz.afinal.http.AjaxCallBack
            public void onFailure(Throwable t2, int errorNo, String strMsg) {
                super.onFailure(t2, errorNo, strMsg);
            }
            ...
            public void onSuccess(String s2) {
                ...
                try {
                    if (!new JSONObject(s2).optString("code").equals("200") || HandoutsInfoAdapter.this.mActionListener == null) {
                        return;
                    }
                    HandoutsInfoAdapter.this.mActionListener.updateBottom();
                } catch (Exception e2) {
    ...
    public void putPraise(String id, String type) {
        ...
        YJYHttpUtils.post(this.context.getApplicationContext(), NetworkRequestsURL.mPutPraseUrl, ajaxParams, new AjaxCallBack<String>() { // from class: com.psychiatrygarden.adapter.HandoutsInfoAdapter.8
            @Override // net.tsz.afinal.http.AjaxCallBack
            public void onFailure(Throwable t2, int errorNo, String strMsg) {
                super.onFailure(t2, errorNo, strMsg);
            }
    ...
    public HandoutsInfoAdapter(Context context, List<CommentBean.DataBean.HotBean> list, BaseActivity mActivity, String is_is_prohibit, String appId) {
        this.is_is_prohibit = "0";
        this.mAppId = "";
        setList(list);
        this.context = context;
