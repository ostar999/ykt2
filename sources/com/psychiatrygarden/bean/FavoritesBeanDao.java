...
public class FavoritesBeanDao extends AbstractDao<FavoritesBean, Long> {
    ...
    public FavoritesBeanDao(DaoConfig config, DaoSession daoSession) {
        super(config, daoSession);
    }

    @Override // de.greenrobot.dao.AbstractDao
    public void bindValues(SQLiteStatement stmt, FavoritesBean entity) {
        stmt.clearBindings();
    ...
    @Override // de.greenrobot.dao.AbstractDao
    public Long getKey(FavoritesBean entity) {
        if (entity != null) {
    ...
    @Override // de.greenrobot.dao.AbstractDao
    public Long updateKeyAfterInsert(FavoritesBean entity, long rowId) {
    ...
    /* JADX WARN: Can't rename method to resolve collision */
    @Override // de.greenrobot.dao.AbstractDao
    public FavoritesBean readEntity(Cursor cursor, int offset) {
        int i2 = offset + 0;
        ...
        int i18 = offset + 16;
        return new FavoritesBean(lValueOf, string, string2, string3, lValueOf2, lValueOf3, string4, string5, string6, string7, string8, string9, lValueOf4, lValueOf5, lValueOf6, lValueOf7, cursor.isNull(i18) ? null : cursor.getString(i18));
    }

    @Override // de.greenrobot.dao.AbstractDao
    public void readEntity(Cursor cursor, FavoritesBean entity, int offset) {
        int i2 = offset + 0;
