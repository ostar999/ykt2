...
public class SubmitAnsweredQuestionBeanBeiDao extends AbstractDao<SubmitAnsweredQuestionBeanBei, Void> {
    public static final String TABLENAME = "SUBMIT_ANSWERED_QUESTION_BEAN_BEI";
    ...
    public SubmitAnsweredQuestionBeanBeiDao(DaoConfig config) {
        super(config);
    }

    public static void createTable(SQLiteDatabase db, boolean ifNotExists) throws SQLException {
        db.execSQL("CREATE TABLE " + (ifNotExists ? "IF NOT EXISTS " : "") + "'SUBMIT_ANSWERED_QUESTION_BEAN_BEI' ('QUESTION_ID' INTEGER,'ANSWER' TEXT,'IS_RIGHT' TEXT,'APP_ID' TEXT,'QUESTION_APP_ID' TEXT UNIQUE );");
    }
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) throws SQLException {
        ...
        sb.append("'SUBMIT_ANSWERED_QUESTION_BEAN_BEI'");
        db.execSQL(sb.toString());
    }

    @Override // de.greenrobot.dao.AbstractDao
    public Void getKey(SubmitAnsweredQuestionBeanBei entity) {
        return null;
    }
    ...
    @Override // de.greenrobot.dao.AbstractDao
    public Void updateKeyAfterInsert(SubmitAnsweredQuestionBeanBei entity, long rowId) {
        return null;
    }

    public SubmitAnsweredQuestionBeanBeiDao(DaoConfig config, DaoSession daoSession) {
        super(config, daoSession);
    }

    @Override // de.greenrobot.dao.AbstractDao
    public void bindValues(SQLiteStatement stmt, SubmitAnsweredQuestionBeanBei entity) {
        stmt.clearBindings();
    ...
    @Override // de.greenrobot.dao.AbstractDao
    public SubmitAnsweredQuestionBeanBei readEntity(Cursor cursor, int offset) {
        int i2 = offset + 0;
        ...
        int i5 = offset + 3;
        int i6 = offset + 4;
        return new SubmitAnsweredQuestionBeanBei(lValueOf, string, string2, cursor.isNull(i5) ? null : cursor.getString(i5), cursor.isNull(i6) ? null : cursor.getString(i6));
    }

    @Override // de.greenrobot.dao.AbstractDao
    public void readEntity(Cursor cursor, SubmitAnsweredQuestionBeanBei entity, int offset) {
        int i2 = offset + 0;
