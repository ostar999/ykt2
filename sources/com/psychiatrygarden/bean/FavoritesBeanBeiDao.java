...
public class FavoritesBeanBeiDao extends AbstractDao<FavoritesBeanBei, Long> {
    ...
    public FavoritesBeanBeiDao(DaoConfig config) {
        super(config);
    }

    public static void createTable(SQLiteDatabase db, boolean ifNotExists) throws SQLException {
        db.execSQL("CREATE TABLE " + (ifNotExists ? "IF NOT EXISTS " : "") + "'FAVORITES_BEAN_BEI' ('QUESTION_ID' INTEGER PRIMARY KEY ,'CHAPTER_PARENT_ID' TEXT,'CHAPTER_ID' TEXT,'YEAR' TEXT,'CATE_NUM' INTEGER,'YEAR_NUM' INTEGER,'MEDIA_URL' TEXT,'ISXUESHUO' TEXT,'ISZHUANSHUO' TEXT,'ISGAOPINKAODIAN' TEXT,'IS_PRACTICE' TEXT,'UNIT' TEXT);");
    }
    ...
    public FavoritesBeanBeiDao(DaoConfig config, DaoSession daoSession) {
        super(config, daoSession);
    }

    @Override // de.greenrobot.dao.AbstractDao
    public void bindValues(SQLiteStatement stmt, FavoritesBeanBei entity) {
        stmt.clearBindings();
    ...
    @Override // de.greenrobot.dao.AbstractDao
    public Long getKey(FavoritesBeanBei entity) {
        if (entity != null) {
    ...
    @Override // de.greenrobot.dao.AbstractDao
    public Long updateKeyAfterInsert(FavoritesBeanBei entity, long rowId) {
    ...
    /* JADX WARN: Can't rename method to resolve collision */
    @Override // de.greenrobot.dao.AbstractDao
    public FavoritesBeanBei readEntity(Cursor cursor, int offset) {
        int i2 = offset + 0;
        int i3 = offset + 1;
        int i4 = offset + 2;
        int i5 = offset + 3;
        ...
        int i12 = offset + 10;
        int i13 = offset + 11;
        return new FavoritesBeanBei(cursor.isNull(i2) ? null : Long.valueOf(cursor.getLong(i2)), cursor.isNull(i3) ? null : cursor.getString(i3), cursor.isNull(i4) ? null : cursor.getString(i4), cursor.isNull(i5) ? null : cursor.getString(i5), cursor.isNull(i6) ? null : Long.valueOf(cursor.getLong(i6)), cursor.isNull(i7) ? null : Long.valueOf(cursor.getLong(i7)), cursor.isNull(i8) ? null : cursor.getString(i8), cursor.isNull(i9) ? null : cursor.getString(i9), cursor.isNull(i10) ? null : cursor.getString(i10), cursor.isNull(i11) ? null : cursor.getString(i11), cursor.isNull(i12) ? null : cursor.getString(i12), cursor.isNull(i13) ? null : cursor.getString(i13));
    }

    @Override // de.greenrobot.dao.AbstractDao
    public void readEntity(Cursor cursor, FavoritesBeanBei entity, int offset) {
        int i2 = offset + 0;
