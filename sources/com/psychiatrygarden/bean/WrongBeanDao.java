...
public class WrongBeanDao extends AbstractDao<WrongBean, Long> {
    public static final String TABLENAME = "WRONG_BEAN";
    ...
    public static class Properties {
        ...
        public static final Property Part_id = new Property(12, Long.class, "part_id", false, "PART_ID");
        public static final Property Part_parent_id = new Property(13, Long.class, "part_parent_id", false, "PART_PARENT_ID");
        public static final Property Part_num_am = new Property(14, Long.class, "part_num_am", false, "PART_NUM_AM");
        public static final Property Part_num_pm = new Property(15, Long.class, "part_num_pm", false, "PART_NUM_PM");
        public static final Property Type = new Property(16, String.class, "type", false, Intents.WifiConnect.TYPE);
    }

    public WrongBeanDao(DaoConfig config) {
        super(config);
    }

    public static void createTable(SQLiteDatabase db, boolean ifNotExists) throws SQLException {
        db.execSQL("CREATE TABLE " + (ifNotExists ? "IF NOT EXISTS " : "") + "'WRONG_BEAN' ('QUESTION_ID' INTEGER PRIMARY KEY ,'CHAPTER_PARENT_ID' TEXT,'CHAPTER_ID' TEXT,'YEAR' TEXT,'CATE_NUM' INTEGER,'YEAR_NUM' INTEGER,'MEDIA_URL' TEXT,'ISXUESHUO' TEXT,'ISZHUANSHUO' TEXT,'ISGAOPINKAODIAN' TEXT,'IS_PRACTICE' TEXT,'UNIT' TEXT,'PART_ID' INTEGER,'PART_PARENT_ID' INTEGER,'PART_NUM_AM' INTEGER,'PART_NUM_PM' INTEGER,'TYPE' TEXT);");
    }
    ...
    public WrongBeanDao(DaoConfig config, DaoSession daoSession) {
        super(config, daoSession);
    }

    @Override // de.greenrobot.dao.AbstractDao
    public void bindValues(SQLiteStatement stmt, WrongBean entity) {
        stmt.clearBindings();
        ...
        if (part_id != null) {
            stmt.bindLong(13, part_id.longValue());
        }
        Long part_parent_id = entity.getPart_parent_id();
        if (part_parent_id != null) {
            stmt.bindLong(14, part_parent_id.longValue());
        }
        Long part_num_am = entity.getPart_num_am();
        if (part_num_am != null) {
            stmt.bindLong(15, part_num_am.longValue());
        }
        Long part_num_pm = entity.getPart_num_pm();
        if (part_num_pm != null) {
            stmt.bindLong(16, part_num_pm.longValue());
        }
    ...
    @Override // de.greenrobot.dao.AbstractDao
    public Long getKey(WrongBean entity) {
        if (entity != null) {
    ...
    @Override // de.greenrobot.dao.AbstractDao
    public Long updateKeyAfterInsert(WrongBean entity, long rowId) {
    ...
    /* JADX WARN: Can't rename method to resolve collision */
    @Override // de.greenrobot.dao.AbstractDao
    public WrongBean readEntity(Cursor cursor, int offset) {
        int i2 = offset + 0;
        ...
        int i14 = offset + 12;
        Long lValueOf4 = cursor.isNull(i14) ? null : Long.valueOf(cursor.getLong(i14));
        int i15 = offset + 13;
        Long lValueOf5 = cursor.isNull(i15) ? null : Long.valueOf(cursor.getLong(i15));
        int i16 = offset + 14;
        Long lValueOf6 = cursor.isNull(i16) ? null : Long.valueOf(cursor.getLong(i16));
        int i17 = offset + 15;
        Long lValueOf7 = cursor.isNull(i17) ? null : Long.valueOf(cursor.getLong(i17));
        int i18 = offset + 16;
        return new WrongBean(lValueOf, string, string2, string3, lValueOf2, lValueOf3, string4, string5, string6, string7, string8, string9, lValueOf4, lValueOf5, lValueOf6, lValueOf7, cursor.isNull(i18) ? null : cursor.getString(i18));
    }

    @Override // de.greenrobot.dao.AbstractDao
    public void readEntity(Cursor cursor, WrongBean entity, int offset) {
        int i2 = offset + 0;
        ...
        int i14 = offset + 12;
        entity.setPart_id(cursor.isNull(i14) ? null : Long.valueOf(cursor.getLong(i14)));
        int i15 = offset + 13;
        entity.setPart_parent_id(cursor.isNull(i15) ? null : Long.valueOf(cursor.getLong(i15)));
        int i16 = offset + 14;
        entity.setPart_num_am(cursor.isNull(i16) ? null : Long.valueOf(cursor.getLong(i16)));
        int i17 = offset + 15;
        entity.setPart_num_pm(cursor.isNull(i17) ? null : Long.valueOf(cursor.getLong(i17)));
        int i18 = offset + 16;
        entity.setType(cursor.isNull(i18) ? null : cursor.getString(i18));
    }
}
