...
public class NotesBean {
    ...
    public NotesBean setType(String type) {
        this.type = type;
        return this;
    }
    ...
    public NotesBean(Long question_id) {
        this.question_id = question_id;
    }

    public NotesBean(Long question_id, String chapter_parent_id, String chapter_id, String year, Long cate_num, Long year_num, String content, String media_url, String isxueshuo, String iszhuanshuo, String isgaopinkaodian, String is_practice, String unit, Long part_id, Long part_parent_id, Long part_num_am, Long part_num_pm, String type) {
        this.question_id = question_id;
        this.chapter_parent_id = chapter_parent_id;
        this.chapter_id = chapter_id;
        this.year = year;
