...
public class WrongBeanBei {
    ...
    public WrongBeanBei(Long question_id) {
        this.question_id = question_id;
    }

    public WrongBeanBei(Long question_id, String chapter_parent_id, String chapter_id, String year, Long cate_num, Long year_num, String media_url, String isxueshuo, String iszhuanshuo, String isgaopinkaodian, String is_practice, String unit) {
        this.question_id = question_id;
        this.chapter_parent_id = chapter_parent_id;
        this.chapter_id = chapter_id;
        this.year = year;
