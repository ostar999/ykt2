...
public class SubmitNotesBeanDao extends AbstractDao<SubmitNotesBean, Void> {
    public static final String TABLENAME = "SUBMIT_NOTES_BEAN";
    ...
    public SubmitNotesBeanDao(DaoConfig config) {
        super(config);
    }

    public static void createTable(SQLiteDatabase db, boolean ifNotExists) throws SQLException {
        db.execSQL("CREATE TABLE " + (ifNotExists ? "IF NOT EXISTS " : "") + "'SUBMIT_NOTES_BEAN' ('QUESTION_ID' INTEGER,'CONTENT' TEXT,'APP_ID' TEXT,'QUESTION_APP_ID' TEXT UNIQUE );");
    }
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) throws SQLException {
        ...
        sb.append("'SUBMIT_NOTES_BEAN'");
        db.execSQL(sb.toString());
    }

    @Override // de.greenrobot.dao.AbstractDao
    public Void getKey(SubmitNotesBean entity) {
        return null;
    }
    ...
    @Override // de.greenrobot.dao.AbstractDao
    public Void updateKeyAfterInsert(SubmitNotesBean entity, long rowId) {
        return null;
    }

    public SubmitNotesBeanDao(DaoConfig config, DaoSession daoSession) {
        super(config, daoSession);
    }

    @Override // de.greenrobot.dao.AbstractDao
    public void bindValues(SQLiteStatement stmt, SubmitNotesBean entity) {
        stmt.clearBindings();
    ...
    @Override // de.greenrobot.dao.AbstractDao
    public SubmitNotesBean readEntity(Cursor cursor, int offset) {
        int i2 = offset + 0;
        int i3 = offset + 1;
        int i4 = offset + 2;
        int i5 = offset + 3;
        return new SubmitNotesBean(cursor.isNull(i2) ? null : Long.valueOf(cursor.getLong(i2)), cursor.isNull(i3) ? null : cursor.getString(i3), cursor.isNull(i4) ? null : cursor.getString(i4), cursor.isNull(i5) ? null : cursor.getString(i5));
    }

    @Override // de.greenrobot.dao.AbstractDao
    public void readEntity(Cursor cursor, SubmitNotesBean entity, int offset) {
        int i2 = offset + 0;
