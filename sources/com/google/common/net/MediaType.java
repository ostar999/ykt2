...
public final class MediaType {
    ...
    public static final MediaType XML_UTF_8 = createConstantUtf8("text", AliyunVodHttpCommon.Format.FORMAT_XML);
    public static final MediaType VTT_UTF_8 = createConstantUtf8("text", "vtt");
    public static final MediaType BMP = createConstant("image", ImgUtil.IMAGE_TYPE_BMP);
    public static final MediaType CRW = createConstant("image", "x-canon-crw");
    public static final MediaType GIF = createConstant("image", ImgUtil.IMAGE_TYPE_GIF);
    ...
    public static final MediaType APPLICATION_XML_UTF_8 = createConstantUtf8("application", AliyunVodHttpCommon.Format.FORMAT_XML);
    ...
    public static final MediaType JSON_UTF_8 = createConstantUtf8("application", AliyunVodHttpCommon.Format.FORMAT_JSON);
