...
public class EventBus {
    ...
    public static final class LoggingHandler implements SubscriberExceptionHandler {
        ...
        private static Logger logger(SubscriberExceptionContext subscriberExceptionContext) {
            return Logger.getLogger(EventBus.class.getName() + StrPool.DOT + subscriberExceptionContext.getEventBus().identifier());
        }
    ...
    public EventBus(SubscriberExceptionHandler subscriberExceptionHandler) {
        this(ServletHandler.__DEFAULT_SERVLET, MoreExecutors.directExecutor(), Dispatcher.perThreadDispatchQueue(), subscriberExceptionHandler);
    }
