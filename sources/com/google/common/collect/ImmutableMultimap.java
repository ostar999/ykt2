...
public abstract class ImmutableMultimap<K, V> extends BaseImmutableMultimap<K, V> implements Serializable {
    ...
    public static class FieldSettersHolder {
        ...
        static final Serialization.FieldSetter<ImmutableMultimap> SIZE_FIELD_SETTER = Serialization.getFieldSetter(ImmutableMultimap.class, DatabaseManager.SIZE);
    }
    ...
    public static class Builder<K, V> {
        ...
        public Builder<K, V> put(K k2, V v2) {
            ...
            if (collection == null) {
                ...
                map.put(k2, collectionNewMutableValueCollection);
        ...
        public Builder<K, V> putAll(K k2, Iterable<? extends V> iterable) {
            if (k2 != null) {
                ...
                this.builderMap.put(k2, collectionNewMutableValueCollection);
                return this;
            }
