...
public final class MutableClassToInstanceMap<B> extends ForwardingMap<Class<? extends B>, B> implements ClassToInstanceMap<B>, Serializable {
    ...
    public static <B, T extends B> T cast(Class<T> cls, B b3) {
        return (T) Primitives.wrap(cls).cast(b3);
    }
    ...
    public static <B> Map.Entry<Class<? extends B>, B> checkedEntry(final Map.Entry<Class<? extends B>, B> entry) {
        return new ForwardingMapEntry<Class<? extends B>, B>() { // from class: com.google.common.collect.MutableClassToInstanceMap.1
            ...
            public B setValue(B b3) {
                return (B) super.setValue(MutableClassToInstanceMap.cast(getKey(), b3));
            }
    ...
    @CanIgnoreReturnValue
    public B put(Class<? extends B> cls, B b3) {
        return (B) super.put((MutableClassToInstanceMap<B>) cls, (Class<? extends B>) cast(cls, b3));
    }
}
