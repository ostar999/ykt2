...
final class Murmur3_128HashFunction extends AbstractHashFunction implements Serializable {
    ...
    public static final class Murmur3_128Hasher extends AbstractStreamingHasher {
        ...
        private void bmix64(long j2, long j3) {
            long jMixK1 = mixK1(j2) ^ this.f7055h1;
            this.f7055h1 = jMixK1;
            long jRotateLeft = Long.rotateLeft(jMixK1, 27);
            long j4 = this.h2;
            this.f7055h1 = ((jRotateLeft + j4) * 5) + 1390208809;
            long jMixK2 = mixK2(j3) ^ j4;
            this.h2 = jMixK2;
            this.h2 = ((Long.rotateLeft(jMixK2, 31) + this.f7055h1) * 5) + 944331445;
        }
        ...
        public HashCode makeHash() {
            ...
            this.f7055h1 = j5;
            this.h2 = j4 + j5;
            this.f7055h1 = fmix64(j5);
            long jFmix64 = fmix64(this.h2);
            long j6 = this.f7055h1 + jFmix64;
            this.f7055h1 = j6;
            this.h2 = jFmix64 + j6;
            return HashCode.fromBytesNoCopy(ByteBuffer.wrap(new byte[16]).order(ByteOrder.LITTLE_ENDIAN).putLong(this.f7055h1).putLong(this.h2).array());
        }
