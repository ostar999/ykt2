...
public class ReflectionHelper {
    ...
    public static String getAccessibleObjectDescription(AccessibleObject accessibleObject, boolean z2) {
        ...
        if (accessibleObject instanceof Field) {
            ...
            str = "field '" + field.getDeclaringClass().getName() + DictionaryFactory.SHARP + field.getName() + "'";
        } else if (accessibleObject instanceof Method) {
            Method method = (Method) accessibleObject;
            StringBuilder sb = new StringBuilder(method.getName());
            appendExecutableParameters(method, sb);
            str = "method '" + method.getDeclaringClass().getName() + DictionaryFactory.SHARP + sb.toString() + "'";
