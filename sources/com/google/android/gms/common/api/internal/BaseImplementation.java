...
public class BaseImplementation {
    ...
    public static abstract class ApiMethodImpl<R extends Result, A extends Api.AnyClient> extends BasePendingResult<R> implements ResultHolder<R> {
        ...
        @KeepForSdk
        public abstract void doExecute(@NonNull A a3) throws RemoteException;
        ...
        @KeepForSdk
        public final void run(@NonNull A a3) throws DeadObjectException {
            if (a3 instanceof SimpleClientAdapter) {
                a3 = ((SimpleClientAdapter) a3).getClient();
            }
            try {
                doExecute(a3);
