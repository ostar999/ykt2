...
public class SignInClientImpl extends GmsClient<zae> implements com.google.android.gms.signin.zac {
    ...
    public /* synthetic */ IInterface createServiceInterface(IBinder iBinder) {
        ...
        return iInterfaceQueryLocalInterface instanceof zae ? (zae) iInterfaceQueryLocalInterface : new zag(iBinder);
    }
    ...
    public final void zaa(IAccountAccessor iAccountAccessor, boolean z2) {
        try {
            ((zae) getService()).zaa(iAccountAccessor, this.zaoo.intValue(), z2);
    ...
    public final void zaa(zac zacVar) {
        ...
        try {
            ...
            ((zae) getService()).zaa(new zai(new ResolveAccountRequest(accountOrDefault, this.zaoo.intValue(), "<<default account>>".equals(accountOrDefault.name) ? Storage.getInstance(getContext()).getSavedDefaultGoogleSignInAccount() : null)), zacVar);
