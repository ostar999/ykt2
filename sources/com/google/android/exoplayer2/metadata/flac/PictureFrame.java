...
public final class PictureFrame implements Metadata.Entry {
    ...
    public int hashCode() {
        return ((((((((((((((R2.attr.bl_checkable_gradient_endColor + this.pictureType) * 31) + this.mimeType.hashCode()) * 31) + this.description.hashCode()) * 31) + this.width) * 31) + this.height) * 31) + this.depth) * 31) + this.colors) * 31) + Arrays.hashCode(this.pictureData);
    }
