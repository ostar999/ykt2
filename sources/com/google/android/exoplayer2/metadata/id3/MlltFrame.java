...
public final class MlltFrame extends Id3Frame {
    ...
    public MlltFrame(int i2, int i3, int i4, int[] iArr, int[] iArr2) {
        ...
        this.millisecondsBetweenReference = i4;
    ...
    public int hashCode() {
        return ((((((((R2.attr.bl_checkable_gradient_endColor + this.mpegFramesBetweenReference) * 31) + this.bytesBetweenReference) * 31) + this.millisecondsBetweenReference) * 31) + Arrays.hashCode(this.bytesDeviations)) * 31) + Arrays.hashCode(this.millisecondsDeviations);
    }
