...
public final class DecoderReuseEvaluation {
    ...
    public int hashCode() {
        return ((((((((R2.attr.bl_checkable_gradient_endColor + this.result) * 31) + this.discardReasons) * 31) + this.decoderName.hashCode()) * 31) + this.oldFormat.hashCode()) * 31) + this.newFormat.hashCode();
    }
}
