...
public final class AudioAttributes implements Bundleable {
    ...
    public static final Bundleable.Creator<AudioAttributes> CREATOR = new Bundleable.Creator() { // from class: com.google.android.exoplayer2.audio.b
    ...
    public int hashCode() {
        return ((((((R2.attr.bl_checkable_gradient_endColor + this.contentType) * 31) + this.flags) * 31) + this.usage) * 31) + this.allowedCapturePolicy;
    }
