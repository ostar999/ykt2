...
public final class TranscodingTransformer {
    ...
    public static final class Builder {
        ...
        private void checkSampleMimeType(String str) {
            ...
            sb.append(str2);
            Assertions.checkState(zSupportsSampleMimeType, sb.toString());
        }
    ...
    public final class TranscodingTransformerPlayerListener implements Player.Listener {
        ...
        public void onTimelineChanged(Timeline timeline, int i2) {
            ...
            TranscodingTransformer.this.progressState = (j2 <= 0 || j2 == C.TIME_UNSET) ? 2 : 1;
    ...
    public static final class TranscodingTransformerRenderersFactory implements RenderersFactory {
        ...
        public Renderer[] createRenderers(Handler handler, VideoRendererEventListener videoRendererEventListener, AudioRendererEventListener audioRendererEventListener, TextOutput textOutput, MetadataOutput metadataOutput) {
            ...
            if (!this.transformation.removeVideo) {
                rendererArr[c3] = new TransformerTranscodingVideoRenderer(this.context, this.muxerWrapper, this.mediaClock, this.transformation);
            }
            return rendererArr;
        }
    }
    ...
    private void startTransformation(MediaItem mediaItem, Muxer muxer) {
        ...
        if (this.player == null) {
            ...
            DefaultLoadControl defaultLoadControlBuild = new DefaultLoadControl.Builder().setBufferDurationsMs(50000, 50000, 250, 500).build();
            Context context = this.context;
            ExoPlayer exoPlayerBuild = new ExoPlayer.Builder(context, new TranscodingTransformerRenderersFactory(context, muxerWrapper, this.transformation)).setMediaSourceFactory(this.mediaSourceFactory).setTrackSelector(defaultTrackSelector).setLoadControl(defaultLoadControlBuild).setLooper(this.looper).setClock(this.clock).build();
