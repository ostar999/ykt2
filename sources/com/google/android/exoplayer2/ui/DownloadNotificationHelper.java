...
public final class DownloadNotificationHelper {
    ...
    private Notification buildNotification(Context context, @DrawableRes int i2, @Nullable PendingIntent pendingIntent, @Nullable String str, @StringRes int i3, int i4, int i5, boolean z2, boolean z3, boolean z4) {
    ...
    public Notification buildDownloadCompletedNotification(Context context, @DrawableRes int i2, @Nullable PendingIntent pendingIntent, @Nullable String str) {
        return buildEndStateNotification(context, i2, pendingIntent, str, com.google.android.exoplayer2.core.R.string.exo_download_completed);
    }
    ...
    public Notification buildDownloadFailedNotification(Context context, @DrawableRes int i2, @Nullable PendingIntent pendingIntent, @Nullable String str) {
        return buildEndStateNotification(context, i2, pendingIntent, str, com.google.android.exoplayer2.core.R.string.exo_download_failed);
    }
