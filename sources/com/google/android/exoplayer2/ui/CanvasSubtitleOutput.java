...
final class CanvasSubtitleOutput extends View implements SubtitleView.Output {
    ...
    public void dispatchDraw(Canvas canvas) {
        ...
        while (i3 < size) {
            ...
            this.painters.get(i3).draw(cue, this.style, fResolveTextSize, SubtitleViewUtils.resolveTextSize(cue.textSizeType, cue.textSize, height, i2), this.bottomPaddingFraction, canvas, paddingLeft, paddingTop, width, i4);
            i3++;
            size = size;
            i2 = i2;
            paddingBottom = i4;
