...
public class StyledPlayerView extends FrameLayout implements AdViewProvider {
    ...
    private void maybeShowController(boolean z2) {
        if (!(isPlayingAd() && this.controllerHideDuringAds) && useController()) {
            boolean z3 = this.controller.isFullyVisible() && this.controller.getShowTimeoutMs() <= 0;
    ...
    */
    ...
    public StyledPlayerView(Context context, @Nullable AttributeSet attributeSet, int i2) {
        ...
        if (attributeSet != null) {
            TypedArray typedArrayObtainStyledAttributes = context.getTheme().obtainStyledAttributes(attributeSet, R.styleable.StyledPlayerView, i2, 0);
            try {
                ...
                boolean z11 = typedArrayObtainStyledAttributes.getBoolean(R.styleable.StyledPlayerView_use_artwork, true);
                int resourceId2 = typedArrayObtainStyledAttributes.getResourceId(R.styleable.StyledPlayerView_default_artwork, 0);
                boolean z12 = typedArrayObtainStyledAttributes.getBoolean(R.styleable.StyledPlayerView_use_controller, true);
                int i11 = typedArrayObtainStyledAttributes.getInt(R.styleable.StyledPlayerView_surface_type, 1);
                int i12 = typedArrayObtainStyledAttributes.getInt(R.styleable.StyledPlayerView_resize_mode, 0);
                int i13 = typedArrayObtainStyledAttributes.getInt(R.styleable.StyledPlayerView_show_timeout, 5000);
                boolean z13 = typedArrayObtainStyledAttributes.getBoolean(R.styleable.StyledPlayerView_hide_on_touch, true);
                boolean z14 = typedArrayObtainStyledAttributes.getBoolean(R.styleable.StyledPlayerView_auto_show, true);
                ...
                boolean z15 = typedArrayObtainStyledAttributes.getBoolean(R.styleable.StyledPlayerView_hide_during_ads, true);
        ...
        this.useController = (!z7 || styledPlayerControlView3 == null) ? i8 : z8;
