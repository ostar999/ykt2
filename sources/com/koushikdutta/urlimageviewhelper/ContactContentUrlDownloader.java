...
public class ContactContentUrlDownloader implements UrlDownloader {
    ...
    public void download(final Context context, final String str, String str2, final UrlDownloader.UrlDownloaderCallback urlDownloaderCallback, final Runnable runnable) {
        UrlImageViewHelper.executeTask(new AsyncTask<Void, Void, Void>() { // from class: com.koushikdutta.urlimageviewhelper.ContactContentUrlDownloader.1
            @Override // android.os.AsyncTask
            public Void doInBackground(Void... voidArr) {
                try {
                    urlDownloaderCallback.onDownloadComplete(ContactContentUrlDownloader.this, ContactsContract.Contacts.openContactPhotoInputStream(context.getContentResolver(), Uri.parse(str)), null);
                    return null;
                } catch (Throwable th) {
                    th.printStackTrace();
                    return null;
