...
public class GradientStateDrawableCreator implements ICreateDrawable {
    ...
    private void setSelectorDrawable(StateListDrawable stateListDrawable, @AttrRes int i2) throws Exception {
        stateListDrawable.addState(new int[]{i2}, DrawableFactory.getDrawable(this.typedArray, i2));
    }
