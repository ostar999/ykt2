...
public class SelectorPre21DrawableCreator implements ICreateDrawable {
    ...
    private void setSelectorDrawable(StateListDrawable stateListDrawable, @StyleableRes int i2, @StyleableRes int i3, @AttrRes int i4) throws Exception {
        if (this.typedArray.hasValue(i2) || this.typedArray.hasValue(i3)) {
            ...
            if (this.typedArray.hasValue(i3)) {
                drawable.setStroke(this.typedArray.getDimensionPixelSize(R.styleable.background_bl_stroke_width, 0), this.typedArray.getColor(i3, 0), this.typedArray.getDimension(R.styleable.background_bl_stroke_dashWidth, 0.0f), this.typedArray.getDimension(R.styleable.background_bl_stroke_dashGap, 0.0f));
            }
