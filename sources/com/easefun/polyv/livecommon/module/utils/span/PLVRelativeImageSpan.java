...
public class PLVRelativeImageSpan extends ImageSpan {
    ...
    public PLVRelativeImageSpan(Drawable d3) {
        super(d3);
        this.status = 0;
        this.scale = 1.0f;
    }
    ...
    public PLVRelativeImageSpan(Drawable d3, int verticalAlignment) {
        super(d3, verticalAlignment);
        this.scale = 1.0f;
        this.status = verticalAlignment;
    }

    public PLVRelativeImageSpan(Drawable d3, int verticalAlignment, float spacingScale) {
        super(d3, verticalAlignment);
        this.status = verticalAlignment;
