...
public class PLVRoundRectConstraintLayout extends ConstraintLayout {
    ...
    public PLVRoundRectConstraintLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray typedArrayObtainStyledAttributes = getContext().obtainStyledAttributes(attrs, R.styleable.PLVRoundRectConstraintLayout, defStyleAttr, 0);
        int dimensionPixelSize = typedArrayObtainStyledAttributes.getDimensionPixelSize(R.styleable.PLVRoundRectConstraintLayout_radius, 10);
        int i2 = typedArrayObtainStyledAttributes.getInt(R.styleable.PLVRoundRectConstraintLayout_mode, 15);
