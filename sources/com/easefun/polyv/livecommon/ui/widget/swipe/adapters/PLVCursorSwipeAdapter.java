...
public abstract class PLVCursorSwipeAdapter extends CursorAdapter implements PLVSwipeItemMangerInterface, PLVSwipeAdapterInterface {
    ...
    public PLVCursorSwipeAdapter(Context context, Cursor c3, boolean autoRequery) {
        super(context, c3, autoRequery);
    ...
    public PLVCursorSwipeAdapter(Context context, Cursor c3, int flags) {
        super(context, c3, flags);
        this.mItemManger = new PLVSwipeItemMangerImpl(this);
    }
}
