...
public class TextureMediaPlayer extends MediaPlayerProxy implements IMediaPlayer, ISurfaceTextureHolder {
    ...
    @Override // com.easefun.polyv.mediasdk.player.ISurfaceTextureHolder
    public SurfaceTexture getSurfaceTexture() {
        return this.mSurfaceTexture;
    }

    @Override // com.easefun.polyv.mediasdk.player.MediaPlayerProxy, com.easefun.polyv.mediasdk.player.IMediaPlayer
    public void release() {
        super.release();
