...
public class DownloadChoiceDialog extends Dialog {
    ...
    private void animateDown() {
        ...
        animationSet.setAnimationListener(new Animation.AnimationListener() { // from class: com.aliyun.player.alivcplayerexpand.view.download.DownloadChoiceDialog.1
            @Override // android.view.animation.Animation.AnimationListener
            public void onAnimationEnd(Animation animation) {
                DownloadChoiceDialog.this.mIsAnimating = false;
                DownloadChoiceDialog.this.mContentView.post(new Runnable() { // from class: com.aliyun.player.alivcplayerexpand.view.download.DownloadChoiceDialog.1.1
            ...
            public void onAnimationStart(Animation animation) {
                DownloadChoiceDialog.this.mIsAnimating = true;
            }
        });
