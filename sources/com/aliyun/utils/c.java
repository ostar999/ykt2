...
public class c {
    ...
    private static String f3583a = "c";
    ...
    public class C0038c implements e {
        ...
        public void a(String str) {
            ...
            int i3 = this.f3586a;
            if (i3 < 0) {
                Logger.v(c.f3583a, "getCpuUsageBefore26 unknow ");
                return;
            }
            ...
            try {
                c.this.f3584b = (int) Float.parseFloat(strSubstring);
                Logger.v(c.f3583a, "getCpuUsageBefore26 mMyPidPercent update " + c.this.f3584b);
    ...
    public class d implements e {
        ...
        public void a(String str) throws NumberFormatException {
            try {
                c.this.f3584b = (int) (Float.parseFloat(str) / c.b());
                Logger.v(c.f3583a, "getCpuUsageAfter25 mMyPidPercent update " + c.this.f3584b);
            } catch (Exception unused) {
            }
        }
    }
    ...
    */
    ...
    private void d() throws Throwable {
        a(PLVDanmakuInfo.FONTMODE_TOP, new C0038c());
    }
    ...
    public int e() {
        Logger.d(f3583a, "getMyPicCpuPercent = " + this.f3584b);
        return this.f3584b;
    }
}
