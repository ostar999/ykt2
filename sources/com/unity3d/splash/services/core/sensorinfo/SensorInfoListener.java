...
public class SensorInfoListener implements SensorEventListener {
    ...
    public static boolean startAccelerometerListener(int i2) {
        ...
        SensorManager sensorManager = (SensorManager) ClientProperties.getApplicationContext().getSystemService(am.ac);
    ...
    public static void stopAccelerometerListener() {
        if (_accelerometerListener != null) {
            ((SensorManager) ClientProperties.getApplicationContext().getSystemService(am.ac)).unregisterListener(_accelerometerListener);
