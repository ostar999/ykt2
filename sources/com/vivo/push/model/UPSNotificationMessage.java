...
public class UPSNotificationMessage {
    ...
    public String toString() {
        return "UPSNotificationMessage{mTargetType=" + this.mTargetType + ", mTragetContent='" + this.mTragetContent + CharPool.SINGLE_QUOTE + ", mTitle='" + this.mTitle + CharPool.SINGLE_QUOTE + ", mContent='" + this.mContent + CharPool.SINGLE_QUOTE + ", mNotifyType=" + this.mNotifyType + ", mPurePicUrl='" + this.mPurePicUrl + CharPool.SINGLE_QUOTE + ", mIconUrl='" + this.mIconUrl + CharPool.SINGLE_QUOTE + ", mCoverUrl='" + this.mCoverUrl + CharPool.SINGLE_QUOTE + ", mSkipContent='" + this.mSkipContent + CharPool.SINGLE_QUOTE + ", mSkipType=" + this.mSkipType + ", mShowTime=" + this.mShowTime + ", mMsgId=" + this.mMsgId + ", mParams=" + this.mParams + '}';
    }
}
