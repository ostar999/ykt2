...
public class PLVTRTCDef {
    ...
    public static final String TRTC_SDK_VERSION = "9.3.10768";
    ...
    public static class TRTCMixUser {
        ...
        public String toString() {
            return "userId=" + this.userId + ", roomId=" + this.roomId + ", x=" + this.f10899x + ", y=" + this.f10900y + ", width=" + this.width + ", height=" + this.height + ", zOrder=" + this.zOrder + ", streamType=" + this.streamType + ", pureAudio=" + this.pureAudio;
        }
        ...
        public TRTCMixUser(TRTCCloudDef.TRTCMixUser tRTCMixUser) {
            this.userId = tRTCMixUser.userId;
            this.roomId = tRTCMixUser.roomId;
            this.f10899x = tRTCMixUser.f22290x;
            this.f10900y = tRTCMixUser.f22291y;
    ...
    public static class TRTCTranscodingConfig {
        ...
        public TRTCTranscodingConfig(TRTCCloudDef.TRTCTranscodingConfig tRTCTranscodingConfig) {
