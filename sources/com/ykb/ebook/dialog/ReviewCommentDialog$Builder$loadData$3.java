...
@DebugMetadata(c = "com.ykb.ebook.dialog.ReviewCommentDialog$Builder$loadData$3", f = "ReviewCommentDialog.kt", i = {}, l = {}, m = "invokeSuspend", n = {}, s = {})
/* loaded from: classes7.dex */
public final class ReviewCommentDialog$Builder$loadData$3 extends SuspendLambda implements Function3<CoroutineScope, Throwable, Continuation<? super Unit>, Object> {
    int label;
    final /* synthetic */ ReviewCommentDialog.Builder this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ReviewCommentDialog$Builder$loadData$3(ReviewCommentDialog.Builder builder, Continuation<? super ReviewCommentDialog$Builder$loadData$3> continuation) {
    ...
    public final Object invoke(@NotNull CoroutineScope coroutineScope, @NotNull Throwable th, @Nullable Continuation<? super Unit> continuation) {
        return new ReviewCommentDialog$Builder$loadData$3(this.this$0, continuation).invokeSuspend(Unit.INSTANCE);
    }
