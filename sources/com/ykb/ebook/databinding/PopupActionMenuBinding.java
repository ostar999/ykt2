...
public final class PopupActionMenuBinding implements ViewBinding {
    ...
    @NonNull
    public static PopupActionMenuBinding bind(@NonNull View view) {
                                                            ...
                                                            if (rTextView2 != null) {
                                                                ...
                                                                if (rTextView3 != null) {
                                                                    ...
                                                                    if (rTextView4 != null) {
                                                                        ...
                                                                        if (rTextView5 != null) {
                                                                            return new PopupActionMenuBinding((RelativeLayout) view, rRadioButton, rRadioButton2, rRadioButton3, rRadioButton4, rRadioButton5, rCheckBox, rFrameLayout, frameLayout, rFrameLayout2, imageView, imageView2, rLinearLayout, rTextView, rTextView2, rTextView3, rTextView4, rTextView5);
                                                                        }
                                                                    }
                                                                }
                                                            }
    ...
    @NonNull
    public static PopupActionMenuBinding inflate(@NonNull LayoutInflater layoutInflater) {
        return inflate(layoutInflater, null, false);
    }

    @NonNull
    public static PopupActionMenuBinding inflate(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, boolean z2) {
