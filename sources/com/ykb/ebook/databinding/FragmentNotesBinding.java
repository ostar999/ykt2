...
public final class FragmentNotesBinding implements ViewBinding {
    ...
    private FragmentNotesBinding(@NonNull LinearLayout linearLayout, @NonNull RCheckBox rCheckBox, @NonNull RecyclerView recyclerView, @NonNull ClassicsHeader classicsHeader, @NonNull SmartRefreshLayout smartRefreshLayout, @NonNull TextView textView) {
            ...
            if (recyclerView != null) {
                ...
                if (classicsHeader != null) {
                    ...
                    if (smartRefreshLayout != null) {
                        ...
                        if (textView != null) {
                            return new FragmentNotesBinding((LinearLayout) view, rCheckBox, recyclerView, classicsHeader, smartRefreshLayout, textView);
                        }
                    }
                }
            }
    ...
    @NonNull
    public static FragmentNotesBinding inflate(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, boolean z2) {
