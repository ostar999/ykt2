...
public class FLog {
    ...
    public static class MarkerLog {
        ...
        public void finalize() throws Throwable {
            ...
            FLog.e("Marker log finalized without finish() - uncaught exit point for request", new Object[0]);
        }
        ...
        public synchronized void finish(String str) {
            ...
            FLog.d("(%-4d ms) %s", Long.valueOf(totalDuration), str);
            for (Marker marker : this.mMarkers) {
                long j3 = marker.time;
                FLog.d("(+%-4d) [%2d] %s", Long.valueOf(j3 - j2), Long.valueOf(marker.thread), marker.name);
                j2 = j3;
            }
        }
    }
    ...
    private static String buildMessage(String str, Object... objArr) {
        ...
        while (true) {
            ...
            if (!stackTrace[i2].getClass().equals(FLog.class)) {
