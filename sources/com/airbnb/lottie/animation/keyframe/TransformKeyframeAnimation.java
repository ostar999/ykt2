...
public class TransformKeyframeAnimation {
    ...
    public <T> boolean applyValueCallback(T t2, @Nullable LottieValueCallback<T> lottieValueCallback) {
        ...
        if (t2 == LottieProperty.TRANSFORM_END_OPACITY && (baseKeyframeAnimation = this.endOpacity) != null) {
            if (baseKeyframeAnimation == null) {
        ...
        if (t2 != LottieProperty.TRANSFORM_SKEW_ANGLE || (floatKeyframeAnimation = this.skewAngle) == null) {
            return false;
        }
        if (floatKeyframeAnimation == null) {
    ...
    public Matrix getMatrixForRepeater(float f2) {
        ...
        if (value2 != null) {
            double d3 = f2;
            this.matrix.preScale((float) Math.pow(value2.getScaleX(), d3), (float) Math.pow(value2.getScaleY(), d3));
        }
