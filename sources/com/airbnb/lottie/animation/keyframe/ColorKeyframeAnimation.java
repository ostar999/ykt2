...
public class ColorKeyframeAnimation extends KeyframeAnimation<Integer> {
    ...
    public int getIntValue(Keyframe<Integer> keyframe, float f2) {
        ...
        return (lottieValueCallback == 0 || (num = (Integer) lottieValueCallback.getValueInternal(keyframe.startFrame, keyframe.endFrame.floatValue(), Integer.valueOf(iIntValue), Integer.valueOf(iIntValue2), f2, getLinearCurrentKeyframeProgress(), getProgress())) == null) ? GammaEvaluator.evaluate(MiscUtils.clamp(f2, 0.0f, 1.0f), iIntValue, iIntValue2) : num.intValue();
    }
