...
public enum SHARE_MEDIA {
    ...
    public String getauthstyle(boolean z2) {
    ...
    public String getsharestyle(boolean z2) {
        return toString().equals(Constants.SOURCE_QQ) ? "sso" : toString().equals("SINA") ? z2 ? "sso" : Config.isUmengSina.booleanValue() ? "cloudy self" : "cloudy third" : toString().equals("FACEBOOK") ? z2 ? "sso" : "cloudy third" : (toString().equals("RENREN") || toString().equals("DOUBAN") || toString().equals("TENCENT") || toString().equals("TWITTER") || toString().equals("LINKEDIN")) ? "cloudy self" : "sso";
    }
    ...
    public SnsPlatform toSnsPlatform() {
        ...
        if (toString().equals(Constants.SOURCE_QQ)) {
            ...
            if (toString().equals("EMAIL")) {
                ...
                snsPlatform.mIndex = 0;
                snsPlatform.mKeyword = PLVDocumentMarkToolType.BRUSH;
                ...
                snsPlatform.mIndex = 0;
                snsPlatform.mKeyword = PayMethodKeyKt.ALi_PayMethod;
