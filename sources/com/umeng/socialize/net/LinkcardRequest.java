...
public class LinkcardRequest extends SocializeRequest {
    ...
    private static final String f23739a = "/share/linkcard/";

    /* renamed from: b, reason: collision with root package name */
    private String f23740b;

    /* renamed from: c, reason: collision with root package name */
    private BaseMediaObject f23741c;
    ...
    private String b() {
        BaseMediaObject baseMediaObject = this.f23741c;
    ...
    private String d() {
        return (TextUtils.isEmpty(this.f23741c.getDescription()) || this.f23741c.getDescription().length() <= 300) ? this.f23741c.getDescription() : this.f23741c.getDescription().substring(0, 300);
    }
    ...
    private JSONObject f() throws JSONException {
        JSONObject jSONObject = new JSONObject();
        try {
            UMImage thumbImage = this.f23741c.getThumbImage();
    ...
    private int[] g() {
        ...
        if (baseMediaObject != null && baseMediaObject.getmExtra() != null) {
            Map<String, Object> map = this.f23741c.getmExtra();
    ...
    public String getPath() {
        return f23739a + SocializeUtils.getAppkey(this.mContext) + "/" + Config.EntityKey + "/";
    }
