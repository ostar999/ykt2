...
public class ReLinkerInstance {
    ...
    public void cleanupOldLibFiles(Context context, String str, String str2) {
        ...
        File[] fileArrListFiles = workaroundLibDir.listFiles(new FilenameFilter() { // from class: internal.com.getkeepsafe.relinker.ReLinkerInstance.2
    ...
    public File getWorkaroundLibFile(Context context, String str, String str2) {
        ...
        return new File(getWorkaroundLibDir(context), strMapLibraryName + StrPool.DOT + str2);
    }
    ...
    public void loadLibrary(final Context context, final String str, final String str2, final ReLinker.LoadListener loadListener) {
        ...
        if (loadListener == null) {
            ...
            new Thread(new Runnable() { // from class: internal.com.getkeepsafe.relinker.ReLinkerInstance.1
