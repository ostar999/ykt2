    ...
    public static final <T> Object await(@NotNull final Call<T> call, @NotNull Continuation<? super T> continuation) {
        ...
        call.enqueue(new Callback<T>() { // from class: retrofit2.KotlinExtensions$await$2$2
            ...
            public void onFailure(@NotNull Call<T> call2, @NotNull Throwable t2) {
                ...
                cancellableContinuation.resumeWith(Result.m783constructorimpl(ResultKt.createFailure(t2)));
            }
            ...
            public void onResponse(@NotNull Call<T> call2, @NotNull Response<T> response) {
                ...
                if (!response.isSuccessful()) {
                    ...
                    Result.Companion companion = Result.INSTANCE;
                    cancellableContinuation.resumeWith(Result.m783constructorimpl(ResultKt.createFailure(httpException)));
                    return;
                }
                ...
                if (tBody != null) {
                    ...
                    cancellableContinuation2.resumeWith(Result.m783constructorimpl(tBody));
                    return;
                }
                ...
                cancellableContinuation3.resumeWith(Result.m783constructorimpl(ResultKt.createFailure(kotlinNullPointerException)));
            }
        });
        ...
        call.enqueue(new Callback<T>() { // from class: retrofit2.KotlinExtensions$await$4$2
            ...
            public void onResponse(@NotNull Call<T> call2, @NotNull Response<T> response) {
                ...
                if (response.isSuccessful()) {
                    ...
                    T tBody = response.body();
                    Result.Companion companion = Result.INSTANCE;
                    cancellableContinuation.resumeWith(Result.m783constructorimpl(tBody));
                    return;
                }
                CancellableContinuation cancellableContinuation2 = cancellableContinuationImpl;
                HttpException httpException = new HttpException(response);
                Result.Companion companion2 = Result.INSTANCE;
                cancellableContinuation2.resumeWith(Result.m783constructorimpl(ResultKt.createFailure(httpException)));
            }
        });
        Object result = cancellableContinuationImpl.getResult();
        if (result == IntrinsicsKt__IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
    ...
    public static final <T> Object awaitResponse(@NotNull final Call<T> call, @NotNull Continuation<? super Response<T>> continuation) {
        ...
        call.enqueue(new Callback<T>() { // from class: retrofit2.KotlinExtensions$awaitResponse$2$2
            ...
            public void onResponse(@NotNull Call<T> call2, @NotNull Response<T> response) {
                ...
                CancellableContinuation cancellableContinuation = cancellableContinuationImpl;
                Result.Companion companion = Result.INSTANCE;
                cancellableContinuation.resumeWith(Result.m783constructorimpl(response));
            }
        });
        Object result = cancellableContinuationImpl.getResult();
        if (result == IntrinsicsKt__IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
