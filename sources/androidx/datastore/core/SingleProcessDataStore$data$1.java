...
@DebugMetadata(c = "androidx.datastore.core.SingleProcessDataStore$data$1", f = "SingleProcessDataStore.kt", i = {}, l = {R2.attr.arcShowTick}, m = "invokeSuspend", n = {}, s = {})
...
public final class SingleProcessDataStore$data$1<T> extends SuspendLambda implements Function2<FlowCollector<? super T>, Continuation<? super Unit>, Object> {
    ...
    public final Object invoke(Object obj, Continuation<? super Unit> continuation) {
        return ((SingleProcessDataStore$data$1) create(obj, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        if (i2 == 0) {
            ...
            ConflatedBroadcastChannel conflatedBroadcastChannel = (ConflatedBroadcastChannel) obj2;
            this.this$0.actor.offer(new SingleProcessDataStore.Message.Read(conflatedBroadcastChannel));
            final Flow flowAsFlow = FlowKt.asFlow(conflatedBroadcastChannel);
            Flow<T> flow = new Flow<T>() { // from class: androidx.datastore.core.SingleProcessDataStore$data$1$invokeSuspend$$inlined$map$1
                ...
                public static final class AnonymousClass2 implements FlowCollector<DataAndHash<T>> {
                    final /* synthetic */ FlowCollector $this_unsafeFlow$inlined;
                    final /* synthetic */ SingleProcessDataStore$data$1$invokeSuspend$$inlined$map$1 this$0;
                    ...
                    @DebugMetadata(c = "androidx.datastore.core.SingleProcessDataStore$data$1$invokeSuspend$$inlined$map$1$2", f = "SingleProcessDataStore.kt", i = {}, l = {135}, m = "emit", n = {}, s = {})
                    ...
                    public AnonymousClass2(FlowCollector flowCollector, SingleProcessDataStore$data$1$invokeSuspend$$inlined$map$1 singleProcessDataStore$data$1$invokeSuspend$$inlined$map$1) {
                        this.$this_unsafeFlow$inlined = flowCollector;
                        this.this$0 = singleProcessDataStore$data$1$invokeSuspend$$inlined$map$1;
                    }
                    ...
                    */
                    public java.lang.Object emit(java.lang.Object r5, @org.jetbrains.annotations.NotNull kotlin.coroutines.Continuation r6) {
                        ...
                        L31:
                            ...
                            androidx.datastore.core.DataAndHash r5 = (androidx.datastore.core.DataAndHash) r5
                ...
                public Object collect(@NotNull FlowCollector flowCollector2, @NotNull Continuation continuation) {
                    Object objCollect = flowAsFlow.collect(new AnonymousClass2(flowCollector2, this), continuation);
