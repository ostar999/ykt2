...
public abstract class AsyncTaskLoader<D> extends Loader<D> {
    ...
    public final class LoadTask extends ModernAsyncTask<Void, Void, D> implements Runnable {
        ...
        public void onCancelled(D d3) {
            try {
                AsyncTaskLoader.this.dispatchOnCancelled(this, d3);
            } finally {
        ...
        @Override // androidx.loader.content.ModernAsyncTask
        public void onPostExecute(D d3) {
            try {
                AsyncTaskLoader.this.dispatchOnLoadComplete(this, d3);
            } finally {
                this.mDone.countDown();
            }
        }
    ...
    public void dispatchOnCancelled(AsyncTaskLoader<D>.LoadTask loadTask, D d3) {
        onCanceled(d3);
    ...
    public void dispatchOnLoadComplete(AsyncTaskLoader<D>.LoadTask loadTask, D d3) {
        if (this.mTask != loadTask) {
            dispatchOnCancelled(loadTask, d3);
            return;
        }
        if (isAbandoned()) {
            onCanceled(d3);
