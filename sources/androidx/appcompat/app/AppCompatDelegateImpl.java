...
class AppCompatDelegateImpl extends AppCompatDelegate implements MenuBuilder.Callback, LayoutInflater.Factory2 {
    ...
    private static Configuration generateConfigDelta(@NonNull Configuration configuration, @Nullable Configuration configuration2) {
        ...
        if (configuration2 != null && configuration.diff(configuration2) != 0) {
            ...
            int i25 = configuration.screenLayout & R2.attr.bl_unSelected_gradient_useLevel;
            int i26 = configuration2.screenLayout;
            if (i25 != (i26 & R2.attr.bl_unSelected_gradient_useLevel)) {
                configuration3.screenLayout |= i26 & R2.attr.bl_unSelected_gradient_useLevel;
            }
            if (i6 >= 26) {
    ...
    */
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    private boolean updateAppConfiguration(int r9, @androidx.annotation.Nullable androidx.core.os.LocaleListCompat r10, boolean r11) throws java.lang.IllegalAccessException, java.lang.NoSuchFieldException, android.content.pm.PackageManager.NameNotFoundException, java.lang.SecurityException, java.lang.IllegalArgumentException {
        /*
            r8 = this;
    ...
    public LocaleListCompat calculateApplicationLocales(@NonNull Context context) {
        ...
        LocaleListCompat localeListCompatCombineLocalesIfOverlayExists = i2 >= 24 ? LocaleOverlayHelper.combineLocalesIfOverlayExists(requestedAppLocales, configurationLocales) : requestedAppLocales.isEmpty() ? LocaleListCompat.getEmptyLocaleList() : LocaleListCompat.forLanguageTags(requestedAppLocales.get(0).toString());
