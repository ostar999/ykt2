...
class TwilightCalculator {
    ...
    public void calculateTwilight(long j2, double d3, double d4) {
        double d5 = (0.01720197f * ((j2 - UTC_2000) / 8.64E7f)) + 6.24006f;
        ...
        double dRound = Math.round((r3 - J0) - r7) + J0 + ((-d4) / 360.0d) + (Math.sin(d5) * 0.0053d) + (Math.sin(2.0d * dSin) * (-0.0069d));
