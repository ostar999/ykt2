...
public class Toolbar extends ViewGroup implements MenuHost {
    ...
    */
        ...
        if (Build.VERSION.SDK_INT >= 33) {
            ...
            if (z2 && this.mBackInvokedDispatcher == null) {
                if (this.mBackInvokedCallback == null) {
                    this.mBackInvokedCallback = Api33Impl.newOnBackInvokedCallback(new Runnable() { // from class: androidx.appcompat.widget.w
                        @Override // java.lang.Runnable
                        public final void run() {
                            this.f1225c.collapseActionView();
                        }
                    });
                }
    ...
    public Toolbar(@NonNull Context context, @Nullable AttributeSet attributeSet, int i2) {
        ...
        this.mMenuHostHelper = new MenuHostHelper(new Runnable() { // from class: androidx.appcompat.widget.v
            @Override // java.lang.Runnable
            public final void run() {
                this.f1224c.invalidateMenu();
            }
        });
