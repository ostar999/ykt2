...
public final class SavedStateViewModelFactory extends ViewModelProvider.OnRequeryFactory implements ViewModelProvider.Factory {
    ...
    @NotNull
    public final <T extends ViewModel> T create(@NotNull String key, @NotNull Class<T> modelClass) throws SecurityException, IOException {
        ...
        if (this.lifecycle != null) {
            ...
            if (zIsAssignableFrom && (application = this.application) != null) {
                ...
                t2 = (T) SavedStateViewModelFactoryKt.newInstance(modelClass, constructorFindMatchingConstructor, application, handle);
            } else {
                ...
                t2 = (T) SavedStateViewModelFactoryKt.newInstance(modelClass, constructorFindMatchingConstructor, handle2);
            }
