...
public final class SavedStateHandle {
    ...
    public SavedStateHandle(@NotNull Map<String, ? extends Object> initialState) {
        ...
        this.savedStateProvider = new SavedStateRegistry.SavedStateProvider() { // from class: androidx.lifecycle.f
            ...
            public final Bundle saveState() {
                return SavedStateHandle.m14savedStateProvider$lambda0(this.f1895a);
            }
        };
    ...
    public static final Bundle m14savedStateProvider$lambda0(SavedStateHandle this$0) {
