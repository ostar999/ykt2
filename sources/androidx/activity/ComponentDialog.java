    ...
    public ComponentDialog(@NotNull Context context, @StyleRes int i2) {
        ...
        this.onBackPressedDispatcher = new OnBackPressedDispatcher(new Runnable() { // from class: androidx.activity.d
            ...
            public final void run() {
                ComponentDialog.m0onBackPressedDispatcher$lambda1(this.f1212c);
            }
        });
    }
