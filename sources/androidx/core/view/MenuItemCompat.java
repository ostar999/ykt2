...
public final class MenuItemCompat {
    ...
    public static class Api26Impl {
        ...
        @DoNotInline
        public static MenuItem setAlphabeticShortcut(MenuItem menuItem, char c3, int i2) {
        ...
        @DoNotInline
        public static MenuItem setNumericShortcut(MenuItem menuItem, char c3, int i2) {
            return menuItem.setNumericShortcut(c3, i2);
        }

        @DoNotInline
        public static MenuItem setShortcut(MenuItem menuItem, char c3, char c4, int i2, int i3) {
    ...
    public static void setAlphabeticShortcut(@NonNull MenuItem menuItem, char c3, int i2) {
        if (menuItem instanceof SupportMenuItem) {
            ((SupportMenuItem) menuItem).setAlphabeticShortcut(c3, i2);
        } else if (Build.VERSION.SDK_INT >= 26) {
            Api26Impl.setAlphabeticShortcut(menuItem, c3, i2);
        }
    }
    ...
    public static void setNumericShortcut(@NonNull MenuItem menuItem, char c3, int i2) {
        if (menuItem instanceof SupportMenuItem) {
            ((SupportMenuItem) menuItem).setNumericShortcut(c3, i2);
        } else if (Build.VERSION.SDK_INT >= 26) {
            Api26Impl.setNumericShortcut(menuItem, c3, i2);
        }
    }
    ...
    public static void setShortcut(@NonNull MenuItem menuItem, char c3, char c4, int i2, int i3) {
        if (menuItem instanceof SupportMenuItem) {
            ((SupportMenuItem) menuItem).setShortcut(c3, c4, i2, i3);
        } else if (Build.VERSION.SDK_INT >= 26) {
            Api26Impl.setShortcut(menuItem, c3, c4, i2, i3);
        }
    }
