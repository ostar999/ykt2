...
public class ViewCompat {
    ...
    private static final OnReceiveContentViewBehavior NO_OP_ON_RECEIVE_CONTENT_VIEW_BEHAVIOR = new OnReceiveContentViewBehavior() { // from class: androidx.core.view.r0
    ...
    public static void notifyViewAccessibilityStateChangedIfNeeded(View view, int i2) {
        ...
        if (accessibilityManager.isEnabled()) {
            ...
            if (getAccessibilityLiveRegion(view) != 0 || z2) {
                ...
                Api19Impl.setContentChangeTypes(accessibilityEventObtain, i2);
                if (z2) {
            ...
            if (i2 == 32) {
                ...
                Api19Impl.setContentChangeTypes(accessibilityEventObtain2, i2);
    ...
    public static ContentInfoCompat performReceiveContent(@NonNull View view, @NonNull ContentInfoCompat contentInfoCompat) {
        if (Log.isLoggable(TAG, 3)) {
            Log.d(TAG, "performReceiveContent: " + contentInfoCompat + ", view=" + view.getClass().getSimpleName() + StrPool.BRACKET_START + view.getId() + StrPool.BRACKET_END);
        }
