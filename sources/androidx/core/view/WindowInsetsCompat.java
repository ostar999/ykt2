...
public class WindowInsetsCompat {
    ...
    public static class Impl20 extends Impl {
        ...
        public Insets getInsetsForType(int i2, boolean z2) {
            ...
            int i3;
            if (i2 == 1) {
                return z2 ? Insets.of(0, Math.max(getRootStableInsets().f1812top, getSystemWindowInsets().f1812top), 0, 0) : Insets.of(0, getSystemWindowInsets().f1812top, 0, 0);
            }
            if (i2 == 2) {
                if (z2) {
    ...
    public static Insets insetInsets(@NonNull Insets insets, int i2, int i3, int i4, int i5) {
        ...
        int iMax2 = Math.max(0, insets.f1812top - i3);
    ...
    public int getStableInsetTop() {
        return this.mImpl.getStableInsets().f1812top;
    }
    ...
    public int getSystemWindowInsetTop() {
        return this.mImpl.getSystemWindowInsets().f1812top;
    }
    ...
    public WindowInsetsCompat inset(@NonNull Insets insets) {
        return inset(insets.left, insets.f1812top, insets.right, insets.bottom);
    }
    ...
    public static class BuilderImpl20 extends BuilderImpl {
        ...
        public void setSystemWindowInsets(@NonNull Insets insets) {
            ...
            if (windowInsets != null) {
                this.mPlatformInsets = windowInsets.replaceSystemWindowInsets(insets.left, insets.f1812top, insets.right, insets.bottom);
            }
        }
