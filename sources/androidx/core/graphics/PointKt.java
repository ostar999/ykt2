...
public final class PointKt {
    ...
    @NotNull
    public static final Point div(@NotNull Point point, float f2) {
        Intrinsics.checkNotNullParameter(point, "<this>");
        return new Point(Math.round(point.x / f2), Math.round(point.y / f2));
    }

    @NotNull
    public static final Point minus(@NotNull Point point, @NotNull Point p2) {
        Intrinsics.checkNotNullParameter(point, "<this>");
    ...
    @NotNull
    public static final Point plus(@NotNull Point point, @NotNull Point p2) {
        Intrinsics.checkNotNullParameter(point, "<this>");
        Intrinsics.checkNotNullParameter(p2, "p");
        Point point2 = new Point(point.x, point.y);
        point2.offset(p2.x, p2.y);
    ...
    @NotNull
    public static final Point times(@NotNull Point point, float f2) {
        Intrinsics.checkNotNullParameter(point, "<this>");
        return new Point(Math.round(point.x * f2), Math.round(point.y * f2));
    }
    ...
    @NotNull
    public static final PointF div(@NotNull PointF pointF, float f2) {
        Intrinsics.checkNotNullParameter(pointF, "<this>");
        return new PointF(pointF.x / f2, pointF.y / f2);
    }

    @NotNull
    public static final PointF times(@NotNull PointF pointF, float f2) {
        Intrinsics.checkNotNullParameter(pointF, "<this>");
        return new PointF(pointF.x * f2, pointF.y * f2);
    }
    ...
    @NotNull
    public static final PointF minus(@NotNull PointF pointF, @NotNull PointF p2) {
        Intrinsics.checkNotNullParameter(pointF, "<this>");
        Intrinsics.checkNotNullParameter(p2, "p");
    ...
    @NotNull
    public static final PointF plus(@NotNull PointF pointF, @NotNull PointF p2) {
        Intrinsics.checkNotNullParameter(pointF, "<this>");
        Intrinsics.checkNotNullParameter(p2, "p");
        PointF pointF2 = new PointF(pointF.x, pointF.y);
        pointF2.offset(p2.x, p2.y);
