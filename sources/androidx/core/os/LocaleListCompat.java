...
public final class LocaleListCompat {
    ...
    public static class Api21Impl {
        private static final Locale[] PSEUDO_LOCALE = {new Locale(SocializeProtocolConstants.PROTOCOL_KEY_EN, "XA"), new Locale(ArchiveStreamFactory.AR, "XB")};
    ...
    public static Locale forLanguageTagCompat(String str) {
        if (str.contains("-")) {
            ...
            String[] strArrSplit2 = str.split(StrPool.UNDERLINE, -1);
        ...
        throw new IllegalArgumentException("Can not parse language tag: [" + str + StrPool.BRACKET_END);
    }
