...
public final class ContextKt {
    ...
    public static final void withStyledAttributes(@NotNull Context context, @Nullable AttributeSet attributeSet, @NotNull int[] attrs, @AttrRes int i2, @StyleRes int i3, @NotNull Function1<? super TypedArray, Unit> block) {
        ...
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, attrs, i2, i3);
    ...
    public static final void withStyledAttributes(@NotNull Context context, @StyleRes int i2, @NotNull int[] attrs, @NotNull Function1<? super TypedArray, Unit> block) throws Resources.NotFoundException {
        Intrinsics.checkNotNullParameter(context, "<this>");
        Intrinsics.checkNotNullParameter(attrs, "attrs");
        Intrinsics.checkNotNullParameter(block, "block");
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(i2, attrs);
