...
final class CamUtils {
    ...
    public static float[] xyzFromInt(int i2) {
        ...
        float[] fArr2 = fArr[0];
        float f2 = (fArr2[0] * fLinearized) + (fArr2[1] * fLinearized2) + (fArr2[2] * fLinearized3);
        float[] fArr3 = fArr[1];
        float f3 = (fArr3[0] * fLinearized) + (fArr3[1] * fLinearized2) + (fArr3[2] * fLinearized3);
        float[] fArr4 = fArr[2];
        return new float[]{f2, f3, (fLinearized * fArr4[0]) + (fLinearized2 * fArr4[1]) + (fLinearized3 * fArr4[2])};
    }
