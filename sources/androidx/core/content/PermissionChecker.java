...
public final class PermissionChecker {
    ...
    public static int checkPermission(@NonNull Context context, @NonNull String str, int i2, int i3, @Nullable String str2) {
        ...
        return (Process.myUid() == i3 && ObjectsCompat.equals(context.getPackageName(), str2) ? AppOpsManagerCompat.checkOrNoteProxyOp(context, i3, strPermissionToOp, str2) : AppOpsManagerCompat.noteProxyOpNoThrow(context, strPermissionToOp, str2)) == 0 ? 0 : -2;
    }
