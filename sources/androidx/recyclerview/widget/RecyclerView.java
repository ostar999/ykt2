...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild2, NestedScrollingChild3 {
    ...
    public static abstract class Adapter<VH extends ViewHolder> {
        ...
        public final void bindViewHolder(@NonNull VH vh, int i2) {
            ...
            if (z2) {
                ...
                vh.setFlags(1, R2.attr.bl_activated_textColor);
    ...
    public static class RecycledViewPool {
        ...
        public void detachForPoolingContainer(@NonNull Adapter<?> adapter, boolean z2) {
    ...
    public final class Recycler {
        ...
        public ViewHolder getScrapOrHiddenOrCachedHolderForPosition(int i2, boolean z2) {
            ...
            if (iIndexOfChild != -1) {
                ...
                childViewHolderInt.addFlags(R2.dimen.sp_28);
        ...
        public void recycleViewHolderInternal(ViewHolder viewHolder) {
            ...
            if ((adapter != null && zDoesTransientStatePreventRecycling && adapter.onFailedToRecycleView(viewHolder)) || viewHolder.isRecyclable()) {
                if (this.mViewCacheMax <= 0 || viewHolder.hasAnyOfTheFlags(R2.attr.bl_checkable_gradient_centerY)) {
                    z2 = false;
                } else {
                    int size = this.mCachedViews.size();
        ...
        public void run() {
            ...
            if (overScroller.computeScrollOffset()) {
                ...
                if (recyclerView3.mAdapter != null) {
                    ...
                    i3 = iArr4[0];
                    i2 = iArr4[1];
                    iConsumeFlingInHorizontalStretch -= i3;
                ...
                iArr5[0] = 0;
                iArr5[1] = 0;
                recyclerView5.dispatchNestedScroll(i3, i2, iConsumeFlingInHorizontalStretch, iConsumeFlingInVerticalStretch, null, 1, iArr5);
    ...
    public static abstract class ViewHolder {
        ...
        public String toString() {
            StringBuilder sb = new StringBuilder((getClass().isAnonymousClass() ? "ViewHolder" : getClass().getSimpleName()) + StrPool.DELIM_START + Integer.toHexString(hashCode()) + " position=" + this.mPosition + " id=" + this.mItemId + ", oldPos=" + this.mOldPosition + ", pLpos:" + this.mPreLayoutPosition);
            if (isScrap()) {
                sb.append(" scrap ");
    ...
    private int consumeFlingInStretch(int i2, EdgeEffect edgeEffect, EdgeEffect edgeEffect2, int i3) {
        if (i2 > 0 && edgeEffect != null && EdgeEffectCompat.getDistance(edgeEffect) != 0.0f) {
            int iRound = Math.round(((-i3) / FLING_DESTRETCH_FACTOR) * EdgeEffectCompat.onPullDistance(edgeEffect, ((-i2) * FLING_DESTRETCH_FACTOR) / i3, 0.5f));
            if (iRound != i2) {
                edgeEffect.finish();
            }
            return i2 - iRound;
        ...
        float f2 = i3;
        int iRound2 = Math.round((f2 / FLING_DESTRETCH_FACTOR) * EdgeEffectCompat.onPullDistance(edgeEffect2, (i2 * FLING_DESTRETCH_FACTOR) / f2, 0.5f));
        if (iRound2 != i2) {
            edgeEffect2.finish();
        }
        return i2 - iRound2;
    ...
    private float getSplineFlingDistance(int i2) {
        ...
        return (float) (this.mPhysicalCoef * SCROLL_FRICTION * Math.exp((f2 / (f2 - 1.0d)) * dLog));
    }
    ...
    private void nestedScrollByInternal(int i2, int i3, @Nullable MotionEvent motionEvent, int i4) {
        ...
        int i5 = zCanScrollVertically ? (zCanScrollHorizontally ? 1 : 0) | 2 : zCanScrollHorizontally ? 1 : 0;
    ...
    */
    ...
    public int getAdapterPositionInRecyclerView(ViewHolder viewHolder) {
        if (viewHolder.hasAnyOfTheFlags(R2.attr.bl_checkable_gradient_centerColor) || !viewHolder.isBound()) {
            return -1;
        }
