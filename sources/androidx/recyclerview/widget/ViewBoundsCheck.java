...
class ViewBoundsCheck {
    ...
    public static class BoundFlags {
        ...
        public boolean boundsMatch() {
            ...
            if ((i4 & R2.attr.ic_info_desc_had_collection) != 0 && (i4 & (compare(this.mChildEnd, this.mRvStart) << 8)) == 0) {
                return false;
            }
            int i5 = this.mBoundFlags;
            return (i5 & R2.styleable.NavigationTabStrip_nts_animation_duration) == 0 || (i5 & (compare(this.mChildEnd, this.mRvEnd) << 12)) != 0;
        }
