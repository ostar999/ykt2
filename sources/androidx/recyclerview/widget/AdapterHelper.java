...
final class AdapterHelper implements OpReorderer.Callback {
    ...
    public static final class UpdateOp {
        ...
        public String toString() {
            return Integer.toHexString(System.identityHashCode(this)) + StrPool.BRACKET_START + cmdToString() + ",s:" + this.positionStart + "c:" + this.itemCount + ",p:" + this.payload + StrPool.BRACKET_END;
        }
    }
