...
public class TransitionManager {
    ...
    private static void changeScene(Scene scene, Transition transition) {
        ...
        Transition transitionMo16clone = transition.mo16clone();
        if (currentScene != null && currentScene.isCreatedFromLayoutResource()) {
            transitionMo16clone.setCanRemoveViews(true);
        }
        sceneChangeSetup(sceneRoot, transitionMo16clone);
        scene.enter();
        sceneChangeRunTransition(sceneRoot, transitionMo16clone);
    }
    ...
    public static void beginDelayedTransition(@NonNull ViewGroup viewGroup, @Nullable Transition transition) {
        ...
        Transition transitionMo16clone = transition.mo16clone();
        sceneChangeSetup(viewGroup, transitionMo16clone);
        Scene.setCurrentScene(viewGroup, null);
        sceneChangeRunTransition(viewGroup, transitionMo16clone);
    }
