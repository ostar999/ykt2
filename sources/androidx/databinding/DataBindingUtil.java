...
public class DataBindingUtil {
    ...
    */
    ...
    public static <T extends ViewDataBinding> T inflate(@NonNull LayoutInflater layoutInflater, int i2, @Nullable ViewGroup viewGroup, boolean z2) {
        return (T) inflate(layoutInflater, i2, viewGroup, z2, sDefaultComponent);
    }
    ...
    public static <T extends ViewDataBinding> T inflate(@NonNull LayoutInflater layoutInflater, int i2, @Nullable ViewGroup viewGroup, boolean z2, @Nullable DataBindingComponent dataBindingComponent) {
        boolean z3 = viewGroup != null && z2;
        return z3 ? (T) bindToAddedViews(dataBindingComponent, viewGroup, z3 ? viewGroup.getChildCount() : 0, i2) : (T) bind(dataBindingComponent, layoutInflater.inflate(i2, viewGroup, z2), i2);
    }
