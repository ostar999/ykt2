...
public abstract class KeyCycleOscillator {
    ...
    public static class CycleOscillator {
        ...
        public double getSlope(float f2) {
            ...
            if (curveFit != null) {
                double d3 = f2;
                curveFit.getSlope(d3, this.mSplineSlopeCache);
                this.mCurveFit.getPos(d3, this.mSplineValueCache);
            } else {
            ...
            double d4 = f2;
            double value = this.mOscillator.getValue(d4, this.mSplineValueCache[1]);
            double slope = this.mOscillator.getSlope(d4, this.mSplineValueCache[1], this.mSplineSlopeCache[1]);
    ...
    public static class PathRotateSet extends KeyCycleOscillator {
        ...
        public void setPathRotate(MotionWidget motionWidget, float f2, double d3, double d4) {
            motionWidget.setRotationZ(get(f2) + ((float) Math.toDegrees(Math.atan2(d4, d3))));
        }
    ...
    public String toString() {
        ...
        Iterator<WavePoint> it = this.mWavePoints.iterator();
        while (it.hasNext()) {
            str = str + StrPool.BRACKET_START + it.next().mPosition + " , " + decimalFormat.format(r3.mValue) + "] ";
        }
        return str;
    }
