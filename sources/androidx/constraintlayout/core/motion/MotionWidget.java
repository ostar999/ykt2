...
public class MotionWidget implements TypedValues {
    ...
    public int getHeight() {
        ...
        return widgetFrame.bottom - widgetFrame.f1778top;
    }
    ...
    public int getTop() {
        return this.widgetFrame.f1778top;
    }
    ...
    public String toString() {
        return this.widgetFrame.left + ", " + this.widgetFrame.f1778top + ", " + this.widgetFrame.right + ", " + this.widgetFrame.bottom;
    }
