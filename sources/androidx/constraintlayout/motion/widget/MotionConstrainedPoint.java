...
class MotionConstrainedPoint implements Comparable<MotionConstrainedPoint> {
    ...
    public void fillStandard(double[] data, int[] toUse) {
        float[] fArr = {this.position, this.f1785x, this.f1786y, this.width, this.height, this.alpha, this.elevation, this.rotation, this.rotationX, this.rotationY, this.scaleX, this.scaleY, this.mPivotX, this.mPivotY, this.translationX, this.translationY, this.translationZ, this.mPathRotate};
        int i2 = 0;
        for (int i3 : toUse) {
            if (i3 < 18) {
                data[i2] = fArr[r4];
    ...
    public void applyParameters(ConstraintSet.Constraint c3) {
        ConstraintSet.PropertySet propertySet = c3.propertySet;
        ...
        ConstraintSet.Transform transform = c3.transform;
    ...
    public void different(MotionConstrainedPoint points, boolean[] mask, String[] custom) {
        ...
        mask[1] = mask[1] | diff(this.f1785x, points.f1785x);
        mask[2] = mask[2] | diff(this.f1786y, points.f1786y);
