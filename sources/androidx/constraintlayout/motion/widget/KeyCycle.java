...
public class KeyCycle extends Key {
    ...
    public static class Loader {
        ...
        public static void read(KeyCycle c3, TypedArray a3) {
            ...
            for (int i2 = 0; i2 < indexCount; i2++) {
                ...
                switch (mAttrMap.get(index)) {
                    ...
                    case 8:
                        c3.mWaveVariesBy = a3.getInt(index, c3.mWaveVariesBy);
                        break;
                    case 9:
                    ...
                    case 20:
                        ...
                        break;
                    case 21:
                        c3.mWavePhase = a3.getFloat(index, c3.mWavePhase) / 360.0f;
                        break;
                    default:
