    ...
    */
        ...
        for (int i5 = 0; i5 < childCount; i5++) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                if (layoutParams.isNestedScrollAccepted(i4) && (behavior = layoutParams.getBehavior()) != null) {
                    ...
                    iMax = i2 > 0 ? Math.max(iMax, this.mBehaviorConsumed[0]) : Math.min(iMax, this.mBehaviorConsumed[0]);
                    iMax2 = i3 > 0 ? Math.max(iMax2, this.mBehaviorConsumed[1]) : Math.min(iMax2, this.mBehaviorConsumed[1]);
                    z2 = true;
                }
            }
        }
    ...
    public CoordinatorLayout(@NonNull Context context, @Nullable AttributeSet attributeSet, @AttrRes int i2) {
        ...
        if (i2 == 0) {
            ...
            ViewCompat.saveAttributeDataForStyleable(this, context, R.styleable.CoordinatorLayout, attributeSet, typedArrayObtainStyledAttributes, i2, 0);
        }
        ...
        for (int i9 = 0; i9 < childCount; i9++) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                if (layoutParams.isNestedScrollAccepted(i6) && (behavior = layoutParams.getBehavior()) != null) {
                    ...
                    if (i4 > 0) {
                        iMin = Math.max(i7, this.mBehaviorConsumed[0]);
                    } else {
                        iMin = Math.min(i7, this.mBehaviorConsumed[0]);
                    }
                    i7 = iMin;
                    if (i5 > 0) {
                        z2 = true;
