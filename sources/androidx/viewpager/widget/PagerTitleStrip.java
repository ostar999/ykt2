...
public class PagerTitleStrip extends ViewGroup {
    ...
    public void updateText(int i2, PagerAdapter pagerAdapter) {
        int size = pagerAdapter != null ? pagerAdapter.getSize() : 0;
        this.mUpdatingText = true;
        CharSequence pageTitle = null;
        this.mPrevText.setText((i2 < 1 || pagerAdapter == null) ? null : pagerAdapter.getPageTitle(i2 - 1));
        this.mCurrText.setText((pagerAdapter == null || i2 >= size) ? null : pagerAdapter.getPageTitle(i2));
        int i3 = i2 + 1;
        if (i3 < size && pagerAdapter != null) {
