...
abstract class SpecialEffectsController {
    ...
    public static class Operation {
        ...
        public String toString() {
            return "Operation " + StrPool.DELIM_START + Integer.toHexString(System.identityHashCode(this)) + "} " + StrPool.DELIM_START + "mFinalState = " + this.mFinalState + "} " + StrPool.DELIM_START + "mLifecycleImpact = " + this.mLifecycleImpact + "} " + StrPool.DELIM_START + "mFragment = " + this.mFragment + "}";
        }
