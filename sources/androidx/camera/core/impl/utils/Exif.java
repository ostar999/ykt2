...
public final class Exif {
    ...
    public static final class Speed {
        ...
        public static Converter fromKilometersPerHour(double d3) {
            return new Converter(d3 * 0.621371d);
        }

        public static Converter fromKnots(double d3) {
            return new Converter(d3 * 1.15078d);
        }

        public static Converter fromMilesPerHour(double d3) {
            return new Converter(d3);
        }
    }
