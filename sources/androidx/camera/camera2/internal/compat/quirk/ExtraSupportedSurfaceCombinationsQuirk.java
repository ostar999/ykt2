...
public class ExtraSupportedSurfaceCombinationsQuirk implements Quirk {
    ...
    public List<SurfaceCombination> getExtraSupportedSurfaceCombinations(@NonNull String str, int i2) {
        return isSamsungS7() ? getSamsungS7ExtraCombinations(str) : supportExtraFullConfigurationsSamsungDevice() ? getLimitedDeviceExtraSupportedFullConfigurations(i2) : Collections.emptyList();
    }
}
