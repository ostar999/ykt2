...
public final class HostnamesKt {
    ...
    */
    ...
    public static final String toCanonicalHost(@NotNull String str) {
        ...
        InetAddress inetAddressDecodeIpv6 = (StringsKt__StringsJVMKt.startsWith$default(str, StrPool.BRACKET_START, false, 2, null) && StringsKt__StringsJVMKt.endsWith$default(str, StrPool.BRACKET_END, false, 2, null)) ? decodeIpv6(str, 1, str.length() - 1) : decodeIpv6(str, 0, str.length());
        ...
        throw new AssertionError("Invalid IPv6 address: '" + str + CharPool.SINGLE_QUOTE);
    }
}
