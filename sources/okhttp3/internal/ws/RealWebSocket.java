...
public final class RealWebSocket implements WebSocket, WebSocketReader.FrameCallback {
    ...
    public final void checkUpgradeSuccess$okhttp(@NotNull Response response, @Nullable Exchange exchange) throws IOException {
        ...
        if (response.code() != 101) {
            throw new ProtocolException("Expected HTTP 101 response but was '" + response.code() + ' ' + response.message() + CharPool.SINGLE_QUOTE);
        }
        ...
        if (!StringsKt__StringsJVMKt.equals("Upgrade", strHeader$default, true)) {
            throw new ProtocolException("Expected 'Connection' header value 'Upgrade' but was '" + ((Object) strHeader$default) + CharPool.SINGLE_QUOTE);
        }
        String strHeader$default2 = Response.header$default(response, "Upgrade", null, 2, null);
        if (!StringsKt__StringsJVMKt.equals(io.socket.engineio.client.transports.WebSocket.NAME, strHeader$default2, true)) {
            throw new ProtocolException("Expected 'Upgrade' header value 'websocket' but was '" + ((Object) strHeader$default2) + CharPool.SINGLE_QUOTE);
        }
        ...
        throw new ProtocolException("Expected 'Sec-WebSocket-Accept' header value '" + strBase64 + "' but was '" + ((Object) strHeader$default3) + CharPool.SINGLE_QUOTE);
    }
    ...
    public final void failWebSocket(@NotNull Exception e2, @Nullable Response response) throws IOException {
        Intrinsics.checkNotNullParameter(e2, "e");
        synchronized (this) {
            if (this.failed) {
                return;
            ...
            if (byteStringPoll == null) {
                ...
                if (objPoll instanceof Close) {
                    ...
                    if (i2 != -1) {
                        ...
                        taskQueue.schedule(new Task(strStringPlus, z2, this) { // from class: okhttp3.internal.ws.RealWebSocket$writeOneFrame$lambda-8$$inlined$execute$default$1
