...
public final class Challenge {
    ...
    public final Map<String, String> m2437deprecated_authParams() {
    ...
    public final Charset m2438deprecated_charset() {
        return charset();
    }
    ...
    public final String m2439deprecated_realm() {
        return realm();
    }
    ...
    public int hashCode() {
        return ((R2.attr.carousel_touchUp_velocityThreshold + this.scheme.hashCode()) * 31) + this.authParams.hashCode();
    }
