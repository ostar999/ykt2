...
public final class ConnectionSpec {
    ...
    public final List<CipherSuite> m2442deprecated_cipherSuites() {
        return cipherSuites();
    }
    ...
    public final List<TlsVersion> m2444deprecated_tlsVersions() {
        return tlsVersions();
    }
    ...
    public int hashCode() {
        ...
        String[] strArr = this.cipherSuitesAsString;
        int iHashCode = (R2.attr.bl_checkable_gradient_endColor + (strArr == null ? 0 : Arrays.hashCode(strArr))) * 31;
