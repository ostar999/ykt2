...
public final class Request {
    ...
    public static class Builder {
        ...
        public Builder url(@NotNull String url) {
            ...
            if (StringsKt__StringsJVMKt.startsWith(url, "ws:", true)) {
                ...
                url = Intrinsics.stringPlus(URIUtil.HTTP_COLON, strSubstring);
            } else if (StringsKt__StringsJVMKt.startsWith(url, "wss:", true)) {
                String strSubstring2 = url.substring(4);
                Intrinsics.checkNotNullExpressionValue(strSubstring2, "this as java.lang.String).substring(startIndex)");
                url = Intrinsics.stringPlus(URIUtil.HTTPS_COLON, strSubstring2);
            }
    ...
    public final CacheControl m2528deprecated_cacheControl() {
        return cacheControl();
    }
