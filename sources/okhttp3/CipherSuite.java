...
public final class CipherSuite {
    ...
    static {
        ...
        ORDER_BY_NAME = new Comparator<String>() { // from class: okhttp3.CipherSuite$Companion$ORDER_BY_NAME$1
            ...
            public int compare(@NotNull String a3, @NotNull String b3) {
                Intrinsics.checkNotNullParameter(a3, "a");
                Intrinsics.checkNotNullParameter(b3, "b");
                int iMin = Math.min(a3.length(), b3.length());
                for (int i2 = 4; i2 < iMin; i2++) {
                    char cCharAt = a3.charAt(i2);
                    char cCharAt2 = b3.charAt(i2);
                    if (cCharAt != cCharAt2) {
        ...
        TLS_FALLBACK_SCSV = companion.init("TLS_FALLBACK_SCSV", R2.layout.item_mock_test_review_share_stem);
        ...
        TLS_AES_128_GCM_SHA256 = companion.init("TLS_AES_128_GCM_SHA256", R2.color.foor_color);
        TLS_AES_256_GCM_SHA384 = companion.init("TLS_AES_256_GCM_SHA384", R2.color.foreground_material_dark);
        TLS_CHACHA20_POLY1305_SHA256 = companion.init("TLS_CHACHA20_POLY1305_SHA256", R2.color.foreground_material_light);
        TLS_AES_128_CCM_SHA256 = companion.init("TLS_AES_128_CCM_SHA256", R2.color.forestgreen);
        TLS_AES_128_CCM_8_SHA256 = companion.init("TLS_AES_128_CCM_8_SHA256", R2.color.format_bar_ripple_animation);
    }
