...
public final class Route {
    ...
    public int hashCode() {
        return ((((R2.attr.bl_checkable_gradient_endColor + this.address.hashCode()) * 31) + this.proxy.hashCode()) * 31) + this.socketAddress.hashCode();
    }
