...
public final class MediaType {
    ...
    public static final class Companion {
        ...
        public final MediaType m2491deprecated_get(@NotNull String mediaType) {
        ...
        public final MediaType m2492deprecated_parse(@NotNull String mediaType) {
            Intrinsics.checkNotNullParameter(mediaType, "mediaType");
    ...
    public final String parameter(@NotNull String name) {
        ...
        while (true) {
            int i3 = i2 + 2;
            if (StringsKt__StringsJVMKt.equals(this.parameterNamesAndValues[i2], name, true)) {
