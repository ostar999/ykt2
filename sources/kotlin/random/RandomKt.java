...
public final class RandomKt {
    ...
    public static final void checkRangeBounds(double d3, double d4) {
        if (!(d4 > d3)) {
            throw new IllegalArgumentException(boundsErrorMessage(Double.valueOf(d3), Double.valueOf(d4)).toString());
        }
    }
}
