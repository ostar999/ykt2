...
public final class DurationKt {
    ...
    public static final long durationOf(long j2, int i2) {
        return Duration.m2136constructorimpl((j2 << 1) + i2);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final long durationOfMillis(long j2) {
        return Duration.m2136constructorimpl((j2 << 1) + 1);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final long durationOfMillisNormalized(long j2) {
        return new LongRange(-4611686018426L, MAX_NANOS_IN_MILLIS).contains(j2) ? durationOfNanos(millisToNanos(j2)) : durationOfMillis(RangesKt___RangesKt.coerceIn(j2, -4611686018427387903L, MAX_MILLIS));
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final long durationOfNanos(long j2) {
        return Duration.m2136constructorimpl(j2 << 1);
    }
    ...
    */
    ...
    private static final long m2261timeskIfJnKk(double d3, long j2) {
        return Duration.m2173timesUwyO8pc(j2, d3);
    }
    ...
    private static final long m2262timesmvk6XK0(int i2, long j2) {
        return Duration.m2174timesUwyO8pc(j2, i2);
    }
    ...
    public static final long getDays(double d3) {
        return toDuration(d3, DurationUnit.DAYS);
    }

    public static final long getHours(double d3) {
        return toDuration(d3, DurationUnit.HOURS);
    }

    public static final long getMicroseconds(double d3) {
        return toDuration(d3, DurationUnit.MICROSECONDS);
    }

    public static final long getMilliseconds(double d3) {
        return toDuration(d3, DurationUnit.MILLISECONDS);
    }

    public static final long getMinutes(double d3) {
        return toDuration(d3, DurationUnit.MINUTES);
    }

    public static final long getNanoseconds(double d3) {
        return toDuration(d3, DurationUnit.NANOSECONDS);
    }

    public static final long getSeconds(double d3) {
        return toDuration(d3, DurationUnit.SECONDS);
    }
    ...
    @SinceKotlin(version = "1.6")
    @WasExperimental(markerClass = {ExperimentalTime.class})
    public static final long toDuration(double d3, @NotNull DurationUnit unit) {
        Intrinsics.checkNotNullParameter(unit, "unit");
        ...
        if (!Double.isNaN(dConvertDurationUnit)) {
            ...
            return durationOfMillisNormalized(MathKt__MathJVMKt.roundToLong(DurationUnitKt__DurationUnitJvmKt.convertDurationUnit(d3, unit, DurationUnit.MILLISECONDS)));
        }
