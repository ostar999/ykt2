...
public final /* data */ class TimedValue<T> {
    ...
    public static /* synthetic */ TimedValue m2293copyRFiDyg4$default(TimedValue timedValue, Object obj, long j2, int i2, Object obj2) {
        if ((i2 & 1) != 0) {
        ...
        return timedValue.m2295copyRFiDyg4(obj, j2);
    }
    ...
    public final TimedValue<T> m2295copyRFiDyg4(T value, long duration) {
    ...
    public boolean equals(@Nullable Object other) {
        ...
        return Intrinsics.areEqual(this.value, timedValue.value) && Duration.m2141equalsimpl0(this.duration, timedValue.duration);
    }

    /* renamed from: getDuration-UwyO8pc, reason: not valid java name */
    public final long m2296getDurationUwyO8pc() {
        return this.duration;
    }
    ...
    public int hashCode() {
        T t2 = this.value;
        return ((t2 == null ? 0 : t2.hashCode()) * 31) + Duration.m2164hashCodeimpl(this.duration);
    }

    @NotNull
    public String toString() {
        return "TimedValue(value=" + this.value + ", duration=" + ((Object) Duration.m2185toStringimpl(this.duration)) + ')';
    }
}
