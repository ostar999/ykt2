...
public final class ResultKt {
    ...
    private static final <R, T> R fold(Object obj, Function1<? super T, ? extends R> onSuccess, Function1<? super Throwable, ? extends R> onFailure) {
        ...
        Throwable thM786exceptionOrNullimpl = Result.m786exceptionOrNullimpl(obj);
        return thM786exceptionOrNullimpl == null ? onSuccess.invoke(obj) : onFailure.invoke(thM786exceptionOrNullimpl);
    }
    ...
    private static final <R, T extends R> R getOrDefault(Object obj, R r2) {
        return Result.m789isFailureimpl(obj) ? r2 : obj;
    }
    ...
    private static final <R, T extends R> R getOrElse(Object obj, Function1<? super Throwable, ? extends R> onFailure) {
        Intrinsics.checkNotNullParameter(onFailure, "onFailure");
        Throwable thM786exceptionOrNullimpl = Result.m786exceptionOrNullimpl(obj);
        return thM786exceptionOrNullimpl == null ? obj : onFailure.invoke(thM786exceptionOrNullimpl);
    }
    ...
    private static final <T> Object onFailure(Object obj, Function1<? super Throwable, Unit> action) {
        ...
        if (thM786exceptionOrNullimpl != null) {
            action.invoke(thM786exceptionOrNullimpl);
        }
        return obj;
    }
    ...
    private static final <R, T extends R> Object recover(Object obj, Function1<? super Throwable, ? extends R> transform) {
        ...
        Result.Companion companion = Result.INSTANCE;
        return Result.m783constructorimpl(transform.invoke(thM786exceptionOrNullimpl));
    }
    ...
    private static final <T, R> Object runCatching(T t2, Function1<? super T, ? extends R> block) {
        ...
        try {
            Result.Companion companion = Result.INSTANCE;
            return Result.m783constructorimpl(block.invoke(t2));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            return Result.m783constructorimpl(createFailure(th));
        }
