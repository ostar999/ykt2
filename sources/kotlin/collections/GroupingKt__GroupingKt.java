...
class GroupingKt__GroupingKt extends GroupingKt__GroupingJVMKt {
    ...
    public static final <T, K, R> Map<K, R> aggregate(@NotNull Grouping<T, ? extends K> grouping, @NotNull Function4<? super K, ? super R, ? super T, ? super Boolean, ? extends R> operation) {
        ...
        while (itSourceIterator.hasNext()) {
            ...
            ThirdAppInfoNew thirdAppInfoNew = (Object) linkedHashMap.get(objKeyOf);
            linkedHashMap.put(objKeyOf, operation.invoke(objKeyOf, thirdAppInfoNew, next, Boolean.valueOf(thirdAppInfoNew == null && !linkedHashMap.containsKey(objKeyOf))));
        }
    ...
    public static final <T, K, R, M extends Map<? super K, R>> M aggregateTo(@NotNull Grouping<T, ? extends K> grouping, @NotNull M destination, @NotNull Function4<? super K, ? super R, ? super T, ? super Boolean, ? extends R> operation) {
        ...
        while (itSourceIterator.hasNext()) {
            ?? next = itSourceIterator.next();
            Object objKeyOf = grouping.keyOf(next);
            ThirdAppInfoNew thirdAppInfoNew = (Object) destination.get(objKeyOf);
            destination.put(objKeyOf, operation.invoke(objKeyOf, thirdAppInfoNew, next, Boolean.valueOf(thirdAppInfoNew == null && !destination.containsKey(objKeyOf))));
        }
        return destination;
    }
    ...
    public static final <S, T extends S, K> Map<K, S> reduce(@NotNull Grouping<T, ? extends K> grouping, @NotNull Function3<? super K, ? super S, ? super T, ? extends S> operation) {
        ...
        while (itSourceIterator.hasNext()) {
            ...
            ThirdAppInfoNew thirdAppInfoNew = (Object) linkedHashMap.get(objKeyOf);
            if (!(thirdAppInfoNew == null && !linkedHashMap.containsKey(objKeyOf))) {
                sInvoke = operation.invoke(objKeyOf, thirdAppInfoNew, sInvoke);
            }
    ...
    public static final <S, T extends S, K, M extends Map<? super K, S>> M reduceTo(@NotNull Grouping<T, ? extends K> grouping, @NotNull M destination, @NotNull Function3<? super K, ? super S, ? super T, ? extends S> operation) {
        ...
        while (itSourceIterator.hasNext()) {
            ...
            Object objKeyOf = grouping.keyOf(sInvoke);
            ThirdAppInfoNew thirdAppInfoNew = (Object) destination.get(objKeyOf);
            if (!(thirdAppInfoNew == null && !destination.containsKey(objKeyOf))) {
                sInvoke = operation.invoke(objKeyOf, thirdAppInfoNew, sInvoke);
            }
    ...
    public static final <T, K, R, M extends Map<? super K, R>> M foldTo(@NotNull Grouping<T, ? extends K> grouping, @NotNull M destination, R r2, @NotNull Function2<? super R, ? super T, ? extends R> operation) {
        ...
        while (itSourceIterator.hasNext()) {
            ...
            ThirdAppInfoNew thirdAppInfoNew = (Object) destination.get(kKeyOf);
            if (thirdAppInfoNew == null && !destination.containsKey(kKeyOf)) {
                thirdAppInfoNew = (Object) r2;
            }
            destination.put(kKeyOf, operation.invoke(thirdAppInfoNew, next));
        }
        return destination;
    }
    ...
    public static final <T, K, R> Map<K, R> fold(@NotNull Grouping<T, ? extends K> grouping, R r2, @NotNull Function2<? super R, ? super T, ? extends R> operation) {
        ...
        while (itSourceIterator.hasNext()) {
            ?? next = itSourceIterator.next();
            K kKeyOf = grouping.keyOf(next);
            ThirdAppInfoNew thirdAppInfoNew = (Object) linkedHashMap.get(kKeyOf);
            if (thirdAppInfoNew == null && !linkedHashMap.containsKey(kKeyOf)) {
                thirdAppInfoNew = (Object) r2;
            }
            linkedHashMap.put(kKeyOf, operation.invoke(thirdAppInfoNew, next));
        }
        return linkedHashMap;
    }
}
