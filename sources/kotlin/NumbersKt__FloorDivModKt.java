...
class NumbersKt__FloorDivModKt extends NumbersKt__BigIntegersKt {
    ...
    @InlineOnly
    private static final int floorDiv(byte b3, byte b4) {
        int i2 = b3 / b4;
        return ((b3 ^ b4) >= 0 || b4 * i2 == b3) ? i2 : i2 - 1;
    }

    @SinceKotlin(version = "1.5")
    @IntrinsicConstEvaluation
    @InlineOnly
    private static final byte mod(byte b3, byte b4) {
        int i2 = b3 % b4;
    ...
    @IntrinsicConstEvaluation
    @InlineOnly
    private static final int floorDiv(byte b3, short s2) {
        int i2 = b3 / s2;
        return ((b3 ^ s2) >= 0 || s2 * i2 == b3) ? i2 : i2 - 1;
    }

    @SinceKotlin(version = "1.5")
    @IntrinsicConstEvaluation
    @InlineOnly
    private static final short mod(byte b3, short s2) {
        int i2 = b3 % s2;
    ...
    @IntrinsicConstEvaluation
    @InlineOnly
    private static final int floorDiv(byte b3, int i2) {
        int i3 = b3 / i2;
        return ((b3 ^ i2) >= 0 || i2 * i3 == b3) ? i3 : i3 - 1;
    }

    @SinceKotlin(version = "1.5")
    @IntrinsicConstEvaluation
    @InlineOnly
    private static final int mod(byte b3, int i2) {
        int i3 = b3 % i2;
    ...
    @IntrinsicConstEvaluation
    @InlineOnly
    private static final long floorDiv(byte b3, long j2) {
        long j3 = b3;
        long j4 = j3 / j2;
    ...
    @IntrinsicConstEvaluation
    @InlineOnly
    private static final long mod(byte b3, long j2) {
        long j3 = b3 % j2;
    ...
    @IntrinsicConstEvaluation
    @InlineOnly
    private static final int floorDiv(short s2, byte b3) {
        int i2 = s2 / b3;
        return ((s2 ^ b3) >= 0 || b3 * i2 == s2) ? i2 : i2 - 1;
    }

    @SinceKotlin(version = "1.5")
    @IntrinsicConstEvaluation
    @InlineOnly
    private static final byte mod(short s2, byte b3) {
        int i2 = s2 % b3;
    ...
    @IntrinsicConstEvaluation
    @InlineOnly
    private static final int floorDiv(int i2, byte b3) {
        int i3 = i2 / b3;
        return ((i2 ^ b3) >= 0 || b3 * i3 == i2) ? i3 : i3 - 1;
    }

    @SinceKotlin(version = "1.5")
    @IntrinsicConstEvaluation
    @InlineOnly
    private static final byte mod(int i2, byte b3) {
        int i3 = i2 % b3;
    ...
    @IntrinsicConstEvaluation
    @InlineOnly
    private static final long floorDiv(long j2, byte b3) {
        long j3 = b3;
        long j4 = j2 / j3;
    ...
    @IntrinsicConstEvaluation
    @InlineOnly
    private static final byte mod(long j2, byte b3) {
        long j3 = j2 % b3;
    ...
    @IntrinsicConstEvaluation
    @InlineOnly
    private static final double mod(float f2, double d3) {
        double d4 = f2 % d3;
        if (d4 == 0.0d) {
            return d4;
        }
    ...
    @IntrinsicConstEvaluation
    @InlineOnly
    private static final double mod(double d3, float f2) {
        double d4 = f2;
        double d5 = d3 % d4;
        if (d5 == 0.0d) {
            return d5;
