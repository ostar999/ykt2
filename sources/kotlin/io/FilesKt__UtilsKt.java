...
public class FilesKt__UtilsKt extends FilesKt__FileTreeWalkKt {
    ...
    */
    ...
    public static final String getNameWithoutExtension(@NotNull File file) {
        ...
        String name = file.getName();
        Intrinsics.checkNotNullExpressionValue(name, "name");
        return StringsKt__StringsKt.substringBeforeLast$default(name, StrPool.DOT, (String) null, 2, (Object) null);
    }
    ...
    public static final File resolveSibling(@NotNull File file, @NotNull File relative) {
        ...
        Intrinsics.checkNotNullParameter(relative, "relative");
        FilePathComponents components = FilesKt__FilePathComponentsKt.toComponents(file);
        return resolve(resolve(components.getRoot(), components.getSize() == 0 ? new File(StrPool.DOUBLE_DOT) : components.subPath(0, components.getSize() - 1)), relative);
    }
    ...
    private static final String toRelativeStringOrNull$FilesKt__UtilsKt(File file, File file2) throws IOException {
        ...
        int i3 = size - 1;
        if (i2 <= i3) {
            while (!Intrinsics.areEqual(filePathComponentsNormalize$FilesKt__UtilsKt2.getSegments().get(i3).getName(), StrPool.DOUBLE_DOT)) {
        ...
        if (i2 < size2) {
            ...
            List listDrop = CollectionsKt___CollectionsKt.drop(filePathComponentsNormalize$FilesKt__UtilsKt.getSegments(), i2);
            String separator = File.separator;
            Intrinsics.checkNotNullExpressionValue(separator, "separator");
    ...
    private static final List<File> normalize$FilesKt__UtilsKt(List<? extends File> list) {
        ...
        for (File file : list) {
            String name = file.getName();
            if (!Intrinsics.areEqual(name, StrPool.DOT)) {
                if (!Intrinsics.areEqual(name, StrPool.DOUBLE_DOT)) {
                    arrayList.add(file);
                } else if (arrayList.isEmpty() || Intrinsics.areEqual(((File) CollectionsKt___CollectionsKt.last((List) arrayList)).getName(), StrPool.DOUBLE_DOT)) {
                    arrayList.add(file);
                } else {
