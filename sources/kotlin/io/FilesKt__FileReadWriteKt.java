        ...
        try {
            ...
            if (i3 > 0) {
                ...
                if (i6 != -1) {
                    ...
                    bArrCopyInto = ArraysKt___ArraysJvmKt.copyInto(buffer, bArrCopyOf, i2, 0, exposingBufferByteArrayOutputStream.size());
                }
            }
