...
public final class UStringsKt {
    ...
    public static final String m2121toStringJSWoG40(long j2, int i2) {
    ...
    public static final String m2122toStringLxnNnR4(byte b3, int i2) {
        String string = Integer.toString(b3 & 255, CharsKt__CharJVMKt.checkRadix(i2));
    ...
    public static final String m2123toStringV7xB4Y4(int i2, int i3) {
        String string = Long.toString(i2 & InternalZipConstants.ZIP_64_LIMIT, CharsKt__CharJVMKt.checkRadix(i3));
        Intrinsics.checkNotNullExpressionValue(string, "toString(this, checkRadix(radix))");
        return string;
    }
    ...
    public static final String m2124toStringolVBNx4(short s2, int i2) {
        String string = Integer.toString(s2 & 65535, CharsKt__CharJVMKt.checkRadix(i2));
        Intrinsics.checkNotNullExpressionValue(string, "toString(this, checkRadix(radix))");
        return string;
    }
    ...
    public static final UByte toUByteOrNull(@NotNull String str, int i2) {
        ...
        if (Integer.compare(data ^ Integer.MIN_VALUE, UInt.m878constructorimpl(255) ^ Integer.MIN_VALUE) > 0) {
            return null;
        }
    ...
    public static final UInt toUIntOrNull(@NotNull String str, int i2) {
        ...
        int iM878constructorimpl = UInt.m878constructorimpl(i2);
        int iA = 119304647;
        while (i3 < length) {
            ...
            if (Integer.compare(i4 ^ Integer.MIN_VALUE, iA ^ Integer.MIN_VALUE) > 0) {
                if (iA == 119304647) {
                    iA = b.a(-1, iM878constructorimpl);
                    if (Integer.compare(i4 ^ Integer.MIN_VALUE, iA ^ Integer.MIN_VALUE) > 0) {
                    }
                }
                return null;
            }
            int iM878constructorimpl2 = UInt.m878constructorimpl(i4 * iM878constructorimpl);
            int iM878constructorimpl3 = UInt.m878constructorimpl(UInt.m878constructorimpl(iDigitOf) + iM878constructorimpl2);
            if (Integer.compare(iM878constructorimpl3 ^ Integer.MIN_VALUE, iM878constructorimpl2 ^ Integer.MIN_VALUE) < 0) {
                return null;
            }
            i3++;
            i4 = iM878constructorimpl3;
        }
        return UInt.m872boximpl(i4);
    }
    ...
    public static final ULong toULongOrNull(@NotNull String str, int i2) {
        ...
        long jM957constructorimpl = ULong.m957constructorimpl(i2);
        long j2 = 0;
        ...
        while (i3 < length) {
            ...
            if (Long.compare(j2 ^ Long.MIN_VALUE, jA ^ Long.MIN_VALUE) > 0) {
                if (jA == 512409557603043100L) {
                    jA = f.a(-1L, jM957constructorimpl);
                    if (Long.compare(j2 ^ Long.MIN_VALUE, jA ^ Long.MIN_VALUE) > 0) {
                    }
                }
                return null;
            }
            long jM957constructorimpl2 = ULong.m957constructorimpl(j2 * jM957constructorimpl);
            long jM957constructorimpl3 = ULong.m957constructorimpl(ULong.m957constructorimpl(UInt.m878constructorimpl(r13) & InternalZipConstants.ZIP_64_LIMIT) + jM957constructorimpl2);
            if (Long.compare(jM957constructorimpl3 ^ Long.MIN_VALUE, jM957constructorimpl2 ^ Long.MIN_VALUE) < 0) {
                return null;
            }
            i3++;
            j2 = jM957constructorimpl3;
        }
        return ULong.m951boximpl(j2);
    }
    ...
    public static final UShort toUShortOrNull(@NotNull String str, int i2) {
        ...
        int data = uIntOrNull.getData();
        if (Integer.compare(data ^ Integer.MIN_VALUE, UInt.m878constructorimpl(65535) ^ Integer.MIN_VALUE) > 0) {
            return null;
        }
        return UShort.m1058boximpl(UShort.m1064constructorimpl((short) data));
    }
}
