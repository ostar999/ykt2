...
public class StringsKt__StringBuilderJVMKt extends StringsKt__RegexExtensionsKt {
    ...
    @InlineOnly
    private static final void set(StringBuilder sb, int i2, char c3) {
        Intrinsics.checkNotNullParameter(sb, "<this>");
        sb.setCharAt(i2, c3);
    }
    ...
    @Deprecated(level = DeprecationLevel.WARNING, message = "Use appendLine instead. Note that the new method always appends the line feed character '\\n' regardless of the system line separator.", replaceWith = @ReplaceWith(expression = "appendLine(value)", imports = {}))
    @InlineOnly
    private static final Appendable appendln(Appendable appendable, char c3) throws IOException {
        Intrinsics.checkNotNullParameter(appendable, "<this>");
        Appendable appendableAppend = appendable.append(c3);
        Intrinsics.checkNotNullExpressionValue(appendableAppend, "append(value)");
        return appendln(appendableAppend);
    }
    ...
    @SinceKotlin(version = "1.4")
    @InlineOnly
    private static final StringBuilder appendLine(StringBuilder sb, byte b3) {
        Intrinsics.checkNotNullParameter(sb, "<this>");
        sb.append((int) b3);
        Intrinsics.checkNotNullExpressionValue(sb, "append(value.toInt())");
        sb.append('\n');
    ...
    @SinceKotlin(version = "1.4")
    @InlineOnly
    private static final StringBuilder appendLine(StringBuilder sb, double d3) {
        Intrinsics.checkNotNullParameter(sb, "<this>");
        sb.append(d3);
        Intrinsics.checkNotNullExpressionValue(sb, "append(value)");
        sb.append('\n');
    ...
    @Deprecated(level = DeprecationLevel.WARNING, message = "Use appendLine instead. Note that the new method always appends the line feed character '\\n' regardless of the system line separator.", replaceWith = @ReplaceWith(expression = "appendLine(value)", imports = {}))
    @InlineOnly
    private static final StringBuilder appendln(StringBuilder sb, char c3) {
        Intrinsics.checkNotNullParameter(sb, "<this>");
        sb.append(c3);
        Intrinsics.checkNotNullExpressionValue(sb, "append(value)");
        return appendln(sb);
    ...
    @Deprecated(level = DeprecationLevel.WARNING, message = "Use appendLine instead. Note that the new method always appends the line feed character '\\n' regardless of the system line separator.", replaceWith = @ReplaceWith(expression = "appendLine(value)", imports = {}))
    @InlineOnly
    private static final StringBuilder appendln(StringBuilder sb, byte b3) {
        Intrinsics.checkNotNullParameter(sb, "<this>");
        sb.append((int) b3);
        Intrinsics.checkNotNullExpressionValue(sb, "append(value.toInt())");
        return appendln(sb);
    ...
    @Deprecated(level = DeprecationLevel.WARNING, message = "Use appendLine instead. Note that the new method always appends the line feed character '\\n' regardless of the system line separator.", replaceWith = @ReplaceWith(expression = "appendLine(value)", imports = {}))
    @InlineOnly
    private static final StringBuilder appendln(StringBuilder sb, double d3) {
        Intrinsics.checkNotNullParameter(sb, "<this>");
        sb.append(d3);
        Intrinsics.checkNotNullExpressionValue(sb, "append(value)");
        return appendln(sb);
