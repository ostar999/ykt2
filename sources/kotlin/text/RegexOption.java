...
public final class RegexOption implements FlagEnum {
    ...
    static {
        ...
        MULTILINE = new RegexOption("MULTILINE", 1, 8, i3, i4, defaultConstructorMarker);
        int i5 = 0;
        int i6 = 2;
        DefaultConstructorMarker defaultConstructorMarker2 = null;
        LITERAL = new RegexOption("LITERAL", i2, 16, i5, i6, defaultConstructorMarker2);
        UNIX_LINES = new RegexOption("UNIX_LINES", 3, 1, i3, i4, defaultConstructorMarker);
        COMMENTS = new RegexOption("COMMENTS", 4, 4, i5, i6, defaultConstructorMarker2);
        DOT_MATCHES_ALL = new RegexOption("DOT_MATCHES_ALL", 5, 32, i3, i4, defaultConstructorMarker);
        CANON_EQ = new RegexOption("CANON_EQ", 6, 128, i5, i6, defaultConstructorMarker2);
    }
