...
public class StringsKt__StringNumberConversionsJVMKt extends StringsKt__StringBuilderKt {
    ...
    @SinceKotlin(version = "1.1")
    @InlineOnly
    private static final String toString(byte b3, int i2) {
        String string = Integer.toString(b3, CharsKt__CharJVMKt.checkRadix(CharsKt__CharJVMKt.checkRadix(i2)));
    ...
    private static final String toString(short s2, int i2) {
        String string = Integer.toString(s2, CharsKt__CharJVMKt.checkRadix(CharsKt__CharJVMKt.checkRadix(i2)));
        Intrinsics.checkNotNullExpressionValue(string, "toString(this, checkRadix(radix))");
        return string;
    }
