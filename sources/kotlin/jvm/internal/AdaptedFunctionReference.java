...
public class AdaptedFunctionReference implements FunctionBase, Serializable {
    ...
    public int hashCode() {
        ...
        Class cls = this.owner;
        return ((((((((((iHashCode + (cls != null ? cls.hashCode() : 0)) * 31) + this.name.hashCode()) * 31) + this.signature.hashCode()) * 31) + (this.isTopLevel ? R2.attr.customColorDrawableValue : R2.attr.customIsDrag)) * 31) + this.arity) * 31) + this.flags;
    }
