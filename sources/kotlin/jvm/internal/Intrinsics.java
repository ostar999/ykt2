...
public class Intrinsics {
    ...
    public static void checkFieldIsNotNull(Object obj, String str, String str2) {
        ...
        throw ((IllegalStateException) sanitizeStackTrace(new IllegalStateException("Field specified as non-null is null: " + str + StrPool.DOT + str2)));
    }
    ...
    public static void checkReturnedValueIsNotNull(Object obj, String str, String str2) {
        ...
        throw ((IllegalStateException) sanitizeStackTrace(new IllegalStateException("Method specified as non-null returned null: " + str + StrPool.DOT + str2)));
    }
    ...
    private static String createParameterIsNullExceptionMessage(String str) {
        ...
        return "Parameter specified as non-null is null: method " + stackTraceElement.getClassName() + StrPool.DOT + stackTraceElement.getMethodName() + ", parameter " + str;
    }
    ...
    @SinceKotlin(version = "1.1")
    public static boolean areEqual(Double d3, double d4) {
        return d3 != null && d3.doubleValue() == d4;
    }

    @SinceKotlin(version = "1.1")
    public static boolean areEqual(double d3, Double d4) {
        return d4 != null && d3 == d4.doubleValue();
    }
