...
public class MathKt__MathJVMKt extends MathKt__MathHKt {
    ...
    public static final double acosh(double d3) {
        ...
        if (d3 > Constants.upper_taylor_2_bound) {
            return Math.log(d3) + Constants.LN2;
        }
        double d4 = 1;
        double d5 = d3 - d4;
    ...
    @SinceKotlin(version = "1.2")
    @InlineOnly
    private static final double asin(double d3) {
        return Math.asin(d3);
    }
    ...
    public static final double asinh(double d3) {
        ...
        if (d3 < d4) {
            return d3 <= (-d4) ? -asinh(-d3) : Math.abs(d3) >= Constants.taylor_2_bound ? d3 - (((d3 * d3) * d3) / 6) : d3;
        }
        if (d3 <= Constants.upper_taylor_n_bound) {
    ...
    @SinceKotlin(version = "1.2")
    @InlineOnly
    private static final double atan(double d3) {
        return Math.atan(d3);
    }

    @SinceKotlin(version = "1.2")
    @InlineOnly
    private static final double atan2(double d3, double d4) {
        return Math.atan2(d3, d4);
    }

    @SinceKotlin(version = "1.2")
    public static final double atanh(double d3) {
        if (Math.abs(d3) < Constants.taylor_n_bound) {
            return Math.abs(d3) > Constants.taylor_2_bound ? d3 + (((d3 * d3) * d3) / 3) : d3;
        }
        double d4 = 1;
    ...
    @InlineOnly
    private static final double cbrt(double d3) {
        return Math.cbrt(d3);
    }

    @SinceKotlin(version = "1.2")
    @InlineOnly
    private static final double ceil(double d3) {
        return Math.ceil(d3);
    }

    @SinceKotlin(version = "1.2")
    @InlineOnly
    private static final double cos(double d3) {
        return Math.cos(d3);
    }

    @SinceKotlin(version = "1.2")
    @InlineOnly
    private static final double cosh(double d3) {
        return Math.cosh(d3);
    }

    @SinceKotlin(version = "1.2")
    @InlineOnly
    private static final double exp(double d3) {
        return Math.exp(d3);
    }

    @SinceKotlin(version = "1.2")
    @InlineOnly
    private static final double expm1(double d3) {
        return Math.expm1(d3);
    }

    @SinceKotlin(version = "1.2")
    @InlineOnly
    private static final double floor(double d3) {
        return Math.floor(d3);
    }

    private static final double getAbsoluteValue(double d3) {
        return Math.abs(d3);
    }
    ...
    private static final double getSign(double d3) {
    ...
    private static final double getUlp(double d3) {
        return Math.ulp(d3);
    }
    ...
    @SinceKotlin(version = "1.2")
    @InlineOnly
    private static final double hypot(double d3, double d4) {
        return Math.hypot(d3, d4);
    }

    @SinceKotlin(version = "1.2")
    @InlineOnly
    private static final double ln(double d3) {
        return Math.log(d3);
    }

    @SinceKotlin(version = "1.2")
    @InlineOnly
    private static final double ln1p(double d3) {
    ...
    @SinceKotlin(version = "1.2")
    @InlineOnly
    private static final double log10(double d3) {
    ...
    @SinceKotlin(version = "1.2")
    @InlineOnly
    private static final double max(double d3, double d4) {
        return Math.max(d3, d4);
    }

    @SinceKotlin(version = "1.2")
    @InlineOnly
    private static final double min(double d3, double d4) {
        return Math.min(d3, d4);
    }

    @SinceKotlin(version = "1.2")
    @InlineOnly
    private static final double nextDown(double d3) {
        return Math.nextAfter(d3, Double.NEGATIVE_INFINITY);
    }

    @SinceKotlin(version = "1.2")
    @InlineOnly
    private static final double nextTowards(double d3, double d4) {
        return Math.nextAfter(d3, d4);
    }

    @SinceKotlin(version = "1.2")
    @InlineOnly
    private static final double nextUp(double d3) {
    ...
    @SinceKotlin(version = "1.2")
    @InlineOnly
    private static final double round(double d3) {
        return Math.rint(d3);
    }
    ...
    @SinceKotlin(version = "1.2")
    @InlineOnly
    private static final double sign(double d3) {
        return Math.signum(d3);
    }

    @SinceKotlin(version = "1.2")
    @InlineOnly
    private static final double sin(double d3) {
        return Math.sin(d3);
    }

    @SinceKotlin(version = "1.2")
    @InlineOnly
    private static final double sinh(double d3) {
        return Math.sinh(d3);
    }

    @SinceKotlin(version = "1.2")
    @InlineOnly
    private static final double sqrt(double d3) {
        return Math.sqrt(d3);
    }

    @SinceKotlin(version = "1.2")
    @InlineOnly
    private static final double tan(double d3) {
        return Math.tan(d3);
    }

    @SinceKotlin(version = "1.2")
    @InlineOnly
    private static final double tanh(double d3) {
        return Math.tanh(d3);
    }
    ...
    @SinceKotlin(version = "1.2")
    @InlineOnly
    private static final double withSign(double d3, double d4) {
    ...
    @SinceKotlin(version = "1.2")
    @InlineOnly
    private static final double pow(double d3, int i2) {
        return Math.pow(d3, i2);
    }
    ...
    @SinceKotlin(version = "1.2")
    @InlineOnly
    private static final double withSign(double d3, int i2) {
        return Math.copySign(d3, i2);
    }
