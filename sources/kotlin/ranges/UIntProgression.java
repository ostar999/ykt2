...
public class UIntProgression implements Iterable<UInt>, KMappedMarker {
    ...
    public static final class Companion {
        ...
        public final UIntProgression m2030fromClosedRangeNkh28Cs(int rangeStart, int rangeEnd, int step) {
    ...
    private UIntProgression(int i2, int i3, int i4) {
        ...
        this.first = i2;
        this.last = UProgressionUtilKt.m2014getProgressionLastElementNkh28Cs(i2, i3, i4);
        this.step = i4;
    }
    ...
    public String toString() {
        ...
        if (this.step > 0) {
            ...
            sb.append((Object) UInt.m924toStringimpl(this.first));
            sb.append(StrPool.DOUBLE_DOT);
            sb.append((Object) UInt.m924toStringimpl(this.last));
            sb.append(" step ");
            i2 = this.step;
        } else {
            sb = new StringBuilder();
