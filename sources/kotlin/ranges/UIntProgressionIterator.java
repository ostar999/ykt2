...
final class UIntProgressionIterator implements Iterator<UInt>, KMappedMarker {
    ...
    private UIntProgressionIterator(int i2, int i3, int i4) {
        ...
        boolean z2 = true;
        if (i4 <= 0 ? Integer.compare(i2 ^ Integer.MIN_VALUE, i3 ^ Integer.MIN_VALUE) < 0 : Integer.compare(i2 ^ Integer.MIN_VALUE, i3 ^ Integer.MIN_VALUE) > 0) {
            z2 = false;
        }
        this.hasNext = z2;
        this.step = UInt.m878constructorimpl(i4);
    ...
    public /* bridge */ /* synthetic */ UInt next() {
        return UInt.m872boximpl(m2031nextpVg5ArA());
    }

    /* renamed from: next-pVg5ArA, reason: not valid java name */
    public int m2031nextpVg5ArA() {
        int i2 = this.next;
        if (i2 != this.finalElement) {
            this.next = UInt.m878constructorimpl(this.step + i2);
        } else {
            if (!this.hasNext) {
