...
public final class ReflectJvmMapping {
    ...
    public static final <T> Constructor<T> getJavaConstructor(@NotNull KFunction<? extends T> kFunction) {
        ...
        Member memberMo2078getMember = (kCallableImplAsKCallableImpl == null || (caller = kCallableImplAsKCallableImpl.getCaller()) == null) ? null : caller.mo2078getMember();
        if (memberMo2078getMember instanceof Constructor) {
            return (Constructor) memberMo2078getMember;
        }
        return null;
    }
    ...
    public static final Method getJavaMethod(@NotNull KFunction<?> kFunction) {
        ...
        KCallableImpl<?> kCallableImplAsKCallableImpl = UtilKt.asKCallableImpl(kFunction);
        Member memberMo2078getMember = (kCallableImplAsKCallableImpl == null || (caller = kCallableImplAsKCallableImpl.getCaller()) == null) ? null : caller.mo2078getMember();
        if (memberMo2078getMember instanceof Method) {
            return (Method) memberMo2078getMember;
        }
        return null;
    }
