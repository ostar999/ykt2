...
public final class KTypesJvm {
    ...
    public static final KClass<?> getJvmErasure(@NotNull KClassifier kClassifier) {
        ...
        while (true) {
            ...
            ClassifierDescriptor classifierDescriptorMo2086getDeclarationDescriptor = ((KTypeImpl) kType).getType().getConstructor().mo2086getDeclarationDescriptor();
            classDescriptor = classifierDescriptorMo2086getDeclarationDescriptor instanceof ClassDescriptor ? (ClassDescriptor) classifierDescriptorMo2086getDeclarationDescriptor : null;
