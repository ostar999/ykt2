...
public abstract class KDeclarationContainerImpl implements ClassBasedDeclarationContainer {
    ...
    private final List<Class<?>> loadParameterTypes(String desc) {
        ...
        while (desc.charAt(i2) != ')') {
            ...
            if (StringsKt__StringsKt.contains$default((CharSequence) "VZCBSIFJD", cCharAt, false, 2, (Object) null)) {
                iIndexOf$default = i3 + 1;
            } else {
                if (cCharAt != 'L') {
                    throw new KotlinReflectionInternalError("Unknown type prefix in the method signature: " + desc);
                }
                iIndexOf$default = StringsKt__StringsKt.indexOf$default((CharSequence) desc, ';', i2, false, 4, (Object) null) + 1;
            }
            arrayList.add(parseType(desc, i2, iIndexOf$default));
            i2 = iIndexOf$default;
        }
        return arrayList;
    }
    ...
    private final Method lookupMethod(Class<?> cls, String str, Class<?>[] clsArr, Class<?> cls2, boolean z2) throws NoSuchMethodException, SecurityException {
        ...
        for (Class<?> superInterface : interfaces) {
            ...
            Method methodLookupMethod2 = lookupMethod(superInterface, str, clsArr, cls2, z2);
    ...
    @NotNull
    public final FunctionDescriptor findFunctionDescriptor(@NotNull String name, @NotNull String signature) throws IOException {
        List functions;
        Intrinsics.checkNotNullParameter(name, "name");
    ...
    @NotNull
    public final PropertyDescriptor findPropertyDescriptor(@NotNull String name, @NotNull String signature) throws IOException {
        Intrinsics.checkNotNullParameter(name, "name");
        Intrinsics.checkNotNullParameter(signature, "signature");
