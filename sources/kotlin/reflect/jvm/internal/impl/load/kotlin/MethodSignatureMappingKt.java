...
public final class MethodSignatureMappingKt {
    ...
    @NotNull
    public static final String computeJvmDescriptor(@NotNull FunctionDescriptor functionDescriptor, boolean z2, boolean z3) {
        String strAsString;
    ...
    public static final boolean forceSingleValueParameterBoxing(@NotNull CallableDescriptor f2) {
        ...
        if (!Intrinsics.areEqual(functionDescriptor.getName().asString(), PLVRemoveMicSiteEvent.EVENT_NAME) || functionDescriptor.getValueParameters().size() != 1 || SpecialBuiltinMembers.isFromJavaOrBuiltins((CallableMemberDescriptor) f2)) {
            return false;
        }
