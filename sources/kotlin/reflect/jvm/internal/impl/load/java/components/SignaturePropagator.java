...
public interface SignaturePropagator {
    ...
    public static class PropagatedSignature {
        ...
        public PropagatedSignature(@NotNull KotlinType kotlinType, @Nullable KotlinType kotlinType2, @NotNull List<ValueParameterDescriptor> list, @NotNull List<TypeParameterDescriptor> list2, @NotNull List<String> list3, boolean z2) {
            if (kotlinType == null) {
                $$$reportNull$$$0(0);
            }
            if (list == null) {
