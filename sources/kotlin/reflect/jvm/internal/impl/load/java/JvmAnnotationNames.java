...
public final class JvmAnnotationNames {
    ...
    static {
        ...
        METADATA_DESC = "L" + JvmClassName.byFqNameWithoutInnerClasses(fqName).getInternalName() + h.f3376b;
        ...
        SERIALIZED_IR_DESC = "L" + JvmClassName.byFqNameWithoutInnerClasses(fqName2).getInternalName() + h.f3376b;
