...
public final class ClassId {
    ...
    */
    ...
    public FqName asSingleFqName() {
        ...
        return new FqName(this.packageFqName.asString() + StrPool.DOT + this.relativeClassName.asString());
    }
    ...
    @NotNull
    public static ClassId fromString(@NotNull String str, boolean z2) {
        String str2;
        if (str == null) {
            $$$reportNull$$$0(12);
        }
