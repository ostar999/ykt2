...
public final class JvmBuiltInsCustomizer implements AdditionalClassPartsProvider, PlatformDependentDeclarationFilter {
        ...
        for (Object obj : collectionInvoke) {
            ...
            if (simpleFunctionDescriptor.getKind() == CallableMemberDescriptor.Kind.DECLARATION && simpleFunctionDescriptor.getVisibility().isPublicAPI() && !KotlinBuiltIns.isDeprecated(simpleFunctionDescriptor)) {
                ...
                if ((collection instanceof Collection) && collection.isEmpty()) {
                    ...
                    z2 = false;
                    if (!z2 && !isMutabilityViolation(simpleFunctionDescriptor, zIsMutable)) {
                        z3 = true;
                    }
                }
            }
    ...
    public static final Iterable getJdkMethodStatus$lambda$9(JvmBuiltInsCustomizer this$0, ClassDescriptor classDescriptor) {
        ...
        Intrinsics.checkNotNullExpressionValue(collectionMo2087getSupertypes, "it.typeConstructor.supertypes");
        ArrayList arrayList = new ArrayList();
        Iterator<T> it = collectionMo2087getSupertypes.iterator();
        while (it.hasNext()) {
            ClassifierDescriptor classifierDescriptorMo2086getDeclarationDescriptor = ((KotlinType) it.next()).getConstructor().mo2086getDeclarationDescriptor();
            ClassifierDescriptor original = classifierDescriptorMo2086getDeclarationDescriptor != null ? classifierDescriptorMo2086getDeclarationDescriptor.getOriginal() : null;
            ...
            */
            public final java.lang.Boolean invoke(kotlin.reflect.jvm.internal.impl.descriptors.CallableMemberDescriptor r3) {
                ...
                L22:
                    ...
                    return r3
                */
                throw new UnsupportedOperationException("Method not decompiled: kotlin.reflect.jvm.internal.impl.builtins.jvm.JvmBuiltInsCustomizer.C11652.invoke(kotlin.reflect.jvm.internal.impl.descriptors.CallableMemberDescriptor):java.lang.Boolean");
            }
        });
    ...
    private final boolean isTrivialCopyConstructorFor(ConstructorDescriptor constructorDescriptor, ClassDescriptor classDescriptor) {
        if (constructorDescriptor.getValueParameters().size() == 1) {
            ...
            ClassifierDescriptor classifierDescriptorMo2086getDeclarationDescriptor = ((ValueParameterDescriptor) CollectionsKt___CollectionsKt.single((List) valueParameters)).getType().getConstructor().mo2086getDeclarationDescriptor();
            if (Intrinsics.areEqual(classifierDescriptorMo2086getDeclarationDescriptor != null ? DescriptorUtilsKt.getFqNameUnsafe(classifierDescriptorMo2086getDeclarationDescriptor) : null, DescriptorUtilsKt.getFqNameUnsafe(classDescriptor))) {
                return true;
            }
        }
        return false;
    ...
    public Collection<SimpleFunctionDescriptor> getFunctions(@NotNull final Name name, @NotNull ClassDescriptor classDescriptor) {
        ...
        if (Intrinsics.areEqual(name, CloneableClassScope.Companion.getCLONE_NAME()) && (classDescriptor instanceof DeserializedClassDescriptor) && KotlinBuiltIns.isArrayOrPrimitiveArray(classDescriptor)) {
            ...
            return z2 ? CollectionsKt__CollectionsKt.emptyList() : CollectionsKt__CollectionsJVMKt.listOf(createCloneForArray(deserializedClassDescriptor, (SimpleFunctionDescriptor) CollectionsKt___CollectionsKt.single(getCloneableType().getMemberScope().getContributedFunctions(name, NoLookupLocation.FROM_BUILTINS))));
        }
