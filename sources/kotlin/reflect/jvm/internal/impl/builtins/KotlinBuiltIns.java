...
public abstract class KotlinBuiltIns {
    ...
    public KotlinBuiltIns(@NotNull StorageManager storageManager) {
        ...
        this.builtInClassesByName = storageManager.createMemoizedFunction(new Function1<Name, ClassDescriptor>() { // from class: kotlin.reflect.jvm.internal.impl.builtins.KotlinBuiltIns.3
            ...
            public ClassDescriptor invoke(Name name) {
                ClassifierDescriptor classifierDescriptorMo2088getContributedClassifier = KotlinBuiltIns.this.getBuiltInsPackageScope().mo2088getContributedClassifier(name, NoLookupLocation.FROM_BUILTINS);
                ...
                throw new AssertionError("Must be a class descriptor " + name + ", but was " + classifierDescriptorMo2088getContributedClassifier);
            }
        });
    }
    ...
    private static KotlinType getElementTypeForUnsignedArray(@NotNull KotlinType kotlinType, @NotNull ModuleDescriptor moduleDescriptor) {
        ...
        if (!unsignedTypes.isShortNameOfUnsignedArray(classifierDescriptorMo2086getDeclarationDescriptor.getName()) || (classId = DescriptorUtilsKt.getClassId(classifierDescriptorMo2086getDeclarationDescriptor)) == null || (unsignedClassIdByArrayClassId = unsignedTypes.getUnsignedClassIdByArrayClassId(classId)) == null || (classDescriptorFindClassAcrossModuleDependencies = FindClassInModuleKt.findClassAcrossModuleDependencies(moduleDescriptor, unsignedClassIdByArrayClassId)) == null) {
            return null;
        }
    ...
    public static PrimitiveType getPrimitiveArrayElementType(@NotNull KotlinType kotlinType) {
        ...
        return getPrimitiveArrayType(classifierDescriptorMo2086getDeclarationDescriptor);
    }
    ...
    public static boolean isPrimitiveArray(@NotNull KotlinType kotlinType) {
        ...
        ClassifierDescriptor classifierDescriptorMo2086getDeclarationDescriptor = kotlinType.getConstructor().mo2086getDeclarationDescriptor();
        return (classifierDescriptorMo2086getDeclarationDescriptor == null || getPrimitiveArrayType(classifierDescriptorMo2086getDeclarationDescriptor) == null) ? false : true;
    }
    ...
    public static boolean isPrimitiveTypeOrNullablePrimitiveType(@NotNull KotlinType kotlinType) {
        ...
        ClassifierDescriptor classifierDescriptorMo2086getDeclarationDescriptor = kotlinType.getConstructor().mo2086getDeclarationDescriptor();
        return (classifierDescriptorMo2086getDeclarationDescriptor instanceof ClassDescriptor) && isPrimitiveClass((ClassDescriptor) classifierDescriptorMo2086getDeclarationDescriptor);
    }
    ...
    public static boolean isTypeConstructorForGivenClass(@NotNull TypeConstructor typeConstructor, @NotNull FqNameUnsafe fqNameUnsafe) {
        ...
        return (classifierDescriptorMo2086getDeclarationDescriptor instanceof ClassDescriptor) && classFqNameEquals(classifierDescriptorMo2086getDeclarationDescriptor, fqNameUnsafe);
    }
