...
public abstract class ReflectJavaMember extends ReflectJavaElement implements ReflectJavaAnnotationOwner, ReflectJavaModifierListOwner, JavaMember {
    ...
    @NotNull
    public final List<JavaValueParameter> getValueParameters(@NotNull Type[] parameterTypes, @NotNull Annotation[][] parameterAnnotations, boolean z2) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
        String str;
        ...
        while (i2 < length) {
            ...
            if (listLoadParameterNames != null) {
                str = (String) CollectionsKt___CollectionsKt.getOrNull(listLoadParameterNames, i2 + size);
                if (str == null) {
            ...
            arrayList.add(new ReflectJavaValueParameter(reflectJavaTypeCreate, parameterAnnotations[i2], str, z2 && i2 == ArraysKt___ArraysKt.getLastIndex(parameterTypes)));
            i2++;
        }
        return arrayList;
    }
