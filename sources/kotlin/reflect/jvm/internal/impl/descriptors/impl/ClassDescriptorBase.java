...
public abstract class ClassDescriptorBase extends AbstractClassDescriptor {
    ...
    public ClassDescriptorBase(@NotNull StorageManager storageManager, @NotNull DeclarationDescriptor declarationDescriptor, @NotNull Name name, @NotNull SourceElement sourceElement, boolean z2) {
