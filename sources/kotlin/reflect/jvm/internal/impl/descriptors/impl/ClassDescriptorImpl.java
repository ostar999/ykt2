...
public class ClassDescriptorImpl extends ClassDescriptorBase {
    ...
    public ClassDescriptorImpl(@NotNull DeclarationDescriptor declarationDescriptor, @NotNull Name name, @NotNull Modality modality, @NotNull ClassKind classKind, @NotNull Collection<KotlinType> collection, @NotNull SourceElement sourceElement, boolean z2, @NotNull StorageManager storageManager) {
