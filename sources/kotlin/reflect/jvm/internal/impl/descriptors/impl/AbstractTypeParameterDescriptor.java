...
public abstract class AbstractTypeParameterDescriptor extends DeclarationDescriptorNonRootImpl implements TypeParameterDescriptor {
    ...
    public class TypeParameterTypeConstructor extends AbstractTypeConstructor {
        ...
        public void reportSupertypeLoopError(@NotNull KotlinType kotlinType) {
            ...
            this.this$0.mo2089reportSupertypeLoopError(kotlinType);
        }
    ...
    public List<KotlinType> getUpperBounds() {
        List<KotlinType> listMo2087getSupertypes = ((TypeParameterTypeConstructor) getTypeConstructor()).mo2087getSupertypes();
        if (listMo2087getSupertypes == null) {
            $$$reportNull$$$0(8);
        }
        return listMo2087getSupertypes;
    }
    ...
    public abstract void mo2089reportSupertypeLoopError(@NotNull KotlinType kotlinType);
