...
public final class DescriptorUtilKt {
    ...
    public static final ClassDescriptor resolveClassByFqName(@NotNull ModuleDescriptor moduleDescriptor, @NotNull FqName fqName, @NotNull LookupLocation lookupLocation) {
        ...
        ClassifierDescriptor classifierDescriptorMo2088getContributedClassifier2 = memberScope.mo2088getContributedClassifier(nameShortName, lookupLocation);
        ClassDescriptor classDescriptor = classifierDescriptorMo2088getContributedClassifier2 instanceof ClassDescriptor ? (ClassDescriptor) classifierDescriptorMo2088getContributedClassifier2 : null;
        if (classDescriptor != null) {
        ...
        if (classDescriptorResolveClassByFqName == null || (unsubstitutedInnerClassesScope = classDescriptorResolveClassByFqName.getUnsubstitutedInnerClassesScope()) == null) {
            classifierDescriptorMo2088getContributedClassifier = null;
        } else {
            Name nameShortName2 = fqName.shortName();
            Intrinsics.checkNotNullExpressionValue(nameShortName2, "fqName.shortName()");
            classifierDescriptorMo2088getContributedClassifier = unsubstitutedInnerClassesScope.mo2088getContributedClassifier(nameShortName2, lookupLocation);
        }
