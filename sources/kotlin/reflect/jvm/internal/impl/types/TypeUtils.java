    ...
    */
    ...
    public static ClassDescriptor getClassDescriptor(@NotNull KotlinType kotlinType) {
        ...
        if (classifierDescriptorMo2086getDeclarationDescriptor instanceof ClassDescriptor) {
            return (ClassDescriptor) classifierDescriptorMo2086getDeclarationDescriptor;
        }
        return null;
    }
    ...
    public static List<KotlinType> getImmediateSupertypes(@NotNull KotlinType kotlinType) {
        ...
        Collection<KotlinType> collectionMo2087getSupertypes = kotlinType.getConstructor().mo2087getSupertypes();
        ArrayList arrayList = new ArrayList(collectionMo2087getSupertypes.size());
        Iterator<KotlinType> it = collectionMo2087getSupertypes.iterator();
        while (it.hasNext()) {
    ...
    public static TypeParameterDescriptor getTypeParameterDescriptorOrNull(@NotNull KotlinType kotlinType) {
        ...
        if (kotlinType.getConstructor().mo2086getDeclarationDescriptor() instanceof TypeParameterDescriptor) {
            return (TypeParameterDescriptor) kotlinType.getConstructor().mo2086getDeclarationDescriptor();
        }
        return null;
    }
    ...
    public static boolean hasNullableSuperType(@NotNull KotlinType kotlinType) {
        ...
        if (kotlinType.getConstructor().mo2086getDeclarationDescriptor() instanceof ClassDescriptor) {
            return false;
        }
    ...
    public static boolean isNullableType(@NotNull KotlinType kotlinType) {
        ...
        if (constructor instanceof IntersectionTypeConstructor) {
            Iterator<KotlinType> it = constructor.mo2087getSupertypes().iterator();
            while (it.hasNext()) {
                if (isNullableType(it.next())) {
                    return true;
                }
    ...
    @NotNull
    public static KotlinType makeNullableAsSpecified(@NotNull KotlinType kotlinType, boolean z2) {
        if (kotlinType == null) {
            $$$reportNull$$$0(3);
        }
    ...
    @NotNull
    public static SimpleType makeNullableIfNeeded(@NotNull SimpleType simpleType, boolean z2) {
        if (simpleType == null) {
            $$$reportNull$$$0(5);
        }
        if (!z2) {
    ...
    private static boolean contains(@Nullable KotlinType kotlinType, @NotNull Function1<UnwrappedType, Boolean> function1, SmartSet<KotlinType> smartSet) {
        ...
        TypeConstructor constructor = kotlinType.getConstructor();
        if (constructor instanceof IntersectionTypeConstructor) {
            Iterator<KotlinType> it = ((IntersectionTypeConstructor) constructor).mo2087getSupertypes().iterator();
            while (it.hasNext()) {
    ...
    @NotNull
    public static KotlinType makeNullableIfNeeded(@NotNull KotlinType kotlinType, boolean z2) {
        if (kotlinType == null) {
            $$$reportNull$$$0(8);
        }
        if (z2) {
