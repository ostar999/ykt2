...
public final class NewKotlinTypeCheckerImpl implements NewKotlinTypeChecker {
    ...
    public boolean equalTypes(@NotNull KotlinType a3, @NotNull KotlinType b3) {
        Intrinsics.checkNotNullParameter(a3, "a");
        Intrinsics.checkNotNullParameter(b3, "b");
        return equalTypes(ClassicTypeCheckerStateKt.createClassicTypeCheckerState$default(false, false, null, getKotlinTypePreparator(), getKotlinTypeRefiner(), 6, null), a3.unwrap(), b3.unwrap());
    }
    ...
    public final boolean equalTypes(@NotNull TypeCheckerState typeCheckerState, @NotNull UnwrappedType a3, @NotNull UnwrappedType b3) {
        Intrinsics.checkNotNullParameter(typeCheckerState, "<this>");
        Intrinsics.checkNotNullParameter(a3, "a");
        Intrinsics.checkNotNullParameter(b3, "b");
        return AbstractTypeChecker.INSTANCE.equalTypes(typeCheckerState, a3, b3);
    }
