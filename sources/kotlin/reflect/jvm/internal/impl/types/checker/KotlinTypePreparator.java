...
public abstract class KotlinTypePreparator extends AbstractTypePreparator {
    ...
    public /* synthetic */ class AnonymousClass1 extends FunctionReference implements Function1<KotlinTypeMarker, UnwrappedType> {
        ...
        @NotNull
        public final UnwrappedType invoke(@NotNull KotlinTypeMarker p02) {
    ...
    private final SimpleType transformToNewType(SimpleType simpleType) {
        ...
        if (constructor instanceof CapturedTypeConstructorImpl) {
            ...
            if (capturedTypeConstructorImpl.getNewTypeConstructor() == null) {
                ...
                Collection<KotlinType> collectionMo2087getSupertypes = capturedTypeConstructorImpl.mo2087getSupertypes();
        ...
        if (constructor instanceof IntegerValueTypeConstructor) {
            Collection<KotlinType> collectionMo2087getSupertypes2 = ((IntegerValueTypeConstructor) constructor).mo2087getSupertypes();
            ArrayList arrayList2 = new ArrayList(CollectionsKt__IterablesKt.collectionSizeOrDefault(collectionMo2087getSupertypes2, 10));
            Iterator<T> it2 = collectionMo2087getSupertypes2.iterator();
            while (it2.hasNext()) {
        ...
        Collection<KotlinType> collectionMo2087getSupertypes3 = intersectionTypeConstructor.mo2087getSupertypes();
        ArrayList arrayList3 = new ArrayList(CollectionsKt__IterablesKt.collectionSizeOrDefault(collectionMo2087getSupertypes3, 10));
        Iterator<T> it3 = collectionMo2087getSupertypes3.iterator();
        while (it3.hasNext()) {
