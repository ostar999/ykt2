...
public abstract class AbstractClassTypeConstructor extends AbstractTypeConstructor implements TypeConstructor {
    ...
    */
    ...
    public KotlinType defaultSupertypeIfEmpty() {
        if (KotlinBuiltIns.isSpecialClassWithNoSupertypes(mo2086getDeclarationDescriptor())) {
            return null;
        }
    ...
    public Collection<KotlinType> getAdditionalNeighboursInSupertypeGraph(boolean z2) {
        DeclarationDescriptor containingDeclaration = mo2086getDeclarationDescriptor().getContainingDeclaration();
        ...
        ClassDescriptor classDescriptorMo2079getCompanionObjectDescriptor = classDescriptor.mo2079getCompanionObjectDescriptor();
        if (z2 && classDescriptorMo2079getCompanionObjectDescriptor != null) {
            smartList.add(classDescriptorMo2079getCompanionObjectDescriptor.getDefaultType());
        }
        return smartList;
    }
    ...
    public KotlinBuiltIns getBuiltIns() {
        KotlinBuiltIns builtIns = DescriptorUtilsKt.getBuiltIns(mo2086getDeclarationDescriptor());
        if (builtIns == null) {
            $$$reportNull$$$0(1);
        }
        return builtIns;
    ...
    public abstract ClassDescriptor mo2086getDeclarationDescriptor();
    ...
    public boolean isSameClassifier(@NotNull ClassifierDescriptor classifierDescriptor) {
        ...
        return (classifierDescriptor instanceof ClassDescriptor) && areFqNamesEqual(mo2086getDeclarationDescriptor(), classifierDescriptor);
    }
}
