...
public class OverridingUtil {
    ...
    public static class OverrideCompatibilityInfo {
        private static final OverrideCompatibilityInfo SUCCESS = new OverrideCompatibilityInfo(Result.OVERRIDABLE, c.f3449g);
    ...
    */
    ...
    @NotNull
    public static <D> Set<D> filterOverrides(@NotNull Set<D> set, boolean z2, @Nullable Function0<?> function0, @NotNull Function2<? super D, ? super D, Pair<CallableDescriptor, CallableDescriptor>> function2) {
        if (set == null) {
            $$$reportNull$$$0(9);
        }
        if (function2 == null) {
    ...
    @NotNull
    private static Modality getMinimalModality(@NotNull Collection<CallableMemberDescriptor> collection, boolean z2, @NotNull Modality modality) {
        if (collection == null) {
            $$$reportNull$$$0(93);
        }
        if (modality == null) {
    ...
    public static boolean isVisibleForOverride(@NotNull MemberDescriptor memberDescriptor, @NotNull MemberDescriptor memberDescriptor2, boolean z2) {
    ...
    public static <D extends CallableDescriptor> boolean overrides(@NotNull D d3, @NotNull D d4, boolean z2, boolean z3) {
        if (d3 == null) {
            $$$reportNull$$$0(13);
        }
        if (d4 == null) {
        ...
        if (!d3.equals(d4) && DescriptorEquivalenceForOverrides.INSTANCE.areEquivalent(d3.getOriginal(), d4.getOriginal(), z2, z3)) {
            return true;
        }
    ...
    public static <H> H selectMostSpecificMember(@NotNull Collection<H> collection, @NotNull Function1<H, CallableDescriptor> function1) {
        ...
        H h4 = (H) CollectionsKt___CollectionsKt.first(collection);
    ...
    @NotNull
    public OverrideCompatibilityInfo isOverridableByWithoutExternalConditions(@NotNull CallableDescriptor callableDescriptor, @NotNull CallableDescriptor callableDescriptor2, boolean z2) {
        if (callableDescriptor == null) {
            $$$reportNull$$$0(30);
        }
        if (callableDescriptor2 == null) {
        ...
        for (int i4 = 0; i4 < listCompiledValueParameters.size(); i4++) {
            if (!areTypesEquivalent(listCompiledValueParameters.get(i4), listCompiledValueParameters2.get(i4), typeCheckerStateCreateTypeCheckerState)) {
        ...
        if (z2) {
            ...
            if (returnType != null && returnType2 != null) {
                ...
                if (i2 == 0 && !AbstractTypeChecker.INSTANCE.isSubtypeOf(typeCheckerStateCreateTypeCheckerState, returnType2.unwrap(), returnType.unwrap())) {
    ...
    @NotNull
    public OverrideCompatibilityInfo isOverridableBy(@NotNull CallableDescriptor callableDescriptor, @NotNull CallableDescriptor callableDescriptor2, @Nullable ClassDescriptor classDescriptor, boolean z2) {
        if (callableDescriptor == null) {
            $$$reportNull$$$0(22);
        }
        if (callableDescriptor2 == null) {
