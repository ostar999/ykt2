...
public final class InnerClassesScopeWrapper extends MemberScopeImpl {
    ...
    public ClassifierDescriptor mo2088getContributedClassifier(@NotNull Name name, @NotNull LookupLocation location) {
        ...
        ClassifierDescriptor classifierDescriptorMo2088getContributedClassifier = this.workerScope.mo2088getContributedClassifier(name, location);
        ...
        if (classifierDescriptorMo2088getContributedClassifier instanceof TypeAliasDescriptor) {
            return (TypeAliasDescriptor) classifierDescriptorMo2088getContributedClassifier;
        }
        return null;
    }
    ...
    public void mo2092recordLookup(@NotNull Name name, @NotNull LookupLocation location) {
        Intrinsics.checkNotNullParameter(name, "name");
        Intrinsics.checkNotNullParameter(location, "location");
        this.workerScope.mo2092recordLookup(name, location);
    }
