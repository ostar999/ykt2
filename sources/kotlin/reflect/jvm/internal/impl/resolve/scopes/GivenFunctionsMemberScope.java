...
public abstract class GivenFunctionsMemberScope extends MemberScopeImpl {
    ...
    public final List<DeclarationDescriptor> createFakeOverrides(List<? extends FunctionDescriptor> list) {
        ...
        Collection<KotlinType> collectionMo2087getSupertypes = this.containingClass.getTypeConstructor().mo2087getSupertypes();
        Intrinsics.checkNotNullExpressionValue(collectionMo2087getSupertypes, "containingClass.typeConstructor.supertypes");
