...
public class DescriptorUtils {
    ...
    public static ClassDescriptor getClassDescriptorForTypeConstructor(@NotNull TypeConstructor typeConstructor) {
        ...
        ClassDescriptor classDescriptor = (ClassDescriptor) typeConstructor.mo2086getDeclarationDescriptor();
    ...
    public static ModuleDescriptor getContainingModuleOrNull(@NotNull KotlinType kotlinType) {
        ...
        return getContainingModuleOrNull(classifierDescriptorMo2086getDeclarationDescriptor);
    }
    ...
    @NotNull
    public static DescriptorVisibility getDefaultConstructorVisibility(@NotNull ClassDescriptor classDescriptor, boolean z2) {
        if (classDescriptor == null) {
            $$$reportNull$$$0(48);
        }
    ...
    public static ClassDescriptor getSuperClassDescriptor(@NotNull ClassDescriptor classDescriptor) {
        ...
        Iterator<KotlinType> it = classDescriptor.getTypeConstructor().mo2087getSupertypes().iterator();
        while (it.hasNext()) {
    ...
    private static boolean isSameClass(@NotNull KotlinType kotlinType, @NotNull DeclarationDescriptor declarationDescriptor) {
        ...
        DeclarationDescriptor original = classifierDescriptorMo2086getDeclarationDescriptor.getOriginal();
    ...
    public static boolean isSubtypeOfClass(@NotNull KotlinType kotlinType, @NotNull DeclarationDescriptor declarationDescriptor) {
        ...
        Iterator<KotlinType> it = kotlinType.getConstructor().mo2087getSupertypes().iterator();
        while (it.hasNext()) {
    ...
    @Nullable
    public static <D extends DeclarationDescriptor> D getParentOfType(@Nullable DeclarationDescriptor declarationDescriptor, @NotNull Class<D> cls, boolean z2) {
        if (cls == null) {
            $$$reportNull$$$0(19);
        }
        if (declarationDescriptor == null) {
