        ...
        public Data() {
            ...
            this.objectInstance = ReflectProperties.lazy(new Function0<T>(this) { // from class: kotlin.reflect.jvm.internal.KClassImpl$Data$objectInstance$2
                ...
                public final T invoke() {
                    ...
                    T t2 = (T) ((!descriptor.isCompanionObject() || CompanionObjectMappingUtilsKt.isMappedIntrinsicCompanionObject(CompanionObjectMapping.INSTANCE, descriptor)) ? kClassImpl.getJClass().getDeclaredField("INSTANCE") : kClassImpl.getJClass().getEnclosingClass().getDeclaredField(descriptor.getName().asString())).get(null);
            ...
            this.supertypes = ReflectProperties.lazySoft(new Function0<List<? extends KTypeImpl>>(this) { // from class: kotlin.reflect.jvm.internal.KClassImpl$Data$supertypes$2
                ...
                public final List<? extends KTypeImpl> invoke() {
                    Collection<KotlinType> collectionMo2087getSupertypes = this.this$0.getDescriptor().getTypeConstructor().mo2087getSupertypes();
                    Intrinsics.checkNotNullExpressionValue(collectionMo2087getSupertypes, "descriptor.typeConstructor.supertypes");
                    ArrayList arrayList = new ArrayList(collectionMo2087getSupertypes.size());
                    final KClassImpl<T>.Data data = this.this$0;
                    final KClassImpl<T> kClassImpl = kClassImpl;
                    for (final KotlinType kotlinType : collectionMo2087getSupertypes) {
                        ...
                        arrayList.add(new KTypeImpl(kotlinType, new Function0<Type>() { // from class: kotlin.reflect.jvm.internal.KClassImpl$Data$supertypes$2$1$1
                            ...
                            public final Type invoke() {
                                ...
                                if (!(classifierDescriptorMo2086getDeclarationDescriptor instanceof ClassDescriptor)) {
                                    throw new KotlinReflectionInternalError("Supertype not a class: " + classifierDescriptorMo2086getDeclarationDescriptor);
                                }
                                Class<?> javaClass = UtilKt.toJavaClass((ClassDescriptor) classifierDescriptorMo2086getDeclarationDescriptor);
                                if (javaClass == null) {
                                    throw new KotlinReflectionInternalError("Unsupported superclass of " + data + ": " + classifierDescriptorMo2086getDeclarationDescriptor);
                                }
                                ...
                                throw new KotlinReflectionInternalError("No superclass of " + data + " in Java reflection for " + classifierDescriptorMo2086getDeclarationDescriptor);
                            }
                        }));
                    }
