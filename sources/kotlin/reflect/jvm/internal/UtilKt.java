    ...
    */
    ...
    private static final Object toRuntimeValue(ConstantValue<?> constantValue, ClassLoader classLoader) {
        ...
        if (constantValue instanceof EnumValue) {
            ...
            ClassifierDescriptor classifierDescriptorMo2086getDeclarationDescriptor = ((KClassValue.Value.LocalClass) value2).getType().getConstructor().mo2086getDeclarationDescriptor();
    ...
    private static final Class<?> loadClass(ClassLoader classLoader, String str, String str2, int i2) {
        ...
        sb.append(StringsKt__StringsJVMKt.replace$default(str2, '.', Typography.dollar, false, 4, (Object) null));
        if (i2 > 0) {
            sb.append(h.f3376b);
        }
