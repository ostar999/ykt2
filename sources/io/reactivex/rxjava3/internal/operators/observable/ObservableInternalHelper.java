...
public final class ObservableInternalHelper {
    ...
    public static final class FlatMapWithCombinerInner<U, R, T> implements Function<U, R> {
        ...
        public R apply(U u2) throws Throwable {
            return this.combiner.apply(this.f27358t, u2);
        }
    }
    ...
    public static final class FlatMapWithCombinerOuter<T, R, U> implements Function<T, ObservableSource<R>> {
        ...
        @Override // io.reactivex.rxjava3.functions.Function
        public ObservableSource<R> apply(final T t2) throws Throwable {
            ...
            return new ObservableMap(observableSourceApply, new FlatMapWithCombinerInner(this.combiner, t2));
        }
    }
    ...
    public static final class ItemDelayFunction<T, U> implements Function<T, ObservableSource<T>> {
        ...
        @Override // io.reactivex.rxjava3.functions.Function
        public ObservableSource<T> apply(final T v2) throws Throwable {
            ObservableSource<U> observableSourceApply = this.itemDelay.apply(v2);
            Objects.requireNonNull(observableSourceApply, "The itemDelay returned a null ObservableSource");
            return new ObservableTake(observableSourceApply, 1L).map(Functions.justFunction(v2)).defaultIfEmpty(v2);
        }
    }
