...
public final class FlowableConcatMapSingle<T, R> extends Flowable<R> {
        ...
        */
        public void drain() {
            ...
            L6c:
                r1.consumed = r10
            L6e:
                io.reactivex.rxjava3.functions.Function<? super T, ? extends io.reactivex.rxjava3.core.SingleSource<? extends R>> r10 = r1.mapper     // Catch: java.lang.Throwable -> L83
                ...
                io.reactivex.rxjava3.core.SingleSource r10 = (io.reactivex.rxjava3.core.SingleSource) r10     // Catch: java.lang.Throwable -> L83
                r1.state = r8
                io.reactivex.rxjava3.internal.operators.mixed.FlowableConcatMapSingle$ConcatMapSingleSubscriber$ConcatMapSingleObserver<R> r11 = r1.inner
                r10.subscribe(r11)
                goto Lc4
            L83:
                r0 = move-exception
    ...
    public void subscribeActual(Subscriber<? super R> s2) {
        this.source.subscribe((FlowableSubscriber) new ConcatMapSingleSubscriber(s2, this.mapper, this.prefetch, this.errorMode));
    }
}
