...
public final class FlowableRange extends Flowable<Integer> {
    ...
    public void subscribeActual(Subscriber<? super Integer> s2) {
        if (s2 instanceof ConditionalSubscriber) {
            s2.onSubscribe(new RangeConditionalSubscription((ConditionalSubscriber) s2, this.start, this.end));
        } else {
            s2.onSubscribe(new RangeSubscription(s2, this.start, this.end));
        }
    }
}
