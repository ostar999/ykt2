...
public final class PublishProcessor<T> extends FlowableProcessor<T> {
    ...
    public void onError(@NonNull Throwable t2) {
        ...
        this.error = t2;
        for (PublishSubscription<T> publishSubscription : this.subscribers.getAndSet(publishSubscriptionArr2)) {
            publishSubscription.onError(t2);
        }
    }
    ...
    public void subscribeActual(@NonNull Subscriber<? super T> t2) {
        PublishSubscription<T> publishSubscription = new PublishSubscription<>(t2, this);
        t2.onSubscribe(publishSubscription);
