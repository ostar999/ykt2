...
public abstract class Flowable<T> implements Publisher<T> {
    ...
    public <R> Flowable<R> switchMap0(Function<? super T, ? extends Publisher<? extends R>> function, int i2, boolean z2) {
        ObjectHelper.requireNonNull(function, "mapper is null");
        ObjectHelper.verifyPositive(i2, "bufferSize");
    ...
    public static <T> Flowable<T> just(T t2, T t3) {
        ObjectHelper.requireNonNull(t2, "The first item is null");
        ObjectHelper.requireNonNull(t3, "The second item is null");
    ...
    @CheckReturnValue
    @NonNull
    public final Flowable<T> subscribeOn(@NonNull Scheduler scheduler, boolean z2) {
        ObjectHelper.requireNonNull(scheduler, "scheduler is null");
    ...
    @BackpressureSupport(BackpressureKind.UNBOUNDED_IN)
    @CheckReturnValue
    public final T blockingFirst(T t2) throws InterruptedException {
        BlockingFirstSubscriber blockingFirstSubscriber = new BlockingFirstSubscriber();
        subscribe((FlowableSubscriber) blockingFirstSubscriber);
        T tBlockingGet = blockingFirstSubscriber.blockingGet();
    ...
    @BackpressureSupport(BackpressureKind.UNBOUNDED_IN)
    @CheckReturnValue
    public final T blockingLast(T t2) throws InterruptedException {
        BlockingLastSubscriber blockingLastSubscriber = new BlockingLastSubscriber();
        subscribe((FlowableSubscriber) blockingLastSubscriber);
        T tBlockingGet = blockingLastSubscriber.blockingGet();
        return tBlockingGet != null ? tBlockingGet : t2;
    ...
    public static <T> Flowable<T> just(T t2, T t3, T t4) {
        ObjectHelper.requireNonNull(t2, "The first item is null");
        ObjectHelper.requireNonNull(t3, "The second item is null");
        ObjectHelper.requireNonNull(t4, "The third item is null");
    ...
    public static <T> Flowable<T> just(T t2, T t3, T t4, T t5) {
        ...
        ObjectHelper.requireNonNull(t3, "The second item is null");
        ObjectHelper.requireNonNull(t4, "The third item is null");
        ObjectHelper.requireNonNull(t5, "The fourth item is null");
    ...
    public static <T> Flowable<T> just(T t2, T t3, T t4, T t5, T t6) {
        ...
        ObjectHelper.requireNonNull(t4, "The third item is null");
        ObjectHelper.requireNonNull(t5, "The fourth item is null");
        ObjectHelper.requireNonNull(t6, "The fifth item is null");
    ...
    public static <T> Flowable<T> just(T t2, T t3, T t4, T t5, T t6, T t7) {
        ...
        ObjectHelper.requireNonNull(t5, "The fourth item is null");
        ObjectHelper.requireNonNull(t6, "The fifth item is null");
        ObjectHelper.requireNonNull(t7, "The sixth item is null");
    ...
    public static <T> Flowable<T> just(T t2, T t3, T t4, T t5, T t6, T t7, T t8) {
        ...
        ObjectHelper.requireNonNull(t6, "The fifth item is null");
        ObjectHelper.requireNonNull(t7, "The sixth item is null");
        ObjectHelper.requireNonNull(t8, "The seventh item is null");
    ...
    public static <T> Flowable<T> just(T t2, T t3, T t4, T t5, T t6, T t7, T t8, T t9) {
        ...
        ObjectHelper.requireNonNull(t7, "The sixth item is null");
        ObjectHelper.requireNonNull(t8, "The seventh item is null");
        ObjectHelper.requireNonNull(t9, "The eighth item is null");
    ...
    public static <T> Flowable<T> just(T t2, T t3, T t4, T t5, T t6, T t7, T t8, T t9, T t10) {
        ...
        ObjectHelper.requireNonNull(t8, "The seventh item is null");
        ObjectHelper.requireNonNull(t9, "The eighth item is null");
        ObjectHelper.requireNonNull(t10, "The ninth is null");
    ...
    public static <T> Flowable<T> just(T t2, T t3, T t4, T t5, T t6, T t7, T t8, T t9, T t10, T t11) {
        ...
        ObjectHelper.requireNonNull(t8, "The seventh item is null");
        ObjectHelper.requireNonNull(t9, "The eighth item is null");
        ObjectHelper.requireNonNull(t10, "The ninth item is null");
        ObjectHelper.requireNonNull(t11, "The tenth item is null");
