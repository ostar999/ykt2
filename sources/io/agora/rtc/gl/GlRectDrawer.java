...
public class GlRectDrawer implements RendererCommon.GlDrawer {
    ...
    private float[] ComputePosVertexAttribArray(int bigWidth, int bigHeight, int smallWidth, int smallHeight) {
        float f2 = bigHeight == smallHeight ? -1.0f : (((bigHeight - smallHeight) * 2.0f) / bigHeight) - 1.0f;
        float f3 = bigWidth == smallWidth ? 1.0f : ((smallWidth * 2.0f) / bigWidth) - 1.0f;
    ...
    public void drawOes(int oesTextureId, float[] texMatrix, int srcWidth, int srcHeight, int x2, int y2, int dstWidth, int dstHeight, int dstWidth_ori, int dstHeight_ori) {
    ...
    public void drawRgb(int textureId, float[] texMatrix, int srcWidth, int srcHeight, int x2, int y2, int dstWidth, int dstHeight, int dstWidth_ori, int dstHeight_ori) {
