...
public class ZipArchiveEntry extends ZipEntry implements ArchiveEntry {
    ...
    private void mergeExtraFields(ZipExtraField[] zipExtraFieldArr, boolean z2) throws ZipException {
    ...
    private ZipExtraField[] copyOf(ZipExtraField[] zipExtraFieldArr, int i2) {
    ...
    public ZipExtraField[] getExtraFields(boolean z2) {
        return z2 ? getAllExtraFields() : getParseableExtraFields();
    }
