...
public class PKCS12ParametersGenerator extends PBEParametersGenerator {
    ...
    public PKCS12ParametersGenerator(Digest digest) {
        ...
        if (digest instanceof ExtendedDigest) {
            this.f27843u = digest.getDigestSize();
            this.f27844v = ((ExtendedDigest) digest).getByteLength();
        } else {
    ...
    private byte[] generateDerivedKey(int i2, int i3) {
        ...
        int i13 = this.f27844v;
        byte[] bArr10 = new byte[i13];
        int i14 = this.f27843u;
        int i15 = ((i3 + i14) - 1) / i14;
        int i16 = 1;
        while (i16 <= i15) {
            int i17 = this.f27843u;
            ...
            for (int i19 = i6; i19 != i13; i19++) {
                bArr10[i19] = bArr11[i19 % i17];
            }
            int i20 = i6;
            while (true) {
                int i21 = this.f27844v;
                if (i20 == length3 / i21) {
                    break;
                }
            ...
            if (i16 == i15) {
                ...
                i4 = 0;
                System.arraycopy(bArr11, 0, bArr4, (i16 - 1) * this.f27843u, i17);
            }
            i16++;
            i6 = i4;
            i8 = 1;
