...
public class PKCS8Generator implements PemObjectGenerator {
    ...
    public PemObject generate() throws PemGenerationException, InvalidKeyException, InvalidAlgorithmParameterException {
        ...
        if (PEMUtilities.isPKCS5Scheme2(dERObjectIdentifier)) {
            ...
            SecretKey secretKeyGenerateSecretKeyForPKCS5Scheme2 = PEMUtilities.generateSecretKeyForPKCS5Scheme2(this.algorithm, this.password, bArr, this.iterationCount);
            AlgorithmParameters algorithmParametersGenerateParameters = this.paramGen.generateParameters();
            try {
                this.cipher.init(1, secretKeyGenerateSecretKeyForPKCS5Scheme2, algorithmParametersGenerateParameters);
                EncryptionScheme encryptionScheme = new EncryptionScheme(new DERObjectIdentifier(this.algorithm), ASN1Object.fromByteArray(algorithmParametersGenerateParameters.getEncoded()));
        ...
        if (!PEMUtilities.isPKCS12(dERObjectIdentifier)) {
        ...
        try {
            this.cipher.init(1, this.secKeyFact.generateSecret(new PBEKeySpec(this.password)), new PBEParameterSpec(bArr2, this.iterationCount));
    ...
    public PKCS8Generator setIterationCount(int i2) {
