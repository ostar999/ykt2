...
public class PGPKeyRingGenerator {
    ...
    public PGPKeyRingGenerator(int i2, PGPKeyPair pGPKeyPair, String str, int i3, char[] cArr, PGPSignatureSubpacketVector pGPSignatureSubpacketVector, PGPSignatureSubpacketVector pGPSignatureSubpacketVector2, SecureRandom secureRandom, String str2) throws PGPException, NoSuchProviderException {
        this(i2, pGPKeyPair, str, i3, cArr, false, pGPSignatureSubpacketVector, pGPSignatureSubpacketVector2, secureRandom, str2);
    }

    public PGPKeyRingGenerator(int i2, PGPKeyPair pGPKeyPair, String str, int i3, char[] cArr, boolean z2, PGPSignatureSubpacketVector pGPSignatureSubpacketVector, PGPSignatureSubpacketVector pGPSignatureSubpacketVector2, SecureRandom secureRandom, String str2) throws PGPException, NoSuchProviderException {
    ...
    public PGPKeyRingGenerator(int i2, PGPKeyPair pGPKeyPair, String str, int i3, char[] cArr, boolean z2, PGPSignatureSubpacketVector pGPSignatureSubpacketVector, PGPSignatureSubpacketVector pGPSignatureSubpacketVector2, SecureRandom secureRandom, Provider provider) throws PGPException, NoSuchProviderException {
        ArrayList arrayList = new ArrayList();
        this.keys = arrayList;
        this.certificationLevel = i2;
        this.masterKey = pGPKeyPair;
        this.id = str;
        this.encAlgorithm = i3;
        ...
        arrayList.add(new PGPSecretKey(i2, pGPKeyPair, str, i3, cArr, z2, pGPSignatureSubpacketVector, pGPSignatureSubpacketVector2, secureRandom, provider));
    }
