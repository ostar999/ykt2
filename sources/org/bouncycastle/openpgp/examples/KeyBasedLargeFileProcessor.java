...
public class KeyBasedLargeFileProcessor {
    private static void decryptFile(InputStream inputStream, InputStream inputStream2, char[] cArr, String str) throws IOException, NoSuchProviderException, PGPException {
        ...
        try {
            ...
            Iterator encryptedDataObjects = ((PGPEncryptedDataList) objNextObject).getEncryptedDataObjects();
            ...
            Object objNextObject2 = new PGPObjectFactory(new BufferedInputStream(((PGPCompressedData) new PGPObjectFactory(pGPPublicKeyEncryptedData.getDataStream(pGPPrivateKeyFindSecretKey, "BC")).nextObject()).getDataStream())).nextObject();
    ...
    private static void decryptFile(String str, String str2, char[] cArr, String str3) throws IOException, NoSuchProviderException, PGPException {
    ...
    private static void encryptFile(OutputStream outputStream, String str, PGPPublicKey pGPPublicKey, boolean z2, boolean z3) throws IOException, NoSuchProviderException {
        if (z2) {
    ...
    private static void encryptFile(String str, String str2, String str3, boolean z2, boolean z3) throws IOException, NoSuchProviderException, PGPException {
        BufferedOutputStream bufferedOutputStream = new BufferedOutputStream(new FileOutputStream(str));
