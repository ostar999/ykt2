...
public class PKCS12Example {
    ...
    public static Certificate createCert(PublicKey publicKey, PrivateKey privateKey, PublicKey publicKey2) throws Exception {
        ...
        DERObjectIdentifier dERObjectIdentifier = X509Name.C;
        hashtable.put(dERObjectIdentifier, "AU");
        DERObjectIdentifier dERObjectIdentifier2 = X509Name.O;
        hashtable.put(dERObjectIdentifier2, "The Legion of the Bouncy Castle");
        DERObjectIdentifier dERObjectIdentifier3 = X509Name.OU;
        ...
        DERObjectIdentifier dERObjectIdentifier5 = X509Name.L;
        hashtable2.put(dERObjectIdentifier5, "Melbourne");
        DERObjectIdentifier dERObjectIdentifier6 = X509Name.CN;
    ...
    public static void main(String[] strArr) throws Exception {
        ...
        Certificate certificateCreateMasterCert = createMasterCert(publicKeyGeneratePublic, privateKeyGeneratePrivate);
        Certificate[] certificateArr = {createCert(publicKeyGeneratePublic3, privateKeyGeneratePrivate2, publicKeyGeneratePublic2), createIntermediateCert(publicKeyGeneratePublic2, privateKeyGeneratePrivate, (X509Certificate) certificateCreateMasterCert), certificateCreateMasterCert};
