...
public class JCESecretKeyFactory extends SecretKeyFactorySpi implements PBE {
    ...
    public static class DESPBEKeyFactory extends JCESecretKeyFactory {
        ...
        public DESPBEKeyFactory(String str, DERObjectIdentifier dERObjectIdentifier, boolean z2, int i2, int i3, int i4, int i5) {
    ...
    public static class PBEKeyFactory extends JCESecretKeyFactory {
        ...
        public PBEKeyFactory(String str, DERObjectIdentifier dERObjectIdentifier, boolean z2, int i2, int i3, int i4, int i5) {
            super(str, dERObjectIdentifier);
            this.forCipher = z2;
            this.scheme = i2;
            this.digest = i3;
    ...
    public SecretKey engineTranslateKey(SecretKey secretKey) throws InvalidKeyException {
        ...
        throw new InvalidKeyException("Key not of type " + this.algName + StrPool.DOT);
    }
}
