...
public class JCEElGamalPublicKey implements ElGamalPublicKey, DHPublicKey {
    ...
    public JCEElGamalPublicKey(SubjectPublicKeyInfo subjectPublicKeyInfo) {
        ...
        try {
            this.f27895y = ((DERInteger) subjectPublicKeyInfo.getPublicKey()).getValue();
    ...
    public JCEElGamalPublicKey(ElGamalPublicKeyParameters elGamalPublicKeyParameters) {
        this.f27895y = elGamalPublicKeyParameters.getY();
    ...
    private void readObject(ObjectInputStream objectInputStream) throws IOException, ClassNotFoundException {
        this.f27895y = (BigInteger) objectInputStream.readObject();
    ...
    public byte[] getEncoded() {
        return new SubjectPublicKeyInfo(new AlgorithmIdentifier(OIWObjectIdentifiers.elGamalAlgorithm, new ElGamalParameter(this.elSpec.getP(), this.elSpec.getG()).getDERObject()), new DERInteger(this.f27895y)).getDEREncoded();
    }
