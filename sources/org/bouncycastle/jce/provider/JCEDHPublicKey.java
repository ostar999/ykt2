...
public class JCEDHPublicKey implements DHPublicKey {
    ...
    private BigInteger f27891y;

    public JCEDHPublicKey(BigInteger bigInteger, DHParameterSpec dHParameterSpec) {
        this.f27891y = bigInteger;
        this.dhSpec = dHParameterSpec;
    }

    public JCEDHPublicKey(DHPublicKey dHPublicKey) {
        this.f27891y = dHPublicKey.getY();
        this.dhSpec = dHPublicKey.getParams();
    }

    public JCEDHPublicKey(DHPublicKeySpec dHPublicKeySpec) {
        this.f27891y = dHPublicKeySpec.getY();
    ...
    public JCEDHPublicKey(SubjectPublicKeyInfo subjectPublicKeyInfo) {
        ...
        try {
            this.f27891y = ((DERInteger) subjectPublicKeyInfo.getPublicKey()).getValue();
    ...
    public JCEDHPublicKey(DHPublicKeyParameters dHPublicKeyParameters) {
        this.f27891y = dHPublicKeyParameters.getY();
    ...
    private void readObject(ObjectInputStream objectInputStream) throws IOException, ClassNotFoundException {
        this.f27891y = (BigInteger) objectInputStream.readObject();
    ...
    public byte[] getEncoded() {
        ...
        return subjectPublicKeyInfo != null ? subjectPublicKeyInfo.getDEREncoded() : new SubjectPublicKeyInfo(new AlgorithmIdentifier(PKCSObjectIdentifiers.dhKeyAgreement, new DHParameter(this.dhSpec.getP(), this.dhSpec.getG(), this.dhSpec.getL()).getDERObject()), new DERInteger(this.f27891y)).getDEREncoded();
    }
