...
public class CscaMasterList extends ASN1Encodable {
    ...
    private CscaMasterList(ASN1Sequence aSN1Sequence) {
        ...
        while (true) {
            ...
            x509CertificateStructureArr[i2] = X509CertificateStructure.getInstance(aSN1Set.getObjectAt(i2));
            i2++;
        }
    }
    ...
    private X509CertificateStructure[] copyCertList(X509CertificateStructure[] x509CertificateStructureArr) {
        ...
        for (int i2 = 0; i2 != length; i2++) {
            x509CertificateStructureArr2[i2] = x509CertificateStructureArr[i2];
        }
    ...
    public DERObject toASN1Object() {
        ...
        while (true) {
            ...
            aSN1EncodableVector2.add(x509CertificateStructureArr[i2]);
            i2++;
        }
    }
}
