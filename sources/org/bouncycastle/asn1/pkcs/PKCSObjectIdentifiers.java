...
public interface PKCSObjectIdentifiers {
    ...
    static {
        ...
        id_hmacWithSHA224 = aSN1ObjectIdentifier5.branch(Constants.VIA_SHARE_TYPE_PUBLISHVIDEO);
        id_hmacWithSHA256 = aSN1ObjectIdentifier5.branch(Constants.VIA_SHARE_TYPE_MINI_PROGRAM);
        id_hmacWithSHA384 = aSN1ObjectIdentifier5.branch(Constants.VIA_REPORT_TYPE_SHARE_TO_QQ);
        id_hmacWithSHA512 = aSN1ObjectIdentifier5.branch(Constants.VIA_REPORT_TYPE_SHARE_TO_QZONE);
        ...
        pkcs_9_at_counterSignature = aSN1ObjectIdentifier6.branch(Constants.VIA_SHARE_TYPE_INFO);
        pkcs_9_at_challengePassword = aSN1ObjectIdentifier6.branch("7");
        pkcs_9_at_unstructuredAddress = aSN1ObjectIdentifier6.branch(Constants.VIA_SHARE_TYPE_PUBLISHVIDEO);
        pkcs_9_at_extendedCertificateAttributes = aSN1ObjectIdentifier6.branch(Constants.VIA_SHARE_TYPE_MINI_PROGRAM);
        pkcs_9_at_signingDescription = aSN1ObjectIdentifier6.branch(Constants.VIA_REPORT_TYPE_JOININ_GROUP);
        pkcs_9_at_extensionRequest = aSN1ObjectIdentifier6.branch(Constants.VIA_REPORT_TYPE_MAKE_FRIEND);
        pkcs_9_at_smimeCapabilities = aSN1ObjectIdentifier6.branch(Constants.VIA_REPORT_TYPE_WPA_STATE);
        ...
        x509Certificate = aSN1ObjectIdentifierBranch.branch("1");
        sdsiCertificate = aSN1ObjectIdentifierBranch.branch("2");
        ...
        x509Crl = aSN1ObjectIdentifierBranch2.branch("1");
        ...
        ASN1ObjectIdentifier aSN1ObjectIdentifierBranch3 = aSN1ObjectIdentifier9.branch(Constants.VIA_REPORT_TYPE_WPA_STATE);
        id_aa_ets_sigPolicyId = aSN1ObjectIdentifierBranch3;
        ASN1ObjectIdentifier aSN1ObjectIdentifierBranch4 = aSN1ObjectIdentifier9.branch("16");
        id_aa_ets_commitmentType = aSN1ObjectIdentifierBranch4;
        ASN1ObjectIdentifier aSN1ObjectIdentifierBranch5 = aSN1ObjectIdentifier9.branch(Constants.VIA_REPORT_TYPE_START_GROUP);
        id_aa_ets_signerLocation = aSN1ObjectIdentifierBranch5;
        id_aa_ets_signerAttr = aSN1ObjectIdentifier9.branch("18");
        ASN1ObjectIdentifier aSN1ObjectIdentifierBranch6 = aSN1ObjectIdentifier9.branch(Constants.VIA_ACT_TYPE_NINETEEN);
        id_aa_ets_otherSigCert = aSN1ObjectIdentifierBranch6;
        ...
        id_aa_sigPolicyId = aSN1ObjectIdentifierBranch3;
        id_aa_commitmentType = aSN1ObjectIdentifierBranch4;
        id_aa_signerLocation = aSN1ObjectIdentifierBranch5;
        id_aa_otherSigCert = aSN1ObjectIdentifierBranch6;
        ...
        ASN1ObjectIdentifier aSN1ObjectIdentifierBranch7 = aSN1ObjectIdentifier10.branch("10.1");
        bagtypes = aSN1ObjectIdentifierBranch7;
        keyBag = aSN1ObjectIdentifierBranch7.branch("1");
        pkcs8ShroudedKeyBag = aSN1ObjectIdentifierBranch7.branch("2");
        certBag = aSN1ObjectIdentifierBranch7.branch("3");
        crlBag = aSN1ObjectIdentifierBranch7.branch("4");
        secretBag = aSN1ObjectIdentifierBranch7.branch("5");
        safeContentsBag = aSN1ObjectIdentifierBranch7.branch(Constants.VIA_SHARE_TYPE_INFO);
        ASN1ObjectIdentifier aSN1ObjectIdentifierBranch8 = aSN1ObjectIdentifier10.branch("1");
        pkcs_12PbeIds = aSN1ObjectIdentifierBranch8;
        pbeWithSHAAnd128BitRC4 = aSN1ObjectIdentifierBranch8.branch("1");
        pbeWithSHAAnd40BitRC4 = aSN1ObjectIdentifierBranch8.branch("2");
        pbeWithSHAAnd3_KeyTripleDES_CBC = aSN1ObjectIdentifierBranch8.branch("3");
        pbeWithSHAAnd2_KeyTripleDES_CBC = aSN1ObjectIdentifierBranch8.branch("4");
        pbeWithSHAAnd128BitRC2_CBC = aSN1ObjectIdentifierBranch8.branch("5");
        pbewithSHAAnd40BitRC2_CBC = aSN1ObjectIdentifierBranch8.branch(Constants.VIA_SHARE_TYPE_INFO);
