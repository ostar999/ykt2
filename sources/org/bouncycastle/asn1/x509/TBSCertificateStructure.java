...
public class TBSCertificateStructure extends ASN1Encodable implements X509ObjectIdentifiers, PKCSObjectIdentifiers {
    ...
    public TBSCertificateStructure(ASN1Sequence aSN1Sequence) {
        ...
        this.serialNumber = DERInteger.getInstance(aSN1Sequence.getObjectAt(i2 + 1));
        this.signature = AlgorithmIdentifier.getInstance(aSN1Sequence.getObjectAt(i2 + 2));
        this.issuer = X509Name.getInstance(aSN1Sequence.getObjectAt(i2 + 3));
        ...
        this.subject = X509Name.getInstance(aSN1Sequence.getObjectAt(i2 + 5));
        int i3 = i2 + 6;
