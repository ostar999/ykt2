...
public class CertificatePolicies extends ASN1Encodable {
    ...
    public String getPolicy(int i2) {
        if (this.policies.size() > i2) {
            return ((DERObjectIdentifier) this.policies.elementAt(i2)).getId();
        }
        return null;
    }
    ...
    public DERObject toASN1Object() {
        ...
        for (int i2 = 0; i2 < this.policies.size(); i2++) {
            aSN1EncodableVector.add(new DERSequence((DERObjectIdentifier) this.policies.elementAt(i2)));
        }
    ...
    public String toString() {
        ...
        for (int i2 = 0; i2 < this.policies.size(); i2++) {
            ...
            str = str + ((DERObjectIdentifier) this.policies.elementAt(i2)).getId();
        }
