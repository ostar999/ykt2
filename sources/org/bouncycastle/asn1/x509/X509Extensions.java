...
public class X509Extensions extends ASN1Encodable {
    ...
    public X509Extensions(Vector vector, Hashtable hashtable) {
        ...
        while (enumerationKeys.hasMoreElements()) {
            this.ordering.addElement(new ASN1ObjectIdentifier(((DERObjectIdentifier) enumerationKeys.nextElement()).getId()));
        }
        Enumeration enumerationElements = this.ordering.elements();
        while (enumerationElements.hasMoreElements()) {
            ASN1ObjectIdentifier aSN1ObjectIdentifier = new ASN1ObjectIdentifier(((DERObjectIdentifier) enumerationElements.nextElement()).getId());
