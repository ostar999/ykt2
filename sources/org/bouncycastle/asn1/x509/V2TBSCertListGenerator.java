...
public class V2TBSCertListGenerator {
    ...
    public void addCRLEntry(DERInteger dERInteger, DERUTCTime dERUTCTime, int i2) {
        addCRLEntry(dERInteger, new Time(dERUTCTime), i2);
    }

    public void addCRLEntry(DERInteger dERInteger, Time time, int i2) {
        addCRLEntry(dERInteger, time, i2, null);
    }

    public void addCRLEntry(DERInteger dERInteger, Time time, int i2, DERGeneralizedTime dERGeneralizedTime) {
        Vector vector = new Vector();
        Vector vector2 = new Vector();
        if (i2 != 0) {
            CRLReason cRLReason = new CRLReason(i2);
            try {
        ...
        if (dERGeneralizedTime != null) {
            try {
                ...
                throw new IllegalArgumentException("error encoding invalidityDate: " + e3);
            }
        }
