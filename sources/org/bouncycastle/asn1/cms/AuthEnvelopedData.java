...
public class AuthEnvelopedData extends ASN1Encodable {
    ...
    public AuthEnvelopedData(ASN1Sequence aSN1Sequence) {
        ...
        int i3 = i2 + 1;
        this.authEncryptedContentInfo = EncryptedContentInfo.getInstance(aSN1Sequence.getObjectAt(i2).getDERObject());
        int i4 = i3 + 1;
        DERObject dERObject2 = aSN1Sequence.getObjectAt(i3).getDERObject();
        if (dERObject2 instanceof ASN1TaggedObject) {
            this.authAttrs = ASN1Set.getInstance((ASN1TaggedObject) dERObject2, false);
            int i5 = i4 + 1;
            DERObject dERObject3 = aSN1Sequence.getObjectAt(i4).getDERObject();
            i4 = i5;
