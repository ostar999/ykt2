...
public class ContentHints extends ASN1Encodable {
    ...
    private ContentHints(ASN1Sequence aSN1Sequence) {
        ...
        this.contentType = DERObjectIdentifier.getInstance(aSN1Sequence.getObjectAt(i2));
    }
    ...
    public static ContentHints getInstance(Object obj) {
        ...
        throw new IllegalArgumentException("unknown object in 'ContentHints' factory : " + obj.getClass().getName() + StrPool.DOT);
    }
