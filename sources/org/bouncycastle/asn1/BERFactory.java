...
class BERFactory {
    ...
    public static BERSet createSet(ASN1EncodableVector aSN1EncodableVector, boolean z2) {
        return aSN1EncodableVector.size() < 1 ? EMPTY_SET : new BERSet(aSN1EncodableVector, z2);
    }
}
