...
public class BCStyle implements X500NameStyle {
    ...
    static {
        ...
        hashtable2.put(am.aF, aSN1ObjectIdentifier);
        hashtable2.put("o", aSN1ObjectIdentifier2);
        hashtable2.put("t", aSN1ObjectIdentifier4);
        hashtable2.put("ou", aSN1ObjectIdentifier3);
        hashtable2.put(AdvanceSetting.CLEAR_NOTIFICATION, aSN1ObjectIdentifier5);
        hashtable2.put(NotifyType.LIGHTS, aSN1ObjectIdentifier8);
        ...
        hashtable2.put(SocializeProtocolConstants.PROTOCOL_KEY_DESCRIPTOR, aSN1ObjectIdentifier31);
        hashtable2.put(AliyunLogKey.KEY_EVENT, aSN1ObjectIdentifier28);
        ...
        hashtable2.put(AliyunLogKey.KEY_DEFINITION, aSN1ObjectIdentifier17);
        ...
        for (int i2 = 0; i2 < rDNs.length; i2++) {
            ...
            if (rDNs[i2].isMultiValued()) {
                ...
                for (int i3 = 0; i3 != typesAndValues.length; i3++) {
                    ...
                    IETFUtils.appendTypeAndValue(stringBuffer, typesAndValues[i3], DefaultSymbols);
                }
            } else {
                IETFUtils.appendTypeAndValue(stringBuffer, rDNs[i2].getFirst(), DefaultSymbols);
            }
        }
