...
public class RFC4519Style implements X500NameStyle {
    ...
    public static final ASN1ObjectIdentifier f27775c;

    /* renamed from: cn, reason: collision with root package name */
    public static final ASN1ObjectIdentifier f27776cn;
    ...
    public static final ASN1ObjectIdentifier f27777l;
    public static final ASN1ObjectIdentifier member;
    public static final ASN1ObjectIdentifier name;

    /* renamed from: o, reason: collision with root package name */
    public static final ASN1ObjectIdentifier f27778o;
    ...
    static {
        ...
        f27777l = aSN1ObjectIdentifier16;
        ...
        f27778o = aSN1ObjectIdentifier19;
        ...
        hashtable.put(aSN1ObjectIdentifier2, am.aF);
        hashtable.put(aSN1ObjectIdentifier3, AdvanceSetting.CLEAR_NOTIFICATION);
        hashtable.put(aSN1ObjectIdentifier4, SocializeProtocolConstants.PROTOCOL_KEY_DESCRIPTOR);
        ...
        hashtable.put(aSN1ObjectIdentifier16, NotifyType.LIGHTS);
        ...
        hashtable2.put(am.aF, aSN1ObjectIdentifier2);
        hashtable2.put(AdvanceSetting.CLEAR_NOTIFICATION, aSN1ObjectIdentifier3);
        hashtable2.put(SocializeProtocolConstants.PROTOCOL_KEY_DESCRIPTOR, aSN1ObjectIdentifier4);
        ...
        hashtable2.put(NotifyType.LIGHTS, aSN1ObjectIdentifier16);
    ...
    public ASN1Encodable stringToValue(ASN1ObjectIdentifier aSN1ObjectIdentifier, String str) {
        if (str.length() == 0 || str.charAt(0) != '#') {
            ...
            return aSN1ObjectIdentifier.equals(dc) ? new DERIA5String(str) : (aSN1ObjectIdentifier.equals(f27775c) || aSN1ObjectIdentifier.equals(serialNumber) || aSN1ObjectIdentifier.equals(dnQualifier) || aSN1ObjectIdentifier.equals(telephoneNumber)) ? new DERPrintableString(str) : new DERUTF8String(str);
        }
        try {
