    ...
    public void setAttrCertCheckers(Set set) {
        ...
        while (it.hasNext()) {
            if (!(it.next() instanceof PKIXAttrCertChecker)) {
                throw new ClassCastException("All elements of set must be of type " + PKIXAttrCertChecker.class.getName() + StrPool.DOT);
            }
        }
        this.attrCertCheckers.clear();
    ...
    public void setTrustedACIssuers(Set set) {
        ...
        while (it.hasNext()) {
            if (!(it.next() instanceof TrustAnchor)) {
                throw new ClassCastException("All elements of set must be of type " + TrustAnchor.class.getName() + StrPool.DOT);
            }
        }
        this.trustedACIssuers.clear();
