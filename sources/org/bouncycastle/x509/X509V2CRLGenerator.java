...
public class X509V2CRLGenerator {
    ...
    public void addCRLEntry(BigInteger bigInteger, Date date, int i2) {
        this.tbsGen.addCRLEntry(new DERInteger(bigInteger), new Time(date), i2);
    }

    public void addCRLEntry(BigInteger bigInteger, Date date, int i2, Date date2) {
        this.tbsGen.addCRLEntry(new DERInteger(bigInteger), new Time(date), i2, new DERGeneralizedTime(date2));
    }
    ...
    public void addExtension(String str, boolean z2, DEREncodable dEREncodable) {
        addExtension(new DERObjectIdentifier(str), z2, dEREncodable);
    }
    ...
    public void addExtension(DERObjectIdentifier dERObjectIdentifier, boolean z2, DEREncodable dEREncodable) {
        this.extGenerator.addExtension(dERObjectIdentifier, z2, dEREncodable);
    }

    public void addExtension(DERObjectIdentifier dERObjectIdentifier, boolean z2, byte[] bArr) {
        this.extGenerator.addExtension(dERObjectIdentifier, z2, bArr);
    }
