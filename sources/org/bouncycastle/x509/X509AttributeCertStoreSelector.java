...
public class X509AttributeCertStoreSelector implements Selector {
    ...
    public boolean match(Object obj) {
        ...
        if ((!this.targetNames.isEmpty() || !this.targetGroups.isEmpty()) && (extensionValue = x509AttributeCertificate.getExtensionValue(X509Extensions.TargetInformation.getId())) != null) {
            try {
                targetsObjects = TargetInformation.getInstance(new ASN1InputStream(((DEROctetString) ASN1Object.fromByteArray(extensionValue)).getOctets()).readObject()).getTargetsObjects();
