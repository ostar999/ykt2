...
public class X509V2AttributeCertificate implements X509AttributeCertificate {
    ...
    private Set getExtensionOIDs(boolean z2) {
        ...
        while (enumerationOids.hasMoreElements()) {
            ...
            if (extensions.getExtension(dERObjectIdentifier).isCritical() == z2) {
    ...
    public X509Attribute[] getAttributes() {
        ...
        for (int i2 = 0; i2 != attributes.size(); i2++) {
            x509AttributeArr[i2] = new X509Attribute((ASN1Encodable) attributes.getObjectAt(i2));
        }
    ...
    public X509Attribute[] getAttributes(String str) {
        ...
        for (int i2 = 0; i2 != attributes.size(); i2++) {
            X509Attribute x509Attribute = new X509Attribute((ASN1Encodable) attributes.getObjectAt(i2));
