...
public class AttrCertExample {
    ...
    public static X509Certificate createClientCert(PublicKey publicKey, PrivateKey privateKey, PublicKey publicKey2) throws Exception {
        ...
        DERObjectIdentifier dERObjectIdentifier3 = X509Name.L;
        hashtable.put(dERObjectIdentifier3, "Melbourne");
        DERObjectIdentifier dERObjectIdentifier4 = X509Name.CN;
    ...
    public static void main(String[] strArr) throws Exception {
        ...
        X509V2AttributeCertificate x509V2AttributeCertificate = (X509V2AttributeCertificate) x509V2AttributeCertificateGenerator.generate(privateKeyGeneratePrivate, "BC");
