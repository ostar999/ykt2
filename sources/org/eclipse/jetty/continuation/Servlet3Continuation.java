...
public class Servlet3Continuation implements Continuation {
    ...
    public void suspend(ServletResponse servletResponse) {
        ...
        this._resumed = false;
        this._expired = false;
        AsyncContext asyncContextStartAsync = this._request.startAsync();
        this._context = asyncContextStartAsync;
        asyncContextStartAsync.setTimeout(this._timeoutMs);
        Iterator<AsyncListener> it = this._listeners.iterator();
        while (it.hasNext()) {
