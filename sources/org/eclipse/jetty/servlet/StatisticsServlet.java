...
public class StatisticsServlet extends HttpServlet {
    ...
    public void doGet(HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse) throws ServletException, IOException {
        ...
        String parameter = httpServletRequest.getParameter(AliyunVodHttpCommon.Format.FORMAT_XML);
        if (parameter == null) {
            parameter = httpServletRequest.getParameter("XML");
        }
        if (parameter == null || !a.f27523u.equalsIgnoreCase(parameter)) {
    ...
    public void init() throws ServletException {
        ...
        if (getInitParameter("restrictToLocalhost") != null) {
            this._restrictToLocalhost = a.f27523u.equals(getInitParameter("restrictToLocalhost"));
        }
    }
}
