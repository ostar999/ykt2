...
public class BufferCache {
    ...
    public CachedBuffer add(String str, int i2) {
        ...
        if (this._index.get(i2) == null) {
            this._index.add(i2, cachedBuffer);
        }
        return cachedBuffer;
    }
    ...
    public CachedBuffer get(int i2) {
        ...
        return (CachedBuffer) this._index.get(i2);
    }

    public CachedBuffer getBest(byte[] bArr, int i2, int i3) {
        Map.Entry bestEntry = this._stringMap.getBestEntry(bArr, i2, i3);
        if (bestEntry != null) {
    ...
    public String toString() {
        return "CACHE[bufferMap=" + this._bufferMap + ",stringMap=" + this._stringMap + ",index=" + this._index + StrPool.BRACKET_END;
    }
