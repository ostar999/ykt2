...
public class SslSocketConnector extends SocketConnector implements SslConnector {
        ...
        public void run() throws IOException {
            try {
                ...
                sSLSocket.addHandshakeCompletedListener(new HandshakeCompletedListener() { // from class: org.eclipse.jetty.server.ssl.SslSocketConnector.SslConnectorEndPoint.1
                    ...
                    public void handshakeCompleted(HandshakeCompletedEvent handshakeCompletedEvent) throws IOException {
                        if (!this.handshook) {
                            this.handshook = true;
                            return;
                        }
    ...
    public ServerSocket newServerSocket(String str, int i2, int i3) throws IOException {
        return this._sslContextFactory.newSslServerSocket(str, i2, i3);
    }
