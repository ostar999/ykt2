...
public class HttpHeaders extends BufferCache {
    ...
    static {
        ...
        ACCEPT_CHARSET_BUFFER = httpHeaders.add("Accept-Charset", 20);
        ...
        TRANSFER_ENCODING_BUFFER = httpHeaders.add("Transfer-Encoding", 5);
        ...
        CONTENT_LANGUAGE_BUFFER = httpHeaders.add("Content-Language", 11);
        CONTENT_LOCATION_BUFFER = httpHeaders.add("Content-Location", 13);
        ...
        IF_RANGE_BUFFER = httpHeaders.add("If-Range", 31);
        IF_UNMODIFIED_SINCE_BUFFER = httpHeaders.add("If-Unmodified-Since", 32);
        KEEP_ALIVE_BUFFER = httpHeaders.add("Keep-Alive", 33);
        MAX_FORWARDS_BUFFER = httpHeaders.add("Max-Forwards", 34);
        PROXY_AUTHORIZATION_BUFFER = httpHeaders.add("Proxy-Authorization", 35);
        ...
        X_FORWARDED_FOR_BUFFER = httpHeaders.add("X-Forwarded-For", 41);
        X_FORWARDED_PROTO_BUFFER = httpHeaders.add("X-Forwarded-Proto", 59);
        X_FORWARDED_SERVER_BUFFER = httpHeaders.add(X_FORWARDED_SERVER, 60);
        X_FORWARDED_HOST_BUFFER = httpHeaders.add("X-Forwarded-Host", 61);
        ACCEPT_RANGES_BUFFER = httpHeaders.add("Accept-Ranges", 42);
        AGE_BUFFER = httpHeaders.add("Age", 43);
        ETAG_BUFFER = httpHeaders.add("ETag", 44);
        LOCATION_BUFFER = httpHeaders.add("Location", 45);
        PROXY_AUTHENTICATE_BUFFER = httpHeaders.add("Proxy-Authenticate", 46);
        RETRY_AFTER_BUFFER = httpHeaders.add("Retry-After", 47);
        ...
        WWW_AUTHENTICATE_BUFFER = httpHeaders.add("WWW-Authenticate", 51);
