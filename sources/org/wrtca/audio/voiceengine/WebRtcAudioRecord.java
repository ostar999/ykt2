...
public class WebRtcAudioRecord {
    ...
    private static WebRtcAudioRecordDataCallback recordDataCallback;
    ...
    public class AudioRecordThread extends Thread {
        ...
        public void run() throws IllegalStateException, SecurityException, IllegalArgumentException {
            ...
            while (this.keepAlive) {
                int i2 = WebRtcAudioRecord.this.audioRecord.read(WebRtcAudioRecord.this.byteBuffer, WebRtcAudioRecord.this.byteBuffer.capacity());
    ...
    public interface WebRtcAudioRecordDataCallback {
        void onWebRtcMicData();

        void onWebRtcMicLevel(int i2);
    }
    ...
    private int initRecording(int i2, int i3) throws IllegalStateException {
        ...
        int minBufferSize = AudioRecord.getMinBufferSize(i2, iChannelCountToConfiguration, 2);
        ...
        try {
            AudioRecord audioRecord = new AudioRecord(audioSource, i2, iChannelCountToConfiguration, 2, iMax);
    ...
    public static void setRecordDataCallback(WebRtcAudioRecordDataCallback webRtcAudioRecordDataCallback) {
        Logging.d(TAG, "Set error callback");
        recordDataCallback = webRtcAudioRecordDataCallback;
    }

    private boolean startRecording() throws IllegalStateException {
        h.a(TAG, "startRecording");
