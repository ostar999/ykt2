...
public class DrawTask implements IDrawTask {
    ...
    private DanmakuContext.ConfigChangedCallback mConfigChangedCallback = new DanmakuContext.ConfigChangedCallback() { // from class: net.polyv.danmaku.controller.DrawTask.1
    ...
    public DrawTask(DanmakuTimer danmakuTimer, DanmakuContext danmakuContext, IDrawTask.TaskListener taskListener) {
        ...
        danmakuRenderer.setOnDanmakuShownListener(new IRenderer.OnDanmakuShownListener() { // from class: net.polyv.danmaku.controller.DrawTask.2
    ...
    */
    public net.polyv.danmaku.danmaku.renderer.IRenderer.RenderingState drawDanmakus(net.polyv.danmaku.danmaku.model.AbsDisplayer r22, net.polyv.danmaku.danmaku.model.DanmakuTimer r23) {
        /*
            r21 = this;
            r0 = r21
            ...
            r2 = 0
            if (r1 == 0) goto Le
            net.polyv.danmaku.danmaku.renderer.IRenderer r1 = r0.mRenderer
            r1.clearRetainer()
            r0.clearRetainerFlag = r2
        Le:
            net.polyv.danmaku.danmaku.model.IDanmakus r1 = r0.danmakuList
            r3 = 0
            if (r1 == 0) goto Lc6
            java.lang.Object r1 = r22.getExtraData()
            android.graphics.Canvas r1 = (android.graphics.Canvas) r1
            net.polyv.danmaku.controller.DrawHelper.clearCanvas(r1)
            boolean r1 = r0.mIsHidden
            if (r1 == 0) goto L27
            boolean r1 = r0.mRequestRender
            if (r1 != 0) goto L27
            net.polyv.danmaku.danmaku.renderer.IRenderer$RenderingState r1 = r0.mRenderingState
            return r1
        L27:
            ...
            net.polyv.danmaku.danmaku.model.android.DanmakuContext r6 = r0.mContext
            net.polyv.danmaku.danmaku.model.android.DanmakuFactory r6 = r6.mDanmakuFactory
            long r6 = r6.MAX_DANMAKU_DURATION
            long r8 = r4 - r6
            r10 = 100
            long r8 = r8 - r10
            long r6 = r6 + r4
            net.polyv.danmaku.danmaku.model.IDanmakus r10 = r0.danmakus
        ...
        L4a:
            ...
            goto L5d
        L4c:
            net.polyv.danmaku.danmaku.model.IDanmakus r4 = r0.danmakuList
            net.polyv.danmaku.danmaku.model.IDanmakus r4 = r4.sub(r8, r6)
            if (r4 == 0) goto L56
            r0.danmakus = r4
        L56:
            ...
            r6 = r4
        L5d:
            net.polyv.danmaku.danmaku.model.IDanmakus r4 = r0.mRunningDanmakus
            r0.beginTracing(r1, r4, r6)
            r5 = 1
            if (r4 == 0) goto L7c
            boolean r7 = r4.isEmpty()
            if (r7 != 0) goto L7c
            net.polyv.danmaku.danmaku.renderer.IRenderer$RenderingState r7 = r0.mRenderingState
            r7.isRunningDanmakus = r5
            net.polyv.danmaku.danmaku.renderer.IRenderer r15 = r0.mRenderer
            r18 = 0
            r16 = r22
            r17 = r4
            r20 = r7
        ...
        L7c:
            net.polyv.danmaku.danmaku.renderer.IRenderer$RenderingState r4 = r0.mRenderingState
            r4.isRunningDanmakus = r2
            if (r6 == 0) goto Lbf
            boolean r2 = r6.isEmpty()
            if (r2 != 0) goto Lbf
            net.polyv.danmaku.danmaku.renderer.IRenderer r4 = r0.mRenderer
            net.polyv.danmaku.danmaku.model.AbsDisplayer r5 = r0.mDisp
            ...
            if (r2 == 0) goto Lbe
            net.polyv.danmaku.danmaku.model.BaseDanmaku r2 = r0.mLastDanmaku
            if (r2 == 0) goto Lac
            boolean r2 = r2.isTimeOut()
            if (r2 == 0) goto Lac
            r0.mLastDanmaku = r3
            net.polyv.danmaku.controller.IDrawTask$TaskListener r2 = r0.mTaskListener
            if (r2 == 0) goto Lac
        ...
        Lc6:
            return r3
        */
        throw new UnsupportedOperationException("Method not decompiled: net.polyv.danmaku.controller.DrawTask.drawDanmakus(net.polyv.danmaku.danmaku.model.AbsDisplayer, net.polyv.danmaku.danmaku.model.DanmakuTimer):net.polyv.danmaku.danmaku.renderer.IRenderer$RenderingState");
    }
    ...
    public IDanmakus getVisibleDanmakusOnTime(long j2) {
        ...
        if (iDanmakusSubnew != null && !iDanmakusSubnew.isEmpty()) {
            iDanmakusSubnew.forEachSync(new IDanmakus.DefaultConsumer<BaseDanmaku>() { // from class: net.polyv.danmaku.controller.DrawTask.5
    ...
    public void loadDanmakus(BaseDanmakuParser baseDanmakuParser) {
        this.danmakuList = baseDanmakuParser.setConfig(this.mContext).setDisplayer(this.mDisp).setTimer(this.mTimer).setListener(new BaseDanmakuParser.Listener() { // from class: net.polyv.danmaku.controller.DrawTask.6
    ...
    public synchronized void removeAllLiveDanmakus() {
        ...
        if (iDanmakus != null && !iDanmakus.isEmpty()) {
            synchronized (this.danmakus) {
                this.danmakus.forEachSync(new IDanmakus.DefaultConsumer<BaseDanmaku>() { // from class: net.polyv.danmaku.controller.DrawTask.3
                    @Override // net.polyv.danmaku.danmaku.model.IDanmakus.Consumer
                    public int accept(BaseDanmaku baseDanmaku) {
                        if (!baseDanmaku.isLive) {
                            return 0;
    ...
    public synchronized void removeUnusedLiveDanmakusIn(final int i2) {
        ...
        if (iDanmakus != null && !iDanmakus.isEmpty() && !this.mLiveDanmakus.isEmpty()) {
            this.mLiveDanmakus.forEachSync(new IDanmakus.DefaultConsumer<BaseDanmaku>() { // from class: net.polyv.danmaku.controller.DrawTask.4
    ...
    public void requestSync(long j2, long j3, final long j4) {
        ...
        iDanmakusObtainRunningDanmakus.forEachSync(new IDanmakus.DefaultConsumer<BaseDanmaku>() { // from class: net.polyv.danmaku.controller.DrawTask.7
            @Override // net.polyv.danmaku.danmaku.model.IDanmakus.Consumer
            public int accept(BaseDanmaku baseDanmaku) {
