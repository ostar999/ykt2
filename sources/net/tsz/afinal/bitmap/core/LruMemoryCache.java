    ...
    */
    private void trimToSize(int r5) {
        ...
        L71:
            ...
            throw r5
        */
        throw new UnsupportedOperationException("Method not decompiled: net.tsz.afinal.bitmap.core.LruMemoryCache.trimToSize(int):void");
    }
    ...
    public final synchronized String toString() {
        ...
        return String.format("LruMemoryCache[maxSize=%d,hits=%d,misses=%d,hitRate=%d%%]", Integer.valueOf(this.maxSize), Integer.valueOf(this.hitCount), Integer.valueOf(this.missCount), Integer.valueOf(i3 != 0 ? (i2 * 100) / i3 : 0));
    }
}
