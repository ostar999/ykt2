...
public class SpecialDanmaku extends BaseDanmaku {
    ...
    public class LinePath {
        ...
        public float[] getBeginPoint() {
            ...
            return new float[]{point.f27740x, point.f27741y};
        }
        ...
        public void setPoints(Point point, Point point2) {
            this.pBegin = point;
            this.pEnd = point2;
            this.delatX = point2.f27740x - point.f27740x;
            this.deltaY = point2.f27741y - point.f27741y;
        }
    }
    ...
    public class Point {
        ...
        public float getDistance(Point point) {
            float fAbs = Math.abs(this.f27740x - point.f27740x);
            float fAbs2 = Math.abs(this.f27741y - point.f27741y);
        ...
        if (j5 > 0 && j4 >= 0 && j4 <= j5) {
            ...
            if (linePathArr2 != null) {
                ...
                if (linePath != null) {
                    ...
                    float f10 = point2.f27740x;
                    float f11 = point2.f27741y;
                    if (f7 != 0.0f) {
                        f4 = f10 + (f7 * f9);
                    }
                    if (f8 != 0.0f) {
